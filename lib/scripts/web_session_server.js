...
const state = {
  ...
  console_errors: 0,
  network_failures: 0,
  fixtures: { file: fixtureFile, routes: [] },
};
...
async function startBrowser() {
  ...
  if (fixtureFile) {
    const { installPlaywrightFixtures } = require("./playwright_fixtures");
    state.fixtures = await installPlaywrightFixtures(page, fixtureFile);
  }
