...
def build_bootstrap_prompt(
    *,
    ...
    return (
        ...
        "- Conversational Dylan is workspace read-only; never edit host paths "
        "(Desktop/Documents/Downloads/Library/ssh/lumen secrets).\n"
        "- Risk resolve / mark-remediated / scan schedule updates must use Lumen CLIs "
        "(Capability Broker). Do not edit LaunchAgents yourself.\n"
