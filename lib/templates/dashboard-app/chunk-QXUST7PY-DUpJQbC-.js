...
import { b as r, h as i } from "./chunk-ABZYJK2D-CVevQ3ur.js";
import { B as a, F as o, G as s, H as c, I as l, L as u, P as d, R as f, U as p, V as m, W as h, h as g, z as _ } from "./chunk-S3R3BYOJ-BtVK2Rr4.js";
import { t as v } from "./line-BTdGI09n.js";
import { n as y, r as b, t as x } from "./chunk-HN2XXSSU-BzJE2DVW.js";
import { t as S } from "./chunk-CVBHYZKI-utcCkCdu.js";
import { i as C, n as w } from "./chunk-ATLVNIR6-CY_EFS1R.js";
import { n as T } from "./chunk-JA3XYJ7Z-RwfPEVEr.js";
import { d as E, r as D } from "./chunk-JZLCHNYA-Ci7qRJgj.js";
//#region node_modules/mermaid/dist/chunks/mermaid.core/chunk-QXUST7PY.mjs
var ee = /* @__PURE__ */ t((e, t, n, r, i, a) => {
	t.arrowTypeStart && k(e, "start", t.arrowTypeStart, n, r, i, a), t.arrowTypeEnd && k(e, "end", t.arrowTypeEnd, n, r, i, a);
}, "addEdgeMarkers"), O = {
	arrow_cross: {
		type: "cross",
		fill: !1
...
}, k = /* @__PURE__ */ t((t, n, r, i, a, o, s) => {
	let c = O[r];
	if (!c) {
		e.warn(`Unknown arrow type: ${r}`);
		return;
	}
	let l = `${a}_${o}-${c.type}${n === "start" ? "Start" : "End"}`;
	if (s && s.trim() !== "") {
		let e = `${l}_${s.replace(/[^\dA-Za-z]/g, "_")}`;
		if (!document.getElementById(e)) {
			let t = document.getElementById(l);
			if (t) {
				let n = t.cloneNode(!0);
				n.id = e, n.querySelectorAll("path, circle, line").forEach((e) => {
					e.setAttribute("stroke", s), c.fill && e.setAttribute("fill", s);
				}), t.parentNode?.appendChild(n);
			}
		}
		t.attr(`marker-${n}`, `url(${i}#${e})`);
	} else t.attr(`marker-${n}`, `url(${i}#${l})`);
}, "addEdgeMarker"), A = /* @__PURE__ */ new Map(), j = /* @__PURE__ */ new Map(), M = /* @__PURE__ */ t(() => {
	A.clear(), j.clear();
}, "clear"), N = /* @__PURE__ */ t((e) => e ? e.reduce((e, t) => e + ";" + t, "") : "", "getLabelStyles"), P = /* @__PURE__ */ t(async (t, a) => {
	let o = i(r().flowchart.htmlLabels), { labelStyles: s } = C(a);
	a.labelStyle = s;
	let c = await T(t, a.label, {
		style: a.labelStyle,
		useHtmlLabels: o,
		addSvgBackground: !0,
		isNode: !1
	});
	e.info("abc82", a, a.labelType);
	let l = t.insert("g").attr("class", "edgeLabel"), u = l.insert("g").attr("class", "label").attr("data-id", a.id);
	...
	u.attr("transform", "translate(" + -d.width / 2 + ", " + -d.height / 2 + ")"), A.set(a.id, l), a.width = d.width, a.height = d.height;
	let f;
	if (a.startLabelLeft) {
		let e = await D(a.startLabelLeft, N(a.labelStyle)), n = t.insert("g").attr("class", "edgeTerminals"), r = n.insert("g").attr("class", "inner");
		f = r.node().appendChild(e);
		let i = e.getBBox();
		r.attr("transform", "translate(" + -i.width / 2 + ", " + -i.height / 2 + ")"), j.get(a.id) || j.set(a.id, {}), j.get(a.id).startLeft = n, F(f, a.startLabelLeft);
	}
	if (a.startLabelRight) {
		let e = await D(a.startLabelRight, N(a.labelStyle)), n = t.insert("g").attr("class", "edgeTerminals"), r = n.insert("g").attr("class", "inner");
		f = n.node().appendChild(e), r.node().appendChild(e);
		let i = e.getBBox();
		r.attr("transform", "translate(" + -i.width / 2 + ", " + -i.height / 2 + ")"), j.get(a.id) || j.set(a.id, {}), j.get(a.id).startRight = n, F(f, a.startLabelRight);
	}
	if (a.endLabelLeft) {
		let e = await D(a.endLabelLeft, N(a.labelStyle)), n = t.insert("g").attr("class", "edgeTerminals"), r = n.insert("g").attr("class", "inner");
		f = r.node().appendChild(e);
		let i = e.getBBox();
		r.attr("transform", "translate(" + -i.width / 2 + ", " + -i.height / 2 + ")"), n.node().appendChild(e), j.get(a.id) || j.set(a.id, {}), j.get(a.id).endLeft = n, F(f, a.endLabelLeft);
	}
	if (a.endLabelRight) {
		let e = await D(a.endLabelRight, N(a.labelStyle)), n = t.insert("g").attr("class", "edgeTerminals"), r = n.insert("g").attr("class", "inner");
		f = r.node().appendChild(e);
		let i = e.getBBox();
		r.attr("transform", "translate(" + -i.width / 2 + ", " + -i.height / 2 + ")"), n.node().appendChild(e), j.get(a.id) || j.set(a.id, {}), j.get(a.id).endRight = n, F(f, a.endLabelRight);
	}
	return c;
}, "insertEdgeLabel");
function F(e, t) {
...
t(F, "setTerminalWidth");
var I = /* @__PURE__ */ t((t, n) => {
	e.debug("Moving label abc88 ", t.id, t.label, A.get(t.id), n);
	let i = n.updatedPath ? n.updatedPath : n.originalPath, { subGraphTitleTotalMargin: a } = S(r());
	if (t.label) {
		let r = A.get(t.id), o = t.x, s = t.y;
		if (i) {
			let r = g.calcLabelPosition(i);
			e.debug("Moving label " + t.label + " from (", o, ",", s, ") to (", r.x, ",", r.y, ") abc88"), n.updatedPath && (o = r.x, s = r.y);
		}
		r.attr("transform", `translate(${o}, ${s + a / 2})`);
	}
	if (t.startLabelLeft) {
		let e = j.get(t.id).startLeft, n = t.x, r = t.y;
		if (i) {
			let e = g.calcTerminalLabelPosition(t.arrowTypeStart ? 10 : 0, "start_left", i);
			n = e.x, r = e.y;
		}
		e.attr("transform", `translate(${n}, ${r})`);
	}
	if (t.startLabelRight) {
		let e = j.get(t.id).startRight, n = t.x, r = t.y;
		if (i) {
			let e = g.calcTerminalLabelPosition(t.arrowTypeStart ? 10 : 0, "start_right", i);
			n = e.x, r = e.y;
		}
		e.attr("transform", `translate(${n}, ${r})`);
	}
	if (t.endLabelLeft) {
		let e = j.get(t.id).endLeft, n = t.x, r = t.y;
		if (i) {
			let e = g.calcTerminalLabelPosition(t.arrowTypeEnd ? 10 : 0, "end_left", i);
			n = e.x, r = e.y;
		}
		e.attr("transform", `translate(${n}, ${r})`);
	}
	if (t.endLabelRight) {
		let e = j.get(t.id).endRight, n = t.x, r = t.y;
		if (i) {
			let e = g.calcTerminalLabelPosition(t.arrowTypeEnd ? 10 : 0, "end_right", i);
			n = e.x, r = e.y;
		}
		e.attr("transform", `translate(${n}, ${r})`);
	}
}, "positionEdgeLabel"), L = /* @__PURE__ */ t((e, t) => {
	let n = e.x, r = e.y, i = Math.abs(t.x - n), a = Math.abs(t.y - r), o = e.width / 2, s = e.height / 2;
	return i >= o || a >= s;
}, "outsideNode"), R = /* @__PURE__ */ t((t, n, r) => {
...
}, "intersection"), z = /* @__PURE__ */ t((t, n) => {
	e.warn("abc88 cutPathAtIntersect", t, n);
	let r = [], i = t[0], a = !1;
	return t.forEach((t) => {
		if (e.info("abc88 checking point", t, n), !L(n, t) && !a) {
			let o = R(n, i, t);
...
t(B, "extractCornerPoints");
var V = /* @__PURE__ */ t(function(e, t, n) {
	let r = t.x - e.x, i = t.y - e.y, a = n / Math.sqrt(r * r + i * i);
	return {
		x: t.x - a * r,
		y: t.y - a * i
	};
}, "findAdjacentPoint"), H = /* @__PURE__ */ t(function(t) {
	let { cornerPointPositions: n } = B(t), r = [];
	for (let i = 0; i < t.length; i++) if (n.includes(i)) {
		let n = t[i - 1], a = t[i + 1], o = t[i], s = V(n, o, 5), c = V(a, o, 5), l = c.x - s.x, u = c.y - s.y;
		r.push(s);
...
}, "generateDashArray"), W = /* @__PURE__ */ t(function(t, i, y, S, C, T, D, O = !1) {
	let { handDrawnSeed: k } = r(), A = i.points, j = !1, M = C;
	var N = T;
	let P = [];
	for (let e in i.cssCompiledStyles) w(e) || P.push(i.cssCompiledStyles[e]);
	e.debug("UIO intersect check", i.points, N.x, M.x), N.intersect && M.intersect && !O && (A = A.slice(1, i.points.length - 1), A.unshift(M.intersect(A[0])), e.debug("Last point UIO", i.start, "-->", i.end, A[A.length - 1], N, N.intersect(A[A.length - 1])), A.push(N.intersect(A[A.length - 1])));
	let F = btoa(JSON.stringify(A));
	i.toCluster && (e.info("to cluster abc88", y.get(i.toCluster)), A = z(i.points, y.get(i.toCluster).node), j = !0), i.fromCluster && (e.debug("from cluster abc88", y.get(i.fromCluster), JSON.stringify(A, null, 2)), A = z(A.reverse(), y.get(i.fromCluster).node).reverse(), j = !0);
	...
	let { x: R, y: B } = x(i), V = v().x(R).y(B).curve(L), W;
	switch (i.thickness) {
		case "normal":
	...
	let K, J = i.curve === "rounded" ? G(q(I, i), 5) : V(I), Y = Array.isArray(i.style) ? i.style : [i.style], X = Y.find((e) => e?.startsWith("stroke:")), Z = !1;
	if (i.look === "handDrawn") {
		let e = E.svg(t);
		Object.assign([], I);
		let r = e.path(J, {
		...
		W += " transition", K = n(r).select("path").attr("id", i.id).attr("class", " " + W + (i.classes ? " " + i.classes : "")).attr("style", Y ? Y.reduce((e, t) => e + ";" + t, "") : "");
		let a = K.attr("d");
		K.attr("d", a), t.node().appendChild(K.node());
	} else {
		let e = P.join(";"), n = Y ? Y.reduce((e, t) => e + t + ";", "") : "", r = "";
		i.animate && (r = " edge-animation-fast"), i.animation && (r = " edge-animation-" + i.animation);
		let a = (e ? e + ";" + n + ";" : n) + ";" + (Y ? Y.reduce((e, t) => e + ";" + t, "") : "");
		K = t.append("path").attr("d", J).attr("id", i.id).attr("class", " " + W + (i.classes ? " " + i.classes : "") + (r ?? "")).attr("style", a), X = a.match(/stroke:([^;]+)/)?.[1], Z = i.animate === !0 || !!i.animation || e.includes("animation");
		let o = K.node(), s = typeof o.getTotalLength == "function" ? o.getTotalLength() : 0, c = b[i.arrowTypeStart] || 0, l = b[i.arrowTypeEnd] || 0;
		if (i.look === "neo" && !Z) {
			let e = `stroke-dasharray: ${i.pattern === "dotted" || i.pattern === "dashed" ? U(s, c, l) : `0 ${c} ${s - c - l} ${l}`}; stroke-dashoffset: 0;`;
			K.attr("style", e + K.attr("style"));
		}
	}
	K.attr("data-edge", !0), K.attr("data-et", "edge"), K.attr("data-id", i.id), K.attr("data-points", F), i.showPoints && I.forEach((e) => {
		t.append("circle").style("stroke", "red").style("fill", "red").attr("r", 1).attr("cx", e.x).attr("cy", e.y);
	});
	let Q = "";
	(r().flowchart.arrowMarkerAbsolute || r().state.arrowMarkerAbsolute) && (Q = window.location.protocol + "//" + window.location.host + window.location.pathname + window.location.search, Q = Q.replace(/\(/g, "\\(").replace(/\)/g, "\\)")), e.info("arrowTypeStart", i.arrowTypeStart), e.info("arrowTypeEnd", i.arrowTypeEnd), ee(K, i, Q, D, S, X);
	let te = Math.floor(A.length / 2), ne = A[te];
	g.isLabelCoordinateInPath(ne, K.attr("d")) || (j = !0);
	let $ = {};
...
function q(e, t) {
	let n = e.map((e) => ({ ...e }));
	if (e.length >= 2 && y[t.arrowTypeStart]) {
		let r = y[t.arrowTypeStart], i = e[0], a = e[1], { angle: o } = K(i, a), s = r * Math.cos(o), c = r * Math.sin(o);
		n[0].x = i.x + s, n[0].y = i.y + c;
	}
	let r = e.length;
	if (r >= 2 && y[t.arrowTypeEnd]) {
		let i = y[t.arrowTypeEnd], a = e[r - 1], o = e[r - 2], { angle: s } = K(o, a), c = i * Math.cos(s), l = i * Math.sin(s);
