import { h as e, p as t } from "./src-B53NoQT1.js";
import { B as n, C as r, U as i, _ as a, a as o, b as s, c, v as l, z as u } from "./chunk-ABZYJK2D-CVevQ3ur.js";
import { t as d } from "./arc-CxYpAARA.js";
import { t as f } from "./chunk-FMBD7UC4-BFlOEP8u.js";
import { a as p, i as m, o as h, t as g } from "./chunk-TZMSLE5B-9hZnkN8w.js";
...
var _ = (function() {
	var t = /* @__PURE__ */ e(function(e, t, n, r) {
		...
		17,
		18
	], r = [1, 9], i = [1, 10], a = [1, 11], o = [1, 12], s = [1, 13], c = [1, 14], l = {
...
_.parser = _;
var v = _, y = "", b = [], x = [], S = [], C = /* @__PURE__ */ e(function() {
	b.length = 0, x.length = 0, y = "", S.length = 0, o();
}, "clear"), w = /* @__PURE__ */ e(function(e) {
	y = e, b.push(e);
}, "addSection"), T = /* @__PURE__ */ e(function() {
	return b;
}, "getSections"), E = /* @__PURE__ */ e(function() {
	let e = A(), t = 0;
	for (; !e && t < 100;) e = A(), t++;
	return x.push(...S), x;
}, "getTasks"), D = /* @__PURE__ */ e(function() {
	let e = [];
	return x.forEach((t) => {
		t.people && e.push(...t.people);
	}), [...new Set(e)].sort();
}, "updateActors"), O = /* @__PURE__ */ e(function(e, t) {
	let n = t.substr(1).split(":"), r = 0, i = [];
	n.length === 1 ? (r = Number(n[0]), i = []) : (r = Number(n[0]), i = n[1].split(","));
	let a = i.map((e) => e.trim()), o = {
		section: y,
		type: y,
		people: a,
		task: e,
	...
	S.push(o);
}, "addTask"), k = /* @__PURE__ */ e(function(e) {
	let t = {
		section: y,
		type: y,
		description: e,
	...
	x.push(t);
}, "addTaskOrg"), A = /* @__PURE__ */ e(function() {
	...
	getConfig: /* @__PURE__ */ e(() => s().journey, "getConfig"),
	clear: C,
	setDiagramTitle: i,
	getDiagramTitle: r,
	setAccTitle: n,
	...
	addTask: O,
	addTaskOrg: k,
	getActors: /* @__PURE__ */ e(function() {
		return D();
	}, "getActors")
}, M = /* @__PURE__ */ e((e) => `.label {
  ...
  ${f()}
`, "getStyles"), N = /* @__PURE__ */ e(function(e, t) {
	return m(e, t);
}, "drawRect"), P = /* @__PURE__ */ e(function(t, n) {
...
}, "drawFace"), F = /* @__PURE__ */ e(function(e, t) {
...
}, "drawCircle"), I = /* @__PURE__ */ e(function(e, t) {
	return p(e, t);
}, "drawText"), L = /* @__PURE__ */ e(function(t, n) {
	function r(e, t, n, r, i) {
		return e + "," + t + " " + (e + n) + "," + t + " " + (e + n) + "," + (t + r - i) + " " + (e + n - i * 1.2) + "," + (t + r) + " " + e + "," + (t + r);
	}
	e(r, "genPoints");
	let i = t.append("polygon");
	i.attr("points", r(n.x, n.y, 50, 20, 7)), i.attr("class", "labelBox"), n.y += n.labelMargin, n.x += .5 * n.labelMargin, I(t, n);
}, "drawLabel"), ee = /* @__PURE__ */ e(function(e, t, n) {
	let r = e.append("g"), i = h();
	i.x = t.x, i.y = t.y, i.fill = t.fill, i.width = n.width * t.taskCount + n.diagramMarginX * (t.taskCount - 1), i.height = n.height, i.class = "journey-section section-type-" + t.num, i.rx = 3, i.ry = 3, N(r, i), V(n)(t.text, r, i.x, i.y, i.width, i.height, { class: "journey-section section-type-" + t.num }, n, t.colour);
}, "drawSection"), R = -1, z = /* @__PURE__ */ e(function(e, t, n) {
	let r = t.x + n.width / 2, i = e.append("g");
	R++, i.append("line").attr("id", "task" + R).attr("x1", r).attr("y1", t.y).attr("x2", r).attr("y2", 450).attr("class", "task-line").attr("stroke-width", "1px").attr("stroke-dasharray", "4 2").attr("stroke", "#666"), P(i, {
		cx: r,
		cy: 300 + (5 - t.score) * 30,
		score: t.score
	});
	let a = h();
	a.x = t.x, a.y = t.y, a.fill = t.fill, a.width = n.width, a.height = n.height, a.class = "task task-type-" + t.num, a.rx = 3, a.ry = 3, N(i, a);
	let o = t.x + 14;
	t.people.forEach((e) => {
		let n = t.actors[e].color, r = {
			cx: o,
			cy: t.y,
			r: 7,
			fill: n,
		...
		F(i, r), o += 10;
	}), V(n)(t.task, i, a.x, a.y, a.width, a.height, { class: "task" }, n, t.colour);
}, "drawTask"), B = /* @__PURE__ */ e(function(e, t) {
	g(e, t);
}, "drawBackgroundRect"), V = /* @__PURE__ */ (function() {
	...
	initGraphics: /* @__PURE__ */ e(function(e) {
...
}, U = /* @__PURE__ */ e(function(e) {
	Object.keys(e).forEach(function(t) {
		q[t] = e[t];
	});
}, "setConf"), W = {}, G = 0;
function K(e) {
	let t = s().journey, n = t.maxLabelWidth;
	G = 0;
	let r = 60;
	Object.keys(W).forEach((i) => {
		...
		H.drawCircle(e, o);
		let s = e.append("text").attr("visibility", "hidden").text(i), c = s.node().getBoundingClientRect().width;
		s.remove();
		let l = [];
		if (c <= n) l = [i];
		else {
			let t = i.split(" "), r = "";
			s = e.append("text").attr("visibility", "hidden"), t.forEach((e) => {
				let t = r ? `${r} ${e}` : e;
				if (s.text(t), s.node().getBoundingClientRect().width > n) {
					if (r && l.push(r), r = e, s.text(e), s.node().getBoundingClientRect().width > n) {
						let t = "";
						for (let r of e) t += r, s.text(t + "-"), s.node().getBoundingClientRect().width > n && (l.push(t.slice(0, -1) + "-"), t = r);
						r = t;
					}
				} else r = t;
			}), r && l.push(r), s.remove();
		...
		l.forEach((n, i) => {
			...
			}, o = H.drawText(e, a).node().getBoundingClientRect().width;
			o > G && o > t.leftMargin - o && (G = o);
		}), r += Math.max(20, l.length * 20);
	});
}
e(K, "drawActorLegend");
var q = s().journey, J = 0, Y = /* @__PURE__ */ e(function(e, n, r, i) {
	let a = s(), o = a.journey.titleColor, l = a.journey.titleFontSize, u = a.journey.titleFontFamily, d = a.securityLevel, f;
	d === "sandbox" && (f = t("#i" + n));
	let p = t(d === "sandbox" ? f.nodes()[0].contentDocument.body : "body");
	X.init();
	let m = p.select("#" + n);
	H.initGraphics(m);
	let h = i.db.getTasks(), g = i.db.getDiagramTitle(), _ = i.db.getActors();
	for (let e in W) delete W[e];
	let v = 0;
	_.forEach((e) => {
		W[e] = {
	...
	}), K(m), J = q.leftMargin + G, X.insert(0, 0, J, Object.keys(W).length * 50), te(m, h, 0);
	let y = X.getBounds();
	g && m.append("text").text(g).attr("x", J).attr("font-size", l).attr("font-weight", "bold").attr("y", 25).attr("fill", o).attr("font-family", u);
	let b = y.stopy - y.starty + 2 * q.diagramMarginY, x = J + y.stopx + 2 * q.diagramMarginX;
	c(m, b, x, q.useMaxWidth), m.append("line").attr("x1", J).attr("y1", q.height * 4).attr("x2", x - J - 4).attr("y2", q.height * 4).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)");
	let S = g ? 70 : 0;
	m.attr("viewBox", `${y.startx} -25 ${x} ${b + S}`), m.attr("preserveAspectRatio", "xMinYMin meet"), m.attr("height", b + S + 25);
}, "draw"), X = {
	data: {
		startx: void 0,
		stopx: void 0,
	...
	updateBounds: /* @__PURE__ */ e(function(t, n, r, i) {
		let a = s().journey, o = this, c = 0;
		function l(s) {
			return /* @__PURE__ */ e(function(e) {
				c++;
				let l = o.sequenceItems.length - c + 1;
				o.updateVal(e, "starty", n - l * a.boxMargin, Math.min), o.updateVal(e, "stopy", i + l * a.boxMargin, Math.max), o.updateVal(X.data, "startx", t - l * a.boxMargin, Math.min), o.updateVal(X.data, "stopx", r + l * a.boxMargin, Math.max), s !== "activation" && (o.updateVal(e, "startx", t - l * a.boxMargin, Math.min), o.updateVal(e, "stopx", r + l * a.boxMargin, Math.max), o.updateVal(X.data, "starty", n - l * a.boxMargin, Math.min), o.updateVal(X.data, "stopy", i + l * a.boxMargin, Math.max));
			}, "updateItemBounds");
		}
		e(l, "updateFn"), this.sequenceItems.forEach(l());
	}, "updateBounds"),
	insert: /* @__PURE__ */ e(function(e, t, n, r) {
		let i = Math.min(e, n), a = Math.max(e, n), o = Math.min(t, r), s = Math.max(t, r);
...
}, Z = q.sectionFills, Q = q.sectionColours, te = /* @__PURE__ */ e(function(e, t, n) {
	let r = s().journey, i = "", a = n + (r.height * 2 + r.diagramMarginY), o = 0, c = "#CCC", l = "black", u = 0;
	for (let [n, s] of t.entries()) {
		if (i !== s.section) {
			c = Z[o % Z.length], u = o % Z.length, l = Q[o % Q.length];
			let a = 0, d = s.section;
			...
			H.drawSection(e, f, r), i = s.section, o++;
		}
		let d = s.people.reduce((e, t) => (W[t] && (e[t] = W[t]), e), {});
		s.x = n * r.taskMargin + n * r.width + J, s.y = a, s.width = r.diagramMarginX, s.height = r.diagramMarginY, s.colour = l, s.fill = c, s.num = u, s.actors = d, H.drawTask(e, s, r), X.insert(s.x, s.y, s.x + s.width + r.taskMargin, 450);
	}
}, "drawTasks"), $ = {
	setConf: U,
	draw: Y
