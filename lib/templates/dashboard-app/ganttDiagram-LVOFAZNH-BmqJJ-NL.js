import { i as e, t } from "./rolldown-runtime-Dbv0sNQl.js";
import { a as n, c as r, d as i, f as a, g as o, h as s, i as c, p as l, s as u, u as d, v as f } from "./src-B53NoQT1.js";
import { B as p, C as m, U as h, _ as g, a as _, b as v, c as y, s as b, v as x, z as S } from "./chunk-ABZYJK2D-CVevQ3ur.js";
import { a as C, i as w, n as T, r as E, t as D } from "./linear-DPEwag4G.js";
import { t as O } from "./init-MwSGRDIl.js";
import { h as k } from "./chunk-S3R3BYOJ-BtVK2Rr4.js";
import { t as ee } from "./dist-DkhStvw3.js";
...
var _e = Math.PI / 180, ve = 180 / Math.PI, ye = 18, be = .96422, xe = 1, Se = .82521, Ce = 4 / 29, we = 6 / 29, Te = 3 * we * we, Ee = we * we * we;
function De(e) {
	if (e instanceof A) return new A(e.l, e.a, e.b, e.opacity);
	if (e instanceof j) return Fe(e);
	e instanceof r || (e = d(e));
	var t = Me(e.r), n = Me(e.g), i = Me(e.b), a = ke((.2225045 * t + .7168786 * n + .0606169 * i) / xe), o, s;
	return t === n && n === i ? o = s = a : (o = ke((.4360747 * t + .3850649 * n + .1430804 * i) / be), s = ke((.0139322 * t + .0971045 * n + .7141733 * i) / Se)), new A(116 * a - 16, 500 * (o - a), 200 * (a - s), e.opacity);
}
function Oe(e, t, n, r) {
	return arguments.length === 1 ? De(e) : new A(e, t, n, r ?? 1);
}
function A(e, t, n, r) {
...
i(A, Oe, a(u, {
	brighter(e) {
		return new A(this.l + ye * (e ?? 1), this.a, this.b, this.opacity);
	},
	darker(e) {
		return new A(this.l - ye * (e ?? 1), this.a, this.b, this.opacity);
	},
	rgb() {
		...
		return t = be * Ae(t), e = xe * Ae(e), n = Se * Ae(n), new r(je(3.1338561 * t - 1.6168667 * e - .4906146 * n), je(-.9787684 * t + 1.9161415 * e + .033454 * n), je(.0719453 * t - .2289914 * e + 1.4052427 * n), this.opacity);
	}
}));
function ke(e) {
	return e > Ee ? e ** (1 / 3) : e / Te + Ce;
}
function Ae(e) {
	return e > we ? e * e * e : Te * (e - Ce);
}
function je(e) {
...
function Ne(e) {
	if (e instanceof j) return new j(e.h, e.c, e.l, e.opacity);
	if (e instanceof A || (e = De(e)), e.a === 0 && e.b === 0) return new j(NaN, 0 < e.l && e.l < 100 ? 0 : NaN, e.l, e.opacity);
	var t = Math.atan2(e.b, e.a) * ve;
	return new j(t < 0 ? t + 360 : t, Math.sqrt(e.a * e.a + e.b * e.b), e.l, e.opacity);
}
function Pe(e, t, n, r) {
	return arguments.length === 1 ? Ne(e) : new j(e, t, n, r ?? 1);
}
function j(e, t, n, r) {
	this.h = +e, this.c = +t, this.l = +n, this.opacity = +r;
}
function Fe(e) {
	if (isNaN(e.h)) return new A(e.l, 0, 0, e.opacity);
	var t = e.h * _e;
	return new A(e.l, Math.cos(t) * e.c, Math.sin(t) * e.c, e.opacity);
}
i(j, Pe, a(u, {
	brighter(e) {
		return new j(this.h, this.c, this.l + ye * (e ?? 1), this.opacity);
	},
	darker(e) {
		return new j(this.h, this.c, this.l - ye * (e ?? 1), this.opacity);
	},
...
function Ie(e) {
	return function(t, r) {
		var i = e((t = Pe(t)).h, (r = Pe(r)).h), a = n(t.c, r.c), o = n(t.l, r.l), s = n(t.opacity, r.opacity);
		return function(e) {
...
var ze = /* @__PURE__ */ new Date(), Be = /* @__PURE__ */ new Date();
function M(e, t, n, r) {
	function i(t) {
	...
	}), n && (i.count = (t, r) => (ze.setTime(+t), Be.setTime(+r), e(ze), e(Be), Math.floor(n(ze, Be))), i.every = (e) => (e = Math.floor(e), !isFinite(e) || !(e > 0) ? null : e > 1 ? i.filter(r ? (t) => r(t) % e === 0 : (t) => i.count(0, t) % e === 0) : i)), i;
}
//#endregion
...
N.every = (e) => (e = Math.floor(e), !isFinite(e) || !(e > 0) ? null : e > 1 ? M((t) => {
...
var P = 1e3, F = P * 60, I = F * 60, L = I * 24, Ve = L * 7, He = L * 30, Ue = L * 365, R = M((e) => {
	e.setTime(e - e.getMilliseconds());
}, (e, t) => {
	e.setTime(+e + t * P);
}, (e, t) => (t - e) / P, (e) => e.getUTCSeconds());
R.range;
//#endregion
//#region node_modules/d3-time/src/minute.js
var We = M((e) => {
	e.setTime(e - e.getMilliseconds() - e.getSeconds() * P);
}, (e, t) => {
	e.setTime(+e + t * F);
}, (e, t) => (t - e) / F, (e) => e.getMinutes());
We.range;
var Ge = M((e) => {
	e.setUTCSeconds(0, 0);
}, (e, t) => {
	e.setTime(+e + t * F);
}, (e, t) => (t - e) / F, (e) => e.getUTCMinutes());
Ge.range;
//#endregion
//#region node_modules/d3-time/src/hour.js
var Ke = M((e) => {
	e.setTime(e - e.getMilliseconds() - e.getSeconds() * P - e.getMinutes() * F);
}, (e, t) => {
	e.setTime(+e + t * I);
}, (e, t) => (t - e) / I, (e) => e.getHours());
Ke.range;
var qe = M((e) => {
	e.setUTCMinutes(0, 0, 0);
}, (e, t) => {
	e.setTime(+e + t * I);
}, (e, t) => (t - e) / I, (e) => e.getUTCHours());
qe.range;
//#endregion
//#region node_modules/d3-time/src/day.js
var z = M((e) => e.setHours(0, 0, 0, 0), (e, t) => e.setDate(e.getDate() + t), (e, t) => (t - e - (t.getTimezoneOffset() - e.getTimezoneOffset()) * F) / L, (e) => e.getDate() - 1);
z.range;
var Je = M((e) => {
	e.setUTCHours(0, 0, 0, 0);
}, (e, t) => {
	e.setUTCDate(e.getUTCDate() + t);
}, (e, t) => (t - e) / L, (e) => e.getUTCDate() - 1);
Je.range;
var Ye = M((e) => {
	e.setUTCHours(0, 0, 0, 0);
}, (e, t) => {
	e.setUTCDate(e.getUTCDate() + t);
}, (e, t) => (t - e) / L, (e) => Math.floor(e / L));
Ye.range;
//#endregion
...
function B(e) {
	...
	}, (e, t) => (t - e - (t.getTimezoneOffset() - e.getTimezoneOffset()) * F) / Ve);
}
var Xe = B(0), Ze = B(1), Qe = B(2), $e = B(3), V = B(4), et = B(5), tt = B(6);
Xe.range, Ze.range, Qe.range, $e.range, V.range, et.range, tt.range;
function H(e) {
	return M((t) => {
...
var nt = H(0), rt = H(1), it = H(2), at = H(3), U = H(4), ot = H(5), st = H(6);
nt.range, rt.range, it.range, at.range, U.range, ot.range, st.range;
//#endregion
...
W.every = (e) => !isFinite(e = Math.floor(e)) || !(e > 0) ? null : M((t) => {
...
G.every = (e) => !isFinite(e = Math.floor(e)) || !(e > 0) ? null : M((t) => {
...
function ut(e, t, n, r, i, a) {
	...
	function c(t, n, r) {
		...
		if (a === o.length) return e.every(w(t / Ue, n / Ue, r));
		if (a === 0) return N.every(Math.max(w(t, n, r), 1));
		let [s, c] = o[i / o[a - 1][2] < o[a][2] / i ? a - 1 : a];
		return s.every(c);
	}
	return [s, c];
}
var [dt, ft] = ut(G, lt, nt, Ye, qe, Ge), [pt, mt] = ut(W, ct, Xe, z, Ke, We);
//#endregion
...
function vt(e) {
	var t = e.dateTime, n = e.date, r = e.time, i = e.periods, a = e.days, o = e.shortDays, s = e.months, c = e.shortMonths, l = Ct(i), u = wt(i), d = Ct(a), f = wt(a), p = Ct(o), m = wt(o), h = Ct(s), g = wt(s), _ = Ct(c), v = wt(c), y = {
		a: re,
		A: ie,
		b: ae,
		B: oe,
	...
	function S(e, t) {
		return function(n) {
			...
			for (n instanceof Date || (n = /* @__PURE__ */ new Date(+n)); ++i < o;) e.charCodeAt(i) === 37 && (r.push(e.slice(a, i)), (c = yt[s = e.charAt(++i)]) == null ? c = s === "e" ? " " : "0" : s = e.charAt(++i), (l = t[s]) && (s = l(n, c)), r.push(s), a = i + 1);
			return r.push(e.slice(a, i)), r.join("");
		};
	}
	function C(e, t) {
		return function(n) {
			var r = _t(1900, void 0, 1), i = w(r, e, n += "", 0), a, o;
			if (i != n.length) return null;
			if ("Q" in r) return new Date(r.Q);
			if ("s" in r) return new Date(r.s * 1e3 + ("L" in r ? r.L : 0));
			if (t && !("Z" in r) && (r.Z = 0), "p" in r && (r.H = r.H % 12 + r.p * 12), r.m === void 0 && (r.m = "q" in r ? r.q : 0), "V" in r) {
				if (r.V < 1 || r.V > 53) return null;
				"w" in r || (r.w = 1), "Z" in r ? (a = gt(_t(r.y, 0, 1)), o = a.getUTCDay(), a = o > 4 || o === 0 ? rt.ceil(a) : rt(a), a = Je.offset(a, (r.V - 1) * 7), r.y = a.getUTCFullYear(), r.m = a.getUTCMonth(), r.d = a.getUTCDate() + (r.w + 6) % 7) : (a = ht(_t(r.y, 0, 1)), o = a.getDay(), a = o > 4 || o === 0 ? Ze.ceil(a) : Ze(a), a = z.offset(a, (r.V - 1) * 7), r.y = a.getFullYear(), r.m = a.getMonth(), r.d = a.getDate() + (r.w + 6) % 7);
			} else ("W" in r || "U" in r) && ("w" in r || (r.w = "u" in r ? r.u % 7 : +("W" in r)), o = "Z" in r ? gt(_t(r.y, 0, 1)).getUTCDay() : ht(_t(r.y, 0, 1)).getDay(), r.m = 0, r.d = "W" in r ? (r.w + 6) % 7 + r.W * 7 - (o + 5) % 7 : r.w + r.U * 7 - (o + 6) % 7);
			return "Z" in r ? (r.H += r.Z / 100 | 0, r.M += r.Z % 100, gt(r)) : ht(r);
		};
	}
	function w(e, t, n, r) {
		for (var i = 0, a = t.length, o = n.length, s, c; i < a;) {
			...
			if (s = t.charCodeAt(i++), s === 37) {
				if (s = t.charAt(i++), c = x[s in yt ? t.charAt(i++) : s], !c || (r = c(e, n, r)) < 0) return -1;
...
function rn(e, t) {
	return e = nn(e), q(V.count(W(e), e) + (W(e).getDay() === 4), t, 2);
}
function an(e) {
	return e.getDay();
}
function on(e, t) {
	return q(Ze.count(W(e) - 1, e), t, 2);
}
function sn(e, t) {
	return q(e.getFullYear() % 100, t, 2);
}
function cn(e, t) {
	return e = nn(e), q(e.getFullYear() % 100, t, 2);
}
function ln(e, t) {
...
function un(e, t) {
	var n = e.getDay();
	return e = n >= 4 || n === 0 ? V(e) : V.ceil(e), q(e.getFullYear() % 1e4, t, 4);
}
function dn(e) {
...
function wn(e, t) {
	return e = Cn(e), q(U.count(G(e), e) + (G(e).getUTCDay() === 4), t, 2);
}
function Tn(e) {
	return e.getUTCDay();
}
function En(e, t) {
	return q(rt.count(G(e) - 1, e), t, 2);
}
function Dn(e, t) {
	return q(e.getUTCFullYear() % 100, t, 2);
}
function On(e, t) {
	return e = Cn(e), q(e.getUTCFullYear() % 100, t, 2);
}
function kn(e, t) {
...
function An(e, t) {
	var n = e.getUTCDay();
	return e = n >= 4 || n === 0 ? U(e) : U.ceil(e), q(e.getUTCFullYear() % 1e4, t, 4);
}
function jn() {
	return "+0000";
}
...
function In(e) {
	return J = vt(e), Fn = J.format, J.parse, J.utcFormat, J.utcParse, J;
}
//#endregion
...
function zn(e, t, n, r, i, a, o, s, c, l) {
	...
	return u.invert = function(e) {
		...
		var n = f();
		return (!e || typeof e.range != "function") && (e = t(n[0], n[n.length - 1], e ?? 10)), e ? f(Re(n, e)) : u;
	}, u.copy = function() {
		return E(u, zn(e, t, n, r, i, a, o, s, c, l));
	}, u;
}
function Bn() {
	return O.apply(zn(pt, mt, W, ct, Xe, z, Ke, We, R, Fn).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]), arguments);
}
//#endregion
...
})), Wn = ee(), Y = /* @__PURE__ */ e(f(), 1), Gn = /* @__PURE__ */ e(Vn(), 1), Kn = /* @__PURE__ */ e(Hn(), 1), qn = /* @__PURE__ */ e(Un(), 1), Jn = (function() {
...
Jn.parser = Jn;
var Yn = Jn;
Y.default.extend(Gn.default), Y.default.extend(Kn.default), Y.default.extend(qn.default);
var Xn = {
	friday: 5,
	saturday: 6
}, X = "", Zn = "", Qn = void 0, $n = "", er = [], tr = [], nr = /* @__PURE__ */ new Map(), rr = [], ir = [], ar = "", or = "", sr = [
	"active",
	"done",
	"crit",
	"milestone",
	"vert"
], cr = [], lr = !1, ur = !1, dr = "sunday", fr = "saturday", pr = 0, mr = /* @__PURE__ */ s(function() {
	rr = [], ir = [], ar = "", cr = [], Kr = 0, Xr = void 0, Zr = void 0, Z = [], X = "", Zn = "", or = "", Qn = void 0, $n = "", er = [], tr = [], lr = !1, ur = !1, pr = 0, nr = /* @__PURE__ */ new Map(), _(), dr = "sunday", fr = "saturday";
}, "clear"), hr = /* @__PURE__ */ s(function(e) {
	Zn = e;
}, "setAxisFormat"), gr = /* @__PURE__ */ s(function() {
	return Zn;
}, "getAxisFormat"), _r = /* @__PURE__ */ s(function(e) {
	Qn = e;
}, "setTickInterval"), vr = /* @__PURE__ */ s(function() {
	return Qn;
}, "getTickInterval"), yr = /* @__PURE__ */ s(function(e) {
	$n = e;
}, "setTodayMarker"), br = /* @__PURE__ */ s(function() {
	return $n;
}, "getTodayMarker"), xr = /* @__PURE__ */ s(function(e) {
	X = e;
}, "setDateFormat"), Sr = /* @__PURE__ */ s(function() {
	lr = !0;
}, "enableInclusiveEndDates"), Cr = /* @__PURE__ */ s(function() {
	return lr;
}, "endDatesAreInclusive"), wr = /* @__PURE__ */ s(function() {
	ur = !0;
}, "enableTopAxis"), Tr = /* @__PURE__ */ s(function() {
	return ur;
}, "topAxisEnabled"), Er = /* @__PURE__ */ s(function(e) {
	or = e;
}, "setDisplayMode"), Dr = /* @__PURE__ */ s(function() {
	return or;
}, "getDisplayMode"), Or = /* @__PURE__ */ s(function() {
	return X;
}, "getDateFormat"), kr = /* @__PURE__ */ s(function(e) {
	er = e.toLowerCase().split(/[\s,]+/);
}, "setIncludes"), Ar = /* @__PURE__ */ s(function() {
	return er;
}, "getIncludes"), jr = /* @__PURE__ */ s(function(e) {
	tr = e.toLowerCase().split(/[\s,]+/);
}, "setExcludes"), Mr = /* @__PURE__ */ s(function() {
	return tr;
}, "getExcludes"), Nr = /* @__PURE__ */ s(function() {
	return nr;
}, "getLinks"), Pr = /* @__PURE__ */ s(function(e) {
	ar = e, rr.push(e);
}, "addSection"), Fr = /* @__PURE__ */ s(function() {
	return rr;
}, "getSections"), Ir = /* @__PURE__ */ s(function() {
	let e = ti(), t = 0;
	for (; !e && t < 10;) e = ti(), t++;
	return ir = Z, ir;
}, "getTasks"), Lr = /* @__PURE__ */ s(function(e, t, n, r) {
	let i = e.format(t.trim()), a = e.format("YYYY-MM-DD");
	return r.includes(i) || r.includes(a) ? !1 : n.includes("weekends") && (e.isoWeekday() === Xn[fr] || e.isoWeekday() === Xn[fr] + 1) || n.includes(e.format("dddd").toLowerCase()) ? !0 : n.includes(i) || n.includes(a);
}, "isInvalidDate"), Rr = /* @__PURE__ */ s(function(e) {
	dr = e;
}, "setWeekday"), zr = /* @__PURE__ */ s(function() {
	return dr;
}, "getWeekday"), Br = /* @__PURE__ */ s(function(e) {
	fr = e;
}, "setWeekend"), Vr = /* @__PURE__ */ s(function(e, t, n, r) {
	...
	let [o, s] = Hr(i, a, t, n, r);
	e.endTime = o.toDate(), e.renderEndTime = s;
}, "checkTaskDates"), Hr = /* @__PURE__ */ s(function(e, t, n, r, i) {
	let a = !1, o = null;
	for (; e <= t;) a || (o = t.toDate()), a = Lr(e, n, r, i), a && (t = t.add(1, "d")), e = e.add(1, "d");
	return [t, o];
}, "fixTaskDates"), Ur = /* @__PURE__ */ s(function(e, t, n) {
	if (n = n.trim(), (t.trim() === "x" || t.trim() === "X") && /^\d+$/.test(n)) return new Date(Number(n));
...
}, "getStartDate"), Wr = /* @__PURE__ */ s(function(e) {
	let t = /^(\d+(?:\.\d+)?)([Mdhmswy]|ms)$/.exec(e.trim());
	return t === null ? [NaN, "ms"] : [Number.parseFloat(t[1]), t[2]];
}, "parseDuration"), Gr = /* @__PURE__ */ s(function(e, t, n, r = !1) {
	n = n.trim();
	...
	let o = (0, Y.default)(e), [s, c] = Wr(n);
	if (!Number.isNaN(s)) {
		let e = o.add(s, c);
		e.isValid() && (o = e);
	}
	return o.toDate();
}, "getEndDate"), Kr = 0, qr = /* @__PURE__ */ s(function(e) {
	return e === void 0 ? (Kr += 1, "task" + Kr) : e;
}, "parseId"), Jr = /* @__PURE__ */ s(function(e, t) {
	let n;
	...
	switch (r.length) {
		case 1:
			i.id = qr(), i.startTime = e.endTime, a = r[0];
			break;
		case 2:
			i.id = qr(), i.startTime = Ur(void 0, X, r[0]), a = r[1];
			break;
		case 3:
			i.id = qr(r[0]), i.startTime = Ur(void 0, X, r[1]), a = r[2];
			break;
		default:
	}
	return a && (i.endTime = Gr(i.startTime, X, a, lr), i.manualEndTime = (0, Y.default)(a, "YYYY-MM-DD", !0).isValid(), Vr(i, X, tr, er)), i;
}, "compileData"), Yr = /* @__PURE__ */ s(function(e, t) {
	let n;
	n = t.substr(0, 1) === ":" ? t.substr(1, t.length) : t;
	let r = n.split(","), i = {};
	si(r, i, sr);
	...
	return i;
}, "parseData"), Xr, Zr, Z = [], Qr = {}, $r = /* @__PURE__ */ s(function(e, t) {
	let n = {
		section: ar,
		type: ar,
		processed: !1,
	...
	n.raw.startTime = r.startTime, n.raw.endTime = r.endTime, n.id = r.id, n.prevTaskId = Zr, n.active = r.active, n.done = r.done, n.crit = r.crit, n.milestone = r.milestone, n.vert = r.vert, n.order = pr, pr++;
	let i = Z.push(n);
	Zr = n.id, Qr[n.id] = i - 1;
}, "addTask"), Q = /* @__PURE__ */ s(function(e) {
	let t = Qr[e];
	return Z[t];
}, "findTaskById"), ei = /* @__PURE__ */ s(function(e, t) {
	let n = {
		section: ar,
		type: ar,
		description: e,
	...
	n.startTime = r.startTime, n.endTime = r.endTime, n.id = r.id, n.active = r.active, n.done = r.done, n.crit = r.crit, n.milestone = r.milestone, n.vert = r.vert, Xr = n, ir.push(n);
}, "addTaskOrg"), ti = /* @__PURE__ */ s(function() {
	let e = /* @__PURE__ */ s(function(e) {
		...
		switch (Z[e].raw.startTime.type) {
			case "prevTaskEnd":
				...
				break;
			case "getStartDate":
				n = Ur(void 0, X, Z[e].raw.startTime.startData), n && (Z[e].startTime = n);
				break;
		}
		return Z[e].startTime && (Z[e].endTime = Gr(Z[e].startTime, X, Z[e].raw.endTime.data, lr), Z[e].endTime && (Z[e].processed = !0, Z[e].manualEndTime = (0, Y.default)(Z[e].raw.endTime.data, "YYYY-MM-DD", !0).isValid(), Vr(Z[e], X, tr, er))), Z[e].processed;
	}, "compileTask"), t = !0;
	for (let [n, r] of Z.entries()) e(n), t &&= r.processed;
	return t;
}, "compileTasks"), ni = /* @__PURE__ */ s(function(e, t) {
	let n = t;
	v().securityLevel !== "loose" && (n = (0, Wn.sanitizeUrl)(t)), e.split(",").forEach(function(e) {
		Q(e) !== void 0 && (ai(e, () => {
			window.open(n, "_self");
		}), nr.set(e, n));
	}), ri(e, "clickable");
}, "setLink"), ri = /* @__PURE__ */ s(function(e, t) {
	e.split(",").forEach(function(e) {
		let n = Q(e);
		n !== void 0 && n.classes.push(t);
	});
}, "setClass"), ii = /* @__PURE__ */ s(function(e, t, n) {
	if (v().securityLevel !== "loose" || t === void 0) return;
	let r = [];
	if (typeof n == "string") {
		r = n.split(/,(?=(?:(?:[^"]*"){2})*[^"]*$)/);
	...
	r.length === 0 && r.push(e), Q(e) !== void 0 && ai(e, () => {
		k.runFunc(t, ...r);
	});
}, "setClickFun"), ai = /* @__PURE__ */ s(function(e, t) {
	cr.push(function() {
	...
	getConfig: /* @__PURE__ */ s(() => v().gantt, "getConfig"),
	clear: mr,
	setDateFormat: xr,
	getDateFormat: Or,
	enableInclusiveEndDates: Sr,
	endDatesAreInclusive: Cr,
	enableTopAxis: wr,
	topAxisEnabled: Tr,
	setAxisFormat: hr,
	getAxisFormat: gr,
...
var ci = /* @__PURE__ */ s(function() {
	...
	return i;
}, "getMaxIntersections"), $, di = {
	parser: Yn,
	db: oi,
	renderer: {
		setConf: ci,
		draw: /* @__PURE__ */ s(function(e, t, n, r) {
			let i = v().gantt, a = v().securityLevel, c;
			a === "sandbox" && (c = l("#i" + t));
			...
			let _ = u.select(`[id="${t}"]`), x = Bn().domain([ne(p, function(e) {
				return e.startTime;
			}), te(p, function(e) {
				return e.endTime;
			...
			s(S, "taskCompare"), p.sort(S), C(p, $, g), y(_, g, $, i.useMaxWidth), _.append("text").text(r.db.getDiagramTitle()).attr("x", $ / 2).attr("y", i.titleTopMargin).attr("class", "titleText");
			function C(e, t, n) {
				let a = i.barHeight, o = a + i.barGap, s = i.topPadding, c = i.leftPadding, l = D().domain([0, m.length]).range(["#00B9FA", "#F95002"]).interpolate(Le);
				T(o, s, c, t, n, e, r.db.getExcludes(), r.db.getIncludes()), E(c, s, t, n), w(e, o, s, c, a, l, t, n), O(o, s, c, a, l), k(c, s, t, n);
			}
			s(C, "makeGantt");
			...
			function T(e, t, n, a, s, c, l, u) {
				...
				_.append("g").selectAll("rect").data(m).enter().append("rect").attr("id", (e) => "exclude-" + e.start.format("YYYY-MM-DD")).attr("x", (e) => x(e.start.startOf("day")) + n).attr("y", i.gridLineStartPadding).attr("width", (e) => x(e.end.endOf("day")) - x(e.start.startOf("day"))).attr("height", s - t - i.gridLineStartPadding).attr("transform-origin", function(t, r) {
					return (x(t.start) + n + .5 * (x(t.end) - x(t.start))).toString() + "px " + (r * e + .5 * s).toString() + "px";
			...
			function E(e, t, n, a) {
				...
				let l = ge(x).tickSize(-a + t + i.gridLineStartPadding).tickFormat(Fn(c)), u = /^([1-9]\d*)(millisecond|second|minute|hour|day|week|month)$/.exec(r.db.getTickInterval() || i.tickInterval);
				if (u !== null) {
					let e = u[1], t = u[2], n = r.db.getWeekday() || i.weekday;
					switch (t) {
						case "millisecond":
							l.ticks(N.every(e));
							break;
				...
				if (_.append("g").attr("class", "grid").attr("transform", "translate(" + e + ", " + (a - 50) + ")").call(l).selectAll("text").style("text-anchor", "middle").attr("fill", "#000").attr("stroke", "none").attr("font-size", 10).attr("dy", "1em"), r.db.topAxisEnabled() || i.topAxis) {
					let n = he(x).tickSize(-a + t + i.gridLineStartPadding).tickFormat(Fn(c));
					if (u !== null) {
						let e = u[1], t = u[2], a = r.db.getWeekday() || i.weekday;
						switch (t) {
							case "millisecond":
								n.ticks(N.every(e));
								break;
			...
			function O(e, t) {
				...
				_.append("g").selectAll("text").data(r).enter().append(function(e) {
					let t = e[0].split(b.lineBreakRegex), n = -(t.length - 1) / 2, r = d.createElementNS("http://www.w3.org/2000/svg", "text");
