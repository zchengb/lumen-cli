...
import { g as n, h as r, p as i } from "./src-B53NoQT1.js";
import { B as a, C as o, G as s, I as c, U as l, _ as u, a as d, b as f, d as p, v as m, y as h, z as g } from "./chunk-ABZYJK2D-CVevQ3ur.js";
import { r as _, s as v } from "./chunk-S3R3BYOJ-BtVK2Rr4.js";
import { t as y } from "./chunk-EXTU4WIE-By1ZThX0.js";
import { i as b, n as x, o as S, r as C } from "./chunk-JA3XYJ7Z-RwfPEVEr.js";
import { t as w } from "./mermaid-parser.core-CqbA3hT_.js";
import { t as T } from "./chunk-4BX2VUAB-BqrFk22c.js";
import { t as E } from "./cytoscape.esm-Cpra_XI_.js";
...
var D = /* @__PURE__ */ t(((e, t) => {
		...
		return (function(e) {
			...
			(function(e, t, n) {
				...
				f.RANDOM_SEED = 1, f.prototype = Object.create(d.prototype), f.prototype.getGraphManager = function() {
					...
					var e = !this.checkLayoutSuccess() && this.layout();
			...
			(function(e, t, n) {
				...
				l.prototype.initParameters = function() {
					...
					var e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : !0, t = arguments.length > 1 && arguments[1] !== void 0 && arguments[1], n, r, i, o, s = this.getAllNodes(), c;
			...
			(function(e, t, n) {
				...
				r.svd = function(e) {
					...
					if (o) for (var L = this.n - 1; L >= 0; L--) {
						if (function(e, t) {
							return e && t;
						}(L < c, n[L] !== 0)) for (var R = L + 1; R < t; R++) {
							for (var z = 0, B = L + 1; B < this.n; B++) z += this.V[B][L] * this.V[B][R];
							z = -z / this.V[L + 1][L];
							for (var V = L + 1; V < this.n; V++) this.V[V][R] += z * this.V[V][L];
						}
					...
					for (var te = E - 1, H = 0, ne = 2 ** -52, re = 2 ** -966; E > 0;) {
						...
						switch (U++, W) {
							...
							case 2:
								...
								n[U - 1] = 0;
								for (var Z = U; Z < E; Z++) {
									var se = r.hypot(this.s[Z], oe), ce = this.s[Z] / se, le = oe / se;
									if (this.s[Z] = se, oe = -le * n[Z], n[Z] = ce * n[Z], a) for (var ue = 0; ue < this.m; ue++) se = ce * this.U[ue][Z] + le * this.U[ue][U - 1], this.U[ue][U - 1] = -le * this.U[ue][Z] + ce * this.U[ue][U - 1], this.U[ue][Z] = se;
								}
								break;
							case 3:
								var de = Math.max(Math.max(Math.max(Math.max(Math.abs(this.s[E - 1]), Math.abs(this.s[E - 2])), Math.abs(n[E - 2])), Math.abs(this.s[U])), Math.abs(n[U])), fe = this.s[E - 1] / de, pe = this.s[E - 2] / de, me = n[E - 2] / de, he = this.s[U] / de, ge = n[U] / de, _e = ((pe + fe) * (pe - fe) + me * me) / 2, ve = fe * me * (fe * me), ye = 0;
								(function(e, t) {
									return e || t;
								})(_e !== 0, ve !== 0) && (ye = Math.sqrt(_e * _e + ve), _e < 0 && (ye = -ye), ye = ve / (_e + ye));
								for (var be = (he + fe) * (he - fe) + ye, xe = he * ge, Q = U; Q < E - 1; Q++) {
									var $ = r.hypot(be, xe), Se = be / $, Ce = xe / $;
									if (Q !== U && (n[Q - 1] = $), be = Se * this.s[Q] + Ce * n[Q], n[Q] = Se * n[Q] - Ce * this.s[Q], xe = Ce * this.s[Q + 1], this.s[Q + 1] = Se * this.s[Q + 1], o) for (var we = 0; we < this.n; we++) $ = Se * this.V[we][Q] + Ce * this.V[we][Q + 1], this.V[we][Q + 1] = -Ce * this.V[we][Q] + Se * this.V[we][Q + 1], this.V[we][Q] = $;
									if ($ = r.hypot(be, xe), Se = be / $, Ce = xe / $, this.s[Q] = $, be = Se * n[Q] + Ce * this.s[Q + 1], this.s[Q + 1] = -Ce * n[Q] + Se * this.s[Q + 1], xe = Ce * n[Q + 1], n[Q + 1] = Se * n[Q + 1], a && Q < this.m - 1) for (var Te = 0; Te < this.m; Te++) $ = Se * this.U[Te][Q] + Ce * this.U[Te][Q + 1], this.U[Te][Q + 1] = -Ce * this.U[Te][Q] + Se * this.U[Te][Q + 1], this.U[Te][Q] = $;
								}
								n[E - 2] = be, H += 1;
								break;
							case 4:
					...
					c.handleConstraints = function(e) {
						...
						var h = function(e, t) {
							...
							d.forEach(function(e, r) {
								e == 0 ? (m.push(r), n || (t == "horizontal" ? f.set(r, c.has(r) ? l[c.get(r)] : i.get(r)) : f.set(r, c.has(r) ? u[c.get(r)] : i.get(r)))) : f.set(r, -Infinity), n && p.set(r, /* @__PURE__ */ new Set([r]));
						...
						if (t.fixedNodeConstraint && t.fixedNodeConstraint.forEach(function(e) {
							...
							if (t.fixedNodeConstraint && t.fixedNodeConstraint.length > 1) t.fixedNodeConstraint.forEach(function(e, t) {
								...
								if (A < O.size / 2) v(t.relativePlacementConstraint), w = !1, T = !1;
									...
									var I = _(N, "horizontal"), L = _(P, "vertical");
									k[j].forEach(function(e, t) {
										C[t] = [l[c.get(e)], u[c.get(e)]], S[t] = [], I.has(e) ? S[t][0] = I.get(e) : S[t][0] = l[c.get(e)], L.has(e) ? S[t][1] = L.get(e) : S[t][1] = u[c.get(e)];
									}), w = !0;
								}
							}
							if (w) {
								for (var R = void 0, z = o.transpose(S), B = o.transpose(C), V = 0; V < z.length; V++) z[V] = o.multGamma(z[V]), B[V] = o.multGamma(B[V]);
								var ee = o.multMat(z, o.transpose(B)), te = s.svd(ee);
								R = o.multMat(te.V, o.transpose(te.U));
								for (var H = 0; H < c.size; H++) {
									var ne = [l[H], u[H]], re = [R[0][0], R[1][0]], U = [R[0][1], R[1][1]];
						...
						if (i.ENFORCE_CONSTRAINTS) {
							...
							t.relativePlacementConstraint && (function() {
								...
								var N = b(S), P = b(C), F = y(N), I = y(P), L = x(S), R = x(C), z = [], B = [];
								F.forEach(function(e, t) {
									z[t] = [], e.forEach(function(e) {
										L.get(e).length == 0 && z[t].push(e);
									});
								}), I.forEach(function(e, t) {
									B[t] = [], e.forEach(function(e) {
										R.get(e).length == 0 && B[t].push(e);
									});
								});
								var V = _(S, "horizontal", s, a, z), ee = _(C, "vertical", d, o, B), te = function(e) {
									r.get(e) ? r.get(e).forEach(function(t) {
										l[c.get(t)] = V.get(e);
									}) : l[c.get(e)] = V.get(e);
								}, H = !0, ne = !1, re = void 0;
								try {
									for (var U = V.keys()[Symbol.iterator](), W; !(H = (W = U.next()).done); H = !0) {
										var G = W.value;
										te(G);
									}
								} catch (e) {
								...
								try {
									for (var Y = ee.keys()[Symbol.iterator](), ae; !(K = (ae = Y.next()).done); K = !0) {
										var G = ae.value;
										ie(G);
									}
								} catch (e) {
			...
			var t = {
				...
				657: ((e, t, n) => {
					...
					e.exports = { spectralLayout: function(e) {
						...
						try {
							for (var H = c.keys()[Symbol.iterator](), ne; !(V = (ne = H.next()).done); V = !0) {
								var re = ne.value;
								B(re);
							}
						} catch (e) {
...
}, "isArchitectureJunction"), re = /* @__PURE__ */ r((e) => e.data(), "edgeData"), U = /* @__PURE__ */ r((e) => e.data(), "nodeData"), W = p.architecture, G = class {
	constructor() {
		this.nodes = {}, this.groups = {}, this.edges = [], this.registeredIds = {}, this.elements = {}, this.setAccTitle = a, this.getAccTitle = m, this.setDiagramTitle = l, this.getDiagramTitle = o, this.getAccDescription = u, this.setAccDescription = g, this.clear();
	}
	static {
		r(this, "ArchitectureDB");
	}
	clear() {
		this.nodes = {}, this.groups = {}, this.edges = [], this.registeredIds = {}, this.dataStructures = void 0, this.elements = {}, d();
	}
	...
	addEdge({ lhsId: e, rhsId: t, lhsDir: n, rhsDir: r, lhsInto: i, rhsInto: a, lhsGroup: o, rhsGroup: s, title: c }) {
		if (!P(n)) throw Error(`Invalid direction given for left hand side of edge ${e}--${t}. Expected (L,R,T,B) got ${String(n)}`);
		if (!P(r)) throw Error(`Invalid direction given for right hand side of edge ${e}--${t}. Expected (L,R,T,B) got ${String(r)}`);
	...
	T(e, t), e.groups.map((e) => t.addGroup(e)), e.services.map((e) => t.addService({
		...e,
		type: "service"
	...
	parse: /* @__PURE__ */ r(async (e) => {
		...
		n.debug(t);
		let r = K.parser?.yy;
		if (!(r instanceof G)) throw Error("parser.parser?.yy was not a ArchitectureDB. This is due to a bug within Mermaid, please report this issue at https://github.com/mermaid-js/mermaid/issues.");
		ie(t, r);
	}, "parse")
}, q = /* @__PURE__ */ r((e) => `
  .edge {
...
`, "getStyles"), J = /* @__PURE__ */ r((e) => `<g><rect width="80" height="80" style="fill: #087ebf; stroke-width: 0px;"/>${e}</g>`, "wrapIcon"), Y = {
	...
	width: 80,
	icons: {
		database: { body: J("<path id=\"b\" data-name=\"4\" d=\"m20,57.86c0,3.94,8.95,7.14,20,7.14s20-3.2,20-7.14\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><path id=\"c\" data-name=\"3\" d=\"m20,45.95c0,3.94,8.95,7.14,20,7.14s20-3.2,20-7.14\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><path id=\"d\" data-name=\"2\" d=\"m20,34.05c0,3.94,8.95,7.14,20,7.14s20-3.2,20-7.14\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><ellipse id=\"e\" data-name=\"1\" cx=\"40\" cy=\"22.14\" rx=\"20\" ry=\"7.14\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><line x1=\"20\" y1=\"57.86\" x2=\"20\" y2=\"22.14\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><line x1=\"60\" y1=\"57.86\" x2=\"60\" y2=\"22.14\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/>") },
		server: { body: J("<rect x=\"17.5\" y=\"17.5\" width=\"45\" height=\"45\" rx=\"2\" ry=\"2\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><line x1=\"17.5\" y1=\"32.5\" x2=\"62.5\" y2=\"32.5\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><line x1=\"17.5\" y1=\"47.5\" x2=\"62.5\" y2=\"47.5\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><g><path d=\"m56.25,25c0,.27-.45.5-1,.5h-10.5c-.55,0-1-.23-1-.5s.45-.5,1-.5h10.5c.55,0,1,.23,1,.5Z\" style=\"fill: #fff; stroke-width: 0px;\"/><path d=\"m56.25,25c0,.27-.45.5-1,.5h-10.5c-.55,0-1-.23-1-.5s.45-.5,1-.5h10.5c.55,0,1,.23,1,.5Z\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10;\"/></g><g><path d=\"m56.25,40c0,.27-.45.5-1,.5h-10.5c-.55,0-1-.23-1-.5s.45-.5,1-.5h10.5c.55,0,1,.23,1,.5Z\" style=\"fill: #fff; stroke-width: 0px;\"/><path d=\"m56.25,40c0,.27-.45.5-1,.5h-10.5c-.55,0-1-.23-1-.5s.45-.5,1-.5h10.5c.55,0,1,.23,1,.5Z\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10;\"/></g><g><path d=\"m56.25,55c0,.27-.45.5-1,.5h-10.5c-.55,0-1-.23-1-.5s.45-.5,1-.5h10.5c.55,0,1,.23,1,.5Z\" style=\"fill: #fff; stroke-width: 0px;\"/><path d=\"m56.25,55c0,.27-.45.5-1,.5h-10.5c-.55,0-1-.23-1-.5s.45-.5,1-.5h10.5c.55,0,1,.23,1,.5Z\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10;\"/></g><g><circle cx=\"32.5\" cy=\"25\" r=\".75\" style=\"fill: #fff; stroke: #fff; stroke-miterlimit: 10;\"/><circle cx=\"27.5\" cy=\"25\" r=\".75\" style=\"fill: #fff; stroke: #fff; stroke-miterlimit: 10;\"/><circle cx=\"22.5\" cy=\"25\" r=\".75\" style=\"fill: #fff; stroke: #fff; stroke-miterlimit: 10;\"/></g><g><circle cx=\"32.5\" cy=\"40\" r=\".75\" style=\"fill: #fff; stroke: #fff; stroke-miterlimit: 10;\"/><circle cx=\"27.5\" cy=\"40\" r=\".75\" style=\"fill: #fff; stroke: #fff; stroke-miterlimit: 10;\"/><circle cx=\"22.5\" cy=\"40\" r=\".75\" style=\"fill: #fff; stroke: #fff; stroke-miterlimit: 10;\"/></g><g><circle cx=\"32.5\" cy=\"55\" r=\".75\" style=\"fill: #fff; stroke: #fff; stroke-miterlimit: 10;\"/><circle cx=\"27.5\" cy=\"55\" r=\".75\" style=\"fill: #fff; stroke: #fff; stroke-miterlimit: 10;\"/><circle cx=\"22.5\" cy=\"55\" r=\".75\" style=\"fill: #fff; stroke: #fff; stroke-miterlimit: 10;\"/></g>") },
		disk: { body: J("<rect x=\"20\" y=\"15\" width=\"40\" height=\"50\" rx=\"1\" ry=\"1\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><ellipse cx=\"24\" cy=\"19.17\" rx=\".8\" ry=\".83\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><ellipse cx=\"56\" cy=\"19.17\" rx=\".8\" ry=\".83\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><ellipse cx=\"24\" cy=\"60.83\" rx=\".8\" ry=\".83\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><ellipse cx=\"56\" cy=\"60.83\" rx=\".8\" ry=\".83\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><ellipse cx=\"40\" cy=\"33.75\" rx=\"14\" ry=\"14.58\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><ellipse cx=\"40\" cy=\"33.75\" rx=\"4\" ry=\"4.17\" style=\"fill: #fff; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><path d=\"m37.51,42.52l-4.83,13.22c-.26.71-1.1,1.02-1.76.64l-4.18-2.42c-.66-.38-.81-1.26-.33-1.84l9.01-10.8c.88-1.05,2.56-.08,2.09,1.2Z\" style=\"fill: #fff; stroke-width: 0px;\"/>") },
		internet: { body: J("<circle cx=\"40\" cy=\"40\" r=\"22.5\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><line x1=\"40\" y1=\"17.5\" x2=\"40\" y2=\"62.5\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><line x1=\"17.5\" y1=\"40\" x2=\"62.5\" y2=\"40\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><path d=\"m39.99,17.51c-15.28,11.1-15.28,33.88,0,44.98\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><path d=\"m40.01,17.51c15.28,11.1,15.28,33.88,0,44.98\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><line x1=\"19.75\" y1=\"30.1\" x2=\"60.25\" y2=\"30.1\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/><line x1=\"19.75\" y1=\"49.9\" x2=\"60.25\" y2=\"49.9\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/>") },
		cloud: { body: J("<path d=\"m65,47.5c0,2.76-2.24,5-5,5H20c-2.76,0-5-2.24-5-5,0-1.87,1.03-3.51,2.56-4.36-.04-.21-.06-.42-.06-.64,0-2.6,2.48-4.74,5.65-4.97,1.65-4.51,6.34-7.76,11.85-7.76.86,0,1.69.08,2.5.23,2.09-1.57,4.69-2.5,7.5-2.5,6.1,0,11.19,4.38,12.28,10.17,2.14.56,3.72,2.51,3.72,4.83,0,.03,0,.07-.01.1,2.29.46,4.01,2.48,4.01,4.9Z\" style=\"fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;\"/>") },
		unknown: S,
		blank: { body: J("") }
	}
}, ae = /* @__PURE__ */ r(async function(e, t, n) {
	let r = n.getConfigField("padding"), i = n.getConfigField("iconSize"), a = i / 2, o = i / 6, s = o / 2;
	await Promise.all(t.edges().map(async (t) => {
		let { source: i, sourceDir: c, sourceArrow: l, sourceGroup: u, target: d, targetDir: p, targetArrow: m, targetGroup: h, label: g } = re(t), { x: _, y } = t[0].sourceEndpoint(), { x: b, y: S } = t[0].midpoint(), { x: C, y: w } = t[0].targetEndpoint(), T = r + 4;
		if (u && (F(c) ? _ += c === "L" ? -T : T : y += c === "T" ? -T : T + 18), h && (F(p) ? C += p === "L" ? -T : T : w += p === "T" ? -T : T + 18), !u && n.getNode(i)?.type === "junction" && (F(c) ? _ += c === "L" ? a : -a : y += c === "T" ? a : -a), !h && n.getNode(d)?.type === "junction" && (F(p) ? C += p === "L" ? a : -a : w += p === "T" ? a : -a), t[0]._private.rscratch) {
			let t = e.insert("g");
			if (t.insert("path").attr("d", `M ${_},${y} L ${b},${S} L${C},${w} `).attr("class", "edge").attr("id", v(i, d, { prefix: "L" })), l) {
				let e = F(c) ? M[c](_, o) : _ - s, n = I(c) ? M[c](y, o) : y - s;
				t.insert("polygon").attr("points", j[c](o)).attr("transform", `translate(${e},${n})`).attr("class", "arrow");
			}
			if (m) {
				let e = F(p) ? M[p](C, o) : C - s, n = I(p) ? M[p](w, o) : w - s;
				t.insert("polygon").attr("points", j[p](o)).attr("transform", `translate(${e},${n})`).attr("class", "arrow");
			}
			if (g) {
				let e = L(c, p) ? "XY" : F(c) ? "X" : "Y", n = 0;
				n = e === "X" ? Math.abs(_ - C) : e === "Y" ? Math.abs(y - w) / 1.5 : Math.abs(_ - C) / 2;
				let r = t.append("g");
				if (await x(r, g, {
					useHtmlLabels: !1,
					width: n,
					classes: "architecture-service-label"
				}, f()), r.attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "middle").attr("text-anchor", "middle"), e === "X") r.attr("transform", "translate(" + b + ", " + S + ")");
				else if (e === "Y") r.attr("transform", "translate(" + b + ", " + S + ") rotate(-90)");
				else if (e === "XY") {
					let e = B(c, p);
					if (e && R(e)) {
						let t = r.node().getBoundingClientRect(), [n, i] = ee(e);
...
}, "drawEdges"), X = /* @__PURE__ */ r(async function(e, t, n) {
		...
		if (o.type === "group") {
			...
			if (o.label) {
				...
				await x(e, o.label, {
					...
					width: c,
					classes: "architecture-service-label"
				}, f()), e.attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "start").attr("text-anchor", "start"), e.attr("transform", "translate(" + (m + a + 4) + ", " + (h + a + 2) + ")");
			}
			n.setElementForId(o.id, d);
		}
	}));
}, "drawGroups"), oe = /* @__PURE__ */ r(async function(e, t, n) {
	let r = f();
	for (let i of n) {
		...
		let o = n.append("g");
		if (i.icon) o.html(`<g>${await C(i.icon, {
			height: a,
			width: a,
			fallbackPrefix: Y.prefix
		})}</g>`);
		else if (i.iconText) {
			o.html(`<g>${await C("blank", {
				height: a,
				width: a,
				fallbackPrefix: Y.prefix
			})}</g>`);
			let e = o.append("g").append("foreignObject").attr("width", a).attr("height", a).append("div").attr("class", "node-icon-text").attr("style", `height: ${a}px;`).append("div").html(c(i.iconText, r)), t = parseInt(window.getComputedStyle(e.node(), null).getPropertyValue("font-size").replace(/\D/g, "")) ?? 16;
	...
	return 0;
}, "drawServices"), Z = /* @__PURE__ */ r(function(e, t, n) {
	n.forEach((n) => {
...
function me(e, t, a, o, s, { spatialMaps: c, groupAlignments: l }) {
	return new Promise((u) => {
		let d = i("body").append("div").attr("id", "cy").attr("style", "display:none"), f = E({
		...
		h.one("layoutstop", () => {
			...
			for (let t of Object.values(f.edges())) if (t.data?.()) {
				...
				if (n !== i && r !== a) {
					let n = t.sourceEndpoint(), r = t.targetEndpoint(), { sourceDir: i } = re(t), [a, o] = I(i) ? [n.x, r.y] : [r.x, n.y], { weights: s, distances: c } = e(n, r, a, o);
...
var he = {
	...
	renderer: { draw: /* @__PURE__ */ r(async (e, t, n, r) => {
		let i = r.db, a = i.getServices(), o = i.getJunctions(), c = i.getGroups(), l = i.getEdges(), u = i.getDataStructures(), d = y(t), f = d.append("g");
		f.attr("class", "architecture-edges");
		let p = d.append("g");
		p.attr("class", "architecture-services");
		let m = d.append("g");
		m.attr("class", "architecture-groups"), await oe(i, p, a), Z(i, p, o);
		let h = await me(a, o, c, l, i, u);
		await ae(f, h, i), await X(m, h, i), le(i, h), s(void 0, d, i.getConfigField("padding"), i.getConfigField("useMaxWidth"));
	}, "draw") },
	styles: q
};
//#endregion
