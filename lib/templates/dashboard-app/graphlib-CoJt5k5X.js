import { A as e, C as t, D as n, E as r, M as i, O as a, T as o, j as s, k as c, w as l, x as u, y as d } from "./chunk-S3R3BYOJ-BtVK2Rr4.js";
import { D as f, T as ee, _ as te, a as p, f as m, o as h, s as ne, u as re, w as g } from "./identity-7Us_sWsB.js";
import { n as _, t as v } from "./isEmpty-DbxQP0Mx.js";
import { C as y, E as b, S as x, T as S, a as ie, b as ae, c as C, i as oe, n as w, s as se, t as ce, w as le, x as T } from "./reduce-BWLEslnA.js";
...
var E = Object.getOwnPropertySymbols ? function(e) {
	for (var t = []; e;) S(t, x(e)), e = a(e);
	return t;
} : y;
//#endregion
...
function Me(t, n, r) {
	...
	switch (n) {
		...
		case ke:
		case Ae:
		case je: return e(t, r);
		case P: return new i();
		case F:
		case ye: return new i(t);
		case I: return O(t);
		case ve: return new i();
		case be: return j(t);
	}
}
//#endregion
...
var L = p && p.isMap, Fe = L ? h(L) : Pe, Ie = "[object Set]";
function Le(e) {
	return m(e) && _(e) == Ie;
}
//#endregion
...
H[z] = H[He] = H[et] = H[tt] = H[Ue] = H[We] = H[nt] = H[rt] = H[it] = H[at] = H[ot] = H[qe] = H[Je] = H[V] = H[Ye] = H[Xe] = H[Ze] = H[Qe] = H[st] = H[ct] = H[lt] = H[ut] = !0, H[Ge] = H[B] = H[$e] = !1;
function U(e, r, a, s, l, u) {
	var d, f = r & ze, p = r & Be, m = r & Ve;
	if (a && (d = l ? a(e, s, l, u) : a(e)), d !== void 0) return d;
	if (!ee(e)) return e;
	var h = re(e);
	if (h) {
		if (d = ge(e), !f) return c(e, d);
	} else {
		var g = _(e), v = g == B || g == Ke;
		if (ne(e)) return i(e, f);
		if (g == V || g == z || v && !l) {
			if (d = p || v ? {} : n(e), !f) return p ? pe(e, de(d, e)) : fe(e, ue(d, e));
		} else {
			if (!H[g]) return l ? e : {};
			d = Me(e, g, f);
		}
	...
	var y = u.get(e);
	if (y) return y;
	u.set(e, d), Re(e) ? e.forEach(function(t) {
		d.add(U(t, r, a, t, e, u));
	}) : Fe(e) && e.forEach(function(t, n) {
		d.set(n, U(t, r, a, n, e, u));
	});
	var b = h ? void 0 : (m ? p ? me : ae : p ? t : T)(e);
	return oe(b || e, function(t, n) {
		b && (n = t, t = e[n]), o(d, n, U(t, r, a, n, e, u));
	}), d;
}
//#endregion
...
var dt = d(function(e) {
	...
	setDefaultNodeLabel(e) {
		return g(e) || (e = u(e)), this._defaultNodeLabelFn = e, this;
	}
	nodeCount() {
	...
	setNode(e, t) {
		return Object.prototype.hasOwnProperty.call(this._nodes, e) ? (arguments.length > 1 && (this._nodes[e] = t), this) : (this._nodes[e] = arguments.length > 1 ? t : this._defaultNodeLabelFn(e), this._isCompound && (this._parent[e] = q, this._children[e] = {}, this._children[q][e] = !0), this._in[e] = {}, this._preds[e] = {}, this._out[e] = {}, this._sucs[e] = {}, ++this._nodeCount, this);
	}
	node(e) {
	...
	removeNode(e) {
		if (Object.prototype.hasOwnProperty.call(this._nodes, e)) {
			...
			delete this._nodes[e], this._isCompound && (this._removeFromParentsChildList(e), delete this._parent[e], w(this.children(e), (e) => {
				this.setParent(e);
			}), delete this._children[e]), w(T(this._in[e]), t), delete this._in[e], delete this._preds[e], w(T(this._out[e]), t), delete this._out[e], delete this._sucs[e], --this._nodeCount;
		}
		return this;
	}
	setParent(e, t) {
		...
		if (K(t)) t = q;
			...
			t += "";
			for (var n = t; !K(n); n = this.parent(n)) if (n === e) throw Error("Setting " + t + " as parent of " + e + " would create a cycle");
			this.setNode(t);
		}
	...
	children(e) {
		if (K(e) && (e = q), this._isCompound) {
			var t = this._children[e];
			if (t) return T(t);
		} else if (e === q) return this.nodes();
	...
	neighbors(e) {
		...
		if (t) return dt(t, this.successors(e));
	}
	isLeaf(e) {
	...
	filterNodes(e) {
		...
		var n = this;
		w(this._nodes, function(n, r) {
			e(r) && t.setNode(r, n);
		}), w(this._edgeObjs, function(e) {
		...
		return this._isCompound && w(t.nodes(), function(e) {
			t.setParent(e, i(e));
		}), t;
	}
	setDefaultEdgeLabel(e) {
		return g(e) || (e = u(e)), this._defaultEdgeLabelFn = e, this;
	}
	edgeCount() {
	...
	setEdge() {
		...
		typeof a == "object" && a && "v" in a ? (e = a.v, t = a.w, n = a.name, arguments.length === 2 && (r = arguments[1], i = !0)) : (e = a, t = arguments[1], n = arguments[3], arguments.length > 2 && (r = arguments[2], i = !0)), e = "" + e, t = "" + t, K(n) || (n = "" + n);
		var o = Q(this._isDirected, e, t, n);
		if (Object.prototype.hasOwnProperty.call(this._edgeLabels, o)) return i && (this._edgeLabels[o] = r), this;
		if (!K(n) && !this._isMultigraph) throw Error("Cannot set a named edge when isMultigraph = false");
		this.setNode(e), this.setNode(t), this._edgeLabels[o] = i ? r : this._defaultEdgeLabelFn(e, t, n);
		var s = pt(this._isDirected, e, t, n);
		return e = s.v, t = s.w, Object.freeze(s), this._edgeObjs[o] = s, X(this._preds[t], e), X(this._sucs[e], t), this._in[t][o] = s, this._out[e][o] = s, this._edgeCount++, this;
	}
	edge(e, t, n) {
		var r = arguments.length === 1 ? $(this._isDirected, arguments[0]) : Q(this._isDirected, e, t, n);
	...
	removeEdge(e, t, n) {
		var r = arguments.length === 1 ? $(this._isDirected, arguments[0]) : Q(this._isDirected, e, t, n), i = this._edgeObjs[r];
		return i && (e = i.v, t = i.w, delete this._edgeLabels[r], delete this._edgeObjs[r], Z(this._preds[t], e), Z(this._sucs[e], t), delete this._in[t][r], delete this._out[e][r], this._edgeCount--), this;
	}
	inEdges(e, t) {
		var n = this._in[e];
		if (n) {
			var r = G(n);
			return t ? C(r, function(e) {
				return e.v === t;
			}) : r;
		}
	}
...
function $(e, t) {
	return Q(e, t.v, t.w, t.name);
}
//#endregion
export { U as i, K as n, G as r, Y as t };
