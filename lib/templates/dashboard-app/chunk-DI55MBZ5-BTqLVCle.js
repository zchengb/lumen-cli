...
import { B as n, C as r, U as i, _ as a, a as o, b as s, s as c, v as l, z as u } from "./chunk-ABZYJK2D-CVevQ3ur.js";
import { h as d, o as f } from "./chunk-S3R3BYOJ-BtVK2Rr4.js";
import { r as p } from "./chunk-N4CR4FBY-C3Oe3dWX.js";
import { t as m } from "./chunk-55IACEB6-7rZAUXZ_.js";
import { t as h } from "./chunk-QN33PNHL-isVexcb8.js";
...
var _ = g, v = "TB", y = "TB", b = "dir", x = "state", S = "root", C = "relation", w = "classDef", T = "style", E = "applyClass", D = "default", O = "divider", k = "fill:none", A = "fill: #333", j = "c", M = "text", N = "normal", P = "rect", F = "rectWithTitle", ee = "stateStart", te = "stateEnd", I = "divider", L = "roundedWithTitle", ne = "note", re = "noteGroup", R = "statediagram", ie = `${R}-state`, ae = "transition", oe = "note", se = `${ae} note-edge`, ce = `${R}-${oe}`, le = `${R}-cluster`, ue = `${R}-cluster-alt`, z = "parent", B = "note", de = "state", V = "----", fe = `${V}${B}`, H = `${V}${z}`, U = /* @__PURE__ */ t((e, t = y) => {
	...
	draw: /* @__PURE__ */ t(async function(t, n, r, i) {
		...
		let { securityLevel: a, state: o, layout: c } = s();
		i.db.extract(i.db.getRootDocV2());
		let l = i.db.getData(), u = m(n, a);
		l.type = i.type, l.layoutAlgorithm = c, l.nodeSpacing = o?.nodeSpacing || 50, l.rankSpacing = o?.rankSpacing || 50, l.markers = ["barb"], l.diagramId = n, await p(l, u);
		try {
...
t(K, "stateDomId");
var me = /* @__PURE__ */ t((t, n, r, i, a, o, l, u) => {
	e.trace("items", n), n.forEach((e) => {
		switch (e.stmt) {
			...
			case C:
				{
					X(t, e.state1, r, i, a, o, l, u), X(t, e.state2, r, i, a, o, l, u);
					let n = {
						id: "edge" + G,
						start: e.state1.id,
						end: e.state2.id,
						...
						style: k,
						labelStyle: "",
						label: c.sanitizeText(e.description ?? "", s()),
						arrowheadStyle: A,
						labelpos: j,
						labelType: M,
						thickness: N,
...
var X = /* @__PURE__ */ t((t, n, r, i, a, o, l, u) => {
	...
	if (e.info("dataFetcher parsedItem", n, f, m), d !== "root") {
		...
		if (f.shape === I && (f.label = ""), t && t.id !== "root" && (e.trace("Setting node ", d, " to be child of its parent ", t.id), f.parentId = t.id), f.centerLabel = !0, n.note) {
			...
			let o = d, c = e.id;
			n.note.position === "left of" && (o = e.id, c = d), a.push({
				id: o + "-" + c,
				start: o,
				end: c,
				arrowhead: "none",
	...
	n.doc && (e.trace("Adding nodes children "), me(n, n.doc, r, i, a, !o, l, u));
	...
	constructor(e) {
		this.version = e, this.nodes = [], this.edges = [], this.rootDoc = [], this.classes = _e(), this.documents = { root: Q() }, this.currentDocument = this.documents.root, this.startEndCount = 0, this.dividerCnt = 0, this.links = /* @__PURE__ */ new Map(), this.getAccTitle = l, this.setAccTitle = n, this.getAccDescription = a, this.setAccDescription = u, this.setDiagramTitle = i, this.getDiagramTitle = r, this.clear(), this.setRootDoc = this.setRootDoc.bind(this), this.getDividerId = this.getDividerId.bind(this), this.setDirection = this.setDirection.bind(this), this.trimColon = this.trimColon.bind(this);
	}
	static {
		t(this, "StateDB");
	}
	...
	addState(t, n = D, r = void 0, i = void 0, a = void 0, o = void 0, l = void 0, u = void 0) {
		let d = t?.trim();
		...
		if (i && (e.info("Setting state description", d, i), (Array.isArray(i) ? i : [i]).forEach((e) => this.addDescription(d, e.trim()))), a) {
			let e = this.currentDocument.states.get(d);
			if (!e) throw Error(`State not found: ${d}`);
			e.note = a, e.note.text = c.sanitizeText(e.note.text, s());
		}
		o && (e.info("Setting state classes", d, o), (Array.isArray(o) ? o : [o]).forEach((e) => this.setCssClass(d, e.trim()))), l && (e.info("Setting state styles", d, l), (Array.isArray(l) ? l : [l]).forEach((e) => this.setStyle(d, e.trim()))), u && (e.info("Setting state styles", d, l), (Array.isArray(u) ? u : [u]).forEach((e) => this.setTextStyle(d, e.trim())));
	}
	clear(e) {
		this.nodes = [], this.edges = [], this.documents = { root: Q() }, this.currentDocument = this.documents.root, this.startEndCount = 0, this.classes = _e(), e || (this.links = /* @__PURE__ */ new Map(), o());
	}
	getState(e) {
	...
	addRelationObjs(e, t, n = "") {
		...
		this.addState(r, i, e.doc, e.description, e.note, e.classes, e.styles, e.textStyles), this.addState(a, o, t.doc, t.description, t.note, t.classes, t.styles, t.textStyles), this.currentDocument.relations.push({
			id1: r,
			id2: a,
			relationTitle: c.sanitizeText(n, s())
		});
	}
	addRelation(e, t, n) {
		if (typeof e == "object" && typeof t == "object") this.addRelationObjs(e, t, n);
			...
			this.addState(r, i), this.addState(a, o), this.currentDocument.relations.push({
				id1: r,
				id2: a,
				relationTitle: n ? c.sanitizeText(n, s()) : void 0
			});
		}
	}
	addDescription(e, t) {
		let n = this.currentDocument.states.get(e), r = t.startsWith(":") ? t.replace(":", "").trim() : t;
		n?.descriptions?.push(c.sanitizeText(r, s()));
	}
	cleanupLabel(e) {
