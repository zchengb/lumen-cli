...
import { B as r, C as i, H as a, U as o, _ as s, a as c, b as l, et as u, s as d, u as f, v as p, z as ee } from "./chunk-ABZYJK2D-CVevQ3ur.js";
import { t as m } from "./channel-Div8HQ8s.js";
import { h, s as g } from "./chunk-S3R3BYOJ-BtVK2Rr4.js";
import { n as _, t as te } from "./chunk-MI3HLSF2-DVisFF9Y.js";
...
import { o as ne } from "./chunk-JZLCHNYA-Ci7qRJgj.js";
import "./chunk-QXUST7PY-DUpJQbC-.js";
import { r as re, t as v } from "./chunk-N4CR4FBY-C3Oe3dWX.js";
import { t as y } from "./chunk-FMBD7UC4-BFlOEP8u.js";
import { t as b } from "./chunk-55IACEB6-7rZAUXZ_.js";
...
var S = "flowchart-", C = class {
	constructor() {
		this.vertexCounter = 0, this.config = l(), this.vertices = /* @__PURE__ */ new Map(), this.edges = [], this.classes = /* @__PURE__ */ new Map(), this.subGraphs = [], this.subGraphLookup = /* @__PURE__ */ new Map(), this.tooltips = /* @__PURE__ */ new Map(), this.subCount = 0, this.firstGraphFlag = !0, this.secCount = -1, this.posCrossRef = [], this.funs = [], this.setAccTitle = r, this.setAccDescription = ee, this.setDiagramTitle = o, this.getAccTitle = p, this.getAccDescription = s, this.getDiagramTitle = i, this.funs.push(this.setupToolTips.bind(this)), this.addVertex = this.addVertex.bind(this), this.firstGraph = this.firstGraph.bind(this), this.setDirection = this.setDirection.bind(this), this.addSubGraph = this.addSubGraph.bind(this), this.addLink = this.addLink.bind(this), this.setLink = this.setLink.bind(this), this.updateLink = this.updateLink.bind(this), this.addClass = this.addClass.bind(this), this.setClass = this.setClass.bind(this), this.destructLink = this.destructLink.bind(this), this.setClickEvent = this.setClickEvent.bind(this), this.setTooltip = this.setTooltip.bind(this), this.updateLinkInterpolate = this.updateLinkInterpolate.bind(this), this.setClickFun = this.setClickFun.bind(this), this.bindFunctions = this.bindFunctions.bind(this), this.lex = { firstGraph: this.firstGraph.bind(this) }, this.clear(), this.setGen("gen-2");
	}
	static {
		t(this, "FlowDB");
	}
	...
	addVertex(e, t, n, r, i, a, o = {}, s) {
		...
		if (f === void 0 && (f = {
			id: e,
			labelType: "text",
			domId: S + e + "-" + this.vertexCounter,
			styles: [],
			classes: []
		}, this.vertices.set(e, f)), this.vertexCounter++, t === void 0 ? f.text === void 0 && (f.text = e) : (this.config = l(), d = this.sanitizeText(t.text.trim()), f.labelType = t.type, d.startsWith("\"") && d.endsWith("\"") && (d = d.substring(1, d.length - 1)), f.text = d), n !== void 0 && (f.type = n), r?.forEach((e) => {
			f.styles.push(e);
		}), i?.forEach((e) => {
			f.classes.push(e);
	...
	addSingleLink(t, n, r, i) {
		...
		if (this.edges.length < (this.config.maxEdges ?? 500)) e.info("Pushing edge..."), this.edges.push(a);
...
You have to call mermaid.initialize.`);
	...
	setClickFun(e, t, n) {
		...
		if (l().securityLevel !== "loose" || t === void 0) return;
		let i = [];
		if (typeof n == "string") {
			i = n.split(/,(?=(?:(?:[^"]*"){2})*[^"]*$)/);
	...
	setLink(e, t, n) {
		e.split(",").forEach((e) => {
			...
			r !== void 0 && (r.link = h.formatUrl(t, this.config), r.linkTarget = n);
	...
	setupToolTips(e) {
		...
		(t._groups || t)[0][0] === null && (t = n("body").append("div").attr("class", "mermaidTooltip").style("opacity", 0)), n(e).select("svg").selectAll("g.node").on("mouseover", (e) => {
	...
	clear(e = "gen-2") {
		this.vertices = /* @__PURE__ */ new Map(), this.classes = /* @__PURE__ */ new Map(), this.edges = [], this.funs = [this.setupToolTips.bind(this)], this.subGraphs = [], this.subGraphLookup = /* @__PURE__ */ new Map(), this.subCount = 0, this.tooltips = /* @__PURE__ */ new Map(), this.firstGraphFlag = !0, this.version = e, this.config = l(), c();
	}
	setGen(e) {
	...
	addSubGraph(n, r, i) {
		...
		let s = (/* @__PURE__ */ t((e) => {
			...
			return {
				nodeList: e.filter(function(e) {
					let i = typeof e;
					return e.stmt && e.stmt === "dir" ? (r = e.value, !1) : e.trim() === "" ? !1 : i in t ? t[i].hasOwnProperty(e) ? !1 : t[i][e] = !0 : !n.includes(e) && n.push(e);
				}),
				dir: r
			};
		}, "uniq"))(r.flat()), c = s.nodeList, u = s.dir, d = l().flowchart ?? {};
		if (u ??= d.inheritDir ? this.getDirection() ?? l().direction ?? void 0 : void 0, this.version === "gen-1") for (let e = 0; e < c.length; e++) c[e] = this.lookUpDomId(c[e]);
		...
		return e.info("Adding", f.id, f.nodes, f.dir), f.nodes = this.makeUniq(f, this.subGraphs).nodes, this.subGraphs.push(f), this.subGraphLookup.set(a, f), a;
	}
	getPosForId(e) {
	...
	getData() {
		let e = l(), t = [], n = [], r = this.getSubGraphs(), i = /* @__PURE__ */ new Map(), a = /* @__PURE__ */ new Map();
	...
	draw: /* @__PURE__ */ t(async function(t, r, i, a) {
		...
		let { securityLevel: o, flowchart: s, layout: c } = l(), u;
		o === "sandbox" && (u = n("#i" + r));
		let d = o === "sandbox" ? u.nodes()[0].contentDocument : document;
		e.debug("Before getData: ");
		let f = a.db.getData();
		e.debug("Data: ", f);
		let p = b(r, o), ee = a.db.getDirection();
		f.type = a.type, f.layoutAlgorithm = v(c), f.layoutAlgorithm === "dagre" && c === "elk" && e.warn("flowchart-elk was moved to an external package in Mermaid v11. Please refer [release notes](https://github.com/mermaid-js/mermaid/releases/tag/v11.0.0) for more details. This diagram will be rendered using `dagre` layout as a fallback."), f.direction = ee, f.nodeSpacing = s?.nodeSpacing || 50, f.rankSpacing = s?.rankSpacing || 50, f.markers = [
			"point",
			"circle",
			"cross"
		], f.diagramId = r, e.debug("REF1:", f), await re(f, p);
		let m = f.config.flowchart?.diagramPadding ?? 8;
		h.insertTitle(p, "flowchartTitleText", s?.titleTopMargin || 0, a.db.getDiagramTitle()), x(p, m, "flowchart", s?.useMaxWidth || !1);
	...
	var e = /* @__PURE__ */ t(function(e, t, n, r) {
		...
		123,
		124
	], o = [2, 2], s = [1, 13], c = [1, 14], l = [1, 15], u = [1, 16], d = [1, 23], f = [1, 25], p = [1, 26], ee = [1, 27], m = [1, 49], h = [1, 48], g = [1, 29], _ = [1, 30], te = [1, 31], ne = [1, 32], re = [1, 33], v = [1, 44], y = [1, 46], b = [1, 42], x = [1, 47], S = [1, 43], C = [1, 50], w = [1, 45], T = [1, 51], E = [1, 52], D = [1, 34], ie = [1, 35], ae = [1, 36], oe = [1, 37], O = [1, 57], k = [
		1,
		8,
		9,
		10,
		...
		77,
		78
	], ce = [1, 78], le = [1, 91], ue = [1, 96], de = [1, 95], fe = [1, 92], pe = [1, 88], me = [1, 94], he = [1, 90], ge = [1, 97], _e = [1, 93], ve = [1, 98], ye = [1, 89], be = [
		8,
		9,
		10,
		11,
		...
		parse: /* @__PURE__ */ t(function(e) {
			...
			for (var v, y, b, x, S, C = {}, w, T, E, D;;) {
				if (b = r[r.length - 1], this.defaultActions[b] ? x = this.defaultActions[b] : (v ??= re(), x = s[b] && s[b][v]), x === void 0 || !x.length || !x[0]) {
					...
					ie = m.showPosition ? "Parse error on line " + (l + 1) + ":\n" + m.showPosition() + "\nExpecting " + D.join(", ") + ", got '" + (this.terminals_[v] || v) + "'" : "Parse error on line " + (l + 1) + ": Unexpected " + (v == p ? "end of input" : "'" + (this.terminals_[v] || v) + "'"), this.parseError(ie, {
						text: m.match,
	...
	return t(rt, "Parser"), rt.prototype = nt, nt.Parser = rt, new rt();
})();
T.parser = T;
var E = T, D = Object.assign({}, E);
D.parse = (e) => {
	let t = e.replace(/}\s*\n/g, "}\n");
	return E.parse(t);
};
var ie = D, ae = /* @__PURE__ */ t((e, t) => {
	let n = m;
...
`, "getStyles"),
	init: /* @__PURE__ */ t((e) => {
		e.flowchart ||= {}, e.layout && a({ layout: e.layout }), e.flowchart.arrowMarkerAbsolute = e.arrowMarkerAbsolute, a({ flowchart: { arrowMarkerAbsolute: e.arrowMarkerAbsolute } });
	}, "init")
};
//#endregion
