...
import { E as r, I as i, a, b as o, c as s, et as c, h as l, s as u, y as d } from "./chunk-ABZYJK2D-CVevQ3ur.js";
import { t as f } from "./channel-Div8HQ8s.js";
import { H as p, c as m, h, i as g } from "./chunk-S3R3BYOJ-BtVK2Rr4.js";
import { t as _ } from "./line-BTdGI09n.js";
import { t as v } from "./chunk-HN2XXSSU-BzJE2DVW.js";
import { t as y } from "./chunk-CVBHYZKI-utcCkCdu.js";
import { a as b, n as x } from "./chunk-JA3XYJ7Z-RwfPEVEr.js";
import { t as S } from "./chunk-FMBD7UC4-BFlOEP8u.js";
import { t as C } from "./graphlib-CoJt5k5X.js";
import { t as w } from "./clone-DNq5FlID.js";
...
T.parser = T;
var E = T, D = /* @__PURE__ */ new Map(), O = [], k = /* @__PURE__ */ new Map(), A = "color", j = "fill", M = "bgFill", ee = ",", te = o(), N = /* @__PURE__ */ new Map(), ne = /* @__PURE__ */ t((e) => u.sanitizeText(e, te), "sanitizeText"), re = /* @__PURE__ */ t(function(e, t = "") {
	let n = N.get(e);
	n || (n = {
		id: e,
		styles: [],
		textStyles: []
	}, N.set(e, n)), t?.split(ee).forEach((e) => {
		let t = e.replace(/([^;]*);/, "$1").trim();
		if (RegExp(A).exec(e)) {
			let e = t.replace(j, M).replace(A, j);
			n.textStyles.push(e);
		}
		n.styles.push(t);
	});
...
}, "addStyle2Node"), ae = /* @__PURE__ */ t(function(e, t) {
...
}, "setCssClass"), oe = /* @__PURE__ */ t((t, n) => {
	let r = t.flat(), i = [], a = r.find((e) => e?.type === "column-setting")?.columns ?? -1;
	for (let t of r) {
		if (typeof a == "number" && a > 0 && t.type !== "column-setting" && typeof t.widthInColumns == "number" && t.widthInColumns > a && e.warn(`Block ${t.id} width ${t.widthInColumns} exceeds configured column width ${a}`), t.label &&= ne(t.label), t.type === "classDef") {
			re(t.id, t.css);
			continue;
		}
		if (t.type === "applyClass") {
			ae(t.id, t?.styleClass ?? "");
			continue;
		}
		if (t.type === "applyStyles") {
			t?.stylesStr && ie(t.id, t?.stylesStr);
			continue;
		}
		if (t.type === "column-setting") n.columns = t.columns ?? -1;
		else if (t.type === "edge") {
			let e = (k.get(t.id) ?? 0) + 1;
			k.set(t.id, e), t.id = e + "-" + t.id, O.push(t);
		} else {
			t.label || (t.type === "composite" ? t.label = "" : t.label = t.id);
			let e = D.get(t.id);
			if (e === void 0 ? D.set(t.id, t) : (t.type !== "na" && (e.type = t.type), t.label !== t.id && (e.label = t.label)), t.children && oe(t.children, t), t.type === "space") {
				let e = t.width ?? 1;
				for (let n = 0; n < e; n++) {
					let e = w(t);
					e.id = e.id + "-" + n, D.set(e.id, e), i.push(e);
				}
	...
	e.debug("Clear called"), a(), F = {
		id: "root",
		type: "composite",
		children: [],
		columns: -1
	}, D = /* @__PURE__ */ new Map([["root", F]]), P = [], N = /* @__PURE__ */ new Map(), O = [], k = /* @__PURE__ */ new Map();
}, "clear");
function ce(t) {
...
var de = 0, fe = {
	...
	getBlocksFlat: /* @__PURE__ */ t(() => [...D.values()], "getBlocksFlat"),
	getBlocks: /* @__PURE__ */ t(() => P || [], "getBlocks"),
	getEdges: /* @__PURE__ */ t(() => O, "getEdges"),
	setHierarchy: /* @__PURE__ */ t((e) => {
		F.children = e, oe(e, F), P = F.children;
	}, "setHierarchy"),
	getBlock: /* @__PURE__ */ t((e) => D.get(e), "getBlock"),
	...
	clear: se,
	generateId: /* @__PURE__ */ t(() => (de++, "id-" + Math.random().toString(36).substr(2, 12) + "-" + de), "generateId")
}, I = /* @__PURE__ */ t((e, t) => {
	let n = f;
	return c(n(e, "r"), n(e, "g"), n(e, "b"), t);
}, "fade"), pe = /* @__PURE__ */ t((e) => `.label {
  ...
  ${S()}
`, "getStyles"), me = /* @__PURE__ */ t((e, t, n, r) => {
	t.forEach((t) => {
		he[t](e, n, r);
	});
}, "insertMarkers"), he = {
...
t(_e, "calculateBlockPosition");
var ve = /* @__PURE__ */ t((t) => {
	let n = 0, r = 0;
	for (let i of t.children) {
		let { width: a, height: o, x: s, y: c } = i.size ?? {
			width: 0,
			height: 0,
			x: 0,
			y: 0
		};
		e.debug("getMaxChildSize abc95 child:", i.id, "width:", a, "height:", o, "x:", s, "y:", c, i.type), i.type !== "space" && (a > n && (n = a / (t.widthInColumns ?? 1)), o > r && (r = o));
	}
	return {
		width: n,
		height: r
...
function R(t, n, r = 0, i = 0) {
	...
	if (t.children?.length > 0) {
		...
		for (let n of t.children) n.size && (e.debug(`abc95 Setting size of children of ${t.id} id=${n.id} ${a} ${o} ${JSON.stringify(n.size)}`), n.size.width = a * (n.widthInColumns ?? 1) + L * ((n.widthInColumns ?? 1) - 1), n.size.height = o, n.size.x = 0, n.size.y = 0, e.debug(`abc95 updating size of ${t.id} children child:${n.id} maxWidth:${a} maxHeight:${o}`));
		...
		c > 0 && c < l && (u = c);
		let d = Math.ceil(l / u), f = u * (a + L) + L, p = d * (o + L) + L;
		if (f < r) {
			e.debug(`Detected to small sibling: abc95 ${t.id} siblingWidth ${r} siblingHeight ${i} width ${f}`), f = r, p = i;
			let n = (r - u * L - L) / u, s = (i - d * L - L) / d;
			e.debug("Size indata abc88", t.id, "childWidth", n, "maxWidth", a), e.debug("Size indata abc88", t.id, "childHeight", s, "maxHeight", o), e.debug("Size indata abc88 xSize", u, "padding", L);
...
function z(t, n) {
	...
	if (e.debug("layoutBlocks columns abc95", t.id, "=>", r, t), t.children && t.children.length > 0) {
		let i = t?.children[0]?.size?.width ?? 0, a = t.children.length * i + (t.children.length - 1) * L;
		e.debug("widthOfChildren 88", a, "posX");
		let o = 0;
		e.debug("abc91 block?.size?.x", t.id, t?.size?.x);
		let s = t?.size?.x ? t?.size?.x + (-t?.size?.width / 2 || 0) : -L, c = 0;
		for (let i of t.children) {
			let a = t;
			if (!i.size) continue;
			let { width: l, height: u } = i.size, { px: d, py: f } = _e(r, o);
			if (f != c && (c = f, s = t?.size?.x ? t?.size?.x + (-t?.size?.width / 2 || 0) : -L, e.debug("New row in layout for block", t.id, " and child ", i.id, c)), e.debug(`abc89 layout blocks (child) id: ${i.id} Pos: ${o} (px, py) ${d},${f} (${a?.size?.x},${a?.size?.y}) parent: ${a.id} width: ${l}${L}`), a.size) {
				let t = l / 2;
				i.size.x = s + L + t, e.debug(`abc91 layout blocks (calc) px, pyid:${i.id} startingPos=X${s} new startingPosX${i.size.x} ${t} padding=${L} width=${l} halfWidth=${t} => x:${i.size.x} y:${i.size.y} ${i.widthInColumns} (width * (child?.w || 1)) / 2 ${l * (i?.widthInColumns ?? 1) / 2}`), s = i.size.x + t, i.size.y = a.size.y - a.size.height / 2 + f * (u + L) + u / 2 + L, e.debug(`abc88 layout blocks (calc) px, pyid:${i.id}startingPosX${s}${L}${t}=>x:${i.size.x}y:${i.size.y}${i.widthInColumns}(width * (child?.w || 1)) / 2${l * (i?.widthInColumns ?? 1) / 2}`);
			}
			i.children && z(i, n);
			let p = i?.widthInColumns ?? 1;
			r > 0 && (p = Math.min(p, r - o % r)), o += p, e.debug("abc88 columnsPos", i, o);
		}
	}
...
t(V, "applyStyle");
function be(e, t) {
	let r = n(document.createElementNS("http://www.w3.org/2000/svg", "foreignObject")), a = r.append("xhtml:div"), o = e.label, s = e.isNode ? "nodeLabel" : "edgeLabel", c = a.append("span");
	return c.html(i(o, t)), V(c, e.labelStyle), c.attr("class", s), V(a, e.labelStyle), a.style("display", "inline-block"), a.style("white-space", "nowrap"), a.attr("xmlns", "http://www.w3.org/1999/xhtml"), r.node();
}
t(be, "addHtmlLabel");
var H = /* @__PURE__ */ t(async (t, n, r, i) => {
	let a = t || "";
	typeof a == "object" && (a = a[0]);
	let s = o();
	if (l(s.flowchart.htmlLabels)) return a = a.replace(/\\n|\n/g, "<br />"), e.debug("vertexText" + a), be({
		isNode: i,
		label: await b(g(a)),
...
}, "createLabel"), xe = /* @__PURE__ */ t((e, t, n, r, i) => {
	t.arrowTypeStart && Ce(e, "start", t.arrowTypeStart, n, r, i), t.arrowTypeEnd && Ce(e, "end", t.arrowTypeEnd, n, r, i);
}, "addEdgeMarkers"), Se = {
	arrow_cross: "cross",
	arrow_point: "point",
	arrow_barb: "barb",
...
}, "addEdgeMarker"), U = {}, W = {}, we = /* @__PURE__ */ t(async (e, t) => {
	let r = o(), i = l(r.flowchart.htmlLabels), a = t.labelType === "markdown" ? x(e, t.label, {
		style: t.labelStyle,
		useHtmlLabels: i,
		addSvgBackground: !0
	}, r) : await H(t.label, t.labelStyle), s = e.insert("g").attr("class", "edgeLabel"), c = s.insert("g").attr("class", "label");
	c.node().appendChild(a);
	let u = a.getBBox();
	if (i) {
		let e = a.children[0], t = n(a);
		u = e.getBoundingClientRect(), t.attr("width", u.width), t.attr("height", u.height);
	}
	c.attr("transform", "translate(" + -u.width / 2 + ", " + -u.height / 2 + ")"), U[t.id] = s, t.width = u.width, t.height = u.height;
	let d;
	if (t.startLabelLeft) {
		let n = await H(t.startLabelLeft, t.labelStyle), r = e.insert("g").attr("class", "edgeTerminals"), i = r.insert("g").attr("class", "inner");
		d = i.node().appendChild(n);
		let a = n.getBBox();
		i.attr("transform", "translate(" + -a.width / 2 + ", " + -a.height / 2 + ")"), W[t.id] || (W[t.id] = {}), W[t.id].startLeft = r, G(d, t.startLabelLeft);
	}
	if (t.startLabelRight) {
		let n = await H(t.startLabelRight, t.labelStyle), r = e.insert("g").attr("class", "edgeTerminals"), i = r.insert("g").attr("class", "inner");
		d = r.node().appendChild(n), i.node().appendChild(n);
		let a = n.getBBox();
		i.attr("transform", "translate(" + -a.width / 2 + ", " + -a.height / 2 + ")"), W[t.id] || (W[t.id] = {}), W[t.id].startRight = r, G(d, t.startLabelRight);
	}
	if (t.endLabelLeft) {
		let n = await H(t.endLabelLeft, t.labelStyle), r = e.insert("g").attr("class", "edgeTerminals"), i = r.insert("g").attr("class", "inner");
		d = i.node().appendChild(n);
		let a = n.getBBox();
		i.attr("transform", "translate(" + -a.width / 2 + ", " + -a.height / 2 + ")"), r.node().appendChild(n), W[t.id] || (W[t.id] = {}), W[t.id].endLeft = r, G(d, t.endLabelLeft);
	}
	if (t.endLabelRight) {
		let n = await H(t.endLabelRight, t.labelStyle), r = e.insert("g").attr("class", "edgeTerminals"), i = r.insert("g").attr("class", "inner");
		d = i.node().appendChild(n);
		let a = n.getBBox();
		i.attr("transform", "translate(" + -a.width / 2 + ", " + -a.height / 2 + ")"), r.node().appendChild(n), W[t.id] || (W[t.id] = {}), W[t.id].endRight = r, G(d, t.endLabelRight);
	}
	return a;
}, "insertEdgeLabel");
function G(e, t) {
	o().flowchart.htmlLabels && e && (e.style.width = t.length * 9 + "px", e.style.height = "12px");
}
t(G, "setTerminalWidth");
var Te = /* @__PURE__ */ t((t, n) => {
	e.debug("Moving label abc88 ", t.id, t.label, U[t.id], n);
	let r = n.updatedPath ? n.updatedPath : n.originalPath, { subGraphTitleTotalMargin: i } = y(o());
	if (t.label) {
		let a = U[t.id], o = t.x, s = t.y;
		if (r) {
			let i = h.calcLabelPosition(r);
	...
	if (t.startLabelLeft) {
		...
		if (r) {
			let e = h.calcTerminalLabelPosition(t.arrowTypeStart ? 10 : 0, "start_left", r);
			n = e.x, i = e.y;
		}
	...
	if (t.startLabelRight) {
		...
		if (r) {
			let e = h.calcTerminalLabelPosition(t.arrowTypeStart ? 10 : 0, "start_right", r);
			n = e.x, i = e.y;
		}
		e.attr("transform", `translate(${n}, ${i})`);
	}
	if (t.endLabelLeft) {
		...
		if (r) {
			let e = h.calcTerminalLabelPosition(t.arrowTypeEnd ? 10 : 0, "end_left", r);
			n = e.x, i = e.y;
		}
		e.attr("transform", `translate(${n}, ${i})`);
	}
	if (t.endLabelRight) {
		...
		if (r) {
			let e = h.calcTerminalLabelPosition(t.arrowTypeEnd ? 10 : 0, "end_right", r);
			n = e.x, i = e.y;
		}
		e.attr("transform", `translate(${n}, ${i})`);
	}
}, "positionEdgeLabel"), Ee = /* @__PURE__ */ t((e, t) => {
	let n = e.x, r = e.y, i = Math.abs(t.x - n), a = Math.abs(t.y - r), o = e.width / 2, s = e.height / 2;
	return i >= o || a >= s;
}, "outsideNode"), De = /* @__PURE__ */ t((t, n, r) => {
  ...
  node        : x:${t.x} y:${t.y} w:${t.width} h:${t.height}`);
...
}, "intersection"), Oe = /* @__PURE__ */ t((t, n) => {
...
}, "cutPathAtIntersect"), ke = /* @__PURE__ */ t(function(t, n, i, a, s, c, l) {
	let u = i.points;
	e.debug("abc88 InsertEdge: edge=", i, "e=", n);
	let d = !1, f = c.node(n.v);
	var m = c.node(n.w);
	m?.intersect && f?.intersect && (u = u.slice(1, i.points.length - 1), u.unshift(f.intersect(u[0])), u.push(m.intersect(u[u.length - 1]))), i.toCluster && (e.debug("to cluster abc88", a[i.toCluster]), u = Oe(i.points, a[i.toCluster].node), d = !0), i.fromCluster && (e.debug("from cluster abc88", a[i.fromCluster]), u = Oe(u.reverse(), a[i.fromCluster].node).reverse(), d = !0);
	...
	(o().flowchart.arrowMarkerAbsolute || o().state.arrowMarkerAbsolute) && (w = r(!0)), xe(C, i, w, l, s);
	let T = {};
	return d && (T.updatedPath = u), T.originalPath = i.points, T;
}, "insertEdge"), Ae = /* @__PURE__ */ t((e) => {
	...
	return t;
}, "expandAndDeduplicateDirections"), je = /* @__PURE__ */ t((e, t, n) => {
	let r = Ae(e), i = t.height + 2 * n.padding, a = i / 2, o = t.width + 2 * a + n.padding, s = n.padding / 2;
...
t(Pe, "intersectEllipse");
var Fe = Pe;
function Ie(e, t, n) {
	return Fe(e, t, t, n);
}
t(Ie, "intersectCircle");
var Le = Ie;
function Re(e, t, n, r) {
	var i = t.y - e.y, a, o = e.x - t.x, s, c = t.x * e.y - e.x * t.y, l, u, d, f = i * n.x + o * n.y + c, p = i * r.x + o * r.y + c, m, h, g, _, v;
	if (!(f !== 0 && p !== 0 && ze(f, p)) && (a = r.y - n.y, s = n.x - r.x, l = r.x * n.y - n.x * r.y, u = a * e.x + s * e.y + l, d = a * t.x + s * t.y + l, !(u !== 0 && d !== 0 && ze(u, d)) && (m = i * s - a * o, m !== 0))) return h = Math.abs(m / 2), g = o * l - s * c, _ = g < 0 ? (g - h) / m : (g + h) / m, g = a * c - i * l, v = g < 0 ? (g - h) / m : (g + h) / m, {
		x: _,
		y: v
	};
}
...
var K = {
...
}, q = /* @__PURE__ */ t(async (e, r, a, s) => {
	let c = o(), u, d = r.useHtmlLabels || l(c.flowchart.htmlLabels);
	u = a || "node default";
	let f = e.insert("g").attr("class", u).attr("id", r.domId || r.id), p = f.insert("g").attr("class", "label").attr("style", r.labelStyle), m;
	m = r.labelText === void 0 ? "" : typeof r.labelText == "string" ? r.labelText : r.labelText[0];
	let h = p.node(), _;
	_ = r.labelType === "markdown" ? x(p, i(g(m), c), {
		useHtmlLabels: d,
		width: r.width || c.flowchart.wrappingWidth,
		classes: "markdown-node-label"
	}, c) : h.appendChild(await H(i(g(m), c), r.labelStyle, !1, s));
	let v = _.getBBox(), y = r.padding / 2;
	if (l(c.flowchart.htmlLabels)) {
			...
			await Promise.all([...i].map((n) => new Promise((r) => {
				function i() {
					if (n.style.display = "flex", n.style.flexDirection = "column", e) {
						let e = c.fontSize ? c.fontSize : window.getComputedStyle(document.body).fontSize, t = parseInt(e, 10) * 5 + "px";
	...
	return d ? p.attr("transform", "translate(" + -v.width / 2 + ", " + -v.height / 2 + ")") : p.attr("transform", "translate(0, " + -v.height / 2 + ")"), r.centerLabel && p.attr("transform", "translate(" + -v.width / 2 + ", " + -v.height / 2 + ")"), p.insert("rect", ":first-child"), {
		shapeSvg: f,
		bbox: v,
		halfPadding: y,
		label: p
...
var Ue = /* @__PURE__ */ t(async (t, n) => {
	n.useHtmlLabels || o().flowchart.htmlLabels || (n.centerLabel = !0);
...
}, "note"), We = /* @__PURE__ */ t((e) => e ? " " + e : "", "formatClass"), X = /* @__PURE__ */ t((e, t) => `${t || "node default"}${We(e.classes)} ${We(e.class)}`, "getClassesFromNode"), Ge = /* @__PURE__ */ t(async (t, n) => {
...
}, "choice"), qe = /* @__PURE__ */ t(async (e, t) => {
...
}, "hexagon"), Je = /* @__PURE__ */ t(async (e, t) => {
	let { shapeSvg: n, bbox: r } = await q(e, t, void 0, !0), i = r.height + 2 * t.padding, a = i / 2, o = r.width + 2 * a + t.padding, s = je(t.directions, r, t), c = Y(n, o, i, s);
	return c.attr("style", t.style), J(t, c), t.intersect = function(e) {
		return K.polygon(t, s, e);
	}, n;
}, "block_arrow"), Ye = /* @__PURE__ */ t(async (e, t) => {
...
}, "rect_left_inv_arrow"), Xe = /* @__PURE__ */ t(async (e, t) => {
...
}, "lean_right"), Ze = /* @__PURE__ */ t(async (e, t) => {
	let { shapeSvg: n, bbox: r } = await q(e, t, X(t, void 0), !0), i = r.width + t.padding, a = r.height + t.padding, o = [
		{
			x: 2 * a / 6,
			y: 0
...
}, "lean_left"), Qe = /* @__PURE__ */ t(async (e, t) => {
	let { shapeSvg: n, bbox: r } = await q(e, t, X(t, void 0), !0), i = r.width + t.padding, a = r.height + t.padding, o = [
		{
			x: -2 * a / 6,
			y: 0
...
}, "trapezoid"), $e = /* @__PURE__ */ t(async (e, t) => {
	let { shapeSvg: n, bbox: r } = await q(e, t, X(t, void 0), !0), i = r.width + t.padding, a = r.height + t.padding, o = [
		{
			x: a / 6,
			y: 0
...
}, "inv_trapezoid"), et = /* @__PURE__ */ t(async (e, t) => {
	let { shapeSvg: n, bbox: r } = await q(e, t, X(t, void 0), !0), i = r.width + t.padding, a = r.height + t.padding, o = [
		{
			x: 0,
			y: 0
...
}, "rect_right_inv_arrow"), tt = /* @__PURE__ */ t(async (e, t) => {
...
}, "cylinder"), nt = /* @__PURE__ */ t(async (t, n) => {
...
}, "composite"), it = /* @__PURE__ */ t(async (t, n) => {
...
var at = /* @__PURE__ */ t(async (t, r) => {
	let i;
	i = r.classes ? "node " + r.classes : "node default";
	let a = t.insert("g").attr("class", i).attr("id", r.domId || r.id), s = a.insert("rect", ":first-child"), c = a.insert("line"), u = a.insert("g").attr("class", "label"), d = r.labelText.flat ? r.labelText.flat() : r.labelText, f = "";
	f = typeof d == "object" ? d[0] : d, e.info("Label text abc79", f, d, typeof d == "object");
	let p = u.node().appendChild(await H(f, r.labelStyle, !0, !0)), m = {
		width: 0,
		height: 0
	};
	if (l(o().flowchart.htmlLabels)) {
		let e = p.children[0], t = n(p);
		m = e.getBoundingClientRect(), t.attr("width", m.width), t.attr("height", m.height);
	}
	e.info("Text 2", d);
	let h = d.slice(1, d.length), g = p.getBBox(), _ = u.node().appendChild(await H(h.join ? h.join("<br/>") : h, r.labelStyle, !0, !0));
	if (l(o().flowchart.htmlLabels)) {
		let e = _.children[0], t = n(_);
		m = e.getBoundingClientRect(), t.attr("width", m.width), t.attr("height", m.height);
	}
	let v = r.padding / 2;
	return n(_).attr("transform", "translate( " + (m.width > g.width ? 0 : (g.width - m.width) / 2) + ", " + (g.height + v + 5) + ")"), n(p).attr("transform", "translate( " + (m.width < g.width ? 0 : -(g.width - m.width) / 2) + ", 0)"), m = u.node().getBBox(), u.attr("transform", "translate(" + -m.width / 2 + ", " + (-m.height / 2 - v + 3) + ")"), s.attr("class", "outer title-state").attr("x", -m.width / 2 - v).attr("y", -m.height / 2 - v).attr("width", m.width + r.padding).attr("height", m.height + r.padding), c.attr("class", "divider").attr("x1", -m.width / 2 - v).attr("x2", m.width / 2 + v).attr("y1", -m.height / 2 - v + g.height + v).attr("y2", -m.height / 2 - v + g.height + v), J(r, s), r.intersect = function(e) {
		return K.rect(r, e);
	}, a;
}, "rectWithTitle"), ot = /* @__PURE__ */ t(async (e, t) => {
...
}, "stadium"), st = /* @__PURE__ */ t(async (t, n) => {
...
}, "circle"), ct = /* @__PURE__ */ t(async (t, n) => {
...
}, "doublecircle"), lt = /* @__PURE__ */ t(async (e, t) => {
	let { shapeSvg: n, bbox: r } = await q(e, t, X(t, void 0), !0), i = r.width + t.padding, a = r.height + t.padding, o = [
		{
			x: 0,
			y: 0
	...
	class_box: /* @__PURE__ */ t(async (e, t) => {
		...
		let a = e.insert("g").attr("class", i).attr("id", t.domId || t.id), s = a.insert("rect", ":first-child"), c = a.insert("line"), u = a.insert("line"), d = 0, f = 4, p = a.insert("g").attr("class", "label"), m = 0, h = t.classData.annotations?.[0], g = t.classData.annotations[0] ? "«" + t.classData.annotations[0] + "»" : "", _ = p.node().appendChild(await H(g, t.labelStyle, !0, !0)), v = _.getBBox();
		if (l(o().flowchart.htmlLabels)) {
			let e = _.children[0], t = n(_);
			v = e.getBoundingClientRect(), t.attr("width", v.width), t.attr("height", v.height);
		}
		t.classData.annotations[0] && (f += v.height + 4, d += v.width);
		let y = t.classData.label;
		t.classData.type !== void 0 && t.classData.type !== "" && (o().flowchart.htmlLabels ? y += "&lt;" + t.classData.type + "&gt;" : y += "<" + t.classData.type + ">");
		let b = p.node().appendChild(await H(y, t.labelStyle, !0, !0));
		...
		f += x.height + 4, x.width > d && (d = x.width);
		let S = [];
		t.classData.members.forEach(async (e) => {
			let r = e.getDisplayDetails(), i = r.displayText;
			o().flowchart.htmlLabels && (i = i.replace(/</g, "&lt;").replace(/>/g, "&gt;"));
			let a = p.node().appendChild(await H(i, r.cssStyle ? r.cssStyle : t.labelStyle, !0, !0)), s = a.getBBox();
			if (l(o().flowchart.htmlLabels)) {
				let e = a.children[0], t = n(a);
		...
		if (t.classData.methods.forEach(async (e) => {
			...
			s.width > d && (d = s.width), f += s.height + 4, C.push(a);
		}), f += 8, h) {
			let e = (d - v.width) / 2;
			n(_).attr("transform", "translate( " + (-1 * d / 2 + e) + ", " + -1 * f / 2 + ")"), m = v.height + 4;
		}
		let w = (d - x.width) / 2;
		return n(b).attr("transform", "translate( " + (-1 * d / 2 + w) + ", " + (-1 * f / 2 + m) + ")"), m += x.height + 4, c.attr("class", "divider").attr("x1", -d / 2 - r).attr("x2", d / 2 + r).attr("y1", -f / 2 - r + 8 + m).attr("y2", -f / 2 - r + 8 + m), m += 8, S.forEach((e) => {
			n(e).attr("transform", "translate( " + -d / 2 + ", " + (-1 * f / 2 + m + 8 / 2) + ")");
			let t = e?.getBBox();
			m += (t?.height ?? 0) + 4;
		}), m += 8, u.attr("class", "divider").attr("x1", -d / 2 - r).attr("x2", d / 2 + r).attr("y1", -f / 2 - r + 8 + m).attr("y2", -f / 2 - r + 8 + m), m += 8, C.forEach((e) => {
...
}, Q = {}, pt = /* @__PURE__ */ t(async (e, t, n) => {
	let r, i;
	if (t.link) {
		let a;
		o().securityLevel === "sandbox" ? a = "_top" : t.linkTarget && (a = t.linkTarget || "_blank"), r = e.insert("svg:a").attr("xlink:href", t.link).attr("target", a), i = await ft[t.shape](r, t, n);
...
function ht(e, t, n = !1) {
	...
	let c = m(r?.styles ?? []), l = r.label, u = r.size ?? {
		width: 0,
		height: 0,
		x: 0,
		y: 0
...
async function gt(e, t, n) {
	...
	let i = await pt(e, r, { config: d() }), a = i.node().getBBox(), o = n.getBlock(r.id);
	o.size = {
		width: a.width,
		height: a.height,
		x: 0,
...
async function _t(e, t, n) {
	let r = ht(t, n, !0);
	n.getBlock(r.id).type !== "space" && (await pt(e, r, { config: d() }), t.intersect = r?.intersect, mt(r));
}
...
async function bt(e, t, n, r, i) {
	...
	for (let n of t) if (n.start && n.end) {
		...
		if (t?.size && o?.size) {
			...
			}, void 0, "block", a, i), n.label && (await we(e, {
				...n,
				label: n.label,
...
var xt = {
	...
	renderer: {
		draw: /* @__PURE__ */ t(async function(t, r, i, a) {
			...
			await vt(_, m, l);
			let v = ye(l);
			if (await yt(_, m, l), await bt(_, g, h, l, r), v) {
