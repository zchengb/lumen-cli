...
import { A as r, B as i, C as a, I as o, U as s, _ as c, a as l, b as u, s as d, v as f, z as p } from "./chunk-ABZYJK2D-CVevQ3ur.js";
import { h as m, s as h } from "./chunk-S3R3BYOJ-BtVK2Rr4.js";
import { r as g, t as _ } from "./chunk-N4CR4FBY-C3Oe3dWX.js";
import { t as v } from "./chunk-FMBD7UC4-BFlOEP8u.js";
import { t as y } from "./chunk-55IACEB6-7rZAUXZ_.js";
import { t as b } from "./chunk-QN33PNHL-isVexcb8.js";
...
var S = x, C = [
	...
	getDisplayDetails() {
		let e = this.visibility + r(this.id);
		this.memberType === "method" && (e += `(${r(this.parameters.trim())})`, this.returnType && (e += " : " + r(this.returnType))), e = e.trim();
	...
	parseMember(e) {
		...
		if (this.memberType === "method") {
			...
			if (n) {
				let e = n[1] ? n[1].trim() : "";
				if (C.includes(e) && (this.visibility = e), this.id = n[2], this.parameters = n[3] ? n[3].trim() : "", t = n[4] ? n[4].trim() : "", this.returnType = n[5] ? n[5].trim() : "", t === "") {
			...
			C.includes(r) && (this.visibility = r), /[$*]/.exec(i) && (t = i), this.id = e.substring(this.visibility === "" ? 0 : 1, t === "" ? n : n - 1);
		}
		this.classifier = t, this.id = this.id.startsWith(" ") ? " " + this.id.trim() : this.id.trim();
		let n = `${this.visibility ? "\\" + this.visibility : ""}${r(this.id)}${this.memberType === "method" ? `(${r(this.parameters)})${this.returnType ? " : " + r(this.returnType) : ""}` : ""}`;
...
}, T = "classId-", E = 0, D = /* @__PURE__ */ t((e) => d.sanitizeText(e, u()), "sanitizeText"), O = class {
	constructor() {
	...
	addClass(e) {
		let t = d.sanitizeText(e, u()), { className: n, type: r } = this.splitClassNameAndType(t);
		if (this.classes.has(n)) return;
		let i = d.sanitizeText(n, u());
		this.classes.set(i, {
			id: i,
			type: r,
			label: i,
	...
	lookUpDomId(e) {
		let t = d.sanitizeText(e, u());
		if (this.classes.has(t)) return this.classes.get(t).domId;
		throw Error("Class not found: " + t);
	}
	clear() {
		this.relations = [], this.classes = /* @__PURE__ */ new Map(), this.notes = [], this.interfaces = [], this.functions = [], this.functions.push(this.setupToolTips.bind(this)), this.namespaces = /* @__PURE__ */ new Map(), this.namespaceCounter = 0, this.direction = "TB", l();
	}
	getClass(e) {
	...
	addRelation(t) {
		...
		t.relation.type1 === this.relationType.LOLLIPOP && !n.includes(t.relation.type2) ? (this.addClass(t.id2), this.addInterface(t.id1, t.id2), t.id1 = `interface${this.interfaces.length - 1}`) : t.relation.type2 === this.relationType.LOLLIPOP && !n.includes(t.relation.type1) ? (this.addClass(t.id1), this.addInterface(t.id2, t.id1), t.id2 = `interface${this.interfaces.length - 1}`) : (this.addClass(t.id1), this.addClass(t.id2)), t.id1 = this.splitClassNameAndType(t.id1).className, t.id2 = this.splitClassNameAndType(t.id2).className, t.relationTitle1 = d.sanitizeText(t.relationTitle1.trim(), u()), t.relationTitle2 = d.sanitizeText(t.relationTitle2.trim(), u()), this.relations.push(t);
	}
	addAnnotation(e, t) {
	...
	addMember(e, t) {
		...
		if (typeof t == "string") {
			let e = t.trim();
			e.startsWith("<<") && e.endsWith(">>") ? r.annotations.push(D(e.substring(2, e.length - 2))) : e.indexOf(")") > 0 ? r.methods.push(new w(e, "method")) : e && r.members.push(new w(e, "attribute"));
		}
	}
	addMembers(e, t) {
	...
	cleanupLabel(e) {
		return e.startsWith(":") && (e = e.substring(1)), D(e.trim());
	}
	setCssClass(e, t) {
		e.split(",").forEach((e) => {
			let n = e;
	...
	setTooltip(e, t) {
		e.split(",").forEach((e) => {
			t !== void 0 && (this.classes.get(e).tooltip = D(t));
		});
	}
	getTooltip(e, t) {
	...
	setLink(e, t, n) {
		...
		e.split(",").forEach((e) => {
			...
			a && (a.link = m.formatUrl(t, r), r.securityLevel === "sandbox" ? a.linkTarget = "_top" : typeof n == "string" ? a.linkTarget = D(n) : a.linkTarget = "_blank");
	...
	addNamespace(e) {
		this.namespaces.has(e) || (this.namespaces.set(e, {
			...
			children: {},
			domId: T + e + "-" + this.namespaceCounter
...
}, k = /* @__PURE__ */ t((e) => `g.classGroup text {
...
`, "getStyles"), A = {
	...
	draw: /* @__PURE__ */ t(async function(t, n, r, i) {
		...
		let { securityLevel: a, state: o, layout: s } = u(), c = i.db.getData(), l = y(n, a);
		c.type = i.type, c.layoutAlgorithm = _(s), c.nodeSpacing = o?.nodeSpacing || 50, c.rankSpacing = o?.rankSpacing || 50, c.markers = [
			"aggregation",
			"extension",
			"composition",
			"dependency",
			"lollipop"
		], c.diagramId = n, await g(c, l), m.insertTitle(l, "classDiagramTitleText", o?.titleTopMargin ?? 25, i.db.getDiagramTitle()), b(l, 8, "classDiagram", o?.useMaxWidth ?? !0);
	}, "draw"),
...
//#endregion
export { k as i, S as n, A as r, O as t };
