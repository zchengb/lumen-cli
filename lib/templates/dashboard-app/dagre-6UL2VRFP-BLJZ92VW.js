...
import { b as n } from "./chunk-ABZYJK2D-CVevQ3ur.js";
import "./chunk-S3R3BYOJ-BtVK2Rr4.js";
import "./chunk-HN2XXSSU-BzJE2DVW.js";
import { t as r } from "./chunk-CVBHYZKI-utcCkCdu.js";
import "./chunk-ATLVNIR6-CY_EFS1R.js";
import "./chunk-JA3XYJ7Z-RwfPEVEr.js";
import { a as i, c as a, i as o, l as s, n as c, t as l, u } from "./chunk-JZLCHNYA-Ci7qRJgj.js";
import { a as d, i as f, n as p, r as m, t as h } from "./chunk-QXUST7PY-DUpJQbC-.js";
import { a as g } from "./flatten-DfijLD2s.js";
import { n as _, t as v } from "./graphlib-CoJt5k5X.js";
import { t as y } from "./clone-DNq5FlID.js";
import { t as b } from "./dagre-Z_t-HCKA.js";
...
var w = /* @__PURE__ */ new Map(), T = /* @__PURE__ */ new Map(), E = /* @__PURE__ */ new Map(), D = /* @__PURE__ */ t(() => {
	T.clear(), E.clear(), w.clear();
}, "clear"), O = /* @__PURE__ */ t((t, n) => {
	let r = T.get(n) || [];
	return e.trace("In isDescendant", n, " ", t, " = ", r.includes(t)), r.includes(t);
}, "isDescendant"), k = /* @__PURE__ */ t((t, n) => {
	let r = T.get(n) || [];
	return e.info("Descendants of ", n, " is ", r), e.info("Edge is ", t), t.v === n || t.w === n ? !1 : r ? r.includes(t.v) || O(t.v, n) || O(t.w, n) || r.includes(t.w) : (e.debug("Tilt, ", n, ",not in descendants"), !1);
}, "edgeInCluster"), A = /* @__PURE__ */ t((t, n, r, i) => {
	...
	t !== i && a.push(t), e.warn("Copying (nodes) clusterId", t, "nodes", a), a.forEach((a) => {
		if (n.children(a).length > 0) A(a, n, r, i);
			...
			e.debug("Copying Edges", s), s.forEach((a) => {
				...
				try {
					k(a, i) ? (e.info("Copying as ", a.v, a.w, o, a.name), r.setEdge(a.v, a.w, o, a.name), e.info("newGraph edges ", r.edges(), r.edge(r.edges()[0]))) : e.info("Skipping copy of edge ", a.v, "-->", a.w, " rootId: ", i, " clusterId:", t);
				} catch (t) {
					e.error(t);
				}
			});
...
}, "copy"), j = /* @__PURE__ */ t((e, t) => {
	let n = t.children(e), r = [...n];
	for (let i of n) E.set(i, e), r = [...r, ...j(i, t)];
	return r;
}, "extractDescendants"), M = /* @__PURE__ */ t((e, t, n) => {
...
}, "findCommonEdges"), N = /* @__PURE__ */ t((t, n, r) => {
	let i = n.children(t);
	...
	return a;
}, "findNonClusterChild"), P = /* @__PURE__ */ t((e) => !w.has(e) || !w.get(e).externalConnections ? e : w.has(e) ? w.get(e).id : e, "getAnchorId"), F = /* @__PURE__ */ t((t, n) => {
	if (!t || n > 10) {
		e.debug("Opting out, no graph ");
		return;
	} else e.debug("Opting in, graph ");
	t.nodes().forEach(function(n) {
		t.children(n).length > 0 && (e.warn("Cluster identified", n, " Replacement id in edges: ", N(n, t, n)), T.set(n, j(n, t)), w.set(n, {
			id: N(n, t, n),
			clusterData: t.node(n)
		}));
	}), t.nodes().forEach(function(n) {
		let r = t.children(n), i = t.edges();
		r.length > 0 ? (e.debug("Cluster identified", n, T), i.forEach((t) => {
			O(t.v, n) ^ O(t.w, n) && (e.warn("Edge: ", t, " leaves cluster ", n), e.warn("Descendants of XXX ", n, ": ", T.get(n)), w.get(n).externalConnections = !0);
		})) : e.debug("Not a cluster ", n, T);
	});
	for (let e of w.keys()) {
		let n = w.get(e).id, r = t.parent(n);
	...
	t.edges().forEach(function(n) {
		...
		let i = n.v, a = n.w;
		if (e.warn("Fix XXX", w, "ids:", n.v, n.w, "Translating: ", w.get(n.v), " --- ", w.get(n.w)), w.get(n.v) || w.get(n.w)) {
			if (e.warn("Fixing and trying - removing XXX", n.v, n.w, n.name), i = P(n.v), a = P(n.w), t.removeEdge(n.v, n.w, n.name), i !== n.v) {
				let e = t.parent(i);
	...
	}), e.warn("Adjusted Graph", x(t)), I(t, 0), e.trace(w);
}, "adjustClustersAndEdges"), I = /* @__PURE__ */ t((t, n) => {
	...
	e.debug("Nodes = ", r, n);
	for (let i of r) if (e.debug("Extracting node", i, w, w.has(i) && !w.get(i).externalConnections, !t.parent(i), t.node(i), t.children("D"), " Depth ", n), !w.has(i)) e.debug("Not a cluster", i, n);
	else if (!w.get(i).externalConnections && t.children(i) && t.children(i).length > 0) {
		e.warn("Cluster without external connections, without a parent and with children", i, n);
		let r = t.graph().rankdir === "TB" ? "LR" : "TB";
		w.get(i)?.clusterData?.dir && (r = w.get(i).clusterData.dir, e.warn("Fixing dir", w.get(i).clusterData.dir, r));
		let a = new v({
			multigraph: !0,
			compound: !0
		}).setGraph({
		...
		e.warn("Old graph before copy", x(t)), A(i, t, a, i), t.setNode(i, {
			clusterNode: !0,
			id: i,
			clusterData: w.get(i).clusterData,
			label: w.get(i).label,
			graph: a
		}), e.warn("New graph after copy node: (", i, ")", x(a)), e.debug("Old graph after copy", x(t));
	} else e.warn("Cluster ** ", i, " **not meeting the criteria !externalConnections:", !w.get(i).externalConnections, " no parent: ", !t.parent(i), " children ", t.children(i) && t.children(i).length > 0, t.children("D"), n), e.debug(w);
	r = t.nodes(), e.warn("New list of nodes", r);
	for (let i of r) {
		let r = t.node(i);
		e.warn(" Now next level", i, r), r?.clusterNode && I(r.graph, n + 1);
	}
}, "extractor"), L = /* @__PURE__ */ t((e, t) => {
...
}, "sorter"), R = /* @__PURE__ */ t((e) => L(e, e.children()), "sortNodesByHierarchy"), z = /* @__PURE__ */ t(async (n, c, l, f, h, g) => {
	...
	await Promise.all(c.nodes().map(async function(t) {
		...
		if (e.info("(Insert) Node XXX" + t + ": " + JSON.stringify(c.node(t))), n?.clusterNode) {
			...
			let a = await z(T, n.graph, l, f, c.node(t), g), o = a.elem;
			u(n, o), n.diff = a.diff || 0, e.info("New compound node after recursive render XAX", t, "width", n.width, "height", n.height), s(o, n);
		} else c.children(t).length > 0 ? (e.trace("Cluster - the non recursive path XBX", t, n.id, n, n.width, "Graph:", c), e.trace(N(n.id, c)), w.set(n.id, {
			id: N(n.id, c),
			node: n
		})) : (e.trace("Node - the non recursive path XAX", t, T, c.node(t), _), await i(T, c.node(t), {
			config: g,
			dir: _
		}));
		...
		let t = c.edges().map(async function(t) {
			...
			e.info("Edge " + t.v + " -> " + t.w + ": " + JSON.stringify(t)), e.info("Edge " + t.v + " -> " + t.w + ": ", t, " ", JSON.stringify(c.edge(t))), e.info("Fix", w, "ids:", t.v, t.w, "Translating: ", w.get(t.v), w.get(t.w)), await m(C, n);
		});
		await Promise.all(t);
	}, "processEdges"))(), e.info("Graph before layout:", JSON.stringify(x(c))), e.info("############################################# XXX"), e.info("###                Layout                 ### XXX"), e.info("############################################# XXX"), b(c), e.info("Graph after layout:", JSON.stringify(x(c)));
	let E = 0, { subGraphTitleTotalMargin: D } = r(g);
	return await Promise.all(R(c).map(async function(t) {
		let n = c.node(t);
		if (e.info("Position XBX => " + t + ": (" + n.x, "," + n.y, ") width: ", n.width, " height: ", n.height), n?.clusterNode) n.y += D, e.info("A tainted cluster node XBX1", t, n.id, n.width, n.height, n.x, n.y, c.parent(t)), w.get(n.id).node = n, a(n);
			...
			e.debug("OffsetY", a, "labelHeight", i, "halfPadding", r), await o(y, n), w.get(n.id).node = n;
		} else {
		...
		let n = c.edge(t);
		e.info("Edge " + t.v + " -> " + t.w + ": " + JSON.stringify(n), n), n.points.forEach((e) => e.y += D / 2);
		let r = c.node(t.v);
		var i = c.node(t.w);
		d(n, p(S, n, w, l, r, i, f));
	...
	}), e.warn("Returning from recursive render XAX", v, E), {
		elem: v,
		diff: E
	};
}, "recursiveRender"), B = /* @__PURE__ */ t(async (t, r) => {
	let i = new v({
		multigraph: !0,
		compound: !0
	}).setGraph({
	...
	f(a, t.markers, t.type, t.diagramId), c(), h(), l(), D(), t.nodes.forEach((e) => {
	...
	}), e.warn("Graph at first:", JSON.stringify(x(i))), F(i), e.warn("Graph after XAX:", JSON.stringify(x(i)));
	let o = n();
	await z(a, i, t.type, t.diagramId, void 0, o);
}, "render");
//#endregion
export { B as render };
