...
import { B as i, C as a, U as o, _ as s, a as c, b as l, et as u, v as d, z as f } from "./chunk-ABZYJK2D-CVevQ3ur.js";
import { t as p } from "./channel-Div8HQ8s.js";
...
import { t as v } from "./chunk-55IACEB6-7rZAUXZ_.js";
import { t as y } from "./chunk-QN33PNHL-isVexcb8.js";
...
var b = (function() {
	...
	return t(q, "Parser"), q.prototype = K, K.Parser = q, new q();
})();
b.parser = b;
var x = b, S = class {
	constructor() {
		...
		}, this.setAccTitle = i, this.getAccTitle = d, this.setAccDescription = f, this.getAccDescription = s, this.setDiagramTitle = o, this.getDiagramTitle = a, this.getConfig = /* @__PURE__ */ t(() => l().er, "getConfig"), this.clear(), this.addEntity = this.addEntity.bind(this), this.addAttributes = this.addAttributes.bind(this), this.addRelationship = this.addRelationship.bind(this), this.setDirection = this.setDirection.bind(this), this.addCssStyles = this.addCssStyles.bind(this), this.addClass = this.addClass.bind(this), this.setClass = this.setClass.bind(this), this.setAccTitle = this.setAccTitle.bind(this), this.setAccDescription = this.setAccDescription.bind(this);
	}
	static {
		t(this, "ErDB");
	}
	addEntity(t, n = "") {
		return this.entities.has(t) ? !this.entities.get(t)?.alias && n && (this.entities.get(t).alias = n, e.info(`Add alias '${n}' to entity '${t}'`)) : (this.entities.set(t, {
			...
			cssClasses: "default",
			cssStyles: []
		}), e.info("Added new entity :", t)), this.entities.get(t);
	}
	getEntity(e) {
	...
	addAttributes(t, n) {
		...
		for (i = n.length - 1; i >= 0; i--) n[i].keys || (n[i].keys = []), n[i].comment || (n[i].comment = ""), r.attributes.push(n[i]), e.debug("Added attribute ", n[i].name);
	}
	...
	clear() {
		this.entities = /* @__PURE__ */ new Map(), this.classes = /* @__PURE__ */ new Map(), this.relationships = [], c();
	}
	getData() {
		let e = [], t = [], n = l();
...
n(C, { draw: () => w });
var w = /* @__PURE__ */ t(async function(t, n, i, a) {
	e.info("REF0:"), e.info("Drawing er diagram (unified)", n);
	let { securityLevel: o, er: s, layout: c } = l(), u = a.db.getData(), d = v(n, o);
	u.type = a.type, u.layoutAlgorithm = _(c), u.config.flowchart.nodeSpacing = s?.nodeSpacing || 140, u.config.flowchart.rankSpacing = s?.rankSpacing || 80, u.direction = a.db.getDirection(), u.markers = [
		"only_one",
		"zero_or_one",
		"one_or_more",
		"zero_or_more"
	], u.diagramId = n, await g(u, d), u.layoutAlgorithm === "elk" && d.select(".edges").lower();
	let f = d.selectAll("[id*=\"-background\"]");
	Array.from(f).length > 0 && f.each(function() {
		let e = r(this), t = e.attr("id").replace("-background", ""), n = d.select(`#${CSS.escape(t)}`);
		if (!n.empty()) {
			let t = n.attr("transform");
			e.attr("transform", t);
		}
	}), m.insertTitle(d, "erDiagramTitleText", s?.titleTopMargin ?? 25, a.db.getDiagramTitle()), y(d, 8, "erDiagram", s?.useMaxWidth ?? !0);
}, "draw"), T = /* @__PURE__ */ t((e, t) => {
	let n = p;
