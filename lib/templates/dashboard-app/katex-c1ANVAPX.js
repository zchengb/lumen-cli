...
var e = class e extends Error {
	...
	"\"": "&quot;",
	"'": "&#x27;"
}, i = /[&><"']/g, a = (e) => String(e).replace(i, (e) => r[e]), o = (e) => e.type === "ordgroup" || e.type === "color" ? e.body.length === 1 ? o(e.body[0]) : e : e.type === "font" ? o(e.body) : e, s = /* @__PURE__ */ new Set([
	"mathord",
	"textord",
	"atom"
...
function oe(e) {
	for (var t = 0; t < ae.length; t++) for (var n = ae[t], r = 0; r < n.blocks.length; r++) {
		var i = n.blocks[r];
...
var se = [];
ae.forEach((e) => e.blocks.forEach((e) => se.push(...e)));
function ce(e) {
	for (var t = 0; t < se.length; t += 2) if (e >= se[t] && e <= se[t + 1]) return !0;
	return !1;
}
var D = (e) => e + " " + e, le = 80, ue = function(e, t) {
	...
	switch (e) {
		...
		case "sqrtSize4":
			r = me(t, le);
			break;
		case "sqrtTall": r = ge(t, le, n);
	}
	return r;
}, ve = function(e, t) {
	switch (e) {
		case "⎜": return D("M291 0 H417 V" + t + " H291z");
		case "∣": return D("M145 0 H188 V" + t + " H145z");
		case "∥": return D("M145 0 H188 V" + t + " H145z") + D("M367 0 H410 V" + t + " H367z");
		case "⎟": return D("M457 0 H583 V" + t + " H457z");
		case "⎢": return D("M319 0 H403 V" + t + " H319z");
		case "⎥": return D("M263 0 H347 V" + t + " H263z");
		case "⎪": return D("M384 0 H504 V" + t + " H384z");
		case "⏐": return D("M312 0 H355 V" + t + " H312z");
		case "‖": return D("M257 0 H300 V" + t + " H257z") + D("M478 0 H521 V" + t + " H478z");
		default: return "";
	}
}, ye = {
	...
	leftlinesegment: D("M40 281 V428 H0 V94 H40 V241 H400000 v40z"),
	leftbracketunder: D("M0 0 h120 V290 H399995 v120 H0z"),
	leftbracketover: D("M0 440 h120 V150 H399995 v-120 H0z"),
	leftmapsto: D("M40 281 V448H0V74H40V241H400000v40z"),
	leftToFrom: "M0 147h400000v40H0zm0 214c68 40 115.7 95.7 143 167h22c15.3 0 23\n-.3 23-1 0-1.3-5.3-13.7-16-37-18-35.3-41.3-69-70-101l-7-8h399905v-40H95l7-8\nc28.7-32 52-65.7 70-101 10.7-23.3 16-35.7 16-37 0-.7-7.7-1-23-1h-22C115.7 265.3\n 68 321 0 361zm0-174v-40h399900v40zm100 154v40h399900v-40z",
	longequal: D("M0 50 h400000 v40H0z m0 194h40000v40H0z"),
	...
	rightlinesegment: D("M399960 241 V94 h40 V428 h-40 V281 H0 v-40z"),
	rightbracketunder: D("M399995 0 h-120 V290 H0 v120 H400000z"),
	rightbracketover: D("M399995 440 h-120 V150 H0 v-120 H399995z"),
...
var Se = class {
	...
	return typeof e != "string" && (e = e.unit), e in Ce || e in we || e === "ex";
}, O = function(t, n) {
	var r;
	if (t.unit in Ce) r = Ce[t.unit] / n.fontMetrics().ptPerEm / n.sizeMultiplier;
	...
	t.className = Ee(this.classes), Object.assign(t.style, this.style);
	...
	return t;
}, Ae = /[\s"'>/=\x00-\x1f]/, je = function(t) {
	var n = "<" + t;
	this.classes.length && (n += " class=\"" + a(Ee(this.classes)) + "\"");
	var r = De(this.style);
	r && (n += " style=\"" + a(r) + "\"");
	for (var i of Object.keys(this.attributes)) {
		if (Ae.test(i)) throw new e("Invalid attribute name '" + i + "'");
	...
	constructor(e, t, n, r) {
		this.children = void 0, this.attributes = void 0, this.classes = void 0, this.height = void 0, this.depth = void 0, this.width = void 0, this.maxFontSize = void 0, this.style = void 0, this.italic = void 0, Oe.call(this, e, n, r), this.children = t || [];
	}
	setAttribute(e, t) {
		this.attributes[e] = t;
	}
	...
	constructor(e, t, n, r) {
		this.children = void 0, this.attributes = void 0, this.classes = void 0, this.height = void 0, this.depth = void 0, this.maxFontSize = void 0, this.style = void 0, Oe.call(this, t, r), this.children = n || [], this.setAttribute("href", e);
	}
	setAttribute(e, t) {
		this.attributes[e] = t;
	}
	...
	toMarkup() {
		var e = "<img src=\"" + a(this.src) + "\"" + (" alt=\"" + a(this.alt) + "\""), t = De(this.style);
	...
	constructor(e, t, n, r, i, a, o, s) {
		...
		var c = oe(this.text.charCodeAt(0));
		c && this.classes.push(c + "_fallback"), /[îïíì]/.test(this.text) && (this.text = Fe[this.text]);
	}
	hasClass(e) {
		return this.classes.includes(e);
	}
	toNode() {
		...
		return this.italic > 0 && (t = document.createElement("span"), t.style.marginRight = k(this.italic)), this.classes.length > 0 && (t ||= document.createElement("span"), t.className = Ee(this.classes)), Object.keys(this.style).length > 0 && (t ||= document.createElement("span"), Object.assign(t.style, this.style)), t ? (t.appendChild(e), t) : e;
	}
	toMarkup() {
		var e = !1, t = "<span";
		this.classes.length && (e = !0, t += " class=\"", t += a(Ee(this.classes)), t += "\"");
		var n = "";
		this.italic > 0 && (n += "margin-right:" + k(this.italic) + ";"), n += De(this.style), n && (e = !0, t += " style=\"" + a(n) + "\"");
		var r = a(this.text);
	...
	toNode() {
		...
		return this.alternate ? e.setAttribute("d", this.alternate) : e.setAttribute("d", ye[this.pathName]), e;
	}
	toMarkup() {
		return this.alternate ? "<path d=\"" + a(this.alternate) + "\"/>" : "<path d=\"" + a(ye[this.pathName]) + "\"/>";
	}
}, ze = class {
	constructor(e) {
...
var He = (e) => e instanceof Me || e instanceof Ne || e instanceof Se, Ue = {
	"AMS-Regular": {
		32: [
			0,
			0,
...
function qe(e, t, n) {
	if (!Ue[t]) throw Error("Font metrics not found for font: " + t + ".");
	var r = e.charCodeAt(0), i = Ue[t][r];
	if (!i && e[0] in Ge && (r = Ge[e[0]].charCodeAt(0), i = Ue[t][r]), !i && n === "text" && ce(r) && (i = Ue[t][77]), i) return {
		depth: i[0],
		height: i[1],
		italic: i[2],
		skew: i[3],
...
function Ye(e) {
	var t = e >= 5 ? 0 : e >= 3 ? 1 : 2;
	if (!Je[t]) {
		var n = Je[t] = { cssEmPerMu: We.quad[t] / 18 };
		for (var r in We) We.hasOwnProperty(r) && (n[r] = We[r][t]);
	}
	return Je[t];
}
var A = {
...
j(N, P, V, "–", "--", !0), j(N, P, V, "–", "\\textendash"), j(N, P, V, "—", "---", !0), j(N, P, V, "—", "\\textemdash"), j(N, P, V, "‘", "`", !0), j(N, P, V, "‘", "\\textquoteleft"), j(N, P, V, "’", "'", !0), j(N, P, V, "’", "\\textquoteright"), j(N, P, V, "“", "``", !0), j(N, P, V, "“", "\\textquotedblleft"), j(N, P, V, "”", "''", !0), j(N, P, V, "”", "\\textquotedblright"), j(M, P, V, "°", "\\degree", !0), j(N, P, V, "°", "\\degree"), j(N, P, V, "°", "\\textdegree", !0), j(M, P, V, "£", "\\pounds"), j(M, P, V, "£", "\\mathsterling", !0), j(N, P, V, "£", "\\pounds"), j(N, P, V, "£", "\\textsterling", !0), j(M, F, V, "✠", "\\maltese"), j(N, F, V, "✠", "\\maltese");
for (var nt = "0123456789/@.\"", rt = 0; rt < nt.length; rt++) {
	var it = nt.charAt(rt);
	j(M, P, V, it, it);
}
...
for (var ct = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz", lt = 0; lt < ct.length; lt++) {
	var ut = ct.charAt(lt);
	j(M, P, R, ut, ut), j(N, P, V, ut, ut);
}
...
for (var H, dt = 0; dt < ct.length; dt++) {
	var U = ct.charAt(dt);
	H = String.fromCharCode(55349, 56320 + dt), j(M, P, R, U, H), j(N, P, V, U, H), H = String.fromCharCode(55349, 56372 + dt), j(M, P, R, U, H), j(N, P, V, U, H), H = String.fromCharCode(55349, 56424 + dt), j(M, P, R, U, H), j(N, P, V, U, H), H = String.fromCharCode(55349, 56580 + dt), j(M, P, R, U, H), j(N, P, V, U, H), H = String.fromCharCode(55349, 56684 + dt), j(M, P, R, U, H), j(N, P, V, U, H), H = String.fromCharCode(55349, 56736 + dt), j(M, P, R, U, H), j(N, P, V, U, H), H = String.fromCharCode(55349, 56788 + dt), j(M, P, R, U, H), j(N, P, V, U, H), H = String.fromCharCode(55349, 56840 + dt), j(M, P, R, U, H), j(N, P, V, U, H), H = String.fromCharCode(55349, 56944 + dt), j(M, P, R, U, H), j(N, P, V, U, H), dt < 26 && (H = String.fromCharCode(55349, 56632 + dt), j(M, P, R, U, H), j(N, P, V, U, H), H = String.fromCharCode(55349, 56476 + dt), j(M, P, R, U, H), j(N, P, V, U, H));
}
H = String.fromCharCode(55349, 56668), j(M, P, R, "k", H), j(N, P, V, "k", H);
for (var ft = 0; ft < 10; ft++) {
	var pt = ft.toString();
	H = String.fromCharCode(55349, 57294 + ft), j(M, P, R, pt, H), j(N, P, V, pt, H), H = String.fromCharCode(55349, 57314 + ft), j(M, P, R, pt, H), j(N, P, V, pt, H), H = String.fromCharCode(55349, 57324 + ft), j(M, P, R, pt, H), j(N, P, V, pt, H), H = String.fromCharCode(55349, 57334 + ft), j(M, P, R, pt, H), j(N, P, V, pt, H);
}
for (var mt = "ÐÞþ", ht = 0; ht < mt.length; ht++) {
	var gt = mt.charAt(ht);
	j(M, P, R, gt, gt), j(N, P, V, gt, gt);
}
var _t = {
	mathClass: "mathbf",
	textClass: "textbf",
	...
	if (119808 <= i && i < 120484) return kt[Math.floor((i - 119808) / 26)];
	if (120782 <= i && i <= 120831) return At[Math.floor((i - 120782) / 10)];
	if (i === 120485 || i === 120486) return kt[0];
	if (120486 < i && i < 120782) return xt;
	...
	var a = Mt(e, t, n), o = a.metrics;
	e = a.value;
	var s;
	if (o) {
		var c = o.italic;
		(n === "text" || r && r.font === "mathit") && (c = 0), s = new Ie(e, o.height, o.depth, c, o.skew, o.width, i);
	} else typeof console < "u" && console.warn("No character metrics " + ("for '" + e + "' in style '" + t + "' and mode '" + n + "'")), s = new Ie(e, 0, 0, 0, 0, 0, i);
	if (r) {
	...
	return r === void 0 && (r = []), n.font === "boldsymbol" && Mt(e, "Main-Bold", t).metrics ? Nt(e, "Main-Bold", t, n, r.concat(["mathbf"])) : e === "\\" || A[t][e].font === "main" ? Nt(e, "Main-Regular", t, n, r) : Nt(e, "AMS-Regular", t, n, r.concat(["amsrm"]));
}, Ft = function(e, t, n) {
	return n !== "textord" && Mt(e, "Math-BoldItalic", t).metrics ? {
	...
	if (f) return Nt(i, f, r, t, a.concat(p));
	if (d) {
		var h, g;
		if (d === "boldsymbol") {
			var _ = Ft(i, r, n);
			h = _.fontName, g = [_.fontClass];
		} else u ? (h = Jt[o].fontName, g = [o]) : (h = qt(s, c, l), g = [
			s,
			c,
			l
		]);
		if (Mt(i, h, r).metrics) return Nt(i, h, r, t, a.concat(g));
		if (tt.hasOwnProperty(i) && h.slice(0, 10) === "Typewriter") {
			for (var v = [], y = 0; y < i.length; y++) v.push(Nt(i[y], h, r, t, a.concat(g)));
			return Ut(v);
		}
	}
	if (n === "mathord") return Nt(i, "Math-Italic", r, t, a.concat(["mathnormal"]));
	if (n === "textord") {
		var b = A[r][i] && A[r][i].font;
		if (b === "ams") return Nt(i, qt("amsrm", c, l), r, t, a.concat("amsrm", c, l));
		if (b === "main" || !b) return Nt(i, qt("textrm", c, l), r, t, a.concat(c, l));
		var x = qt(b, c, l);
		return Nt(i, x, r, t, a.concat(x, c, l));
	} else throw Error("unexpected type: " + n + " in makeOrd");
}, Lt = (e, t) => {
	if (Ee(e.classes) !== Ee(t.classes) || e.skew !== t.skew || e.maxFontSize !== t.maxFontSize || e.italic !== 0 && e.hasClass("mathnormal")) return !1;
	...
	for (var t = 0; t < e.length - 1; t++) {
		var n = e[t], r = e[t + 1];
		n instanceof Ie && r instanceof Ie && Lt(n, r) && (n.text += r.text, n.height = Math.max(n.height, r.height), n.depth = Math.max(n.depth, r.depth), n.italic = r.italic, e.splice(t + 1, 1), t--);
	}
	return e;
}, zt = function(e) {
	...
	var i = new Me(e, t, n, r);
	return zt(i), i;
}, Bt = (e, t, n, r) => new Me(e, t, n, r), Vt = function(e, t, n) {
	var r = W([e], [], t);
	...
	return e instanceof Se ? W([], [e], t) : e;
}, Gt = function(e) {
	...
	for (var { children: n, depth: r } = Gt(e), i = 0, a = 0; a < n.length; a++) {
		var o = n[a];
		if (o.type === "elem") {
			var s = o.elem;
	...
	for (var l = [], u = r, d = r, f = r, p = 0; p < n.length; p++) {
		...
		if (m.type === "kern") f += m.size;
			...
			var h = m.elem, g = m.wrapperClasses || [], _ = m.wrapperStyle || {}, v = W(g, [c, h], void 0, _);
	...
	if (u < 0) {
		var x = W(["vlist"], [W([], [])]);
		x.style.height = k(-u), b = [W(["vlist-r"], [y, W(["vlist-s"], [new Ie("​")])]), W(["vlist-r"], [x])];
	} else b = [W(["vlist-r"], [y])];
	var S = W(["vlist-t"], b);
	return b.length === 2 && S.classes.push("vlist-t2"), S.height = d, S.depth = -u, S;
}, Kt = (e, t) => {
	var n = W(["mspace"], [], t), r = O(e, t);
	...
	var [n, r, i] = Yt[e], a = Bt(["overlay"], [new Le([new Re(n)], {
		width: k(r),
		height: k(i),
		style: "width:" + k(r),
...
var on = function(e) {
	...
	if (e.length === 1) {
		var l = e[0];
		l.type === "sizing" ? c = t.havingSize(l.size) : l.type === "styling" && (c = t.havingStyle(ln[l.style]));
	}
	var u = W([r[0] || "leftmost"], [], t), d = W([r[1] || "rightmost"], [], t), f = n === "root";
	return fn(i, (e, t) => {
		var n = t.classes[0], r = e.classes[0];
		n === "mbin" && cn.has(r) ? t.classes[0] = "mord" : r === "mbin" && sn.has(n) && (e.classes[0] = "mord");
	}, { node: u }, d, f), fn(i, (e, t) => {
		var n = hn(t), r = hn(e), i = n && r ? e.hasClass("mtight") ? en[n]?.[r] : $t[n]?.[r] : null;
		if (i) return Kt(i, c);
	}, { node: u }, d, f), i;
	...
	for (var a = 0; a < e.length; a++) {
		...
		c ? n.node = o : i && o.hasClass("newline") && (n.node = W(["leftmost"])), n.insertAfter = ((t) => (n) => {
			e.splice(t + 1, 0, n), a++;
		})(a);
	}
	r && e.pop();
}, pn = function(e) {
	return e instanceof Se || e instanceof Ne || e instanceof Me && e.hasClass("enclosing") ? e : null;
}, mn = function(e, t) {
	var n = pn(e);
	if (n) {
		var r = n.children;
		if (r.length) {
			if (t === "right") return mn(r[r.length - 1], "right");
			if (t === "left") return mn(r[0], "left");
		}
	}
	return e;
}, hn = function(e, t) {
	return e ? (t && (e = mn(e, t)), un[e.classes[0]] || null) : null;
}, gn = function(e, t) {
...
function vn(e, t) {
	...
	for (var a = [], o = [], s = 0; s < r.length; s++) if (o.push(r[s]), r[s].hasClass("mbin") || r[s].hasClass("mrel") || r[s].hasClass("allowbreak")) {
		...
		c || (a.push(_n(o, t)), o = []);
	} else r[s].hasClass("newline") && (o.pop(), o.length > 0 && (a.push(_n(o, t)), o = []), a.push(r[s]));
	o.length > 0 && a.push(_n(o, t));
	var l;
	n ? (l = _n(dn(n, t, !0), t), l.classes = ["tag"], a.push(l)) : i && a.push(i);
	var u = W(["katex-html"], a);
...
var X = class {
	...
	toNode() {
		...
		this.classes.length > 0 && (e.className = Ee(this.classes));
		for (var n = 0; n < this.children.length; n++) if (this.children[n] instanceof bn && this.children[n + 1] instanceof bn) {
			for (var r = this.children[n].toText() + this.children[++n].toText(); this.children[n + 1] instanceof bn;) r += this.children[++n].toText();
			e.appendChild(new bn(r).toNode());
	...
	toMarkup() {
		...
		this.classes.length > 0 && (e += " class =\"" + a(Ee(this.classes)) + "\""), e += ">";
		for (var n = 0; n < this.children.length; n++) e += this.children[n].toMarkup();
...
}, Sn = /* @__PURE__ */ new Set(["\\imath", "\\jmath"]), Cn = /* @__PURE__ */ new Set(["mrow", "mtable"]), wn = function(e, t, n) {
	return A[t][e] && A[t][e].replace && e.charCodeAt(0) !== 55349 && !(tt.hasOwnProperty(e) && n && (n.fontFamily && n.fontFamily.slice(4, 6) === "tt" || n.font && n.font.slice(4, 6) === "tt")) && (e = A[t][e].replace), new bn(e);
}, Tn = function(e) {
	...
	var s = Jt[n].fontName;
	return qe(a, s, r) ? Jt[n].variant : null;
};
function On(e) {
	if (!e) return !1;
	if (e.type === "mi" && e.children.length === 1) {
		var t = e.children[0];
		return t instanceof bn && t.text === ".";
	} else if (e.type === "mo" && e.children.length === 1 && e.getAttribute("separator") === "true" && e.getAttribute("lspace") === "0em" && e.getAttribute("rspace") === "0em") {
		var n = e.children[0];
		return n instanceof bn && n.text === ",";
	} else return !1;
}
var kn = function(e, t, n) {
	if (e.length === 1) {
		var r = Z(e[0], t);
		return n && r instanceof X && r.type === "mo" && (r.setAttribute("lspace", "0em"), r.setAttribute("rspace", "0em")), [r];
	}
	for (var i = [], a, o = 0; o < e.length; o++) {
		var s = Z(e[o], t);
		if (s instanceof X && a instanceof X) {
			if (s.type === "mtext" && a.type === "mtext" && s.getAttribute("mathvariant") === a.getAttribute("mathvariant")) {
				...
				var l = a.children[0];
				if (l instanceof bn && l.text === "̸" && (s.type === "mo" || s.type === "mi" || s.type === "mn")) {
					var u = s.children[0];
					u instanceof bn && u.text.length > 0 && (u.text = u.text.slice(0, 1) + "̸" + u.text.slice(1), i.pop());
				}
			}
		}
		i.push(s), a = s;
	...
	if (!t) return new X("mrow");
	if (rn[t.type]) return rn[t.type](t, n);
	throw new e("Got group of unknown type: '" + t.type + "'");
};
function jn(e, t, n, r, i) {
	var a = kn(e, n), o = a.length === 1 && a[0] instanceof X && Cn.has(a[0].type) ? a[0] : new X("mrow", a), s = new X("annotation", [new bn(t)]);
	s.setAttribute("encoding", "application/x-tex");
	var c = new X("math", [new X("semantics", [o, s])]);
	return c.setAttribute("xmlns", "http://www.w3.org/1998/Math/MathML"), r && c.setAttribute("display", "block"), W([i ? "katex" : "katex-mathml"], [c]);
}
var Mn = [
	[
		1,
	...
	fontMetrics() {
		return this._fontMetrics ||= Ye(this.size), this._fontMetrics;
	}
	getColor() {
...
var In = function(e) {
	...
	if (t.displayMode) {
		var n = ["katex-display"];
		t.leqno && n.push("leqno"), t.fleqn && n.push("fleqn"), e = W(n, [e]);
	}
	return e;
}, Rn = function(e, t, n) {
	var r = In(n), i;
	return n.output === "mathml" ? jn(e, t, r, n.displayMode, !0) : (i = n.output === "html" ? W(["katex"], [vn(e, r)]) : W(["katex"], [jn(e, t, r, n.displayMode, !1), vn(e, r)]), Ln(i, n));
}, zn = function(e, t, n) {
	return Ln(W(["katex"], [vn(e, In(n))]), n);
}, Bn = {
	widehat: "^",
	widecheck: "ˇ",
	widetilde: "~",
	...
	var t = new X("mo", [new bn(Bn[e.replace(/^\\/, "")])]);
	...
	if (/fbox|color|angl/.test(t)) {
		if (a = W(["stretchy", t], [], i), t === "fbox") {
			var s = i.color && i.getColor();
			s && (a.style.borderColor = s);
		}
	} else {
		var c = [];
		/^[bx]cancel$/.test(t) && c.push(new ze({
			x1: "0",
			y1: "0",
			x2: "100%",
			y2: "100%",
			"stroke-width": "0.046em"
		})), /^x?cancel$/.test(t) && c.push(new ze({
			x1: "0",
			y1: "100%",
			x2: "100%",
			y2: "0",
...
var Zn = (e) => {
	if (e instanceof Ie) return e;
	if (He(e) && e.children.length === 1) return Zn(e.children[0]);
}, Qn = (e, t) => {
	var n, r, i;
	e && e.type === "supsub" ? (r = Q(e.base, "accent"), n = r.base, e.base = n, i = Ve(Y(e, t)), e.base = r) : (r = Q(e, "accent"), n = r.base);
	var a = Y(n, t.havingCrampedStyle()), o = r.isShifty && c(n), s = 0;
	o && (s = Zn(a)?.skew ?? 0);
	var l = r.label === "\\c", u = l ? a.height + a.depth : Math.min(a.height, t.fontMetrics().xHeight), d;
	if (r.isStretchy) d = Wn(r, t), d = G({
		...
		var f, p;
		r.label === "\\vec" ? (f = Xt("vec", t), p = Yt.vec[1]) : (f = It({
			type: "textord",
			mode: r.mode,
			text: r.label
		}, t, "textord"), f = Be(f), f.italic = 0, p = f.width, l && (u += f.depth)), d = W(["accent-body"], [f]);
		var m = r.label === "\\textcircled";
		m && (d.classes.push("accent-full"), u = a.height);
		var h = s;
		m || (h -= p / 2), d.style.left = k(h), r.label === "\\textcircled" && (d.style.top = ".2em"), d = G({
			positionType: "firstBaseline",
			children: [
				{
					type: "elem",
	...
	var g = W(["mord", "accent"], [d], t);
	return i ? (i.children[0] = g, i.height = Math.max(g.height, i.height), i.classes[0] = "mord", i) : g;
}, $n = (e, t) => {
	var n = e.isStretchy ? Vn(e.label) : new X("mo", [wn(e.label, e.mode)]), r = new X("mover", [Z(e.base, t), n]);
...
q({
	...
	props: { numArgs: 1 },
	handler: (e, t) => {
		var n = on(t[0]), r = !er.test(e.funcName), i = !r || e.funcName === "\\widehat" || e.funcName === "\\widetilde" || e.funcName === "\\widecheck";
		return {
			type: "accent",
			mode: e.parser.mode,
			label: e.funcName,
	...
	htmlBuilder: (e, t) => {
		var n = Y(e.base, t), r = Wn(e, t), i = e.label === "\\utilde" ? .12 : 0;
		return W(["mord", "accentunder"], [G({
			positionType: "top",
	...
	mathmlBuilder: (e, t) => {
		var n = Vn(e.label), r = new X("munder", [Z(e.base, t), n]);
		return r.setAttribute("accentunder", "true"), r;
	}
});
var tr = (e) => {
	var t = new X("mpadded", e ? [e] : []);
...
q({
	...
	htmlBuilder(e, t) {
		var n = t.style, r = t.havingStyle(n.sup()), i = Wt(Y(e.body, r, t), t), a = e.label.slice(0, 2) === "\\x" ? "x" : "cd";
		i.classes.push(a + "-arrow-pad");
		var o;
		e.below && (r = t.havingStyle(n.sub()), o = Wt(Y(e.below, r, t), t), o.classes.push(a + "-arrow-pad"));
	...
	mathmlBuilder(e, t) {
		...
		if (e.body) {
			var i = tr(Z(e.body, t));
			r = e.below ? new X("munderover", [
				n,
				tr(Z(e.below, t)),
				i
			]) : new X("mover", [n, i]);
		} else e.below ? r = new X("munder", [n, tr(Z(e.below, t))]) : (r = tr(), r = new X("mover", [n, r]));
		return r;
	}
});
function nr(e, t) {
	var n = dn(e.body, t, !0);
	return W([e.mclass], n, t);
}
function rr(e, t) {
	var n, r = kn(e.body, t);
	return e.mclass === "minner" ? n = new X("mpadded", r) : e.mclass === "mord" ? e.isCharacterBox ? (n = r[0], n.type = "mi") : n = new X("mi", r) : (e.isCharacterBox ? (n = r[0], n.type = "mo") : n = new X("mo", r), e.mclass === "mbin" ? (n.attributes.lspace = "0.22em", n.attributes.rspace = "0.22em") : e.mclass === "mpunct" ? (n.attributes.lspace = "0em", n.attributes.rspace = "0.17em") : e.mclass === "mopen" || e.mclass === "mclose" ? (n.attributes.lspace = "0em", n.attributes.rspace = "0em") : e.mclass === "minner" && (n.attributes.lspace = "0.0556em", n.attributes.width = "+0.1111em")), n;
}
q({
	type: "mclass",
	names: [
...
q({
	...
	htmlBuilder(e, t) {
		var n = dn(e.body, t, !0), r = W([e.mclass], n, t);
		return r.style.textShadow = "0.02em 0.01em 0.04px", r;
	},
	mathmlBuilder(e, t) {
		var n = new X("mstyle", kn(e.body, t));
...
q({
	...
	htmlBuilder(e, t) {
		var n = t.havingStyle(t.style.sup()), r = Wt(Y(e.label, n, t), t);
		return r.classes.push("cd-label-" + e.side), r.style.bottom = k(.8 - r.depth), r.height = 0, r.depth = 0, r;
	},
	mathmlBuilder(e, t) {
		var n = new X("mrow", [Z(e.label, t)]);
		return n = new X("mpadded", [n]), n.setAttribute("width", "0"), e.side === "left" && n.setAttribute("lspace", "-1width"), n.setAttribute("voffset", "0.7em"), n = new X("mstyle", [n]), n.setAttribute("displaystyle", "false"), n.setAttribute("scriptlevel", "1"), n;
	}
}), q({
	type: "cdlabelparent",
	names: ["\\\\cdparent"],
	...
	htmlBuilder(e, t) {
		var n = Wt(Y(e.fragment, t), t);
		return n.classes.push("cd-vert-arrow"), n;
	},
	mathmlBuilder(e, t) {
		return new X("mrow", [Z(e.fragment, t)]);
	}
}), q({
	type: "textord",
	names: ["\\@char"],
...
var dr = (e, t) => Ut(dn(e.body, t.withColor(e.color), !1)), fr = (e, t) => {
	var n = new X("mstyle", kn(e.body, t.withColor(e.color)));
...
q({
	...
	htmlBuilder(e, t) {
		var n = W(["mspace"], [], t);
		return e.newLine && (n.classes.push("newline"), e.size && (n.style.marginTop = k(O(e.size, t)))), n;
	},
	mathmlBuilder(e, t) {
		var n = new X("mspace");
		return e.newLine && (n.setAttribute("linebreak", "newline"), e.size && n.setAttribute("height", k(O(e.size, t)))), n;
	}
});
var pr = {
	"\\global": "\\global",
...
var _r = function(e, t, n) {
	var r = qe(A.math[e] && A.math[e].replace || e, t, n);
	if (!r) throw Error("Unsupported symbol " + e + " and font size " + t + ".");
	return r;
}, vr = function(e, t, n, r) {
	var i = n.havingBaseStyle(t), a = W(r.concat(i.sizingClasses(n)), [e], n), o = i.sizeMultiplier / n.sizeMultiplier;
	...
	var o = vr(Nt(e, "Main-Regular", i, r), t, r, a);
	return n && yr(o, r, t), o;
}, xr = function(e, t, n, r) {
	return Nt(e, "Size" + t + "-Regular", n, r);
}, Sr = function(e, t, n, r, i, a) {
	var o = xr(e, t, i, r), s = vr(W(["delimsizing", "size" + t], [o], r), E.TEXT, r, a);
	return n && yr(s, r, E.TEXT), s;
}, Cr = function(e, t, n) {
	return {
		type: "elem",
		elem: W(["delimsizinginner", t === "Size1-Regular" ? "delim-size1" : "delim-size4"], [W([], [Nt(e, t, n)])])
	};
}, wr = function(e, t, n) {
	var r = Ue["Size4-Regular"][e.charCodeAt(0)] ? Ue["Size4-Regular"][e.charCodeAt(0)][4] : Ue["Size1-Regular"][e.charCodeAt(0)][4], i = Bt([], [new Le([new Re("inner", ve(e, Math.round(1e3 * t)))], {
		width: k(r),
		height: k(t),
		style: "width:" + k(r),
	...
	var ee = C / 2 - w, T = [];
	if (u.length > 0) {
		var te = C - m - v, ne = Math.round(C * 1e3), re = be(u, Math.round(te * 1e3)), ie = new Re(u, re), ae = k(d / 1e3), oe = k(ne / 1e3), se = Bt([], [new Le([ie], {
			width: ae,
			height: oe,
			viewBox: "0 0 " + d + " " + ne
		})], r);
		se.height = ne / 1e3, se.style.width = ae, se.style.height = oe, T.push({
			type: "elem",
			elem: se
		});
	} else {
		if (T.push(Cr(l, f, i)), T.push(Er), s === null) {
			var ce = C - m - v + 2 * Tr;
			T.push(wr(c, ce, r));
		} else {
			var D = (C - m - v - y) / 2 + 2 * Tr;
			T.push(wr(c, D, r)), T.push(Er), T.push(Cr(s, f, i)), T.push(Er), T.push(wr(c, D, r));
		}
		T.push(Er), T.push(Cr(o, f, i));
	}
	var le = r.havingBaseStyle(E.TEXT);
	return vr(W(["delimsizing", "mult"], [G({
		positionType: "bottom",
		positionData: ee,
		children: T
	})], le), E.TEXT, r, a);
}, Ar = 80, jr = .08, Mr = function(e, t, n, r, i) {
	return Bt(["hide-tail"], [new Le([new Re(e, _e(e, r, n))], {
		width: "400em",
		height: k(t),
...
}, qr = /* @__PURE__ */ new Set(/* @__PURE__ */ "(,\\lparen,),\\rparen,[,\\lbrack,],\\rbrack,\\{,\\lbrace,\\},\\rbrace,\\lfloor,\\rfloor,⌊,⌋,\\lceil,\\rceil,⌈,⌉,<,>,\\langle,⟨,\\rangle,⟩,\\lt,\\gt,\\lvert,\\rvert,\\lVert,\\rVert,\\lgroup,\\rgroup,⟮,⟯,\\lmoustache,\\rmoustache,⎰,⎱,/,\\backslash,|,\\vert,\\|,\\Vert,\\uparrow,\\Uparrow,\\downarrow,\\Downarrow,\\updownarrow,\\Updownarrow,.".split(","));
function Jr(e) {
...
q({
	...
	htmlBuilder: (e, t) => e.delim === "." ? W([e.mclass]) : Rr(e.delim, e.size, t, e.mode, [e.mclass]),
	mathmlBuilder: (e) => {
		var t = [];
...
q({
	...
	htmlBuilder: (e, t) => {
		Xr(e);
		for (var n = dn(e.body, t, !0, ["mopen", "mclose"]), r = 0, i = 0, a = !1, o = 0; o < n.length; o++) {
			var s = n[o];
			Jr(s) ? a = !0 : (r = Math.max(n[o].height, r), i = Math.max(n[o].depth, i));
		}
		r *= t.sizeMultiplier, i *= t.sizeMultiplier;
		var c = e.left === "." ? gn(t, ["mopen"]) : Gr(e.left, r, i, t, e.mode, ["mopen"]);
		...
		var f;
		if (e.right === ".") f = gn(t, ["mclose"]);
		else {
			var p = e.rightColor ? t.withColor(e.rightColor) : t;
			f = Gr(e.right, r, i, p, e.mode, ["mclose"]);
		}
		return n.push(f), W(["minner"], n, t);
	},
	mathmlBuilder: (e, t) => {
		Xr(e);
		var n = kn(e.body, t);
		if (e.left !== ".") {
			var r = new X("mo", [wn(e.left, e.mode)]);
			r.setAttribute("fence", "true"), n.unshift(r);
		}
		if (e.right !== ".") {
			var i = new X("mo", [wn(e.right, e.mode)]);
	...
	htmlBuilder: (e, t) => {
		var n;
		return e.delim === "." ? n = gn(t, []) : (n = Rr(e.delim, 1, t, e.mode, []), n.isMiddle = {
			delim: e.delim,
			options: t
		}), n;
	},
	mathmlBuilder: (e, t) => {
		var n = new X("mo", [e.delim === "\\vert" || e.delim === "|" ? wn("|", "text") : wn(e.delim, e.mode)]);
		return n.setAttribute("fence", "true"), n.setAttribute("lspace", "0.05em"), n.setAttribute("rspace", "0.05em"), n;
	}
});
var Zr = (e, t) => {
	var n = Wt(Y(e.body, t), t), r = e.label.slice(1), i = t.sizeMultiplier, a, o, s = c(e.body);
	if (r === "sout") a = W(["stretchy", "sout"]), a.height = t.fontMetrics().defaultRuleThickness / i, o = -.5 * t.fontMetrics().xHeight;
	else if (r === "phase") {
		var l = O({
			number: .6,
			unit: "pt"
		...
		n.style.paddingLeft = k(f / 2 + l);
		var p = Math.floor(1e3 * f * i);
		a = Bt(["hide-tail"], [new Le([new Re("phase", he(p))], {
			width: "400em",
			height: k(p / 1e3),
			viewBox: "0 0 400000 " + p,
			preserveAspectRatio: "xMinYMin slice"
		})], t), a.style.height = k(f), o = n.depth + l + u;
	} else {
	...
	return /cancel/.test(r) && (_.height = n.height, _.depth = n.depth), /cancel/.test(r) && !s ? W(["mord", "cancel-lap"], [_], t) : W(["mord"], [_], t);
}, Qr = (e, t) => {
	var n, r = new X(e.label.includes("colorbox") ? "mpadded" : "menclose", [Z(e.body, t)]);
	switch (e.label) {
		case "\\cancel":
...
}, oi = /* @__PURE__ */ new Set(["gather", "gather*"]);
function si(e) {
...
var ui = function(t, n) {
	...
	t.colSeparationType && t.colSeparationType === "small" && (f = .2778 * (n.havingStyle(E.SCRIPT).sizeMultiplier / n.sizeMultiplier));
	var p = t.colSeparationType === "CD" ? O({
		number: 3,
		unit: "ex"
	...
	for (y(o[0]), r = 0; r < t.body.length; ++r) {
		...
		var ee = t.rowGaps[r], T = 0;
		ee && (T = O(ee, n), T > 0 && (T += _, S < T && (S = T), T = 0)), t.addJot && r < t.body.length - 1 && (S += m), C.height = x, C.depth = S, v += x, C.pos = v, v += S + T, c[r] = C, y(o[r + 1]);
	}
	var te = v / 2 + n.fontMetrics().axisHeight, ne = t.cols || [], re = [], ie, ae, oe = [];
	if (t.tags && t.tags.some((e) => e)) for (r = 0; r < a; ++r) {
		var se = c[r], ce = se.pos - te, D = t.tags[r], le = void 0;
		le = D === !0 ? W(["eqn-num"], [], n) : D === !1 ? W([], [], n) : W([], dn(D, n, !0), n), le.depth = se.depth, le.height = se.height, oe.push({
			type: "elem",
			elem: le,
			shift: ce
		});
	}
	for (i = 0, ae = 0; i < s || ae < ne.length; ++i, ++ae) {
		for (var ue = ne[ae], de = !0; (fe = ue)?.type === "separator";) {
			var fe;
			if (de || (ie = W(["arraycolsep"], []), ie.style.width = k(n.fontMetrics().doubleRuleSep), re.push(ie)), ue.separator === "|" || ue.separator === ":") {
				var pe = ue.separator === "|" ? "solid" : "dashed", me = W(["vertical-separator"], [], n);
				me.style.height = k(v), me.style.borderRightWidth = k(u), me.style.borderRightStyle = pe, me.style.margin = "0 " + k(-u / 2);
				var he = v - te;
				he && (me.style.verticalAlign = k(-he)), re.push(me);
			} else throw new e("Invalid separator type: " + ue.separator);
			ae++, ue = ne[ae], de = !1;
		}
		if (!(i >= s)) {
			var ge = void 0;
			(i > 0 || t.hskipBeforeAndAfter) && (ge = ue?.pregap ?? f, ge !== 0 && (ie = W(["arraycolsep"], []), ie.style.width = k(ge), re.push(ie)));
			var _e = [];
			for (r = 0; r < a; ++r) {
				var ve = c[r], ye = ve.cells[i];
				if (ye) {
					var be = ve.pos - te;
			...
			var xe = G({
				positionType: "individualShift",
				children: _e
			}), Se = W(["col-align-" + (ue?.align || "c")], [xe]);
			re.push(Se), (i < s - 1 || t.hskipBeforeAndAfter) && (ge = ue?.postgap ?? f, ge !== 0 && (ie = W(["arraycolsep"], []), ie.style.width = k(ge), re.push(ie)));
		}
	}
	var Ce = W(["mtable"], re);
	if (l.length > 0) {
		for (var we = Vt("hline", n, u), Te = Vt("hdashline", n, u), Ee = [{
			type: "elem",
			elem: Ce,
			shift: 0
		}]; l.length > 0;) {
			var De = l.pop(), Oe = De.pos - te;
			De.isDashed ? Ee.push({
				type: "elem",
				elem: Te,
				shift: Oe
	...
	if (oe.length === 0) return W(["mord"], [Ce], n);
	var ke = W(["tag"], [G({
		positionType: "individualShift",
		children: oe
	})], n);
	...
	for (var n = [], r = new X("mtd", [], ["mtr-glue"]), i = new X("mtd", [], ["mml-eqn-num"]), a = 0; a < e.body.length; a++) {
		for (var o = e.body[a], s = [], c = 0; c < o.length; c++) s.push(new X("mtd", [Z(o[c], t)]));
		e.tags && e.tags[a] && (s.unshift(r), s.push(r), e.leqno ? s.unshift(i) : s.push(i)), n.push(new X("mtr", s));
	}
	var l = new X("mtable", n), u = e.arraystretch === .5 ? .1 : .16 + e.arraystretch - 1 + (e.addJot ? .09 : 0);
	...
	return /[sd]/.test(C) && l.setAttribute("rowlines", C.trim()), d !== "" && (l = new X("menclose", [l]), l.setAttribute("notation", d.trim())), e.arraystretch && e.arraystretch < 1 && (l = new X("mstyle", [l]), l.setAttribute("scriptlevel", "1")), l;
}, pi = function(t, n) {
...
q({
	...
	handler: (e, t) => {
		var { parser: n, funcName: r } = e, i = on(t[0]), a = r;
...
var vi = (e, t) => {
	var n = t.style, r = n.fracNum(), i = n.fracDen(), a = t.havingStyle(r), o = Y(e.numer, a, t);
	if (e.continued) {
		var s = 8.5 / t.fontMetrics().ptPerEm, c = 3.5 / t.fontMetrics().ptPerEm;
		o.height = o.height < s ? s : o.height, o.depth = o.depth < c ? c : o.depth;
	}
	a = t.havingStyle(i);
	var l = Y(e.denom, a, t), u, d, f;
	e.hasBarLine ? (e.barSize ? (d = O(e.barSize, t), u = Vt("frac-line", t, d)) : u = Vt("frac-line", t), d = u.height, f = u.height) : (u = null, d = 0, f = t.fontMetrics().defaultRuleThickness);
	var p, m, h;
	n.size === E.DISPLAY.size ? (p = t.fontMetrics().num1, m = d > 0 ? 3 * f : 7 * f, h = t.fontMetrics().denom1) : (d > 0 ? (p = t.fontMetrics().num2, m = f) : (p = t.fontMetrics().num3, m = 3 * f), h = t.fontMetrics().denom2);
	var g;
	if (u) {
	...
	var b = n.size === E.DISPLAY.size ? t.fontMetrics().delim1 : n.size === E.SCRIPTSCRIPT.size ? t.havingStyle(E.SCRIPT).fontMetrics().delim2 : t.fontMetrics().delim2, x = e.leftDelim == null ? gn(t, ["mopen"]) : Wr(e.leftDelim, b, !0, t.havingStyle(n), e.mode, ["mopen"]), S = e.continued ? W([]) : e.rightDelim == null ? gn(t, ["mclose"]) : Wr(e.rightDelim, b, !0, t.havingStyle(n), e.mode, ["mclose"]);
	return W(["mord"].concat(a.sizingClasses(t)), [
		x,
		W(["mfrac"], [g]),
		S
	], t);
}, yi = (e, t) => {
	var n = new X("mfrac", [Z(e.numer, t), Z(e.denom, t)]);
	...
	if (e.leftDelim != null || e.rightDelim != null) {
		...
		if (i.push(n), e.rightDelim != null) {
			var o = new X("mo", [new bn(e.rightDelim.replace("\\", ""))]);
...
q({
	...
	handler(e, t) {
		var { parser: n } = e, r = t[4], i = t[5], a = on(t[0]), o = a.type === "atom" && a.family === "open" ? Si(a.text) : null, s = on(t[1]), c = s.type === "atom" && s.family === "close" ? Si(s.text) : null, l = Q(t[2], "size"), u, d = null;
...
var Ci = (e, t) => {
	var n = t.style, r, i;
	e.type === "supsub" ? (r = e.sup ? Y(e.sup, t.havingStyle(n.sup()), t) : Y(e.sub, t.havingStyle(n.sub()), t), i = Q(e.base, "horizBrace")) : i = Q(e, "horizBrace");
	var a = Y(i.base, t.havingBaseStyle(E.DISPLAY)), o = Wn(i, t), s = i.isOver ? G({
		positionType: "firstBaseline",
		children: [
			{
				type: "elem",
	...
	if (r) {
		var c = W(["minner", i.isOver ? "mover" : "munder"], [s], t);
		s = i.isOver ? G({
			positionType: "firstBaseline",
			children: [
				{
	...
	return W(["minner", i.isOver ? "mover" : "munder"], [s], t);
};
q({
	type: "horizBrace",
	names: [
	...
	mathmlBuilder: (e, t) => {
		var n = Vn(e.label);
		return new X(e.isOver ? "mover" : "munder", [Z(e.base, t), n]);
	}
}), q({
	type: "href",
	names: ["\\href"],
	...
	htmlBuilder: (e, t) => {
		var n = dn(e.body, t, !1);
		return Ht(e.href, [], n, t);
	},
	mathmlBuilder: (e, t) => {
		var n = An(e.body, t);
		return n instanceof X || (n = new X("mrow", [n])), n.setAttribute("href", e.href), n;
	}
}), q({
	type: "href",
	names: ["\\url"],
	...
	htmlBuilder(e, t) {
		return Ut(dn(e.body, t.withFont(""), !1));
	},
	mathmlBuilder(e, t) {
		return new X("mrow", kn(e.body, t.withFont("")));
	}
}), q({
	type: "html",
	names: [
	...
	htmlBuilder: (e, t) => {
		var n = dn(e.body, t, !1), r = ["enclosing"];
	...
	htmlBuilder: (e, t) => Ut(dn(e.html, t, !1)),
...
var wi = function(t) {
	...
	if (!Te(r)) throw new e("Invalid unit: '" + r.unit + "' in \\includegraphics.");
	return r;
};
q({
	...
	htmlBuilder: (e, t) => {
		var n = O(e.height, t), r = 0;
		e.totalheight.number > 0 && (r = O(e.totalheight, t) - n);
		var i = 0;
		e.width.number > 0 && (i = O(e.width, t));
		var a = { height: k(n + r) };
		i > 0 && (a.width = k(i)), r > 0 && (a.verticalAlign = k(-r));
		var o = new Pe(e.src, e.alt, a);
		return o.height = n, o.depth = r, o;
	},
	mathmlBuilder: (e, t) => {
		var n = new X("mglyph", []);
		n.setAttribute("alt", e.alt);
		var r = O(e.height, t), i = 0;
		if (e.totalheight.number > 0 && (i = O(e.totalheight, t) - r, n.setAttribute("valign", k(-i))), n.setAttribute("height", k(r + i)), e.width.number > 0) {
			var a = O(e.width, t);
	...
	htmlBuilder(e, t) {
		return Kt(e.dimension, t);
	},
	mathmlBuilder(e, t) {
		return new xn(O(e.dimension, t));
	}
}), q({
	type: "lap",
	names: [
	...
	htmlBuilder: (e, t) => {
		var n;
		e.alignment === "clap" ? (n = W([], [Y(e.body, t)]), n = W(["inner"], [n], t)) : n = W(["inner"], [Y(e.body, t)]);
		var r = W(["fix"], []), i = W([e.alignment], [n, r], t), a = W(["strut"]);
		return a.style.height = k(i.height + i.depth), i.depth && (a.style.verticalAlign = k(-i.depth)), i.children.unshift(a), i = W(["thinbox"], [i], t), W(["mord", "vbox"], [i], t);
	},
	mathmlBuilder: (e, t) => {
		var n = new X("mpadded", [Z(e.body, t)]);
		if (e.alignment !== "rlap") {
...
var Ti = (e, t) => {
	switch (t.style.size) {
		case E.DISPLAY.size: return e.display;
		case E.TEXT.size: return e.text;
		case E.SCRIPT.size: return e.script;
		case E.SCRIPTSCRIPT.size: return e.scriptscript;
...
q({
	...
	htmlBuilder: (e, t) => Ut(dn(Ti(e, t), t, !1)),
...
var Ei = (e, t, n, r, i, a, o) => {
	...
	var s = n && c(n), l, u;
	if (t) {
		var d = Y(t, r.havingStyle(i.sup()), r);
		u = {
			elem: d,
	...
	if (n) {
		var f = Y(n, r.havingStyle(i.sub()), r);
		l = {
			elem: f,
	...
	if (l && a !== 0 && !s) {
		var h = W(["mspace"], [], r);
		h.style.marginRight = k(a), m.unshift(h);
	}
	return W(["mop", "op-limits"], m, r);
}, Di = /* @__PURE__ */ new Set(["\\smallint"]), Oi = (e, t) => {
	var n, r, i = !1, a;
	e.type === "supsub" ? (n = e.sup, r = e.sub, a = Q(e.base, "op"), i = !0) : a = Q(e, "op");
	var o = t.style, s = !1;
	o.size === E.DISPLAY.size && a.symbol && !Di.has(a.name) && (s = !0);
	var c, l;
	if (a.symbol) {
		var u = s ? "Size2-Regular" : "Size1-Regular", d = "";
		if ((a.name === "\\oiint" || a.name === "\\oiiint") && (d = a.name.slice(1), a.name = d === "oiint" ? "\\iint" : "\\iiint"), c = Nt(a.name, u, "math", t, [
			"mop",
			"op-symbol",
			s ? "large-op" : "small-op"
		]), l = c.italic, d.length > 0) {
			var f = Xt(d + "Size" + (s ? "2" : "1"), t);
			c = G({
				positionType: "individualShift",
				children: [{
					type: "elem",
		...
		var p = dn(a.body, t, !0);
		p.length === 1 && p[0] instanceof Ie ? (c = p[0], c.classes[0] = "mop") : c = W(["mop"], p, t);
	} else {
		for (var m = [], h = 1; h < a.name.length; h++) m.push(Pt(a.name[h], a.mode, t));
		c = W(["mop"], m, t);
	}
	var g = 0, _ = 0;
	return (c instanceof Ie || a.name === "\\oiint" || a.name === "\\oiiint") && !a.suppressBaseShift && (g = (c.height - c.depth) / 2 - t.fontMetrics().axisHeight, _ = c.italic ?? 0), i ? Ei(c, n, r, t, o, _, g) : (g && (c.style.position = "relative", c.style.top = k(g)), c);
}, ki = (e, t) => {
	var n;
	if (e.symbol) n = new X("mo", [wn(e.name, e.mode)]), Di.has(e.name) && n.setAttribute("largeop", "false");
	else if (e.body) n = new X("mo", kn(e.body, t));
	else {
		n = new X("mi", [new bn(e.name.slice(1))]);
		var r = new X("mo", [wn("⁡", "text")]);
		n = e.parentIsSupSub ? new X("mrow", [n, r]) : yn([n, r]);
	}
	return n;
}, Ai = {
	"∏": "\\prod",
...
var Mi = (e, t) => {
	...
	if (a.body.length > 0) {
		for (var s = dn(a.body.map((e) => {
			...
			var l = s[c];
			l instanceof Ie && (l.text = l.text.replace(/\u2212/, "-").replace(/\u2217/, "*"));
		}
		o = W(["mop"], s, t);
	} else o = W(["mop"], [], t);
...
q({
	...
	mathmlBuilder: (e, t) => {
		for (var n = kn(e.body, t.withFont("mathrm")), r = !0, i = 0; i < n.length; i++) {
			var a = n[i];
			if (!(a instanceof xn)) if (a instanceof X) switch (a.type) {
				case "mi":
				case "mn":
				case "mspace":
				case "mtext": break;
				case "mo":
					var o = a.children[0];
					a.children.length === 1 && o instanceof bn ? o.text = o.text.replace(/\u2212/, "-").replace(/\u2217/, "*") : r = !1;
					break;
				default: r = !1;
			}
			else r = !1;
		}
		r && (n = [new bn(n.map((e) => e.toText()).join(""))]);
		var s = new X("mi", n);
		s.setAttribute("mathvariant", "normal");
		var c = new X("mo", [wn("⁡", "text")]);
		return e.parentIsSupSub ? new X("mrow", [s, c]) : yn([s, c]);
	}
}), $("\\operatorname", "\\@ifstar\\operatornamewithlimits\\operatorname@"), an({
	type: "ordgroup",
	htmlBuilder(e, t) {
		return e.semisimple ? Ut(dn(e.body, t, !1)) : W(["mord"], dn(e.body, t, !0), t);
	},
	mathmlBuilder(e, t) {
	...
	htmlBuilder(e, t) {
		var n = Y(e.body, t.havingCrampedStyle()), r = Vt("overline-line", t), i = t.fontMetrics().defaultRuleThickness;
		return W(["mord", "overline"], [G({
			positionType: "firstBaseline",
			children: [
				{
					type: "elem",
	...
	mathmlBuilder(e, t) {
		var n = new X("mo", [new bn("‾")]);
		n.setAttribute("stretchy", "true");
		var r = new X("mover", [Z(e.body, t), n]);
		return r.setAttribute("accent", "true"), r;
	}
}), q({
	type: "phantom",
	...
	htmlBuilder: (e, t) => Ut(dn(e.body, t.withPhantom(), !1)),
	mathmlBuilder: (e, t) => new X("mphantom", kn(e.body, t))
}), $("\\hphantom", "\\smash{\\phantom{#1}}"), q({
	type: "vphantom",
	names: ["\\vphantom"],
	props: {
		numArgs: 1,
	...
	htmlBuilder: (e, t) => W(["mord", "rlap"], [W(["inner"], [Y(e.body, t.withPhantom())]), W(["fix"], [])], t),
	mathmlBuilder: (e, t) => {
		var n = new X("mpadded", [new X("mphantom", kn(J(e.body), t))]);
		return n.setAttribute("width", "0px"), n;
	}
}), q({
	type: "raisebox",
	...
	mathmlBuilder(e, t) {
		var n = new X("mpadded", [Z(e.body, t)]), r = e.dy.number + e.dy.unit;
	...
	htmlBuilder(e, t) {
		var n = W(["mord", "rule"], [], t), r = O(e.width, t), i = O(e.height, t), a = e.shift ? O(e.shift, t) : 0;
...
q({
	...
	mathmlBuilder: (e, t) => {
		var n = t.havingSize(e.size), r = new X("mstyle", kn(e.body, n));
	...
	htmlBuilder: (e, t) => {
		...
		if (e.smashHeight && (n.height = 0), e.smashDepth && (n.depth = 0), e.smashHeight && e.smashDepth) return W(["mord", "smash"], [n], t);
	...
	htmlBuilder(e, t) {
		var n = Y(e.body, t.havingCrampedStyle());
		n.height === 0 && (n.height = t.fontMetrics().xHeight), n = Wt(n, t);
		...
		if (e.index) {
			var f = t.havingStyle(E.SCRIPTSCRIPT), p = Y(e.index, f, t);
			return W(["mord", "sqrt"], [W(["root"], [G({
				positionType: "shift",
		...
		} else return W(["mord", "sqrt"], [d], t);
	},
	mathmlBuilder(e, t) {
		var { body: n, index: r } = e;
		return r ? new X("mroot", [Z(n, t), Z(r, t)]) : new X("msqrt", [Z(n, t)]);
	}
});
var Fi = {
	display: E.DISPLAY,
...
q({
	...
	mathmlBuilder(e, t) {
		...
		var i = new X("mstyle", kn(e.body, r)), a = {
			display: ["0", "true"],
			text: ["0", "false"],
			script: ["1", "false"],
...
var Li = function(e, t) {
	var n = e.base;
	return n ? n.type === "op" ? n.limits && (t.style.size === E.DISPLAY.size || n.alwaysHandleSupSub) ? Oi : null : n.type === "operatorname" ? n.alwaysHandleSupSub && (t.style.size === E.DISPLAY.size || n.limits) ? Mi : null : n.type === "accent" ? c(n.base) ? Qn : null : n.type === "horizBrace" && !e.sub === n.isOver ? Ci : null : null;
};
an({
	type: "supsub",
	htmlBuilder(e, t) {
		var n = Li(e, t);
		if (n) return n(e, t);
		var { base: r, sup: i, sub: a } = e, o = Y(r, t), s, l, u = t.fontMetrics(), d = 0, f = 0, p = r && c(r);
		if (i) {
			var m = t.havingStyle(t.style.sup());
			s = Y(i, m, t), p || (d = o.height - m.fontMetrics().supDrop * m.sizeMultiplier / t.sizeMultiplier);
		}
		if (a) {
			var h = t.havingStyle(t.style.sub());
			l = Y(a, h, t), p || (f = o.depth + h.fontMetrics().subDrop * h.sizeMultiplier / t.sizeMultiplier);
		}
		var g = t.style === E.DISPLAY ? u.sup1 : t.style.cramped ? u.sup3 : u.sup2, _ = t.sizeMultiplier, v = k(.5 / u.ptPerEm / _), y = null;
		if (l) {
			var b = e.base && e.base.type === "op" && e.base.name && (e.base.name === "\\oiint" || e.base.name === "\\oiiint");
			(o instanceof Ie || b) && (y = k(-(o.italic ?? 0)));
		}
		var x;
		if (s && l) {
		...
		} else if (l) f = Math.max(f, u.sub1, l.height - .8 * u.xHeight), x = G({
			positionType: "shift",
			positionData: f,
			children: [{
				type: "elem",
		...
		else if (s) d = Math.max(d, g, s.depth + .25 * u.xHeight), x = G({
			positionType: "shift",
			positionData: -d,
			children: [{
				type: "elem",
		...
		return W([hn(o, "right") || "mord"], [o, W(["msupsub"], [x])], t);
	},
	mathmlBuilder(e, t) {
		var n = !1, r, i;
		...
		if (n) o = r ? "mover" : "munder";
			...
			var s = e.base;
			o = s && s.type === "op" && s.limits && (t.style === E.DISPLAY || s.alwaysHandleSupSub) || s && s.type === "operatorname" && s.alwaysHandleSupSub && (s.limits || t.style === E.DISPLAY) ? "mover" : "msup";
		} else if (e.sup) {
			var c = e.base;
			o = c && c.type === "op" && c.limits && t.style === E.DISPLAY || c && c.type === "operatorname" && c.alwaysHandleSupSub && (t.style === E.DISPLAY || c.limits) ? "munderover" : "msubsup";
		} else {
			var l = e.base;
			o = l && l.type === "op" && l.limits && (t.style === E.DISPLAY || l.alwaysHandleSupSub) || l && l.type === "operatorname" && l.alwaysHandleSupSub && (l.limits || t.style === E.DISPLAY) ? "munder" : "msub";
		}
		return new X(o, a);
	}
}), an({
	type: "atom",
	htmlBuilder(e, t) {
		return Pt(e.text, e.mode, t, ["m" + e.family]);
	},
	mathmlBuilder(e, t) {
		var n = new X("mo", [wn(e.text, e.mode)]);
		if (e.family === "bin") {
			var r = Dn(e, t);
...
an({
	type: "mathord",
	htmlBuilder(e, t) {
		return It(e, t, "mathord");
	},
	mathmlBuilder(e, t) {
		var n = new X("mi", [wn(e.text, e.mode, t)]), r = Dn(e, t) || "italic";
		return r !== Ri[n.type] && n.setAttribute("mathvariant", r), n;
	}
}), an({
	type: "textord",
	htmlBuilder(e, t) {
		return It(e, t, "textord");
	},
	mathmlBuilder(e, t) {
		var n = wn(e.text, e.mode, t), r = Dn(e, t) || "normal", i = e.mode === "text" ? new X("mtext", [n]) : /[0-9]/.test(e.text) ? new X("mn", [n]) : e.text === "\\prime" ? new X("mo", [n]) : new X("mi", [n]);
...
an({
	...
	htmlBuilder(t, n) {
		if (Bi.hasOwnProperty(t.text)) {
			...
			if (t.mode === "text") {
				var i = It(t, n, "textord");
				return i.classes.push(r), i;
			} else return W(["mspace", r], [Pt(t.text, t.mode, n)], n);
		} else if (zi.hasOwnProperty(t.text)) return W(["mspace", zi[t.text]], [], n);
		else throw new e("Unknown type of space \"" + t.text + "\"");
	},
	mathmlBuilder(t, n) {
		var r;
		if (Bi.hasOwnProperty(t.text)) r = new X("mtext", [new bn("\xA0")]);
		else if (zi.hasOwnProperty(t.text)) return new X("mspace");
		else throw new e("Unknown type of space \"" + t.text + "\"");
		return r;
	}
});
...
an({
	type: "tag",
	mathmlBuilder(e, t) {
		var n = new X("mtable", [new X("mtr", [
			Vi(),
			new X("mtd", [An(e.body, t)]),
			Vi(),
			new X("mtd", [An(e.tag, t)])
		])]);
...
q({
	...
	htmlBuilder(e, t) {
		var n = Gi(e, t);
		return W(["mord", "text"], dn(e.body, n, !0), n);
	},
	mathmlBuilder(e, t) {
		var n = Gi(e, t);
		return An(e.body, n);
	...
	htmlBuilder(e, t) {
		var n = Y(e.body, t), r = Vt("underline-line", t), i = t.fontMetrics().defaultRuleThickness;
		return W(["mord", "underline"], [G({
			positionType: "top",
			positionData: n.height,
			children: [
				{
	...
	mathmlBuilder(e, t) {
		var n = new X("mo", [new bn("‾")]);
		n.setAttribute("stretchy", "true");
		var r = new X("munder", [Z(e.body, t), n]);
		return r.setAttribute("accentunder", "true"), r;
	}
}), q({
	type: "vcenter",
	...
	htmlBuilder(e, t) {
		var n = Y(e.body, t), r = t.fontMetrics().axisHeight;
		return G({
			positionType: "shift",
	...
	mathmlBuilder(e, t) {
		return new X("mrow", [new X("mpadded", [Z(e.body, t)], ["vcenter"])]);
	}
}), q({
	type: "verb",
	names: ["\\verb"],
	...
	htmlBuilder(e, t) {
		for (var n = Ki(e), r = [], i = t.havingStyle(t.style.text()), a = 0; a < n.length; a++) {
			var o = n[a];
			o === "~" && (o = "\\textasciitilde"), r.push(Nt(o, "Typewriter-Regular", e.mode, i, ["mord", "texttt"]));
		}
		return W(["mord", "text"].concat(i.sizingClasses(t)), Rt(r), i);
	},
	mathmlBuilder(e, t) {
		var n = new X("mtext", [new bn(Ki(e))]);
		return n.setAttribute("mathvariant", "monospace"), n;
	}
});
var Ki = (e) => e.body.replace(/ /g, e.star ? "␣" : "\xA0"), qi = tn, Ji = "[ \r\n	]", Yi = "\\\\[a-zA-Z@]+", Xi = "\\\\[^\ud800-\udfff]", Zi = "(" + Yi + ")" + Ji + "*", Qi = "\\\\(\n|[ \r	]+\n?)[ \r	]*", $i = "[̀-ͯ]", ea = RegExp($i + "+$"), ta = "(" + Ji + "+)|" + (Qi + "|") + "([!-\\[\\]-‧‪-퟿豈-￿]" + ($i + "*") + "|[\ud800-\udbff][\udc00-\udfff]" + ($i + "*") + "|\\\\verb\\*([^]).*?\\4|\\\\verb([^*a-zA-Z]).*?\\5" + ("|" + Zi) + ("|" + Xi + ")"), na = class {
	constructor(e, t) {
...
$("\\newcommand", (e) => oa(e, !1, !0, !1)), $("\\renewcommand", (e) => oa(e, !0, !1, !1)), $("\\providecommand", (e) => oa(e, !0, !0, !0)), $("\\message", (e) => {
	...
	return console.log(t, e.macros.get(n), qi[n], A.math[n], A.text[n]), "";
...
var sa = {
	...
	"\\idotsint": "\\dotsi",
	"\\DOTSX": "\\dotsx"
}, ca = /* @__PURE__ */ new Set(["bin", "rel"]);
$("\\dots", function(e) {
	var t = "\\dotso", n = e.expandAfterFuture().text;
	return n in sa ? t = sa[n] : (n.slice(0, 4) === "\\not" || n in A.math && ca.has(A.math[n].group)) && (t = "\\dotsb"), t;
});
var la = {
	")": !0,
	"]": !0,
...
var ua = k(Ue["Main-Regular"][84][1] - .7 * Ue["Main-Regular"][65][1]);
...
var fa = {
	...
	isDefined(e) {
		return this.macros.has(e) || qi.hasOwnProperty(e) || A.math.hasOwnProperty(e) || A.text.hasOwnProperty(e) || fa.hasOwnProperty(e);
	}
	isExpandable(e) {
		var t = this.macros.get(e);
	...
	parseSizeGroup(t) {
		...
		if (!Te(a)) throw new e("Invalid unit: '" + a.unit + "'", n);
		return {
			type: "size",
			mode: this.mode,
			value: a,
	...
	parseSymbol() {
		...
		_a.hasOwnProperty(n[0]) && !A[this.mode][n[0]] && (this.settings.strict && this.mode === "math" && this.settings.reportNonstrict("unicodeTextInMathMode", "Accented Unicode text character \"" + n[0] + "\" used in math mode", t), n = _a[n[0]] + n.slice(1));
		var a = ea.exec(n);
		a && (n = n.substring(0, a.index), n === "i" ? n = "ı" : n === "j" && (n = "ȷ"));
		var o;
		if (A[this.mode][n]) {
			this.settings.strict && this.mode === "math" && mt.includes(n) && this.settings.reportNonstrict("unicodeTextInMathMode", "Latin-1/Unicode text character \"" + n[0] + "\" used in math mode", t);
			var s = A[this.mode][n].group, c = ni.range(t);
			o = Jn(s) ? {
				type: "atom",
				mode: this.mode,
				family: s,
		...
		} else if (n.charCodeAt(0) >= 128) this.settings.strict && (ce(n.charCodeAt(0)) ? this.mode === "math" && this.settings.reportNonstrict("unicodeTextInMathMode", "Unicode text character \"" + n[0] + "\" used in math mode", t) : this.settings.reportNonstrict("unknownSymbol", "Unrecognized Unicode character \"" + n[0] + "\"" + (" (" + n.charCodeAt(0) + ")"), t)), o = {
			type: "textord",
			mode: "text",
			loc: ni.range(t),
			text: n
...
va.endOfExpression = /* @__PURE__ */ new Set([
	"}",
	"\\endgroup",
	"\\end",
	"\\right",
