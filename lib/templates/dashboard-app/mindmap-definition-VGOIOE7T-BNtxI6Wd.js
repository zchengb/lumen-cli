...
import { $ as n, D as r, I as i, Q as a, Z as o, b as s, d as c } from "./chunk-ABZYJK2D-CVevQ3ur.js";
...
import { r as l, t as u } from "./chunk-N4CR4FBY-C3Oe3dWX.js";
import { t as d } from "./chunk-55IACEB6-7rZAUXZ_.js";
import { t as f } from "./chunk-QN33PNHL-isVexcb8.js";
...
var h, g = /* @__PURE__ */ new Uint8Array(16);
function _() {
	if (!h) {
...
var x = b, S = {
	...
	addNode(t, n, r, a) {
		...
		let l = s(), u = l.mindmap?.padding ?? c.mindmap.padding;
		switch (a) {
	...
	decorateNode(e) {
		if (!e) return;
		let t = s(), n = this.nodes[this.nodes.length - 1];
	...
	getData() {
		let t = this.getMindmap(), n = s(), i = r().layout !== void 0, a = n;
		...
		let o = [], c = [];
		this.flattenNodes(t, o), this.generateEdges(t, c), e.debug(`getData: processed ${o.length} nodes and ${c.length} edges`);
...
}, w = { draw: /* @__PURE__ */ t(async (t, n, r, i) => {
	e.debug("Rendering mindmap diagram\n" + t);
	let a = i.db, o = a.getData(), s = d(n, o.config.securityLevel);
	o.type = i.type, o.layoutAlgorithm = u(o.config.layout, { fallback: "cose-bilkent" }), o.diagramId = n, a.getMindmap() && (o.nodes.forEach((e) => {
	...
	}), await l(o, s), f(s, o.config.mindmap?.padding ?? c.mindmap.padding, "mindmapDiagram", o.config.mindmap?.useMaxWidth ?? c.mindmap.useMaxWidth));
}, "draw") }, T = /* @__PURE__ */ t((e) => {
	let t = "";
