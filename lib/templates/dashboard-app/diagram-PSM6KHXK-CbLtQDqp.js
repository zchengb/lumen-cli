...
import { B as r, C as i, U as a, _ as o, a as s, c, d as l, v as u, y as d, z as f } from "./chunk-ABZYJK2D-CVevQ3ur.js";
import { t as p } from "./ordinal-D_ZgubzR.js";
import { t as m } from "./defaultLocale-DnzPsei5.js";
import { r as h } from "./chunk-S3R3BYOJ-BtVK2Rr4.js";
import { t as g } from "./chunk-EXTU4WIE-By1ZThX0.js";
import { i as _, n as v } from "./chunk-ATLVNIR6-CY_EFS1R.js";
import { t as y } from "./mermaid-parser.core-CqbA3hT_.js";
import { t as b } from "./chunk-4BX2VUAB-BqrFk22c.js";
import { t as x } from "./chunk-QN33PNHL-isVexcb8.js";
...
function A(e) {
	for (var t = this, n = j(t, e), r = [t]; t !== n;) t = t.parent, r.push(t);
...
function L(e, t) {
	e instanceof Map ? (e = [void 0, e], t === void 0 && (t = B)) : t === void 0 && (t = z);
	for (var n = new U(e), r, i = [n], a, o, s, c; r = i.pop();) if ((o = t(r.data)) && (c = (o = Array.from(o)).length)) for (r.children = o, s = c - 1; s >= 0; --s) i.push(a = o[s] = new U(o[s])), a.parent = r, a.depth = r.depth + 1;
	return n.eachBefore(H);
}
function R() {
...
function ne(e, t, n, r, i, a) {
	for (var o = [], s = t.children, c, l, u = 0, d = 0, f = s.length, p, m, h = t.value, g, _, v, y, b, x, S; u < f;) {
		...
		}), c.dice ? J(c, n, r, i, h ? r += m * g / h : a) : ee(c, n, r, h ? n += p * g / h : i, a), h -= g, u = d;
	}
	return o;
}
var re = (function e(t) {
...
function ie() {
	var e = re, t = !1, n = 1, r = 1, i = [0], a = G, o = G, s = G, c = G, l = G;
	function u(e) {
		return e.x0 = e.y0 = 0, e.x1 = n, e.y1 = r, e.eachBefore(d), i = [0], t && e.eachBefore(q), e;
	}
	function d(t) {
	...
	return u.round = function(e) {
		...
		return arguments.length ? (o = typeof e == "function" ? e : K(+e), u) : o;
	}, u.paddingRight = function(e) {
		return arguments.length ? (s = typeof e == "function" ? e : K(+e), u) : s;
	}, u.paddingBottom = function(e) {
		return arguments.length ? (c = typeof e == "function" ? e : K(+e), u) : c;
	}, u.paddingLeft = function(e) {
		return arguments.length ? (l = typeof e == "function" ? e : K(+e), u) : l;
	}, u;
}
//#endregion
...
var Y = class {
	constructor() {
		this.nodes = [], this.levels = /* @__PURE__ */ new Map(), this.outerNodes = [], this.classes = /* @__PURE__ */ new Map(), this.setAccTitle = r, this.getAccTitle = u, this.setDiagramTitle = a, this.getDiagramTitle = i, this.getAccDescription = o, this.setAccDescription = f;
	}
	static {
		t(this, "TreeMapDB");
	}
	...
	addClass(e, t) {
		...
		r && r.forEach((e) => {
			v(e) && (n?.textStyles ? n.textStyles.push(e) : n.textStyles = [e]), n?.styles ? n.styles.push(e) : n.styles = [e];
...
var ae = /* @__PURE__ */ t((e, n) => {
	...
	for (let t of e.TreemapRows ?? []) {
		let e = t.item;
		if (!e) continue;
		let i = t.indent ? parseInt(t.indent) : 0, a = oe(e), o = e.classSelector ? n.getStylesForClass(e.classSelector) : [], s = o.length > 0 ? o.join(";") : void 0, c = {
			level: i,
			name: a,
			type: e.$type,
			value: e.value,
	...
	a(i, 0);
}, "populate"), oe = /* @__PURE__ */ t((e) => e.name ? String(e.name) : "", "getItemName"), Z = {
	parser: { yy: void 0 },
	parse: /* @__PURE__ */ t(async (t) => {
		try {
			let n = await y("treemap", t);
	...
	draw: /* @__PURE__ */ t((r, i, a, o) => {
		let s = o.db, l = s.getConfig(), u = l.padding ?? se, f = s.getDiagramTitle(), h = s.getRoot(), { themeVariables: v } = d();
		if (!h) return;
		let y = f ? 30 : 0, b = g(i), S = l.nodeWidth ? l.nodeWidth * Q : 960, C = l.nodeHeight ? l.nodeHeight * Q : 500, w = S, T = C + y;
		b.attr("viewBox", `0 0 ${w} ${T}`), c(b, T, w, l.useMaxWidth);
		let E;
		try {
			let e = l.valueFormat || ",";
			if (e === "$0,0") E = /* @__PURE__ */ t((e) => "$" + m(",")(e), "valueFormat");
			else if (e.startsWith("$") && e.includes(",")) {
				let n = /\.\d+/.exec(e), r = n ? n[0] : "";
				E = /* @__PURE__ */ t((e) => "$" + m("," + r)(e), "valueFormat");
			} else if (e.startsWith("$")) {
				let n = e.substring(1);
				E = /* @__PURE__ */ t((e) => "$" + m(n || "")(e), "valueFormat");
			} else E = m(e);
		} catch (t) {
			e.error("Error creating format function:", t), E = m(",");
		}
		let D = p().range([
			"transparent",
			v.cScale0,
		...
		f && b.append("text").attr("x", w / 2).attr("y", y / 2).attr("class", "treemapTitle").attr("text-anchor", "middle").attr("dominant-baseline", "middle").text(f);
		let A = b.append("g").attr("transform", `translate(0, ${y})`).attr("class", "treemapContainer"), j = L(h).sum((e) => e.value ?? 0).sort((e, t) => (t.value ?? 0) - (e.value ?? 0)), M = ie().size([S, C]).paddingTop((e) => e.children && e.children.length > 0 ? $ + Q : 0).paddingInner(u).paddingLeft((e) => e.children && e.children.length > 0 ? Q : 0).paddingRight((e) => e.children && e.children.length > 0 ? Q : 0).paddingBottom((e) => e.children && e.children.length > 0 ? Q : 0).round(!0)(j), N = M.descendants().filter((e) => e.children && e.children.length > 0), P = A.selectAll(".treemapSection").data(N).enter().append("g").attr("class", "treemapSection").attr("transform", (e) => `translate(${e.x0},${e.y0})`);
		P.append("rect").attr("width", (e) => e.x1 - e.x0).attr("height", $).attr("class", "treemapSectionHeader").attr("fill", "none").attr("fill-opacity", .6).attr("stroke-width", .6).attr("style", (e) => e.depth === 0 ? "display: none;" : ""), P.append("clipPath").attr("id", (e, t) => `clip-section-${i}-${t}`).append("rect").attr("width", (e) => Math.max(0, e.x1 - e.x0 - 12)).attr("height", $), P.append("rect").attr("width", (e) => e.x1 - e.x0).attr("height", (e) => e.y1 - e.y0).attr("class", (e, t) => `treemapSection section${t}`).attr("fill", (e) => D(e.data.name)).attr("fill-opacity", .6).attr("stroke", (e) => O(e.data.name)).attr("stroke-width", 2).attr("stroke-opacity", .4).attr("style", (e) => {
			...
			let t = _({ cssCompiledStyles: e.data.cssCompiledStyles });
			...
			t.text(r);
			let i = e.x1 - e.x0, a;
			a = l.showValues !== !1 && e.value ? i - 10 - 30 - 10 - 6 : i - 6 - 6;
		...
		}), l.showValues !== !1 && P.append("text").attr("class", "treemapSectionValue").attr("x", (e) => e.x1 - e.x0 - 10).attr("y", $ / 2).attr("text-anchor", "end").attr("dominant-baseline", "middle").text((e) => e.value ? E(e.value) : "").attr("font-style", "italic").attr("style", (e) => e.depth === 0 ? "display: none;" : "text-anchor: end; dominant-baseline: middle; font-size: 10px; fill:" + k(e.data.name) + "; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;" + _({ cssCompiledStyles: e.data.cssCompiledStyles }).labelStyles.replace("color:", "fill:"));
		...
		}), l.showValues !== !1 && I.append("text").attr("class", "treemapValue").attr("x", (e) => (e.x1 - e.x0) / 2).attr("y", function(e) {
			return (e.y1 - e.y0) / 2;
		}).attr("style", (e) => "text-anchor: middle; dominant-baseline: hanging; font-size: 28px;fill:" + k(e.data.name) + ";" + _({ cssCompiledStyles: e.data.cssCompiledStyles }).labelStyles.replace("color:", "fill:")).attr("clip-path", (e, t) => `url(#clip-${i}-${t})`).text((e) => e.value ? E(e.value) : "").each(function(e) {
		...
		}), x(b, l.diagramPadding ?? 8, "flowchart", l?.useMaxWidth || !1);
	}, "draw"),
