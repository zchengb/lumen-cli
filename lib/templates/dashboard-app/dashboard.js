			...
			/* @__PURE__ */ (0, Y.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, Y.jsxs)("header", {
					...
					children: [
						...
						n && i === "repositories" && /* @__PURE__ */ (0, Y.jsx)(q_, {
							data: n,
							interact: ee
						}),
						...
						n && i === "settings" && /* @__PURE__ */ (0, Y.jsx)(Y_, {
							data: n,
							project: e,
							notify: S,
							onDirtyChange: _,
...
function W_({ label: e, value: t, onChange: n, markDirty: r }) {
...
function G_({ label: e, value: t, onClose: n, onConfirm: r }) {
...
function K_({ runtime: e, onChange: t }) {
...
function Y_({ data: e, project: t, notify: n, onDirtyChange: r, reload: i }) {
								...
								children: [
									...
									/* @__PURE__ */ (0, Y.jsx)($, {
										...
										children: /* @__PURE__ */ (0, Y.jsx)("select", {
											...
											multiple: !0,
											size: Math.min(Math.max(ge.length, 3), 6),
											value: h,
											onChange: (e) => {
												g(Array.from(e.target.selectedOptions, (e) => e.value)), j();
											},
...
function X_({ enabled: e, onChange: t }) {
	return /* @__PURE__ */ (0, Y.jsxs)("label", {
