...
//#endregion
//#region package.json
var bl = _(), xl = "1.24.24", Sl = (...e) => e.filter((e, t, n) => !!e && e.trim() !== "" && n.indexOf(e) === t).join(" ").trim(), Cl = (e) => e.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase(), wl = (e) => e.replace(/^([A-Z])|[\s-_]+(\w)/g, (e, t, n) => n ? n.toUpperCase() : t.toLowerCase()), Tl = (e) => {
	let t = wl(e);
...
function xu({ data: e, project: t, notify: n, reload: r }) {
	...
	}, ue = /failed|blocked/i.test(String(a.delivery_status || ""));
	return /* @__PURE__ */ (0, U.jsxs)(U.Fragment, { children: [
		/* @__PURE__ */ (0, U.jsxs)(du, {
			...
			action: /* @__PURE__ */ (0, U.jsxs)("span", {
				...
				children: [
					!N && !!(a.story_id || a.jira_key || (i.available_stories || []).length) && /* @__PURE__ */ (0, U.jsxs)("button", {
						className: "button secondary",
						disabled: ee,
						onClick: () => void I(),
...
function Tu({ stages: e, deliveryStatus: t, startedAt: n, finishedAt: r, remediation: i, now: a, onStageClick: o }) {
	...
	return /* @__PURE__ */ (0, U.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, U.jsxs)("div", {
			...
			})] }), /* @__PURE__ */ (0, U.jsxs)("p", { children: [n ? `Started ${iu(n)}` : "Awaiting delivery trigger", r ? ` · Finished ${iu(r)}` : ""] })]
		}), /* @__PURE__ */ (0, U.jsxs)("div", {
			className: "flow-track-wrap",
			children: [/* @__PURE__ */ (0, U.jsx)("span", {
				className: "flow-track",
				children: /* @__PURE__ */ (0, U.jsx)("i", { style: { width: `${d}%` } })
			}), /* @__PURE__ */ (0, U.jsx)("ol", {
				className: "flow-steps",
				style: { "--flow-count": e.length },
				children: e.map((e, t) => {
					let n = String(e.status || "pending").toLowerCase(), r = s || n === "completed" ? "completed" : /running|progress/.test(n) ? "running" : /fail|block/.test(n) ? "failed" : "pending", i = r === "running" ? au(e.active_started_at || e.started_at, new Date(a).toISOString()) : e.duration || "Pending", u = Array.isArray(e.attempts) && e.attempts.length > 1 ? ` · ${e.attempts.length} attempts` : "", d = c && r === "running" && ["implement", "verification"].includes(e.id) ? `Retry ${l} · ${i}` : c && e.id === "verification" && r === "failed" ? `Failed · remediation ${l}` : r === "failed" ? "Needs attention" : `${i}${u}`;
					return /* @__PURE__ */ (0, U.jsx)("li", {
						...
						children: /* @__PURE__ */ (0, U.jsxs)("button", {
							...
							children: [/* @__PURE__ */ (0, U.jsx)("span", {
								...
								className: "flow-copy",
								children: [/* @__PURE__ */ (0, U.jsx)("strong", { children: ru(e.label) }), /* @__PURE__ */ (0, U.jsx)("span", { children: d })]
							})]
						})
					}, `${e.label}-${t}`);
				})
