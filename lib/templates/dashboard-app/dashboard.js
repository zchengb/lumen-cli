...
//#endregion
//#region package.json
var xl = _(), Sl = "1.24.4", Cl = (...e) => e.filter((e, t, n) => !!e && e.trim() !== "" && n.indexOf(e) === t).join(" ").trim(), wl = (e) => e.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase(), Tl = (e) => e.replace(/^([A-Z])|[\s-_]+(\w)/g, (e, t, n) => n ? n.toUpperCase() : t.toLowerCase()), El = (e) => {
	let t = Tl(e);
			...
			/* @__PURE__ */ (0, H.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, H.jsxs)("header", {
					...
					children: [
						...
						n && i === "delivery" && /* @__PURE__ */ (0, H.jsx)(vu, {
							data: n,
							project: e
						}),
						n && i === "repositories" && /* @__PURE__ */ (0, H.jsx)(Mu, {
							data: n,
							interact: v
						}),
	...
	return /* @__PURE__ */ (0, H.jsxs)(H.Fragment, { children: [
		...
		/* @__PURE__ */ (0, H.jsxs)(cu, {
			...
			children: [/* @__PURE__ */ (0, H.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, H.jsxs)("table", { children: [/* @__PURE__ */ (0, H.jsx)("thead", { children: /* @__PURE__ */ (0, H.jsxs)("tr", { children: [
					...
					/* @__PURE__ */ (0, H.jsx)("td", { children: /* @__PURE__ */ (0, H.jsx)(pu, { run: e }) }),
			...
			}), a.length > 10 && /* @__PURE__ */ (0, H.jsx)(mu, {
				page: u,
		...
		/* @__PURE__ */ (0, H.jsxs)(cu, {
			...
			children: [/* @__PURE__ */ (0, H.jsx)("div", {
				...
				id: "tracked-findings",
				className: "findings",
				children: p.length ? p.map((e) => /* @__PURE__ */ (0, H.jsx)(hu, {
					issue: e,
					onIgnore: () => s(e)
				}, e.id)) : /* @__PURE__ */ (0, H.jsx)(fu, { label: "No findings match this status." })
			})]
		}),
		o && /* @__PURE__ */ (0, H.jsx)(_u, {
			onClose: () => s(null),
			onConfirm: (e) => {
				n("/api/issue/ignore", {
					issue_id: o.id,
...
function mu({ page: e, pageCount: t, onChange: n }) {
...
function hu({ issue: e, onIgnore: t }) {
...
function gu({ label: e, value: t, code: n = !1 }) {
	return /* @__PURE__ */ (0, H.jsxs)("section", {
...
function _u({ onClose: e, onConfirm: t }) {
...
function bu({ stages: e, deliveryStatus: t, startedAt: n, finishedAt: r, onStageClick: i }) {
...
function xu({ stage: e, content: t, error: n, loading: r, onClose: i }) {
	return /* @__PURE__ */ (0, H.jsx)("div", {
		className: "modal-backdrop",
		role: "presentation",
		onMouseDown: i,
			...
			children: [
				...
				/* @__PURE__ */ (0, H.jsx)("footer", {
					...
					children: /* @__PURE__ */ (0, H.jsxs)("button", {
						...
						children: [/* @__PURE__ */ (0, H.jsx)(X, { size: 15 }), "Save repositories"]
					})
				})
			]
		}), l && /* @__PURE__ */ (0, H.jsx)(Nu, {
			onClose: () => u(!1),
			onAdd: (e) => {
...
function Pu({ data: e, project: t, interact: n, notify: r }) {
	...
	}, O = i.configured_integrations || [], te = Array.from(new Set([
		...v,
		f,
		m,
		g
								...
								children: [
									...
									/* @__PURE__ */ (0, H.jsx)(Iu, {
										...
										children: /* @__PURE__ */ (0, H.jsx)("select", {
											...
											children: te.map((e) => /* @__PURE__ */ (0, H.jsx)("option", {
												value: e,
												children: e
											}, e))
										})
				...
				children: /* @__PURE__ */ (0, H.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, H.jsx)("div", {
							...
							children: /* @__PURE__ */ (0, H.jsxs)("button", {
								className: "button primary",
								onClick: () => void n("/api/publish-policy", {
									scan_mode: S,
									delivery_mode: w
								}, "Publish policy saved"),
								children: [/* @__PURE__ */ (0, H.jsx)(X, { size: 15 }), "Save"]
							})
						})
					]
				...
				children: /* @__PURE__ */ (0, H.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, H.jsxs)("div", {
						...
						children: /* @__PURE__ */ (0, H.jsx)("div", {
							...
							children: O.length ? O.map((e) => /* @__PURE__ */ (0, H.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, H.jsxs)("div", { children: [/* @__PURE__ */ (0, H.jsx)(su, {
										label: "Reveal value",
										onClick: () => void ee(e),
