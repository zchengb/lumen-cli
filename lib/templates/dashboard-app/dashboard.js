...
function T_({ data: e, project: t, notify: n, reload: r }) {
	let i = e.patch || {}, a = i.current || {}, o = i.runs || [], s = i.scheduler_activity || [], c = !!a.active || /in_progress|running/i.test(String(a.patch_status || "")), [l, u] = (0, N.useState)(""), [d, f] = (0, N.useState)(""), [p, m] = (0, N.useState)(!1), [h, g] = (0, N.useState)(!1), _ = async (e = String(a.run_id || "")) => {
		m(!0), u(""), f("");
		try {
...
function Y_({ data: e, interact: t }) {
	...
	}, x = (e) => [e.java_version && `Java ${e.java_version}`, e.node_version && `Node ${e.node_version}`].filter(Boolean), S = (e) => {
				...
				children: [
					...
					/* @__PURE__ */ (0, X.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, X.jsxs)("div", {
							...
							children: [ee.map((e) => {
								let t = e.health || {}, n = _(e), r = b(e), i = x(t);
									...
									children: /* @__PURE__ */ (0, X.jsxs)("button", {
										...
										children: [
											...
											/* @__PURE__ */ (0, X.jsxs)("div", {
												...
												}), r.length > 0 && /* @__PURE__ */ (0, X.jsxs)("span", {
													className: "repository-card-attention",
													title: r.join(" · "),
													children: [/* @__PURE__ */ (0, X.jsx)(Bh, {
														size: 12,
														"aria-hidden": "true"
											...
											/* @__PURE__ */ (0, X.jsx)("div", {
												className: "repository-card-runtime",
												children: (i.length ? i : ["Runtime version not detected"]).map((e) => /* @__PURE__ */ (0, X.jsx)("span", { children: e }, e))
											}),
											/* @__PURE__ */ (0, X.jsxs)("div", {
