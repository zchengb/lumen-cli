...
//#endregion
//#region package.json
var Xf = "1.24.36", Zf = (...e) => e.filter((e, t, n) => !!e && e.trim() !== "" && n.indexOf(e) === t).join(" ").trim(), Qf = (e) => e.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase(), $f = (e) => e.replace(/^([A-Z])|[\s-_]+(\w)/g, (e, t, n) => n ? n.toUpperCase() : t.toLowerCase()), ep = (e) => {
	let t = $f(e);
...
function Zp({ business: e, technical: t, compact: n = !1 }) {
		...
		children: /* @__PURE__ */ (0, Y.jsx)(Kl, {
			...
			components: {
				...
				code({ className: e, children: t }) {
					...
					return /language-mermaid/.test(e || "") ? /* @__PURE__ */ (0, Y.jsx)(Qp, { chart: n }) : n.includes("\n") ? /* @__PURE__ */ (0, Y.jsx)("pre", { children: /* @__PURE__ */ (0, Y.jsx)("code", {
						className: e,
						children: n
...
function rm({ value: e, onChange: t }) {
	let { frontmatter: n, body: r } = em(e), i = (0, N.useRef)(null), a = (e) => t(tm(n, e)), o = (e, t = "") => {
		let n = i.current;
		if (!n) {
			a(`${r}${e}text${t}`);
			return;
		}
		let o = nm(r, n.selectionStart, n.selectionEnd, e, t);
	...
	return /* @__PURE__ */ (0, Y.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, Y.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, Y.jsx)($p, { content: r })
			}),
...
function im({ label: e, children: t, onClick: n, danger: r = !1, disabled: i = !1, className: a = "" }) {
...
function am({ title: e, action: t, children: n, className: r = "" }) {
			...
			/* @__PURE__ */ (0, Y.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, Y.jsxs)("header", {
					...
					children: [
						...
						n && i === "scan" && /* @__PURE__ */ (0, Y.jsx)(sm, {
							data: n,
							project: e,
							interact: T
						}),
						n && i === "delivery" && /* @__PURE__ */ (0, Y.jsx)(hm, {
							data: n,
							project: e,
							notify: b,
							reload: x
						}),
						n && i === "observatory" && /* @__PURE__ */ (0, Y.jsx)(ym, {
							project: e,
							notify: b,
							onDirtyChange: y
						}),
						n && i === "repositories" && /* @__PURE__ */ (0, Y.jsx)(Fm, {
							data: n,
							interact: T
						}),
						n && i === "prompts" && /* @__PURE__ */ (0, Y.jsx)(jm, {
							data: n,
							project: e,
							interact: T,
							notify: b
						}),
						n && i === "settings" && /* @__PURE__ */ (0, Y.jsx)(Lm, {
							data: n,
							project: e,
							notify: b,
							onDirtyChange: _,
...
function sm({ data: e, project: t, interact: n }) {
	...
	return /* @__PURE__ */ (0, Y.jsxs)(Y.Fragment, { children: [
		...
		/* @__PURE__ */ (0, Y.jsxs)(am, {
			...
			children: [/* @__PURE__ */ (0, Y.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, Y.jsxs)("table", { children: [/* @__PURE__ */ (0, Y.jsx)("thead", { children: /* @__PURE__ */ (0, Y.jsxs)("tr", { children: [
					...
					/* @__PURE__ */ (0, Y.jsx)("td", { children: /* @__PURE__ */ (0, Y.jsx)(um, { run: e }) }),
			...
			}), a.length > 10 && /* @__PURE__ */ (0, Y.jsx)(dm, {
				page: u,
		...
		/* @__PURE__ */ (0, Y.jsxs)(am, {
			...
			children: [/* @__PURE__ */ (0, Y.jsx)("div", {
				...
				id: "tracked-findings",
				className: "findings",
				children: p.length ? p.map((e) => /* @__PURE__ */ (0, Y.jsx)(fm, {
					issue: e,
					onIgnore: () => s(e)
				}, e.id)) : /* @__PURE__ */ (0, Y.jsx)(lm, { label: "No findings match this status." })
			})]
		}),
		o && /* @__PURE__ */ (0, Y.jsx)(mm, {
			onClose: () => s(null),
			onConfirm: (e) => {
				n("/api/issue/ignore", {
					issue_id: o.id,
...
function cm({ label: e, value: t, onClick: n }) {
	return /* @__PURE__ */ (0, Y.jsxs)("div", {
...
function dm({ page: e, pageCount: t, onChange: n }) {
...
function fm({ issue: e, onIgnore: t }) {
...
function pm({ label: e, value: t, code: n = !1 }) {
	return /* @__PURE__ */ (0, Y.jsxs)("section", {
...
function mm({ onClose: e, onConfirm: t }) {
...
function hm({ data: e, project: t, notify: n, reload: r }) {
	...
	return /* @__PURE__ */ (0, Y.jsxs)(Y.Fragment, { children: [
			...
			children: /* @__PURE__ */ (0, Y.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, Y.jsxs)("table", { children: [/* @__PURE__ */ (0, Y.jsx)("thead", { children: /* @__PURE__ */ (0, Y.jsxs)("tr", { children: [
					...
					return /* @__PURE__ */ (0, Y.jsxs)("tr", { children: [
						...
						/* @__PURE__ */ (0, Y.jsx)("td", { children: /* @__PURE__ */ (0, Y.jsx)(wm, { items: e.pull_requests || [] }) }),
						/* @__PURE__ */ (0, Y.jsx)("td", { children: /* @__PURE__ */ (0, Y.jsx)(Tm, {
							checks: t,
							onClick: () => p(t)
						}) }),
						...
						/* @__PURE__ */ (0, Y.jsx)("td", { children: /* @__PURE__ */ (0, Y.jsx)(im, {
					...
					colSpan: 8,
					children: /* @__PURE__ */ (0, Y.jsx)(lm, { label: "No delivery history yet." })
				}) }) })] })
			})
		}),
		/* @__PURE__ */ (0, Y.jsx)(am, {
			...
			children: /* @__PURE__ */ (0, Y.jsx)("div", {
				...
				}, `${e.at}-${t}`)) : /* @__PURE__ */ (0, Y.jsx)(lm, { label: "No scheduled delivery activity recorded yet." })
			})
		}),
		u && /* @__PURE__ */ (0, Y.jsx)(Sm, {
			stage: u,
			content: m,
			error: g,
			loading: v,
		...
		f && /* @__PURE__ */ (0, Y.jsx)(Em, {
			checks: f,
			onClose: () => p(null)
		}),
		S && /* @__PURE__ */ (0, Y.jsx)(_m, {
...
function gm({ stories: e, value: t, onChange: n, busy: r, error: i, onClose: a, onConfirm: o }) {
	return /* @__PURE__ */ (0, Y.jsx)("div", {
		className: "modal-backdrop",
		role: "presentation",
...
function _m({ story: e, busy: t, error: n, onClose: r, onConfirm: i }) {
	return /* @__PURE__ */ (0, Y.jsx)("div", {
		className: "modal-backdrop",
		role: "presentation",
...
function vm({ run: e, busy: t, onClose: n, onConfirm: r }) {
...
function ym({ project: e, notify: t, onDirtyChange: n }) {
		...
		children: [/* @__PURE__ */ (0, Y.jsxs)("aside", {
			...
			children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
				...
				children: [
					...
					!E && !i.length ? /* @__PURE__ */ (0, Y.jsx)(lm, { label: "No stories found in the docs repository." }) : null,
					i.map((e) => {
						let t = Wp(e.jira_key || e.story), n = Wp(e.title, e.story);
						return /* @__PURE__ */ (0, Y.jsxs)("button", {
			...
			})] }) : /* @__PURE__ */ (0, Y.jsx)(lm, { label: "Select a story to inspect." })
		})]
	});
}
function bm({ jiraKey: e, title: t }) {
	return /* @__PURE__ */ (0, Y.jsx)("span", {
...
function xm({ stages: e, deliveryStatus: t, currentStep: n, startedAt: r, finishedAt: i, remediation: a, now: o, onStageClick: s }) {
...
function Sm({ stage: e, content: t, error: n, loading: r, live: i = !1, onClose: a }) {
...
function Tm({ checks: e, onClick: t }) {
...
function Em({ checks: e, onClose: t }) {
	return /* @__PURE__ */ (0, Y.jsx)("div", {
		className: "modal-backdrop",
		role: "presentation",
		onMouseDown: t,
...
function jm({ data: e, project: t, interact: n, notify: r }) {
			...
			children: /* @__PURE__ */ (0, Y.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, Y.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, Y.jsx)("div", {
						...
						children: w.map((e, t) => {
							let n = _.filter((t) => e.layers.includes(km(t, a))), r = [...e.scripts.map((e) => ({
								kind: "script",
								script: e
							})), ...n.map((e) => ({
								kind: "prompt",
								...
								children: [
									...
									/* @__PURE__ */ (0, Y.jsx)("div", {
										...
										children: r.map((e, n) => {
											...
											let i = e.prompt, a = Om(i), o = a.icon;
											return /* @__PURE__ */ (0, Y.jsxs)("button", {
...
function Mm({ item: e, content: t, onChange: n, onClose: r, onSave: i }) {
	let a = Om(e);
	return /* @__PURE__ */ (0, Y.jsx)("div", {
		className: "modal-backdrop",
		role: "presentation",
				...
				/* @__PURE__ */ (0, Y.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, Y.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, Y.jsxs)("label", {
							...
							children: [/* @__PURE__ */ (0, Y.jsx)("span", { children: "Preview" }), /* @__PURE__ */ (0, Y.jsx)($p, { content: t })]
						})]
					})
				}),
				/* @__PURE__ */ (0, Y.jsxs)("footer", { children: [/* @__PURE__ */ (0, Y.jsx)("button", {
...
function $({ label: e, help: t, children: n }) {
	return /* @__PURE__ */ (0, Y.jsxs)("label", {
		...
		children: [/* @__PURE__ */ (0, Y.jsxs)("span", {
			...
			children: [e, t && /* @__PURE__ */ (0, Y.jsx)(Nm, { children: t })]
		}), n]
	});
}
function Pm({ runtime: e, onChange: t }) {
...
function Lm({ data: e, project: t, notify: n, onDirtyChange: r, reload: i }) {
				...
				children: /* @__PURE__ */ (0, Y.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
						...
						children: /* @__PURE__ */ (0, Y.jsx)("div", {
							...
							children: me.length ? me.map((e) => {
								...
								return /* @__PURE__ */ (0, Y.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, Y.jsxs)("div", { children: [/* @__PURE__ */ (0, Y.jsx)(im, {
											label: "Reveal value",
											onClick: () => void fe(e),
							...
							}) : /* @__PURE__ */ (0, Y.jsx)(lm, { label: "No local integration keys configured." })
						})
					})]
				})
			}),
...
function Rm({ enabled: e, onChange: t }) {
	return /* @__PURE__ */ (0, Y.jsxs)("label", {
...
(0, ut.createRoot)(document.getElementById("root")).render(/* @__PURE__ */ (0, Y.jsx)(om, {}));
//#endregion
