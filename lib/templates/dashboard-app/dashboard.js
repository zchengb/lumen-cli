...
function fc(e, t, n) {
	...
	function D(t) {
		return t === 45 && i === 2 ? (e.consume(t), re) : t === 60 && i === 1 ? (e.consume(t), k) : t === 62 && i === 4 ? (e.consume(t), oe) : t === 63 && i === 3 ? (e.consume(t), ae) : t === 93 && i === 5 ? (e.consume(t), ie) : V(t) && (i === 6 || i === 7) ? (e.exit("htmlFlowData"), e.check(lc, se, O)(t)) : t === null || V(t) ? (e.exit("htmlFlowData"), O(t)) : (e.consume(t), D);
	}
	function O(t) {
		return e.check(uc, te, se)(t);
	}
	function te(t) {
...
function gc(e, t, n) {
	...
	function C(t) {
		return V(t) ? (o = C, k(t)) : U(t) ? (e.consume(t), C) : re(t);
	}
	function w(t) {
		return t === 45 || Ko(t) ? (e.consume(t), w) : t === 47 || t === 62 || H(t) ? T(t) : n(t);
	}
	function T(t) {
		return t === 47 ? (e.consume(t), re) : t === 58 || t === 95 || Go(t) ? (e.consume(t), E) : V(t) ? (o = T, k(t)) : U(t) ? (e.consume(t), T) : re(t);
	}
	function E(t) {
	...
	function D(t) {
		return t === null || t === 60 || t === 61 || t === 62 || t === 96 ? n(t) : t === 34 || t === 39 ? (e.consume(t), i = t, O) : V(t) ? (o = D, k(t)) : U(t) ? (e.consume(t), D) : (e.consume(t), te);
	}
	function O(t) {
		return t === i ? (e.consume(t), i = void 0, ne) : t === null ? n(t) : V(t) ? (o = O, k(t)) : (e.consume(t), O);
	}
	function te(t) {
		return t === null || t === 34 || t === 39 || t === 60 || t === 61 || t === 96 ? n(t) : t === 47 || t === 62 || H(t) ? T(t) : (e.consume(t), te);
	}
	function ne(e) {
...
//#endregion
//#region package.json
var wh = "2.2.0", Th = (...e) => e.filter((e, t, n) => !!e && e.trim() !== "" && n.indexOf(e) === t).join(" ").trim(), Eh = (e) => e.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase(), Dh = (e) => e.replace(/^([A-Z])|[\s-_]+(\w)/g, (e, t, n) => n ? n.toUpperCase() : t.toLowerCase()), Oh = (e) => {
	let t = Dh(e);
...
var Kg = (0, M.memo)(function({ chart: e }) {
...
function s_({ value: e, onChange: t }) {
	let { frontmatter: n, body: r } = Zg(e), i = (0, M.useRef)(null), a = (0, M.useRef)(!1), o = (0, M.useRef)(!1), s = (0, M.useRef)(r), c = (0, M.useRef)(n_()), [l, u] = (0, M.useState)(null), [d, f] = (0, M.useState)(!1);
	s.current = r;
	let p = (e) => t(Qg(n, e)), m = () => {
		let e = i.current;
		if (!e) return;
...
function u_() {
	...
	}, D = n?.interactive?.projects || [], O = n?.product?.tagline || "Engineering, made legible.", te = kg[i];
				...
				children: [
					/* @__PURE__ */ (0, X.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, X.jsx)("img", {
							...
							children: [/* @__PURE__ */ (0, X.jsx)("strong", { children: "Lumen" }), /* @__PURE__ */ (0, X.jsx)("span", { children: O })]
						})]
					}),
						...
						children: [/* @__PURE__ */ (0, X.jsx)("span", {
							...
							children: [
								...
								/* @__PURE__ */ (0, X.jsx)("select", {
									...
									children: D.map((e) => /* @__PURE__ */ (0, X.jsx)("option", {
										value: e.slug,
										children: e.name
									}, e.slug))
								}),
...
function w_({ data: e, project: t, notify: n, reload: r }) {
	let i = e.delivery || {}, a = i.current || {}, o = i.runs || [], s = a.stages || [], c = i.scheduler_activity || [], l = i.available_stories || [], [u, d] = (0, M.useState)(null), [f, p] = (0, M.useState)(null), [m, h] = (0, M.useState)(""), [g, _] = (0, M.useState)(""), [v, y] = (0, M.useState)(!1), [b, x] = (0, M.useState)(!1), [S, C] = (0, M.useState)(!1), [w, T] = (0, M.useState)(!1), [E, ee] = (0, M.useState)(""), [D, O] = (0, M.useState)(0), [te, ne] = (0, M.useState)(""), [re, k] = (0, M.useState)(!1), [A, ie] = (0, M.useState)(""), [ae, oe] = (0, M.useState)(null), [se, ce] = (0, M.useState)(""), [j, le] = (0, M.useState)(Date.now()), ue = /in_progress|running/i.test(String(a.delivery_status || "")), de = f_(l, a), fe = (0, M.useCallback)(async (e = a.run_id || "", n = !1) => {
		n || y(!0);
		try {
			...
			children: [
				/* @__PURE__ */ (0, X.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, X.jsx)(P_, {
							label: "Elapsed",
							value: Fg(a.started_at, a.finished_at || (ue ? new Date(j).toISOString() : void 0))
						}),
						/* @__PURE__ */ (0, X.jsx)(P_, {
							label: "Finished",
							value: ue ? "Running" : Pg(a.finished_at)
						})
					]
				}),
	...
	return /* @__PURE__ */ (0, X.jsxs)(X.Fragment, { children: [
		/* @__PURE__ */ (0, X.jsxs)("section", {
			...
			children: [
				...
				/* @__PURE__ */ (0, X.jsx)(__, {
					label: "Status",
					value: Lg(a.patch_status || "not started")
				}),
				/* @__PURE__ */ (0, X.jsx)(__, {
					label: "Recent runs",
					value: o.length
			...
			children: [/* @__PURE__ */ (0, X.jsx)(l_, {
				...
				children: /* @__PURE__ */ (0, X.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, X.jsxs)("div", {
							className: "info-row",
							children: [/* @__PURE__ */ (0, X.jsx)("span", { children: "Self-checks" }), /* @__PURE__ */ (0, X.jsx)("div", { children: b.length ? `${b.filter((e) => e.status === "passed").length}/${b.length} passed` : "—" })]
						}),
						/* @__PURE__ */ (0, X.jsxs)("div", {
							className: "info-row",
		...
		/* @__PURE__ */ (0, X.jsx)(l_, {
			...
			children: /* @__PURE__ */ (0, X.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, X.jsxs)("table", { children: [/* @__PURE__ */ (0, X.jsx)("thead", { children: /* @__PURE__ */ (0, X.jsxs)("tr", { children: [
					...
					/* @__PURE__ */ (0, X.jsx)("th", { children: "Self-check" }),
					/* @__PURE__ */ (0, X.jsx)("th", { children: "Finished" }),
					/* @__PURE__ */ (0, X.jsx)("th", { children: "Log" })
				] }) }), /* @__PURE__ */ (0, X.jsx)("tbody", { children: o.length ? o.map((e) => /* @__PURE__ */ (0, X.jsxs)("tr", { children: [
					/* @__PURE__ */ (0, X.jsx)("td", { children: /* @__PURE__ */ (0, X.jsx)("code", { children: $(e.jira_key) }) }),
					/* @__PURE__ */ (0, X.jsx)("td", { children: $(e.summary) }),
					/* @__PURE__ */ (0, X.jsx)("td", { children: /* @__PURE__ */ (0, X.jsx)(zg, { value: e.status }) }),
					/* @__PURE__ */ (0, X.jsx)("td", { children: (e.repositories || []).map((e) => e.name).filter(Boolean).join(", ") || "—" }),
					/* @__PURE__ */ (0, X.jsx)("td", { children: (e.self_checks || []).length ? `${(e.self_checks || []).filter((e) => e.status === "passed").length}/${(e.self_checks || []).length}` : "—" }),
					/* @__PURE__ */ (0, X.jsx)("td", { children: Pg(e.finished_at) }),
...
function k_({ run: e, busy: t, onClose: n, onConfirm: r }) {
	let i = $(e.jira_key || e.story || e.run_id);
	return /* @__PURE__ */ (0, X.jsx)("div", {
		className: "modal-backdrop",
		role: "presentation",
		...
		children: /* @__PURE__ */ (0, X.jsxs)("section", {
			...
			children: [/* @__PURE__ */ (0, X.jsxs)("div", {
				...
				disabled: t,
				onClick: r,
				children: [/* @__PURE__ */ (0, X.jsx)(hg, { size: 14 }), t ? "Deleting…" : "Delete record"]
			})] })]
		})
	});
}
function A_({ project: e, notify: t, onDirtyChange: n }) {
	let r = new URLSearchParams(window.location.search).get("story") || "", [i, a] = (0, M.useState)([]), [o, s] = (0, M.useState)(r), [c, l] = (0, M.useState)(""), [u, d] = (0, M.useState)(""), [f, p] = (0, M.useState)(""), [m, h] = (0, M.useState)(""), [g, _] = (0, M.useState)(""), [v, y] = (0, M.useState)(""), [b, x] = (0, M.useState)(""), [S, C] = (0, M.useState)({
		story: "",
		plan: ""
	}), [w, T] = (0, M.useState)("story"), [E, ee] = (0, M.useState)(!0), [D, O] = (0, M.useState)(!1), [te, ne] = (0, M.useState)(!1), [re, k] = (0, M.useState)(""), [A, ie] = (0, M.useState)(!1), [ae, oe] = (0, M.useState)(!1), [se, ce] = (0, M.useState)(0), [j, le] = (0, M.useState)(""), [ue, de] = (0, M.useState)(!1), [fe, pe] = (0, M.useState)(""), me = v !== S.story || b !== S.plan, he = f_(i.filter(p_)), ge = he.length > 0;
	(0, M.useEffect)(() => {
		n(me);
	}, [me, n]), (0, M.useEffect)(() => {
		let e = (e) => {
				...
				children: [
					...
					/* @__PURE__ */ (0, X.jsxs)("div", {
						...
						children: [
							...
							!E && !Te.length ? /* @__PURE__ */ (0, X.jsx)(v_, { label: i.length ? "No stories match this filter." : "No stories found in the docs repository." }) : null,
							Te.map((e) => {
				...
				children: o ? /* @__PURE__ */ (0, X.jsxs)(X.Fragment, { children: [/* @__PURE__ */ (0, X.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, X.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, X.jsx)("h2", { children: f ? /* @__PURE__ */ (0, X.jsxs)("a", {
							...
							children: [ge && /* @__PURE__ */ (0, X.jsxs)("button", {
								type: "button",
								className: "button secondary",
								disabled: ue || D,
								onClick: be,
								...
								disabled: !me || te || D,
								onClick: () => void Se(),
								children: [/* @__PURE__ */ (0, X.jsx)(cg, { size: 14 }), te ? "Saving…" : "Save"]
							})]
						})]
					}), /* @__PURE__ */ (0, X.jsx)("div", {
	...
	return /* @__PURE__ */ (0, X.jsxs)(X.Fragment, { children: [
		...
		/* @__PURE__ */ (0, X.jsx)(l_, {
			...
			action: /* @__PURE__ */ (0, X.jsx)(c_, {
				...
				onClick: () => m((e) => !e),
				children: p ? /* @__PURE__ */ (0, X.jsx)(ag, { size: 14 }) : /* @__PURE__ */ (0, X.jsx)(ig, { size: 14 })
			}),
			...
			children: /* @__PURE__ */ (0, X.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, X.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, X.jsx)("div", {
						...
						children: w.map((e, t) => {
							let n = _.filter((t) => e.layers.includes(B_(t, a))), r = [...e.scripts.map((e) => ({
								kind: "script",
								script: e
							})), ...n.map((e) => ({
								kind: "prompt",
...
function U_({ item: e, content: t, onChange: n, onClose: r, onSave: i }) {
	let a = z_(e);
	return /* @__PURE__ */ (0, X.jsx)("div", {
		className: "modal-backdrop",
		role: "presentation",
		...
		children: /* @__PURE__ */ (0, X.jsxs)("section", {
			...
			children: [
				...
				/* @__PURE__ */ (0, X.jsxs)("footer", { children: [/* @__PURE__ */ (0, X.jsx)("button", {
					...
					className: "button primary",
					onClick: i,
					children: [/* @__PURE__ */ (0, X.jsx)(cg, { size: 14 }), "Save prompt"]
				})] })
			]
		})
	});
...
function q_({ label: e, value: t, onChange: n, markDirty: r }) {
	let i = Ng(t), a = Ag.some((e) => e.value === i), [o, s] = (0, M.useState)(!1), c = () => s(!0);
...
function Y_({ data: e, interact: t }) {
	let n = e.interactive?.workspace || {}, [r, i] = (0, M.useState)(n.repositories || []), [a, o] = (0, M.useState)(null), [s, c] = (0, M.useState)(!1), [l, u] = (0, M.useState)("all");
	(0, M.useEffect)(() => i(n.repositories || []), [n.repositories]);
	let d = (e, t) => i((n) => n.map((n, r) => r === e ? {
		...n,
		...t
	} : n)), f = (e) => (e.delivery_steps || []).map((e) => Array.isArray(e.command) ? e.command.join(" ") : "").filter(Boolean).join("\n"), p = (e) => ({
		scan: {
			allow_auto_fix: e.automation?.scan?.allow_auto_fix ?? e.allow_auto_fix !== !1,
			allow_pr: e.automation?.scan?.allow_pr ?? e.allow_pr !== !1
		},
		delivery: { enabled: e.automation?.delivery?.enabled !== !1 },
		patch: { enabled: e.automation?.patch?.enabled === !0 }
	}), m = (e, t, n) => i((r) => r.map((r, i) => i === e ? {
		...r,
		automation: {
			...p(r),
			[t]: {
		...
		"behind",
		"diverged"
	].includes(String(e.health?.git_status)) || ["behind", "diverged"].includes(String(e.health?.sync_status))).length, g = r.filter((e) => p(e).patch.enabled).length, _ = r.filter((e) => l === "all" || l === "patch" && p(e).patch.enabled || l === "attention" && ([
		"changes",
		"behind",
		"diverged"
	].includes(String(e.health?.git_status)) || ["behind", "diverged"].includes(String(e.health?.sync_status))));
	return /* @__PURE__ */ (0, X.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, X.jsxs)(l_, {
			...
			children: [
				...
				/* @__PURE__ */ (0, X.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, X.jsx)(P_, {
							label: "Auto Patch authorized",
							value: g
						}),
						/* @__PURE__ */ (0, X.jsx)(P_, {
							label: "Frontend delivery",
							value: "Disabled globally"
						})
					]
				}),
				/* @__PURE__ */ (0, X.jsxs)("div", {
				...
				/* @__PURE__ */ (0, X.jsxs)("div", {
					...
					children: [_.map((e) => {
						let t = r.indexOf(e), n = e.health || {}, i = p(e), s = a === e.name;
						return /* @__PURE__ */ (0, X.jsxs)("article", {
							className: "repository-row",
							children: [/* @__PURE__ */ (0, X.jsxs)("button", {
								className: "repository-summary",
								onClick: () => o(s ? null : e.name),
								children: [/* @__PURE__ */ (0, X.jsxs)("div", { children: [/* @__PURE__ */ (0, X.jsx)("strong", { children: e.name || "Unnamed repository" }), /* @__PURE__ */ (0, X.jsxs)("span", { children: [
									n.language || "Generic",
									" · ",
									n.build_tools?.join(", ") || "No build tool detected"
								] })] }), /* @__PURE__ */ (0, X.jsxs)("span", {
									className: "repository-summary-state",
									children: [/* @__PURE__ */ (0, X.jsx)(zg, { value: n.git_status || "unknown" }), /* @__PURE__ */ (0, X.jsx)("code", { children: e.default_branch || "main" })]
								})]
								...
								children: [
										...
										children: [
											...
											/* @__PURE__ */ (0, X.jsxs)("div", {
												...
												children: [
													/* @__PURE__ */ (0, X.jsx)(P_, {
														label: "Local path",
														value: /* @__PURE__ */ (0, X.jsx)("code", { children: e.path })
													}),
													/* @__PURE__ */ (0, X.jsx)(P_, {
														label: "Remote",
														value: /* @__PURE__ */ (0, X.jsx)("code", { children: n.remote_url || e.remote_url || "Not configured" })
													}),
													/* @__PURE__ */ (0, X.jsx)(P_, {
														label: "Git status",
														value: /* @__PURE__ */ (0, X.jsx)(zg, { value: n.git_status || "unknown" })
													}),
													/* @__PURE__ */ (0, X.jsx)(P_, {
														label: "Branch sync",
														value: /* @__PURE__ */ (0, X.jsx)(zg, { value: n.sync_status || "unknown" })
													})
												]
											}),
											/* @__PURE__ */ (0, X.jsx)("div", {
									...
									/* @__PURE__ */ (0, X.jsxs)("section", {
										...
										children: [/* @__PURE__ */ (0, X.jsxs)("div", { children: [/* @__PURE__ */ (0, X.jsx)("strong", { children: "Runtime & build" }), /* @__PURE__ */ (0, X.jsx)("span", { children: "Detected from repository files. These values are read-only until the repository changes." })] }), /* @__PURE__ */ (0, X.jsxs)("div", {
											...
											children: [
												/* @__PURE__ */ (0, X.jsx)(P_, {
													label: "Language",
													value: n.language || "Generic"
												}),
												/* @__PURE__ */ (0, X.jsx)(P_, {
													label: "Java",
													value: n.java_version ? `Java ${n.java_version}` : "Not detected"
												}),
												/* @__PURE__ */ (0, X.jsx)(P_, {
													label: "Node",
													value: n.node_version ? `Node ${n.node_version}` : "Not detected"
												}),
												/* @__PURE__ */ (0, X.jsx)(P_, {
													label: "Build tools",
													value: n.build_tools?.join(", ") || "Not detected"
												})
											]
										})]
									}),
									/* @__PURE__ */ (0, X.jsxs)("section", {
										className: "repository-section",
										children: [
											/* @__PURE__ */ (0, X.jsxs)("div", { children: [/* @__PURE__ */ (0, X.jsx)("strong", { children: "Automation permissions" }), /* @__PURE__ */ (0, X.jsx)("span", { children: "Each permission is enforced by its own runtime. Auto Patch is disabled by default." })] }),
											/* @__PURE__ */ (0, X.jsxs)("div", {
												className: "repository-policy-grid",
												children: [
													/* @__PURE__ */ (0, X.jsxs)("label", { children: [/* @__PURE__ */ (0, X.jsx)("input", {
														type: "checkbox",
														checked: i.scan.allow_auto_fix,
														onChange: (e) => m(t, "scan", { allow_auto_fix: e.target.checked })
													}), /* @__PURE__ */ (0, X.jsxs)("span", { children: [/* @__PURE__ */ (0, X.jsx)("strong", { children: "Auto Scan fixes" }), /* @__PURE__ */ (0, X.jsx)("small", { children: "Allow high-confidence Scan fixes in this repository." })] })] }),
													/* @__PURE__ */ (0, X.jsxs)("label", { children: [/* @__PURE__ */ (0, X.jsx)("input", {
														type: "checkbox",
														checked: i.scan.allow_pr,
														onChange: (e) => m(t, "scan", { allow_pr: e.target.checked })
													}), /* @__PURE__ */ (0, X.jsxs)("span", { children: [/* @__PURE__ */ (0, X.jsx)("strong", { children: "Auto Scan pull requests" }), /* @__PURE__ */ (0, X.jsx)("small", { children: "Allow Scan fixes to be published as pull requests." })] })] }),
													/* @__PURE__ */ (0, X.jsxs)("label", { children: [/* @__PURE__ */ (0, X.jsx)("input", {
														type: "checkbox",
														checked: i.delivery.enabled,
														onChange: (e) => m(t, "delivery", { enabled: e.target.checked })
													...
													/* @__PURE__ */ (0, X.jsxs)("label", { children: [/* @__PURE__ */ (0, X.jsx)("input", {
														type: "checkbox",
														checked: i.patch.enabled,
														onChange: (e) => m(t, "patch", { enabled: e.target.checked })
									...
									/* @__PURE__ */ (0, X.jsxs)("section", {
										className: "repository-section",
										children: [
											/* @__PURE__ */ (0, X.jsxs)("div", { children: [/* @__PURE__ */ (0, X.jsx)("strong", { children: "Delivery verification" }), /* @__PURE__ */ (0, X.jsx)("span", { children: "Suggested commands are detected from the build. Saving confirms the commands that Auto Delivery will actually run." })] }),
											n.suggested_commands?.length > 0 && /* @__PURE__ */ (0, X.jsxs)("button", {
												className: "text-button",
												onClick: () => d(t, { delivery_commands: n.suggested_commands.join("\n") }),
												children: [
													"Use ",
													n.suggested_commands.length,
													" suggested command",
													n.suggested_commands.length === 1 ? "" : "s"
												]
											}),
											/* @__PURE__ */ (0, X.jsx)("label", {
												...
												children: /* @__PURE__ */ (0, X.jsx)("textarea", {
													...
													rows: 4,
													placeholder: "No command confirmed. Add one command per line.",
					...
					}), _.length === 0 && /* @__PURE__ */ (0, X.jsx)(v_, { label: "No repositories match this view." })]
				}),
				/* @__PURE__ */ (0, X.jsx)("footer", {
					className: "repository-footer",
					children: /* @__PURE__ */ (0, X.jsxs)("button", {
						className: "button primary",
						onClick: () => void t("/api/repositories", { repositories: r }, "Repository governance saved"),
						children: [/* @__PURE__ */ (0, X.jsx)(cg, { size: 15 }), "Save governance"]
					})
				})
			]
			...
			onClose: () => c(!1),
			onAdd: (e) => {
				t("/api/repositories/clone", { url: e }, "Repository cloned and registered"), c(!1);
			}
		})]
	});
}
	...
	return /* @__PURE__ */ (0, X.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, X.jsxs)("section", {
			...
			children: [
				/* @__PURE__ */ (0, X.jsx)("div", {
					className: "prompt-inspector-header",
					children: /* @__PURE__ */ (0, X.jsxs)("div", { children: [/* @__PURE__ */ (0, X.jsx)("strong", { children: "Add repository" }), /* @__PURE__ */ (0, X.jsx)("span", { children: "Lumen clones the Git URL, detects the branch and tooling, enables existing Scan and Delivery behavior, and leaves Auto Patch off for your approval." })] })
				}),
				/* @__PURE__ */ (0, X.jsx)("div", {
	...
	let De = async (e) => {
		...
		try {
			...
			await Promise.all([
				...
				...Object.entries(he).map(([e, n]) => Rg("/api/integration", t, {
					method: "POST",
					json: {
						key: e,
						value: n
		...
		children: [
									...
									children: [
										...
										/* @__PURE__ */ (0, X.jsx)(G_, {
											...
											children: /* @__PURE__ */ (0, X.jsx)("select", {
												...
												children: je.map((e) => /* @__PURE__ */ (0, X.jsx)("option", {
													value: e,
													children: e
												}, e))
											})
										...
										/* @__PURE__ */ (0, X.jsx)(G_, {
											...
											children: /* @__PURE__ */ (0, X.jsx)("select", {
												...
												children: Array.from(/* @__PURE__ */ new Set([...je, "Block"])).map((e) => /* @__PURE__ */ (0, X.jsx)("option", {
													value: e,
													children: e
												}, e))
											})
					...
					/* @__PURE__ */ (0, X.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, X.jsxs)("div", {
								...
								}), /* @__PURE__ */ (0, X.jsx)("p", { children: ie ? `Polling every ${T} minute(s) for Task and Bug cards.` : "Auto Patch polling is paused." })]
							}),
							/* @__PURE__ */ (0, X.jsxs)("div", {
								className: "settings-control wide",
								children: [/* @__PURE__ */ (0, X.jsxs)("div", {
								...
								return /* @__PURE__ */ (0, X.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, X.jsxs)("div", { children: [/* @__PURE__ */ (0, X.jsx)(c_, {
											label: "Reveal value",
											onClick: () => void Oe(e),
											children: pe[e] ? /* @__PURE__ */ (0, X.jsx)(qh, { size: 15 }) : /* @__PURE__ */ (0, X.jsx)(Jh, { size: 15 })
										}), /* @__PURE__ */ (0, X.jsx)(c_, {
											label: "Copy value",
											onClick: () => void ke(e),
			...
			/* @__PURE__ */ (0, X.jsxs)("footer", {
				...
				children: [/* @__PURE__ */ (0, X.jsx)("span", {
					...
					disabled: !Te,
					onClick: () => void Me(),
					children: [/* @__PURE__ */ (0, X.jsx)(cg, { size: 15 }), "Save changes"]
				})]
			})
		]
	});
