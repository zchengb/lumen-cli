...
//#endregion
//#region package.json
var wh = "2.2.3", Th = (...e) => e.filter((e, t, n) => !!e && e.trim() !== "" && n.indexOf(e) === t).join(" ").trim(), Eh = (e) => e.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase(), Dh = (e) => e.replace(/^([A-Z])|[\s-_]+(\w)/g, (e, t, n) => n ? n.toUpperCase() : t.toLowerCase()), Oh = (e) => {
	let t = Dh(e);
	...
	let w = () => !(g && !window.confirm("You have unsaved Settings changes. Leave without saving?") || v && !window.confirm("You have unsaved Observatory changes. Leave without saving?")), T = (n) => {
		...
		try {
			return await Rg(t, e, {
				method: "POST",
				json: n
			}), S(r, "success"), await C(), !0;
		} catch (e) {
			return S(e instanceof Error ? e.message : "Request failed", "error"), !1;
		}
...
function Y_({ data: e, interact: t }) {
	let n = e.interactive?.workspace || {}, [r, i] = (0, M.useState)(n.repositories || []), [a, o] = (0, M.useState)(!1), [s, c] = (0, M.useState)(null), [l, u] = (0, M.useState)(!1), [d, f] = (0, M.useState)("all");
	(0, M.useEffect)(() => {
		a || i(n.repositories || []);
	}, [n.repositories, a]);
	let p = (e, t) => {
	...
	}, m = (e) => (e.delivery_steps || []).map((e) => Array.isArray(e.command) ? e.command.join(" ") : "").filter(Boolean).join("\n"), h = (e) => ({
		...
		"behind",
		"diverged"
	].includes(String(e.health?.git_status)) || ["behind", "diverged"].includes(String(e.health?.sync_status))).length, y = r.filter((e) => h(e).patch.enabled).length, b = r.filter((e) => d === "all" || d === "patch" && h(e).patch.enabled || d === "attention" && ([
		"changes",
		"behind",
		"diverged"
		...
		children: [/* @__PURE__ */ (0, X.jsxs)(l_, {
			...
			children: [
				...
				/* @__PURE__ */ (0, X.jsxs)("div", {
					...
					children: [b.map((e) => {
						let t = r.indexOf(e), n = e.health || {}, i = h(e), a = s === e.name;
						return /* @__PURE__ */ (0, X.jsxs)("article", {
											...
											/* @__PURE__ */ (0, X.jsx)("div", {
												...
												children: /* @__PURE__ */ (0, X.jsx)(G_, {
													...
													children: /* @__PURE__ */ (0, X.jsx)("select", {
														...
														onChange: (e) => p(t, { default_branch: e.target.value }),
											...
											/* @__PURE__ */ (0, X.jsxs)("div", {
												...
												children: [
													/* @__PURE__ */ (0, X.jsxs)("label", { children: [/* @__PURE__ */ (0, X.jsx)("input", {
														...
														onChange: (e) => g(t, "scan", { allow_auto_fix: e.target.checked })
													...
													/* @__PURE__ */ (0, X.jsxs)("label", { children: [/* @__PURE__ */ (0, X.jsx)("input", {
														...
														onChange: (e) => g(t, "delivery", { enabled: e.target.checked })
													...
													/* @__PURE__ */ (0, X.jsxs)("label", { children: [/* @__PURE__ */ (0, X.jsx)("input", {
														...
														onChange: (e) => g(t, "patch", { enabled: e.target.checked })
									...
									/* @__PURE__ */ (0, X.jsxs)("section", {
										...
										children: [
											...
											n.suggested_commands?.length > 0 && /* @__PURE__ */ (0, X.jsxs)("button", {
												className: "text-button",
												onClick: () => p(t, { delivery_commands: n.suggested_commands.join("\n") }),
												children: [
													"Use ",
											...
											/* @__PURE__ */ (0, X.jsx)("label", {
												...
												children: /* @__PURE__ */ (0, X.jsx)("textarea", {
													value: e.delivery_commands ?? m(e),
													rows: 4,
													placeholder: "Optional override; one command per line.",
													onChange: (e) => p(t, { delivery_commands: e.target.value })
												})
											})
										]
									})
					...
					}), b.length === 0 && /* @__PURE__ */ (0, X.jsx)(v_, { label: "No repositories match this view." })]
				}),
				/* @__PURE__ */ (0, X.jsxs)("footer", {
					className: "repository-footer",
					children: [/* @__PURE__ */ (0, X.jsx)("span", {
						className: a ? "settings-save-status unsaved" : "settings-save-status",
						children: a ? "Unsaved repository changes" : "All changes saved"
					}), /* @__PURE__ */ (0, X.jsxs)("button", {
						className: "button primary",
						onClick: () => void _(),
						children: [/* @__PURE__ */ (0, X.jsx)(cg, { size: 15 }), "Save"]
					})]
				})
			]
