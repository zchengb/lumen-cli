...
function y_({ data: e, project: t, notify: n, reload: r }) {
	let i = e.delivery || {}, a = i.current || {}, o = i.runs || [], s = a.stages || [], c = i.scheduler_activity || [], l = i.available_stories || [], [u, d] = (0, M.useState)(null), [f, p] = (0, M.useState)(null), [m, h] = (0, M.useState)(""), [g, _] = (0, M.useState)(""), [v, y] = (0, M.useState)(!1), [b, x] = (0, M.useState)(!1), [S, C] = (0, M.useState)(!1), [w, T] = (0, M.useState)(!1), [E, ee] = (0, M.useState)(""), [D, te] = (0, M.useState)(0), [ne, re] = (0, M.useState)(""), [ie, O] = (0, M.useState)(!1), [k, ae] = (0, M.useState)(""), [oe, se] = (0, M.useState)(null), [ce, le] = (0, M.useState)(""), [A, ue] = (0, M.useState)(Date.now()), de = /in_progress|running/i.test(String(a.delivery_status || "")), j = s_(l, a), fe = (0, M.useCallback)(async (e = a.run_id || "", n = !1) => {
		n || y(!0);
		try {
...
function b_({ stories: e, value: t, onChange: n, step: r, busy: i, error: a, onClose: o, onContinue: s, onConfirm: c }) {
...
function C_({ project: e, notify: t, onDirtyChange: n }) {
	let r = new URLSearchParams(window.location.search).get("story") || "", [i, a] = (0, M.useState)([]), [o, s] = (0, M.useState)(r), [c, l] = (0, M.useState)(""), [u, d] = (0, M.useState)(""), [f, p] = (0, M.useState)(""), [m, h] = (0, M.useState)(""), [g, _] = (0, M.useState)(""), [v, y] = (0, M.useState)(""), [b, x] = (0, M.useState)(""), [S, C] = (0, M.useState)({
		story: "",
		plan: ""
	}), [w, T] = (0, M.useState)("story"), [E, ee] = (0, M.useState)(!0), [D, te] = (0, M.useState)(!1), [ne, re] = (0, M.useState)(!1), [ie, O] = (0, M.useState)(""), [k, ae] = (0, M.useState)(!1), [oe, se] = (0, M.useState)(!1), [ce, le] = (0, M.useState)(0), [A, ue] = (0, M.useState)(""), [de, j] = (0, M.useState)(!1), [fe, pe] = (0, M.useState)(""), me = v !== S.story || b !== S.plan, he = s_(i.filter(c_)), ge = he.length > 0;
	(0, M.useEffect)(() => {
		n(me);
	}, [me, n]), (0, M.useEffect)(() => {
		let e = (e) => {
