...
function d_() {
	let [e, t] = (0, F.useState)(new URLSearchParams(window.location.search).get("project") || window.DASHBOARD_DATA?.interactive?.project || ""), [n, r] = (0, F.useState)(null), [i, a] = (0, F.useState)(kg.find((e) => `/${e.id}` === window.location.pathname)?.id || "scan"), [o, s] = (0, F.useState)(""), [c, l] = (0, F.useState)(null), [u, d] = (0, F.useState)(!0), [f, p] = (0, F.useState)(() => window.localStorage.getItem("lumen-sidebar-collapsed") === "true"), [m, h] = (0, F.useState)(null), [g, _] = (0, F.useState)(!1), [v, y] = (0, F.useState)(!1), [b, x] = (0, F.useState)(null), S = (0, F.useRef)(0), C = (0, F.useRef)(!1), w = (0, F.useCallback)((e, t = "info") => l({
		message: e,
		tone: t
	}), []), T = async () => {
		let n = ++S.current;
	...
	}, k = n?.interactive?.projects || [], A = n?.product?.tagline || "Engineering, made legible.", j = Ag[i];
...
function Q_({ data: e, project: t, notify: n, onDirtyChange: r, reload: i }) {
	let a = e.interactive?.workspace || {}, o = e.interactive?.schedules || {}, s = e.interactive?.agents || {}, [c, l] = (0, F.useState)(String(a.scan_window_days || 7)), [u, d] = (0, F.useState)(String(o.scan?.cron || "0 12 * * 1-5")), [f, p] = (0, F.useState)(!!o.scan), [m, h] = (0, F.useState)(String(Math.round((o.delivery?.interval_seconds || 300) / 60))), [g, _] = (0, F.useState)(Array.isArray(o.delivery?.jira_statuses) ? o.delivery.jira_statuses.map(String) : String(o.delivery?.jira_status || "To Do,Backlog,In Progress").split(",").map((e) => e.trim()).filter(Boolean)), [v, y] = (0, F.useState)(String(o.delivery?.in_dev_status || "")), [b, x] = (0, F.useState)(String(o.delivery?.dev_done_status || "")), [S, C] = (0, F.useState)(String(o.delivery?.blocked_status || "Block")), [w, T] = (0, F.useState)(!!o.delivery?.enabled), [E, ee] = (0, F.useState)(String(Math.round((o.patch?.interval_seconds || 300) / 60))), [D, O] = (0, F.useState)(Array.isArray(o.patch?.jira_statuses) ? o.patch.jira_statuses.map(String) : ["To Do"]), [k, A] = (0, F.useState)(String(o.patch?.in_progress_status || "In Progress")), [j, M] = (0, F.useState)(String(o.patch?.done_status || "Done")), [N, te] = (0, F.useState)(String(o.patch?.blocked_status || "Block")), [ne, re] = (0, F.useState)(!!o.patch?.enabled), [ie, ae] = (0, F.useState)(Ng(a.models?.scan)), [P, oe] = (0, F.useState)(Ng(a.models?.delivery)), [se, ce] = (0, F.useState)(Ng(a.models?.patch)), [le, ue] = (0, F.useState)([]), [de, fe] = (0, F.useState)({}), [pe, me] = (0, F.useState)({}), [he, ge] = (0, F.useState)(String(a.publish?.scan || "pr")), [_e, ve] = (0, F.useState)(String(a.publish?.delivery || "pr")), [ye, be] = (0, F.useState)(String(a.publish?.patch || "pr")), [xe, Se] = (0, F.useState)(a.feishu_notifications_enabled !== !1), [I, Ce] = (0, F.useState)(!!s.enabled), [we, Te] = (0, F.useState)(Array.isArray(s.agents) ? s.agents.map((e) => ({ ...e })) : []), [Ee, De] = (0, F.useState)({
		...
		let t = Ie(e);
		return t ? `${t} · ${Le(e)}` : Le(e);
	}, ze = (Oe.users?.length ? Oe.users : Oe.user_ids.map((e) => ({
		id: e,
		name: Ie(e)
	}))).filter((e) => e.id), Be = (Oe.chats?.length ? Oe.chats : Oe.chat_ids.map((e) => ({
		id: e,
		name: Ie(e)
	}))).filter((e) => e.id), Ve = (e) => {
	...
	let We = async (e) => {
	...
	}, qe = a.configured_integrations || [], Je = Array.from(new Set([
		"To Do",
		"Backlog",
		"In Progress",
		"Done",
		...
		j,
		N
	].filter(Boolean))), Ye = Array.isArray(o.delivery?.jira_statuses) ? o.delivery.jira_statuses.map(String) : String(o.delivery?.jira_status || "To Do,Backlog,In Progress").split(",").map((e) => e.trim()).filter(Boolean), Xe = Array.isArray(o.patch?.jira_statuses) ? o.patch.jira_statuses.map(String) : ["To Do"], Ze = (e, t) => e.length === t.length && e.every((e, n) => e === t[n]), Qe = f !== !!o.scan || f && u !== String(o.scan?.cron || "0 12 * * 1-5"), $e = w !== !!o.delivery?.enabled || w && (m !== String(Math.round((o.delivery?.interval_seconds || 300) / 60)) || !Ze(g, Ye) || v !== String(o.delivery?.in_dev_status || "") || b !== String(o.delivery?.dev_done_status || "") || S !== String(o.delivery?.blocked_status || "Block")), et = ne !== !!o.patch?.enabled || ne && (E !== String(Math.round((o.patch?.interval_seconds || 300) / 60)) || !Ze(D, Xe) || k !== String(o.patch?.in_progress_status || "In Progress") || j !== String(o.patch?.done_status || "Done") || N !== String(o.patch?.blocked_status || "Block")), tt = he !== String(a.publish?.scan || "pr") || _e !== String(a.publish?.delivery || "pr") || ye !== String(a.publish?.patch || "pr"), nt = I !== Ae.enabled || JSON.stringify(we) !== Ae.agents || JSON.stringify(Ee) !== Ae.access, rt = [
		...
		if (!Me) {
			...
			try {
				...
				})), tt && e.push(() => zg("/api/publish-policy", t, {
					method: "POST",
					json: {
						scan_mode: he,
						delivery_mode: _e,
					...
					/* @__PURE__ */ (0, Y.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
							...
							children: [
								...
								rt.length > 0 && /* @__PURE__ */ (0, Y.jsx)("div", {
									className: "access-mapping-list",
									children: rt.map(([e, t]) => /* @__PURE__ */ (0, Y.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, Y.jsx)("span", { children: e }), /* @__PURE__ */ (0, Y.jsx)("div", {
											...
											children: t.map((t) => /* @__PURE__ */ (0, Y.jsxs)("em", { children: [/* @__PURE__ */ (0, Y.jsx)("strong", { children: Ie(t) || "Unknown" }), /* @__PURE__ */ (0, Y.jsx)("code", {
												title: t,
												children: Le(t)
											})] }, `${e}-${t}`))
										})]
								...
								(ze.length > 0 || Be.length > 0) && /* @__PURE__ */ (0, Y.jsxs)("div", {
									className: "access-identity-panel",
									children: [
										ze.length > 0 && /* @__PURE__ */ (0, Y.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
												...
												children: ze.map((e) => /* @__PURE__ */ (0, Y.jsxs)("button", {
													type: "button",
													className: "access-chip",
													onClick: () => He("mutation_allowed_user_ids", String(e.id)),
													title: `Add ${Re(String(e.id))} to Mutation user IDs`,
													children: [/* @__PURE__ */ (0, Y.jsx)("strong", { children: e.name || Ie(String(e.id)) || "Unknown" }), /* @__PURE__ */ (0, Y.jsx)("code", { children: Le(String(e.id)) })]
												}, `user-${e.id}`))
											})]
										}),
										Be.length > 0 && /* @__PURE__ */ (0, Y.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
												...
												children: Be.map((e) => /* @__PURE__ */ (0, Y.jsxs)("button", {
													...
													onClick: () => He("allowed_chat_ids", String(e.id)),
													title: `Add ${Re(String(e.id))} to Allowed chat IDs`,
													children: [/* @__PURE__ */ (0, Y.jsx)("strong", { children: e.name || Ie(String(e.id)) || "Chat" }), /* @__PURE__ */ (0, Y.jsx)("code", { children: Le(String(e.id)) })]
												}, `chat-${e.id}`))
											})]
										}),
										ze[0]?.id && /* @__PURE__ */ (0, Y.jsxs)("button", {
											type: "button",
											className: "button ghost access-owner-button",
											onClick: () => {
												let e = String(ze[0].id);
												He("mutation_allowed_user_ids", e), He("admin_user_ids", e), He("allowed_user_ids", e);
											},
											children: [
												"Use ",
												Ie(String(ze[0].id)) || "latest user",
												" as owner"
											]
										})
									]
								}),
								ze.length === 0 && /* @__PURE__ */ (0, Y.jsx)("p", {
						...
						children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, Y.jsx)($, {
										...
										children: /* @__PURE__ */ (0, Y.jsx)("input", {
											...
											onChange: (t) => Ue(e.id, { app_id: t.target.value })
										})
									}),
									/* @__PURE__ */ (0, Y.jsx)($, {
										...
										children: /* @__PURE__ */ (0, Y.jsx)("input", {
											...
											onChange: (t) => Ue(e.id, { app_secret: t.target.value }),
									...
									/* @__PURE__ */ (0, Y.jsx)($, {
										...
										children: /* @__PURE__ */ (0, Y.jsxs)("select", {
											...
											onChange: (t) => Ue(e.id, { conversation_enabled: t.target.value === "on" }),
									...
									/* @__PURE__ */ (0, Y.jsx)($, {
										...
										children: /* @__PURE__ */ (0, Y.jsx)("input", {
											...
											onChange: (t) => Ue(e.id, { soft_timeout_seconds: Number(t.target.value) || 90 })
										})
									}),
									/* @__PURE__ */ (0, Y.jsx)($, {
										...
										children: /* @__PURE__ */ (0, Y.jsx)("input", {
											...
											onChange: (t) => Ue(e.id, { hard_timeout_seconds: Number(t.target.value) || 300 })
										})
									}),
									/* @__PURE__ */ (0, Y.jsx)($, {
										...
										children: /* @__PURE__ */ (0, Y.jsxs)("select", {
											...
											onChange: (t) => Ue(e.id, { reaction_enabled: t.target.value === "on" }),
											children: [/* @__PURE__ */ (0, Y.jsx)("option", {
												value: "on",
												children: "Enabled"
											}), /* @__PURE__ */ (0, Y.jsx)("option", {
									...
									/* @__PURE__ */ (0, Y.jsx)($, {
										...
										children: /* @__PURE__ */ (0, Y.jsx)("input", {
											...
											onChange: (t) => Ue(e.id, { max_concurrent_jobs: Number(t.target.value) || 3 })
										})
									}),
									/* @__PURE__ */ (0, Y.jsx)($, {
										label: "SOUL version",
										children: /* @__PURE__ */ (0, Y.jsx)("input", {
											...
											onChange: (t) => Ue(e.id, { soul_version: t.target.value })
										})
									}),
									/* @__PURE__ */ (0, Y.jsx)($, {
										label: "Role id",
										children: /* @__PURE__ */ (0, Y.jsx)("input", {
											value: e.role,
											onChange: (t) => Ue(e.id, { role: t.target.value })
										})
									}),
									/* @__PURE__ */ (0, Y.jsx)($, {
										label: "Workflow",
										children: /* @__PURE__ */ (0, Y.jsx)("input", {
											value: e.workflow,
											onChange: (t) => Ue(e.id, { workflow: t.target.value })
										})
									})
								]
							}), /* @__PURE__ */ (0, Y.jsxs)("label", {
								...
								children: [/* @__PURE__ */ (0, Y.jsx)("span", { children: "SOUL.md" }), /* @__PURE__ */ (0, Y.jsx)("textarea", {
									...
									value: e.soul,
									spellCheck: !1,
									onChange: (t) => Ue(e.id, { soul: t.target.value })
								})]
							})]
						})]
					}, e.id)),
