...
//#endregion
//#region package.json
var wh = "2.2.49", Th = (...e) => e.filter((e, t, n) => !!e && e.trim() !== "" && n.indexOf(e) === t).join(" ").trim(), Eh = (e) => e.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase(), Dh = (e) => e.replace(/^([A-Z])|[\s-_]+(\w)/g, (e, t, n) => n ? n.toUpperCase() : t.toLowerCase()), Oh = (e) => {
	let t = Dh(e);
...
function x_({ issue: e, onIgnore: t }) {
	let [n, r] = (0, F.useState)(!1), i = e.status || e.issue_status || "open", a = ![
		"ignored",
		"resolved",
		"accepted_risk",
		"false_positive"
...
function D_({ phases: e, overallStatus: t }) {
	let n = e.filter((e) => !["screen", "context"].includes(String(e.id || "").toLowerCase())), r = String(t).toLowerCase() === "skipped", i = n.filter((e) => e.status === "completed").length, a = r ? 0 : n.length ? Math.round(i / n.length * 100) : 0;
	return /* @__PURE__ */ (0, X.jsxs)("div", {
...
function Q_({ data: e, project: t, notify: n, onDirtyChange: r, reload: i }) {
	let a = e.interactive?.workspace || {}, o = e.interactive?.schedules || {}, [s, c] = (0, F.useState)(String(a.scan_window_days || 7)), [l, u] = (0, F.useState)(String(o.scan?.cron || "0 12 * * 1-5")), [d, f] = (0, F.useState)(!!o.scan), [p, m] = (0, F.useState)(String(Math.round((o.delivery?.interval_seconds || 300) / 60))), [h, g] = (0, F.useState)(Array.isArray(o.delivery?.jira_statuses) ? o.delivery.jira_statuses.map(String) : String(o.delivery?.jira_status || "To Do,Backlog,In Progress").split(",").map((e) => e.trim()).filter(Boolean)), [_, v] = (0, F.useState)(String(o.delivery?.in_dev_status || "")), [y, b] = (0, F.useState)(String(o.delivery?.dev_done_status || "")), [x, S] = (0, F.useState)(String(o.delivery?.blocked_status || "Block")), [C, w] = (0, F.useState)(!!o.delivery?.enabled), [T, E] = (0, F.useState)(String(Math.round((o.patch?.interval_seconds || 300) / 60))), [ee, D] = (0, F.useState)(Array.isArray(o.patch?.jira_statuses) ? o.patch.jira_statuses.map(String) : ["To Do"]), [O, k] = (0, F.useState)(String(o.patch?.in_progress_status || "In Progress")), [A, j] = (0, F.useState)(String(o.patch?.done_status || "Done")), [M, N] = (0, F.useState)(String(o.patch?.blocked_status || "Block")), [te, ne] = (0, F.useState)(!!o.patch?.enabled), [re, ie] = (0, F.useState)(Mg(a.models?.scan)), [ae, P] = (0, F.useState)(Mg(a.models?.delivery)), [oe, se] = (0, F.useState)(Mg(a.models?.patch)), [ce, le] = (0, F.useState)([]), [ue, de] = (0, F.useState)({}), [fe, pe] = (0, F.useState)({}), [me, he] = (0, F.useState)(String(a.publish?.scan || "pr")), [ge, _e] = (0, F.useState)(String(a.publish?.delivery || "pr")), [ve, ye] = (0, F.useState)(String(a.publish?.patch || "pr")), [be, xe] = (0, F.useState)(a.feishu_notifications_enabled !== !1), [Se, I] = (0, F.useState)(!1), [Ce, we] = (0, F.useState)(!1), Te = () => {
		we(!0), r(!0);
	};
	(0, F.useEffect)(() => {
		Rg("/api/delivery/status-options", t).then((e) => le(Array.isArray(e.options) ? e.options.map(String) : [])).catch(() => le([]));
	}, [t]), (0, F.useEffect)(() => {
		c(String(a.scan_window_days || 7)), u(String(o.scan?.cron || "0 12 * * 1-5")), f(!!o.scan), m(String(Math.round((o.delivery?.interval_seconds || 300) / 60))), g(Array.isArray(o.delivery?.jira_statuses) ? o.delivery.jira_statuses.map(String) : String(o.delivery?.jira_status || "To Do,Backlog,In Progress").split(",").map((e) => e.trim()).filter(Boolean)), v(String(o.delivery?.in_dev_status || "")), b(String(o.delivery?.dev_done_status || "")), S(String(o.delivery?.blocked_status || "Block")), w(!!o.delivery?.enabled), E(String(Math.round((o.patch?.interval_seconds || 300) / 60))), D(Array.isArray(o.patch?.jira_statuses) ? o.patch.jira_statuses.map(String) : ["To Do"]), k(String(o.patch?.in_progress_status || "In Progress")), j(String(o.patch?.done_status || "Done")), N(String(o.patch?.blocked_status || "Block")), ne(!!o.patch?.enabled), ie(Mg(a.models?.scan)), P(Mg(a.models?.delivery)), se(Mg(a.models?.patch)), xe(a.feishu_notifications_enabled !== !1), de({}), pe({}), we(!1), r(!1);
	}, [t]), (0, F.useEffect)(() => {
		he(String(a.publish?.scan || "pr")), _e(String(a.publish?.delivery || "pr")), ye(String(a.publish?.patch || "pr"));
	}, [
		a.publish?.scan,
		a.publish?.delivery,
		a.publish?.patch
	]), (0, F.useEffect)(() => {
		xe(a.feishu_notifications_enabled !== !1);
	...
	let Ee = async (e) => {
	...
	}, ke = a.configured_integrations || [], Ae = Array.from(new Set([
		"To Do",
		"Backlog",
		"In Progress",
		"Done",
		...
		A,
		M
	].filter(Boolean))), je = Array.isArray(o.delivery?.jira_statuses) ? o.delivery.jira_statuses.map(String) : String(o.delivery?.jira_status || "To Do,Backlog,In Progress").split(",").map((e) => e.trim()).filter(Boolean), Me = Array.isArray(o.patch?.jira_statuses) ? o.patch.jira_statuses.map(String) : ["To Do"], Ne = (e, t) => e.length === t.length && e.every((e, n) => e === t[n]), Pe = d !== !!o.scan || d && l !== String(o.scan?.cron || "0 12 * * 1-5"), Fe = C !== !!o.delivery?.enabled || C && (p !== String(Math.round((o.delivery?.interval_seconds || 300) / 60)) || !Ne(h, je) || _ !== String(o.delivery?.in_dev_status || "") || y !== String(o.delivery?.dev_done_status || "") || x !== String(o.delivery?.blocked_status || "Block")), Ie = te !== !!o.patch?.enabled || te && (T !== String(Math.round((o.patch?.interval_seconds || 300) / 60)) || !Ne(ee, Me) || O !== String(o.patch?.in_progress_status || "In Progress") || A !== String(o.patch?.done_status || "Done") || M !== String(o.patch?.blocked_status || "Block")), Le = me !== String(a.publish?.scan || "pr") || ge !== String(a.publish?.delivery || "pr") || ve !== String(a.publish?.patch || "pr"), Re = async () => {
		if (!Se) {
			I(!0);
			try {
				if (!re.trim() || !ae.trim() || !oe.trim()) throw Error("Choose a preset or enter a Cursor-supported model ID for all workflows.");
				let e = [() => Rg("/api/workspace", t, {
					...
					json: {
						...
						patch_model: oe.trim(),
						feishu_notifications_enabled: be
					}
				}), ...Object.entries(fe).map(([e, n]) => () => Rg("/api/integration", t, {
					method: "POST",
					json: {
						key: e,
						value: n
				...
				})), Le && e.push(() => Rg("/api/publish-policy", t, {
					method: "POST",
					json: {
						scan_mode: me,
						delivery_mode: ge,
				...
				pe({}), we(!1), r(!1), n("Settings saved", "success"), i();
			} catch (e) {
		...
		children: [
									...
									children: [
										...
										/* @__PURE__ */ (0, X.jsx)(K_, {
											...
											children: /* @__PURE__ */ (0, X.jsx)("select", {
												...
												children: Ae.map((e) => /* @__PURE__ */ (0, X.jsx)("option", {
													value: e,
													children: e
												}, e))
											})
										...
										/* @__PURE__ */ (0, X.jsx)(K_, {
											...
											children: /* @__PURE__ */ (0, X.jsx)("select", {
												...
												children: Array.from(/* @__PURE__ */ new Set([...Ae, "Block"])).map((e) => /* @__PURE__ */ (0, X.jsx)("option", {
													value: e,
													children: e
												}, e))
											})
					...
					/* @__PURE__ */ (0, X.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, X.jsxs)("div", {
								...
								}), /* @__PURE__ */ (0, X.jsx)("p", { children: te ? `Polling every ${T} minute(s) for Task and Bug cards.` : "Auto Patch polling is paused." })]
							}),
							/* @__PURE__ */ (0, X.jsxs)("div", {
								className: "settings-control wide",
								children: [/* @__PURE__ */ (0, X.jsxs)("div", {
								...
								return /* @__PURE__ */ (0, X.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, X.jsx)("input", {
											type: ue[e] || fe[e] !== void 0 ? "text" : "password",
											value: t,
										...
										/* @__PURE__ */ (0, X.jsxs)("div", { children: [/* @__PURE__ */ (0, X.jsx)(c_, {
											label: "Reveal value",
											onClick: () => void De(e),
											children: ue[e] ? /* @__PURE__ */ (0, X.jsx)(qh, { size: 15 }) : /* @__PURE__ */ (0, X.jsx)(Jh, { size: 15 })
										}), /* @__PURE__ */ (0, X.jsx)(c_, {
											label: "Copy value",
											onClick: () => void Oe(e),
			...
			/* @__PURE__ */ (0, X.jsxs)("footer", {
				...
				children: [/* @__PURE__ */ (0, X.jsx)("span", {
					...
					children: Se ? "Saving settings…" : Ce ? "You have unsaved changes" : "All changes saved"
				}), /* @__PURE__ */ (0, X.jsxs)("button", {
					className: `button primary${Se ? " is-busy" : ""}`,
					disabled: !Ce || Se,
					onClick: () => void Re(),
					children: [Se ? /* @__PURE__ */ (0, X.jsx)(rg, {
						size: 15,
						className: "spin"
					}) : /* @__PURE__ */ (0, X.jsx)(cg, { size: 15 }), Se ? "Saving…" : "Save changes"]
				})]
			})
		]
	});
