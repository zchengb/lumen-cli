...
function Q_({ data: e, project: t, notify: n, onDirtyChange: r, reload: i }) {
	...
	let ze = async (e) => {
	...
	}, He = a.configured_integrations || [], Ue = Array.from(new Set([
		"To Do",
		"Backlog",
		"In Progress",
		"Done",
		...
		j,
		N
	].filter(Boolean))), We = Array.isArray(o.delivery?.jira_statuses) ? o.delivery.jira_statuses.map(String) : String(o.delivery?.jira_status || "To Do,Backlog,In Progress").split(",").map((e) => e.trim()).filter(Boolean), Ge = Array.isArray(o.patch?.jira_statuses) ? o.patch.jira_statuses.map(String) : ["To Do"], Ke = (e, t) => e.length === t.length && e.every((e, n) => e === t[n]), qe = f !== !!o.scan || f && u !== String(o.scan?.cron || "0 12 * * 1-5"), Je = w !== !!o.delivery?.enabled || w && (m !== String(Math.round((o.delivery?.interval_seconds || 300) / 60)) || !Ke(g, We) || v !== String(o.delivery?.in_dev_status || "") || b !== String(o.delivery?.dev_done_status || "") || S !== String(o.delivery?.blocked_status || "Block")), Ye = ne !== !!o.patch?.enabled || ne && (E !== String(Math.round((o.patch?.interval_seconds || 300) / 60)) || !Ke(D, Ge) || k !== String(o.patch?.in_progress_status || "In Progress") || j !== String(o.patch?.done_status || "Done") || N !== String(o.patch?.blocked_status || "Block")), Xe = he !== String(a.publish?.scan || "pr") || _e !== String(a.publish?.delivery || "pr") || ye !== String(a.publish?.patch || "pr"), Ze = I !== Ae.enabled || JSON.stringify(we) !== Ae.agents || JSON.stringify(Ee) !== Ae.access, Qe = async () => {
		if (!Me) {
			Ne(!0);
			try {
				...
				})), Xe && e.push(() => zg("/api/publish-policy", t, {
					method: "POST",
					json: {
						scan_mode: he,
						delivery_mode: _e,
									...
									children: [
										...
										/* @__PURE__ */ (0, Y.jsx)($, {
											...
											children: /* @__PURE__ */ (0, Y.jsx)("select", {
												...
												children: Ue.map((e) => /* @__PURE__ */ (0, Y.jsx)("option", {
													value: e,
													children: e
												}, e))
											})
										...
										/* @__PURE__ */ (0, Y.jsx)($, {
											...
											children: /* @__PURE__ */ (0, Y.jsx)("select", {
												...
												children: Array.from(/* @__PURE__ */ new Set([...Ue, "Block"])).map((e) => /* @__PURE__ */ (0, Y.jsx)("option", {
													value: e,
													children: e
												}, e))
											})
						...
						children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, Y.jsxs)("p", {
									...
									children: [
										...
										". Easiest: message Dylan/Mark once, then click a recent ID below. Or copy open_id from Feishu Open Platform → your app → event/debug logs, or from the sender payload in gateway logs."
									]
								})
							]
						}), /* @__PURE__ */ (0, Y.jsxs)("div", {
							...
							children: [
								...
								(Oe.user_ids.length > 0 || Oe.chat_ids.length > 0) && /* @__PURE__ */ (0, Y.jsxs)("div", {
									...
									style: { marginTop: 12 },
									children: [
										/* @__PURE__ */ (0, Y.jsx)("div", { children: "Recent Feishu IDs from agent traffic — click to add:" }),
										/* @__PURE__ */ (0, Y.jsxs)("div", {
											style: {
												display: "flex",
												flexWrap: "wrap",
											...
											children: [Oe.user_ids.map((e) => /* @__PURE__ */ (0, Y.jsx)("button", {
												...
												onClick: () => Le("mutation_allowed_user_ids", e),
												title: "Add to Mutation user IDs",
												children: e
											}, `user-${e}`)), Oe.chat_ids.map((e) => /* @__PURE__ */ (0, Y.jsx)("button", {
												type: "button",
												className: "button ghost",
												onClick: () => Le("allowed_chat_ids", e),
												title: "Add to Allowed chat IDs",
												children: e
											}, `chat-${e}`))]
										}),
										Oe.user_ids[0] && /* @__PURE__ */ (0, Y.jsx)("div", {
											...
											children: /* @__PURE__ */ (0, Y.jsxs)("button", {
												...
												className: "button ghost",
												onClick: () => {
													Le("mutation_allowed_user_ids", Oe.user_ids[0]), Le("admin_user_ids", Oe.user_ids[0]), Le("allowed_user_ids", Oe.user_ids[0]);
												},
												children: [
								...
								Oe.user_ids.length === 0 && /* @__PURE__ */ (0, Y.jsx)("p", {
									className: "schedule-note",
									style: { marginTop: 12 },
									children: "No recent Feishu user IDs yet. Send any message to Dylan or Mark, refresh Settings, then click the ID here."
								})
							]
						})]
					}),
						...
						children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, Y.jsxs)("p", {
									...
									children: [
										"Security: filesystem ",
										Q(e.security?.filesystem, "workspace_read"),
										" · mutations ",
										Q(e.security?.mutations, "brokered"),
										" · network ",
										Q(e.security?.network, "deny"),
										" · sandbox ",
										Q(e.security?.sandbox, "enabled"),
										" · secrets ",
										Q(e.security?.secrets, "isolated")
									]
								})
							]
						}), /* @__PURE__ */ (0, Y.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, Y.jsx)($, {
										...
										children: /* @__PURE__ */ (0, Y.jsx)("input", {
											...
											onChange: (t) => Re(e.id, { app_id: t.target.value })
										})
									}),
									/* @__PURE__ */ (0, Y.jsx)($, {
										...
										children: /* @__PURE__ */ (0, Y.jsx)("input", {
											...
											onChange: (t) => Re(e.id, { app_secret: t.target.value }),
									...
									/* @__PURE__ */ (0, Y.jsx)($, {
										...
										children: /* @__PURE__ */ (0, Y.jsxs)("select", {
											...
											onChange: (t) => Re(e.id, { conversation_enabled: t.target.value === "on" }),
									...
									/* @__PURE__ */ (0, Y.jsx)($, {
										...
										children: /* @__PURE__ */ (0, Y.jsx)("input", {
											...
											onChange: (t) => Re(e.id, { soft_timeout_seconds: Number(t.target.value) || 90 })
										})
									}),
									/* @__PURE__ */ (0, Y.jsx)($, {
										...
										children: /* @__PURE__ */ (0, Y.jsx)("input", {
											...
											onChange: (t) => Re(e.id, { hard_timeout_seconds: Number(t.target.value) || 300 })
										})
									}),
									/* @__PURE__ */ (0, Y.jsx)($, {
										...
										children: /* @__PURE__ */ (0, Y.jsxs)("select", {
											...
											onChange: (t) => Re(e.id, { reaction_enabled: t.target.value === "on" }),
											children: [/* @__PURE__ */ (0, Y.jsx)("option", {
												value: "on",
												children: "Enabled"
											}), /* @__PURE__ */ (0, Y.jsx)("option", {
									...
									/* @__PURE__ */ (0, Y.jsx)($, {
										...
										children: /* @__PURE__ */ (0, Y.jsx)("input", {
											...
											onChange: (t) => Re(e.id, { max_concurrent_jobs: Number(t.target.value) || 3 })
										})
									}),
									/* @__PURE__ */ (0, Y.jsx)($, {
										label: "SOUL version",
										children: /* @__PURE__ */ (0, Y.jsx)("input", {
											...
											onChange: (t) => Re(e.id, { soul_version: t.target.value })
										})
									}),
									/* @__PURE__ */ (0, Y.jsx)($, {
										label: "Role id",
										children: /* @__PURE__ */ (0, Y.jsx)("input", {
											value: e.role,
											onChange: (t) => Re(e.id, { role: t.target.value })
										})
									}),
									/* @__PURE__ */ (0, Y.jsx)($, {
										label: "Workflow",
										children: /* @__PURE__ */ (0, Y.jsx)("input", {
											value: e.workflow,
											onChange: (t) => Re(e.id, { workflow: t.target.value })
										})
									})
								]
							}), /* @__PURE__ */ (0, Y.jsxs)("label", {
								...
								children: [/* @__PURE__ */ (0, Y.jsx)("span", { children: "SOUL.md" }), /* @__PURE__ */ (0, Y.jsx)("textarea", {
									...
									value: e.soul,
									spellCheck: !1,
									onChange: (t) => Re(e.id, { soul: t.target.value })
								})]
							})]
						})]
					}, e.id)),
