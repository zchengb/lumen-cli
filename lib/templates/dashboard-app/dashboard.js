...
//#endregion
//#region package.json
var bl = _(), xl = "1.22.0", Sl = (...e) => e.filter((e, t, n) => !!e && e.trim() !== "" && n.indexOf(e) === t).join(" ").trim(), Cl = (e) => e.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase(), wl = (e) => e.replace(/^([A-Z])|[\s-_]+(\w)/g, (e, t, n) => n ? n.toUpperCase() : t.toLowerCase()), Tl = (e) => {
	let t = wl(e);
...
function nu(e) {
	let t = Ql(e, "unknown").toLowerCase().replaceAll("_", " ");
	return {
...
function iu({ value: e }) {
	return /* @__PURE__ */ (0, V.jsx)("span", {
		className: `badge ${tu(e)}`,
		children: nu(e)
	});
}
function au({ label: e, children: t, onClick: n, danger: r = !1, className: i = "" }) {
...
function ou({ title: e, action: t, children: n, className: r = "" }) {
				...
				children: [/* @__PURE__ */ (0, V.jsxs)("header", {
					...
					children: [/* @__PURE__ */ (0, V.jsx)("div", { className: "masthead-spacer" }), /* @__PURE__ */ (0, V.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, V.jsx)("span", {
							...
							children: m ? `Updated ${$l(m.toISOString())}` : "Syncing…"
					...
					children: [
						...
						n && i === "delivery" && /* @__PURE__ */ (0, V.jsx)(vu, {
							data: n,
							project: e
						}),
						n && i === "prompts" && /* @__PURE__ */ (0, V.jsx)(ju, {
							data: n,
							project: e,
							interact: v,
							notify: l
						}),
						n && i === "settings" && /* @__PURE__ */ (0, V.jsx)(Mu, {
							data: n,
							project: e,
							interact: v,
							notify: l
...
function cu({ title: e, description: t, action: n }) {
	...
	return /* @__PURE__ */ (0, V.jsxs)(V.Fragment, { children: [
		...
		/* @__PURE__ */ (0, V.jsxs)(ou, {
			...
			children: [/* @__PURE__ */ (0, V.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, V.jsxs)("table", { children: [/* @__PURE__ */ (0, V.jsx)("thead", { children: /* @__PURE__ */ (0, V.jsxs)("tr", { children: [
					...
					/* @__PURE__ */ (0, V.jsx)("td", { children: $l(e.finished_at || e.started_at) }),
					/* @__PURE__ */ (0, V.jsx)("td", { children: /* @__PURE__ */ (0, V.jsx)(iu, { value: e.status }) }),
					/* @__PURE__ */ (0, V.jsx)("td", { children: /* @__PURE__ */ (0, V.jsx)(pu, { run: e }) }),
					/* @__PURE__ */ (0, V.jsx)("td", { children: Ql(e.duration) }),
			...
			}), a.length > 10 && /* @__PURE__ */ (0, V.jsx)(mu, {
				page: u,
		...
		/* @__PURE__ */ (0, V.jsxs)(ou, {
			...
			children: [/* @__PURE__ */ (0, V.jsx)("div", {
				...
				id: "tracked-findings",
				className: "findings",
				children: p.length ? p.map((e) => /* @__PURE__ */ (0, V.jsx)(hu, {
					issue: e,
					onIgnore: () => s(e)
				}, e.id)) : /* @__PURE__ */ (0, V.jsx)(du, { label: "No findings match this status." })
			})]
		}),
		o && /* @__PURE__ */ (0, V.jsx)(_u, {
			onClose: () => s(null),
			onConfirm: (e) => {
				n("/api/issue/ignore", {
					issue_id: o.id,
			...
			children: [/* @__PURE__ */ (0, V.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, V.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, V.jsx)("h4", { children: Ql(e.title, "Untitled finding") }), /* @__PURE__ */ (0, V.jsx)(iu, { value: i })]
					}),
					/* @__PURE__ */ (0, V.jsxs)("p", { children: [
						Ql(e.repository, "Unknown repository"),
						" ",
...
function gu({ label: e, value: t, code: n = !1 }) {
	return /* @__PURE__ */ (0, V.jsxs)("section", {
		...
		children: [/* @__PURE__ */ (0, V.jsx)("h5", { children: e }), n ? /* @__PURE__ */ (0, V.jsx)("pre", { children: /* @__PURE__ */ (0, V.jsx)("code", { children: Ql(t, "No code snippet was captured for this historical finding.") }) }) : /* @__PURE__ */ (0, V.jsx)("p", { children: Ql(t, "Not recorded.") })]
	});
}
...
function vu({ data: e, project: t }) {
	let n = e.delivery || {}, r = n.current || {}, i = n.runs || [], a = r.stages || [], [o, s] = (0, H.useState)(null), [c, l] = (0, H.useState)(null), [u, d] = (0, H.useState)(""), [f, p] = (0, H.useState)(""), [m, h] = (0, H.useState)(!1), g = async (e, n = r.run_id || "") => {
		s(e), d(""), p(""), h(!0);
		try {
			let e = await ru(`/api/delivery/log?run_id=${encodeURIComponent(n)}`, t);
		...
		/* @__PURE__ */ (0, V.jsxs)(ou, {
			...
			children: [/* @__PURE__ */ (0, V.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, V.jsx)(Su, {
						label: "Status",
						value: /* @__PURE__ */ (0, V.jsx)(iu, { value: r.delivery_status || "not started" })
					}),
					/* @__PURE__ */ (0, V.jsx)(Su, {
						label: "Elapsed",
						value: eu(r.started_at, r.finished_at)
					}),
					/* @__PURE__ */ (0, V.jsx)(Su, {
						label: "Finished",
						value: $l(r.finished_at)
					})
				]
			}), /* @__PURE__ */ (0, V.jsx)(bu, {
				stages: a,
					...
					return /* @__PURE__ */ (0, V.jsxs)("tr", { children: [
						/* @__PURE__ */ (0, V.jsx)("td", { children: /* @__PURE__ */ (0, V.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, V.jsxs)("span", {
								...
								children: [/* @__PURE__ */ (0, V.jsx)("code", { children: Ql(e.jira_key || e.story || e.run_id) }), e.story_title && /* @__PURE__ */ (0, V.jsx)("span", {
									className: "history-story-title",
									children: e.story_title
								})]
							}), /* @__PURE__ */ (0, V.jsx)("small", { children: Ql(e.branch, "") })]
						}) }),
						/* @__PURE__ */ (0, V.jsx)("td", { children: $l(e.finished_at || e.started_at) }),
...
function yu({ jiraKey: e, title: t }) {
	return /* @__PURE__ */ (0, V.jsxs)("span", {
		...
		children: [/* @__PURE__ */ (0, V.jsx)("code", { children: Ql(e, "No active delivery") }), t && /* @__PURE__ */ (0, V.jsx)("span", { children: t })]
	});
}
function bu({ stages: e, deliveryStatus: t, startedAt: n, finishedAt: r, onStageClick: i }) {
	...
	return /* @__PURE__ */ (0, V.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, V.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, V.jsxs)("div", { children: [/* @__PURE__ */ (0, V.jsx)("span", { children: "Delivery Flow" }), /* @__PURE__ */ (0, V.jsx)("strong", { children: "Execution path" })] }), /* @__PURE__ */ (0, V.jsxs)("p", { children: [n ? `Started ${$l(n)}` : "Awaiting delivery trigger", r ? ` · Finished ${$l(r)}` : ""] })]
		}), /* @__PURE__ */ (0, V.jsxs)("div", {
					...
					return /* @__PURE__ */ (0, V.jsx)("li", {
						...
						children: /* @__PURE__ */ (0, V.jsxs)("button", {
							...
							children: [/* @__PURE__ */ (0, V.jsx)("span", {
								...
								className: "flow-copy",
								children: [/* @__PURE__ */ (0, V.jsx)("strong", { children: Ql(e.label) }), /* @__PURE__ */ (0, V.jsx)("span", { children: r === "running" ? "In progress" : r === "failed" ? "Needs attention" : e.duration || "Pending" })]
							})]
						})
					}, `${e.label}-${t}`);
				})
		...
		children: /* @__PURE__ */ (0, V.jsxs)("section", {
			...
			children: [/* @__PURE__ */ (0, V.jsxs)("div", {
				...
				children: e.map((e, t) => /* @__PURE__ */ (0, V.jsxs)("article", {
					...
					children: [
						/* @__PURE__ */ (0, V.jsxs)("div", { children: [/* @__PURE__ */ (0, V.jsx)("strong", { children: Ql(e.label) }), /* @__PURE__ */ (0, V.jsx)("span", { children: Ql(e.repository, "Workspace") })] }),
						/* @__PURE__ */ (0, V.jsx)(iu, { value: e.status }),
						/* @__PURE__ */ (0, V.jsx)("p", { children: Ql(e.summary, "No summary recorded.") }),
...
function ju({ data: e, project: t, interact: n, notify: r }) {
	let i = e.interactive?.prompts || [], [a, o] = (0, H.useState)("scan"), [s, c] = (0, H.useState)(null), [l, u] = (0, H.useState)(""), d = i.filter((e) => e.mode === a), f = async (e) => {
		c(e);
		try {
			let n = await ru(`/api/prompt?mode=${encodeURIComponent(e.mode)}&path=${encodeURIComponent(e.path)}`, t);
			u(n.content);
		} catch (e) {
	...
	return /* @__PURE__ */ (0, V.jsxs)(V.Fragment, { children: [
		...
		/* @__PURE__ */ (0, V.jsx)(ou, {
			...
			action: /* @__PURE__ */ (0, V.jsx)("span", {
				className: "muted",
				children: "Prompt nodes are editable"
			}),
			...
			children: /* @__PURE__ */ (0, V.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, V.jsx)("div", {
					...
					children: m.map((e, t) => /* @__PURE__ */ (0, V.jsxs)("section", {
						...
						children: [
							...
							/* @__PURE__ */ (0, V.jsxs)("div", {
								...
								children: [e.scripts.map((e) => /* @__PURE__ */ (0, V.jsxs)("article", {
									className: "workflow-node script-node",
									children: [
										/* @__PURE__ */ (0, V.jsx)(Jl, { size: 14 }),
										/* @__PURE__ */ (0, V.jsxs)("span", { children: [/* @__PURE__ */ (0, V.jsx)("strong", { children: e.name }), /* @__PURE__ */ (0, V.jsx)("small", { children: e.description })] }),
										/* @__PURE__ */ (0, V.jsx)("em", { children: "SCRIPT" })
									]
								}, e.name)), d.filter((t) => e.layers.includes(ku(t, a))).map((e) => {
									let t = Ou(e), n = t.icon;
									return /* @__PURE__ */ (0, V.jsxs)("button", {
										className: `workflow-node prompt-node ${s?.mode === e.mode && s.path === e.path ? "selected" : ""}`,
										onClick: () => void f(e),
										children: [
											/* @__PURE__ */ (0, V.jsx)(n, { size: 14 }),
											/* @__PURE__ */ (0, V.jsxs)("span", { children: [/* @__PURE__ */ (0, V.jsx)("strong", { children: t.title }), /* @__PURE__ */ (0, V.jsx)("small", { children: t.description })] }),
											/* @__PURE__ */ (0, V.jsx)("em", { children: "PROMPT" })
										]
									}, `${e.mode}/${e.path}`);
								})]
							}),
							t < m.length - 1 && /* @__PURE__ */ (0, V.jsx)("span", {
		...
		/* @__PURE__ */ (0, V.jsx)(ou, {
			...
			children: /* @__PURE__ */ (0, V.jsx)("div", {
				...
				children: s ? /* @__PURE__ */ (0, V.jsxs)(V.Fragment, { children: [/* @__PURE__ */ (0, V.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, V.jsxs)("div", { children: [/* @__PURE__ */ (0, V.jsx)("h3", { children: Ou(s).title }), /* @__PURE__ */ (0, V.jsxs)("p", { children: [/* @__PURE__ */ (0, V.jsx)("code", { children: s.path }), " · injected during the selected workflow stage"] })] })
				}), /* @__PURE__ */ (0, V.jsxs)("div", {
				...
				})] }) : /* @__PURE__ */ (0, V.jsx)(du, { label: "Select a prompt node in the workflow to inspect and edit it." })
			})
		})
	] });
}
function Mu({ data: e, project: t, interact: n, notify: r }) {
	let i = e.interactive?.workspace || {}, a = e.interactive?.schedules || {}, [o, s] = (0, H.useState)(String(i.scan_window_days || 7)), [c, l] = (0, H.useState)(String(a.scan?.cron || "0 12 * * 1-5")), [u, d] = (0, H.useState)(String(Math.round((a.delivery?.interval_seconds || 300) / 60))), [f, p] = (0, H.useState)(String(a.delivery?.jira_status || "Ready for Dev")), [m, h] = (0, H.useState)(""), [g, _] = (0, H.useState)(""), [v, y] = (0, H.useState)({}), b = async (e) => {
		let n = await ru(`/api/integration?key=${encodeURIComponent(e)}`, t);
	...
	return /* @__PURE__ */ (0, V.jsxs)(V.Fragment, { children: [/* @__PURE__ */ (0, V.jsx)(cu, {
		title: "SETTINGS",
		...
		children: [
			/* @__PURE__ */ (0, V.jsxs)(ou, {
				...
				children: [/* @__PURE__ */ (0, V.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, V.jsx)(Cu, {
						label: "Workspace",
						value: /* @__PURE__ */ (0, V.jsx)("code", { children: Ql(i.path) })
					}), /* @__PURE__ */ (0, V.jsx)(Cu, {
			...
			/* @__PURE__ */ (0, V.jsxs)(ou, {
				...
				children: [/* @__PURE__ */ (0, V.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, V.jsxs)("div", {
						className: "settings-copy",
						children: [/* @__PURE__ */ (0, V.jsx)("h4", { children: "Auto Scan" }), /* @__PURE__ */ (0, V.jsx)("p", { children: Ql(a.scan?.description, "No recurring scan is configured.") })]
					}), /* @__PURE__ */ (0, V.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, V.jsxs)("div", {
						className: "settings-copy",
						children: [/* @__PURE__ */ (0, V.jsx)("h4", { children: "Auto Delivery" }), /* @__PURE__ */ (0, V.jsx)("p", { children: Ql(a.delivery?.description, "No delivery polling is configured.") })]
					}), /* @__PURE__ */ (0, V.jsxs)("div", {
						className: "settings-control wide",
						children: [/* @__PURE__ */ (0, V.jsxs)("div", {
...
(0, bl.createRoot)(document.getElementById("root")).render(/* @__PURE__ */ (0, V.jsx)(su, {}));
//#endregion
