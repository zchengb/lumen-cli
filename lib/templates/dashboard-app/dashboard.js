...
//#endregion
//#region package.json
var wh = "1.24.37", Th = (...e) => e.filter((e, t, n) => !!e && e.trim() !== "" && n.indexOf(e) === t).join(" ").trim(), Eh = (e) => e.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase(), Dh = (e) => e.replace(/^([A-Z])|[\s-_]+(\w)/g, (e, t, n) => n ? n.toUpperCase() : t.toLowerCase()), Oh = (e) => {
	let t = Dh(e);
...
function Hg({ value: e, onChange: t }) {
	let { frontmatter: n, body: r } = Ig(e), i = (0, M.useRef)(null), a = (0, M.useRef)(!1), o = (0, M.useRef)(!1), s = (0, M.useRef)(r), c = (0, M.useRef)(zg()), [l, u] = (0, M.useState)(null);
	s.current = r;
	let d = (e) => t(Lg(n, e)), f = () => {
		let e = i.current;
		if (!e) return;
		let t = c.current.turndown(e);
		Vg(o.current, t, s.current) && d(t);
	}, p = (0, M.useCallback)(async (e) => {
		let t = i.current;
		if (!t) return;
		o.current = !1, t.innerHTML = Rg(e), t.querySelectorAll("a[href]").forEach((e) => {
...
function Ug({ label: e, children: t, onClick: n, danger: r = !1, disabled: i = !1, className: a = "" }) {
...
function Wg({ title: e, action: t, children: n, className: r = "" }) {
			...
			/* @__PURE__ */ (0, X.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, X.jsxs)("header", {
					...
					children: [
						...
						n && i === "scan" && /* @__PURE__ */ (0, X.jsx)(Kg, {
							data: n,
							project: e,
							interact: T
						}),
						n && i === "delivery" && /* @__PURE__ */ (0, X.jsx)(e_, {
							data: n,
							project: e,
							notify: b,
							reload: x
						}),
						n && i === "observatory" && /* @__PURE__ */ (0, X.jsx)(i_, {
							project: e,
							notify: b,
							onDirtyChange: y
						}),
						n && i === "repositories" && /* @__PURE__ */ (0, X.jsx)(b_, {
							data: n,
							interact: T
						}),
						n && i === "prompts" && /* @__PURE__ */ (0, X.jsx)(g_, {
							data: n,
							project: e,
							interact: T,
							notify: b
						}),
						n && i === "settings" && /* @__PURE__ */ (0, X.jsx)(S_, {
							data: n,
							project: e,
							notify: b,
							onDirtyChange: _,
...
function Kg({ data: e, project: t, interact: n }) {
	...
	return /* @__PURE__ */ (0, X.jsxs)(X.Fragment, { children: [
		...
		/* @__PURE__ */ (0, X.jsxs)(Wg, {
			...
			children: [/* @__PURE__ */ (0, X.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, X.jsxs)("table", { children: [/* @__PURE__ */ (0, X.jsx)("thead", { children: /* @__PURE__ */ (0, X.jsxs)("tr", { children: [
					...
					/* @__PURE__ */ (0, X.jsx)("td", { children: /* @__PURE__ */ (0, X.jsx)(Yg, { run: e }) }),
			...
			}), a.length > 10 && /* @__PURE__ */ (0, X.jsx)(Xg, {
				page: u,
		...
		/* @__PURE__ */ (0, X.jsxs)(Wg, {
			...
			children: [/* @__PURE__ */ (0, X.jsx)("div", {
				...
				id: "tracked-findings",
				className: "findings",
				children: p.length ? p.map((e) => /* @__PURE__ */ (0, X.jsx)(Zg, {
					issue: e,
					onIgnore: () => s(e)
				}, e.id)) : /* @__PURE__ */ (0, X.jsx)(Jg, { label: "No findings match this status." })
			})]
		}),
		o && /* @__PURE__ */ (0, X.jsx)($g, {
			onClose: () => s(null),
			onConfirm: (e) => {
				n("/api/issue/ignore", {
					issue_id: o.id,
...
function qg({ label: e, value: t, onClick: n }) {
	return /* @__PURE__ */ (0, X.jsxs)("div", {
...
function Xg({ page: e, pageCount: t, onChange: n }) {
...
function Zg({ issue: e, onIgnore: t }) {
...
function Qg({ label: e, value: t, code: n = !1 }) {
	return /* @__PURE__ */ (0, X.jsxs)("section", {
...
function $g({ onClose: e, onConfirm: t }) {
...
function e_({ data: e, project: t, notify: n, reload: r }) {
	...
	return /* @__PURE__ */ (0, X.jsxs)(X.Fragment, { children: [
			...
			children: /* @__PURE__ */ (0, X.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, X.jsxs)("table", { children: [/* @__PURE__ */ (0, X.jsx)("thead", { children: /* @__PURE__ */ (0, X.jsxs)("tr", { children: [
					...
					return /* @__PURE__ */ (0, X.jsxs)("tr", { children: [
						...
						/* @__PURE__ */ (0, X.jsx)("td", { children: /* @__PURE__ */ (0, X.jsx)(l_, { items: e.pull_requests || [] }) }),
						/* @__PURE__ */ (0, X.jsx)("td", { children: /* @__PURE__ */ (0, X.jsx)(u_, {
							checks: t,
							onClick: () => p(t)
						}) }),
						...
						/* @__PURE__ */ (0, X.jsx)("td", { children: /* @__PURE__ */ (0, X.jsx)(Ug, {
					...
					colSpan: 8,
					children: /* @__PURE__ */ (0, X.jsx)(Jg, { label: "No delivery history yet." })
				}) }) })] })
			})
		}),
		/* @__PURE__ */ (0, X.jsx)(Wg, {
			...
			children: /* @__PURE__ */ (0, X.jsx)("div", {
				...
				}, `${e.at}-${t}`)) : /* @__PURE__ */ (0, X.jsx)(Jg, { label: "No scheduled delivery activity recorded yet." })
			})
		}),
		u && /* @__PURE__ */ (0, X.jsx)(s_, {
			stage: u,
			content: m,
			error: g,
			loading: v,
		...
		f && /* @__PURE__ */ (0, X.jsx)(d_, {
			checks: f,
			onClose: () => p(null)
		}),
		S && /* @__PURE__ */ (0, X.jsx)(n_, {
...
function t_({ stories: e, value: t, onChange: n, busy: r, error: i, onClose: a, onConfirm: o }) {
	return /* @__PURE__ */ (0, X.jsx)("div", {
		className: "modal-backdrop",
		role: "presentation",
...
function r_({ run: e, busy: t, onClose: n, onConfirm: r }) {
...
function i_({ project: e, notify: t, onDirtyChange: n }) {
		...
		children: [/* @__PURE__ */ (0, X.jsxs)("aside", {
			...
			children: [/* @__PURE__ */ (0, X.jsxs)("div", {
				...
				children: [
					...
					!E && !i.length ? /* @__PURE__ */ (0, X.jsx)(Jg, { label: "No stories found in the docs repository." }) : null,
					i.map((e) => {
			...
			children: o ? /* @__PURE__ */ (0, X.jsxs)(X.Fragment, { children: [/* @__PURE__ */ (0, X.jsx)("div", {
				...
				}), w === "story" ? /* @__PURE__ */ (0, X.jsx)(Hg, {
					value: v,
					onChange: y
				}, `${o || "none"}-story`) : /* @__PURE__ */ (0, X.jsx)(Hg, {
					value: b,
					onChange: x
				}, `${o || "none"}-plan`)]
			})] }) : /* @__PURE__ */ (0, X.jsx)(Jg, { label: "Select a story to inspect." })
		})]
	});
}
...
function o_({ stages: e, deliveryStatus: t, currentStep: n, startedAt: r, finishedAt: i, remediation: a, now: o, onStageClick: s }) {
...
function u_({ checks: e, onClick: t }) {
...
function d_({ checks: e, onClose: t }) {
	return /* @__PURE__ */ (0, X.jsx)("div", {
		className: "modal-backdrop",
		role: "presentation",
		onMouseDown: t,
...
function g_({ data: e, project: t, interact: n, notify: r }) {
			...
			children: /* @__PURE__ */ (0, X.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, X.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, X.jsx)("div", {
						...
						children: w.map((e, t) => {
							let n = _.filter((t) => e.layers.includes(m_(t, a))), r = [...e.scripts.map((e) => ({
								kind: "script",
								script: e
							})), ...n.map((e) => ({
								kind: "prompt",
...
function __({ item: e, content: t, onChange: n, onClose: r, onSave: i }) {
	let a = p_(e);
	return /* @__PURE__ */ (0, X.jsx)("div", {
		className: "modal-backdrop",
		role: "presentation",
...
function $({ label: e, help: t, children: n }) {
	return /* @__PURE__ */ (0, X.jsxs)("label", {
		...
		children: [/* @__PURE__ */ (0, X.jsxs)("span", {
			...
			children: [e, t && /* @__PURE__ */ (0, X.jsx)(v_, { children: t })]
		}), n]
	});
}
	...
	return /* @__PURE__ */ (0, X.jsxs)("section", {
		...
		children: [
			/* @__PURE__ */ (0, X.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, X.jsxs)("div", { children: [/* @__PURE__ */ (0, X.jsxs)("strong", { children: ["Visual runtime ", /* @__PURE__ */ (0, X.jsx)(v_, { children: "These settings tell Lumen how to start the repository, reach its page, authenticate, and provide mock data during visual verification." })] }), /* @__PURE__ */ (0, X.jsx)("span", { children: "Only the runtime inputs needed for visual verification are shown first." })] }), /* @__PURE__ */ (0, X.jsx)("code", { children: e.runtime_profile || n })]
			}),
			/* @__PURE__ */ (0, X.jsxs)("div", {
...
function S_({ data: e, project: t, notify: n, onDirtyChange: r, reload: i }) {
				...
				children: /* @__PURE__ */ (0, X.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, X.jsxs)("div", {
						...
						children: /* @__PURE__ */ (0, X.jsx)("div", {
							...
							children: he.length ? he.map((e) => {
								...
								return /* @__PURE__ */ (0, X.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, X.jsxs)("div", { children: [/* @__PURE__ */ (0, X.jsx)(Ug, {
											label: "Reveal value",
											onClick: () => void pe(e),
							...
							}) : /* @__PURE__ */ (0, X.jsx)(Jg, { label: "No local integration keys configured." })
						})
					})]
				})
			}),
...
function C_({ enabled: e, onChange: t }) {
	return /* @__PURE__ */ (0, X.jsxs)("label", {
...
(0, be.createRoot)(document.getElementById("root")).render(/* @__PURE__ */ (0, X.jsx)(Gg, {}));
//#endregion
