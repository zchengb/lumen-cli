...
function Q_({ data: e, project: t, notify: n, onDirtyChange: r, reload: i }) {
	let a = e.interactive?.workspace || {}, o = e.interactive?.schedules || {}, s = e.interactive?.agents || {}, [c, l] = (0, F.useState)(String(a.scan_window_days || 7)), [u, d] = (0, F.useState)(String(o.scan?.cron || "0 12 * * 1-5")), [f, p] = (0, F.useState)(!!o.scan), [m, h] = (0, F.useState)(String(Math.round((o.delivery?.interval_seconds || 300) / 60))), [g, _] = (0, F.useState)(Array.isArray(o.delivery?.jira_statuses) ? o.delivery.jira_statuses.map(String) : String(o.delivery?.jira_status || "To Do,Backlog,In Progress").split(",").map((e) => e.trim()).filter(Boolean)), [v, y] = (0, F.useState)(String(o.delivery?.in_dev_status || "")), [b, x] = (0, F.useState)(String(o.delivery?.dev_done_status || "")), [S, C] = (0, F.useState)(String(o.delivery?.blocked_status || "Block")), [w, T] = (0, F.useState)(!!o.delivery?.enabled), [E, ee] = (0, F.useState)(String(Math.round((o.patch?.interval_seconds || 300) / 60))), [D, O] = (0, F.useState)(Array.isArray(o.patch?.jira_statuses) ? o.patch.jira_statuses.map(String) : ["To Do"]), [k, A] = (0, F.useState)(String(o.patch?.in_progress_status || "In Progress")), [j, M] = (0, F.useState)(String(o.patch?.done_status || "Done")), [N, te] = (0, F.useState)(String(o.patch?.blocked_status || "Block")), [ne, re] = (0, F.useState)(!!o.patch?.enabled), [ie, ae] = (0, F.useState)(Ng(a.models?.scan)), [P, oe] = (0, F.useState)(Ng(a.models?.delivery)), [se, ce] = (0, F.useState)(Ng(a.models?.patch)), [le, ue] = (0, F.useState)([]), [de, fe] = (0, F.useState)({}), [pe, me] = (0, F.useState)({}), [he, ge] = (0, F.useState)(String(a.publish?.scan || "pr")), [_e, ve] = (0, F.useState)(String(a.publish?.delivery || "pr")), [ye, be] = (0, F.useState)(String(a.publish?.patch || "pr")), [xe, Se] = (0, F.useState)(a.feishu_notifications_enabled !== !1), [I, Ce] = (0, F.useState)(!!s.enabled), [we, Te] = (0, F.useState)(Array.isArray(s.agents) ? s.agents.map((e) => ({ ...e })) : []), [Ee, De] = (0, F.useState)({
		...
		table_name: s.test_case?.table_name || "Test Cases",
		base_app_token_env: s.test_case?.base_app_token_env || "FEISHU_MBPASS_QA_APP_TOKEN",
		...
		Ce(!!e.enabled), Te(t), De(n), ke({
			...
			table_name: e.test_case?.table_name || "Test Cases",
			base_app_token_env: e.test_case?.base_app_token_env || "FEISHU_MBPASS_QA_APP_TOKEN",
	...
	let Je = async (e) => {
		...
		table_name: Me.table_name || "Test Cases",
		base_app_token_env: Me.base_app_token_env || "FEISHU_MBPASS_QA_APP_TOKEN"
	}) !== (() => {
		try {
			let e = JSON.parse(Ae.testCase || "{}");
			return JSON.stringify({
				language: e.language || "zh-Hant",
				table_name: e.table_name || "Test Cases",
				base_app_token_env: e.base_app_token_env || "FEISHU_MBPASS_QA_APP_TOKEN"
			});
		} catch {
			return JSON.stringify({
				language: "zh-Hant",
				table_name: "Test Cases",
				base_app_token_env: "FEISHU_MBPASS_QA_APP_TOKEN"
			});
		}
	})() || !!Pe.trim(), st = [
		...
		if (!Ie) {
			...
			try {
				...
				})), at && e.push(() => zg("/api/publish-policy", t, {
					method: "POST",
					json: {
						scan_mode: he,
						delivery_mode: _e,
		...
		children: [
							...
							children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, Y.jsx)($, {
										...
										children: /* @__PURE__ */ (0, Y.jsx)("input", {
											value: e.role,
											onChange: (t) => qe(e.id, { role: t.target.value })
										})
									}),
									/* @__PURE__ */ (0, Y.jsx)($, {
										label: "Workflow",
										children: /* @__PURE__ */ (0, Y.jsx)("input", {
											value: e.workflow,
											onChange: (t) => qe(e.id, { workflow: t.target.value })
										})
									})
								]
							}), /* @__PURE__ */ (0, Y.jsxs)("label", {
			...
			/* @__PURE__ */ (0, Y.jsx)(u_, {
				...
				children: /* @__PURE__ */ (0, Y.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
						...
						}), /* @__PURE__ */ (0, Y.jsx)("p", { children: "Controls the language Mark writes into the Feishu Bitable Test Cases sheet for this project. Traditional Chinese is the default for mbpass." })]
					}), /* @__PURE__ */ (0, Y.jsxs)("div", {
						className: "settings-control wide",
						children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
							className: "form-grid compact",
							children: [
								...
								/* @__PURE__ */ (0, Y.jsx)($, {
									...
									children: /* @__PURE__ */ (0, Y.jsx)("input", {
										value: Me.table_name || "Test Cases",
										onChange: (e) => {
											Ne((t) => ({
												...t,
								...
								/* @__PURE__ */ (0, Y.jsx)($, {
									...
									help: Me.base_app_token_configured ? `Configured (${Me.base_app_token_masked || "set"}). Leave blank to keep. Env: ${Me.base_app_token_env || "FEISHU_MBPASS_QA_APP_TOKEN"}` : `Stored in ~/.lumen/.env.local as ${Me.base_app_token_env || "FEISHU_MBPASS_QA_APP_TOKEN"}`,
									children: /* @__PURE__ */ (0, Y.jsx)("input", {
										value: Pe,
										placeholder: Me.base_app_token_configured ? "Leave blank to keep current token" : "bas… / G6dI…",
										onChange: (e) => {
											Fe(e.target.value), L();
										},
										autoComplete: "off"
							...
							className: "schedule-note",
							children: "After changing language, ask Milchick/Mark to re-generate the story so new rows use the selected language."
						})]
					})]
				})
			}),
			...
			/* @__PURE__ */ (0, Y.jsxs)("footer", {
				...
				children: [/* @__PURE__ */ (0, Y.jsx)("span", {
					...
					disabled: !Re || Ie,
					onClick: () => void ct(),
					children: [Ie ? /* @__PURE__ */ (0, Y.jsx)(rg, {
						size: 15,
						className: "spin"
					}) : /* @__PURE__ */ (0, Y.jsx)(cg, { size: 15 }), Ie ? "Saving…" : "Save changes"]
				})]
			})
		]
	});
