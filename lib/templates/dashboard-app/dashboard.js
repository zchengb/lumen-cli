...
//#endregion
//#region package.json
var wh = "2.2.4", Th = (...e) => e.filter((e, t, n) => !!e && e.trim() !== "" && n.indexOf(e) === t).join(" ").trim(), Eh = (e) => e.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase(), Dh = (e) => e.replace(/^([A-Z])|[\s-_]+(\w)/g, (e, t, n) => n ? n.toUpperCase() : t.toLowerCase()), Oh = (e) => {
	let t = Dh(e);
...
function u_() {
	let [e, t] = (0, M.useState)(new URLSearchParams(window.location.search).get("project") || window.DASHBOARD_DATA?.interactive?.project || ""), [n, r] = (0, M.useState)(null), [i, a] = (0, M.useState)(Og.find((e) => `/${e.id}` === window.location.pathname)?.id || "scan"), [o, s] = (0, M.useState)(""), [c, l] = (0, M.useState)(null), [u, d] = (0, M.useState)(!0), [f, p] = (0, M.useState)(() => window.localStorage.getItem("lumen-sidebar-collapsed") === "true"), [m, h] = (0, M.useState)(null), [g, _] = (0, M.useState)(!1), [v, y] = (0, M.useState)(!1), [b, x] = (0, M.useState)(null), S = (0, M.useRef)(0), C = (0, M.useCallback)((e, t = "info") => l({
		message: e,
		tone: t
	}), []), w = async () => {
		let n = ++S.current;
	...
	}, O = n?.interactive?.projects || [], te = n?.product?.tagline || "Engineering, made legible.", ne = kg[i];
				...
				children: [
					/* @__PURE__ */ (0, X.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, X.jsx)("img", {
							...
							children: [/* @__PURE__ */ (0, X.jsx)("strong", { children: "Lumen" }), /* @__PURE__ */ (0, X.jsx)("span", { children: te })]
						})]
					}),
			...
			/* @__PURE__ */ (0, X.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, X.jsxs)("header", {
					...
					children: [/* @__PURE__ */ (0, X.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, X.jsx)("strong", { children: ne.title }), /* @__PURE__ */ (0, X.jsx)("span", { children: ne.description })]
					}), /* @__PURE__ */ (0, X.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, X.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, X.jsx)("h2", { children: f ? /* @__PURE__ */ (0, X.jsxs)("a", {
							...
							children: [ge && /* @__PURE__ */ (0, X.jsxs)("button", {
								...
								disabled: !me || te || D,
								onClick: () => void Se(),
								children: [te ? /* @__PURE__ */ (0, X.jsx)(rg, {
									size: 14,
									className: "spin"
								}) : /* @__PURE__ */ (0, X.jsx)(cg, { size: 14 }), te ? "Saving…" : "Save"]
							})]
						})]
					}), /* @__PURE__ */ (0, X.jsx)("div", {
...
function H_({ data: e, project: t, interact: n, notify: r }) {
	let i = e.interactive?.prompts || [], [a, o] = (0, M.useState)("scan"), [s, c] = (0, M.useState)(null), [l, u] = (0, M.useState)(""), [d, f] = (0, M.useState)(!1), [p, m] = (0, M.useState)({
		x: 0,
		y: 0,
		scale: 1
	}), [h, g] = (0, M.useState)(!1), _ = (0, M.useRef)(null), v = (0, M.useRef)(null), y = i.filter((e) => e.mode === a), b = async (e) => {
		c(e);
		try {
...
function Y_({ data: e, interact: t }) {
	let n = e.interactive?.workspace || {}, [r, i] = (0, M.useState)(n.repositories || []), [a, o] = (0, M.useState)(!1), [s, c] = (0, M.useState)(!1), [l, u] = (0, M.useState)(null), [d, f] = (0, M.useState)(!1), [p, m] = (0, M.useState)("all");
	(0, M.useEffect)(() => {
		a || i(n.repositories || []);
	}, [n.repositories, a]);
	let h = (e, t) => {
		...
		"behind",
		"diverged"
	].includes(String(e.health?.git_status)) || ["behind", "diverged"].includes(String(e.health?.sync_status))).length, x = r.filter((e) => _(e).patch.enabled).length, S = r.filter((e) => p === "all" || p === "patch" && _(e).patch.enabled || p === "attention" && ([
		"changes",
		"behind",
		"diverged"
	].includes(String(e.health?.git_status)) || ["behind", "diverged"].includes(String(e.health?.sync_status)))), C = l ? r.find((e) => e.name === l) : null, w = C ? r.indexOf(C) : -1, T = C?.health || {}, E = C ? _(C) : null;
	return /* @__PURE__ */ (0, X.jsxs)("div", {
										...
										children: [
											/* @__PURE__ */ (0, X.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, X.jsxs)("div", { children: [/* @__PURE__ */ (0, X.jsx)("strong", { children: e.name || "Unnamed repository" }), /* @__PURE__ */ (0, X.jsxs)("span", { children: [
													t.language || "Generic",
													" · ",
													t.build_tools?.join(", ") || "No build tool detected"
												] })] }), /* @__PURE__ */ (0, X.jsx)(zh, {
													size: 16,
													"aria-hidden": "true"
												})]
											...
											/* @__PURE__ */ (0, X.jsxs)("div", {
												className: "repository-card-meta",
												children: [/* @__PURE__ */ (0, X.jsx)(zg, { value: t.git_status || "unknown" }), /* @__PURE__ */ (0, X.jsxs)("span", { children: [/* @__PURE__ */ (0, X.jsx)(Zh, {
													size: 12,
													"aria-hidden": "true"
											...
											/* @__PURE__ */ (0, X.jsxs)("div", {
												...
												}), /* @__PURE__ */ (0, X.jsx)("span", { children: t.sync_status || "Sync status unknown" })]
											})
										]
									})
								}, e.name);
							}), S.length === 0 && /* @__PURE__ */ (0, X.jsx)(v_, { label: "No repositories match this view." })]
						})
					}),
					/* @__PURE__ */ (0, X.jsxs)("footer", {
						className: "repository-footer",
						children: [/* @__PURE__ */ (0, X.jsx)("span", {
							className: a ? "settings-save-status unsaved" : "settings-save-status",
							children: s ? "Saving repository…" : a ? "Unsaved repository changes" : "All changes saved"
						}), /* @__PURE__ */ (0, X.jsxs)("button", {
					...
					children: [/* @__PURE__ */ (0, X.jsxs)("header", {
						...
						children: [/* @__PURE__ */ (0, X.jsxs)("div", { children: [
							...
							/* @__PURE__ */ (0, X.jsx)("strong", {
								...
								children: C.name || "Unnamed repository"
							}),
							/* @__PURE__ */ (0, X.jsxs)("p", { children: [
								T.language || "Generic",
								" · ",
							...
							children: [
									...
									children: [
										...
										/* @__PURE__ */ (0, X.jsxs)("div", {
											...
											children: [
												/* @__PURE__ */ (0, X.jsx)(P_, {
													label: "Local path",
													value: /* @__PURE__ */ (0, X.jsx)("code", { children: C.path })
												}),
												/* @__PURE__ */ (0, X.jsx)(P_, {
													label: "Remote",
													value: /* @__PURE__ */ (0, X.jsx)("code", { children: T.remote_url || C.remote_url || "Not configured" })
												}),
												/* @__PURE__ */ (0, X.jsx)(P_, {
													label: "Git status",
													value: /* @__PURE__ */ (0, X.jsx)(zg, { value: T.git_status || "unknown" })
												}),
												/* @__PURE__ */ (0, X.jsx)(P_, {
													label: "Branch sync",
													value: /* @__PURE__ */ (0, X.jsx)(zg, { value: T.sync_status || "unknown" })
												})
											]
										}),
										/* @__PURE__ */ (0, X.jsx)("div", {
											...
											children: /* @__PURE__ */ (0, X.jsx)(G_, {
												...
												children: /* @__PURE__ */ (0, X.jsx)("select", {
													value: C.default_branch || "",
													onChange: (e) => h(w, { default_branch: e.target.value }),
													children: Array.from(new Set([C.default_branch, ...C.branches || []].filter(Boolean))).map((e) => /* @__PURE__ */ (0, X.jsx)("option", {
														value: e,
														children: e
													}, e))
												})
								...
								/* @__PURE__ */ (0, X.jsxs)("section", {
									...
									children: [/* @__PURE__ */ (0, X.jsxs)("div", { children: [/* @__PURE__ */ (0, X.jsx)("strong", { children: "Runtime & build" }), /* @__PURE__ */ (0, X.jsx)("span", { children: "Detected from repository files. These values are read-only until the repository changes." })] }), /* @__PURE__ */ (0, X.jsxs)("div", {
										...
										children: [
											/* @__PURE__ */ (0, X.jsx)(P_, {
												label: "Language",
												value: T.language || "Generic"
											}),
											/* @__PURE__ */ (0, X.jsx)(P_, {
												label: "Java",
												value: T.java_version ? `Java ${T.java_version}` : "Not detected"
											}),
											/* @__PURE__ */ (0, X.jsx)(P_, {
												label: "Node",
												value: T.node_version ? `Node ${T.node_version}` : "Not detected"
											}),
											/* @__PURE__ */ (0, X.jsx)(P_, {
												label: "Build tools",
												value: T.build_tools?.join(", ") || "Not detected"
											})
										]
									})]
								}),
										...
										/* @__PURE__ */ (0, X.jsxs)("div", {
											...
											children: [
												/* @__PURE__ */ (0, X.jsxs)("label", { children: [/* @__PURE__ */ (0, X.jsx)("input", {
													type: "checkbox",
													checked: E.scan.allow_auto_fix,
													onChange: (e) => v(w, "scan", { allow_auto_fix: e.target.checked })
												...
												/* @__PURE__ */ (0, X.jsxs)("label", { children: [/* @__PURE__ */ (0, X.jsx)("input", {
													type: "checkbox",
													checked: E.delivery.enabled,
													onChange: (e) => v(w, "delivery", { enabled: e.target.checked })
												...
												/* @__PURE__ */ (0, X.jsxs)("label", { children: [/* @__PURE__ */ (0, X.jsx)("input", {
													type: "checkbox",
													checked: E.patch.enabled,
													onChange: (e) => v(w, "patch", { enabled: e.target.checked })
								...
								/* @__PURE__ */ (0, X.jsxs)("section", {
									...
									children: [
										...
										T.suggested_commands?.length > 0 && /* @__PURE__ */ (0, X.jsxs)("button", {
											className: "text-button",
											onClick: () => h(w, { delivery_commands: T.suggested_commands.join("\n") }),
											children: [
												"Use ",
												T.suggested_commands.length,
												" suggested command",
												T.suggested_commands.length === 1 ? "" : "s"
											]
										}),
										/* @__PURE__ */ (0, X.jsx)("label", {
											className: "field repository-commands",
											children: /* @__PURE__ */ (0, X.jsx)("textarea", {
												value: C.delivery_commands ?? g(C),
												rows: 4,
												placeholder: "Optional override; one command per line.",
												onChange: (e) => h(w, { delivery_commands: e.target.value })
											})
										})
									]
								})
...
function Z_({ data: e, project: t, notify: n, onDirtyChange: r, reload: i }) {
	...
	(0, M.useEffect)(() => {
		...
		let e = (e) => {
			Ee && (e.preventDefault(), e.returnValue = "");
		};
		return window.addEventListener("beforeunload", e), () => window.removeEventListener("beforeunload", e);
	}, [Ee]);
	let ke = async (e) => {
	...
	}, Me = a.configured_integrations || [], Ne = Array.from(new Set([
		"To Do",
		"Backlog",
		"In Progress",
		"Done",
		...
		ne,
		k
	].filter(Boolean))), Pe = Array.isArray(o.delivery?.jira_statuses) ? o.delivery.jira_statuses.map(String) : String(o.delivery?.jira_status || "To Do,Backlog,In Progress").split(",").map((e) => e.trim()).filter(Boolean), Fe = Array.isArray(o.patch?.jira_statuses) ? o.patch.jira_statuses.map(String) : ["To Do"], Ie = (e, t) => e.length === t.length && e.every((e, n) => e === t[n]), Le = d !== !!o.scan || d && l !== String(o.scan?.cron || "0 12 * * 1-5"), Re = C !== !!o.delivery?.enabled || C && (p !== String(Math.round((o.delivery?.interval_seconds || 300) / 60)) || !Ie(h, Pe) || _ !== String(o.delivery?.in_dev_status || "") || y !== String(o.delivery?.dev_done_status || "") || x !== String(o.delivery?.blocked_status || "Block")), ze = ie !== !!o.patch?.enabled || ie && (T !== String(Math.round((o.patch?.interval_seconds || 300) / 60)) || !Ie(ee, Fe) || O !== String(o.patch?.in_progress_status || "In Progress") || ne !== String(o.patch?.done_status || "Done") || k !== String(o.patch?.blocked_status || "Block")), Be = _e !== String(a.publish?.scan || "pr") || ye !== String(a.publish?.delivery || "pr") || xe !== String(a.publish?.patch || "pr"), Ve = async () => {
		if (!Te) {
			N(!0);
			try {
				...
				})), Be && e.push(() => Rg("/api/publish-policy", t, {
					method: "POST",
					json: {
						scan_mode: _e,
						delivery_mode: ye,
				...
				ge({}), De(!1), r(!1), n("Settings saved", "success"), i();
			} catch (e) {
	...
	return /* @__PURE__ */ (0, X.jsxs)("div", {
		...
		children: [
									...
									children: [
										...
										/* @__PURE__ */ (0, X.jsx)(G_, {
											...
											children: /* @__PURE__ */ (0, X.jsx)("select", {
												...
												children: Ne.map((e) => /* @__PURE__ */ (0, X.jsx)("option", {
													value: e,
													children: e
												}, e))
											})
										...
										/* @__PURE__ */ (0, X.jsx)(G_, {
											...
											children: /* @__PURE__ */ (0, X.jsx)("select", {
												...
												children: Array.from(/* @__PURE__ */ new Set([...Ne, "Block"])).map((e) => /* @__PURE__ */ (0, X.jsx)("option", {
													value: e,
													children: e
												}, e))
											})
			...
			/* @__PURE__ */ (0, X.jsxs)("footer", {
				...
				children: [/* @__PURE__ */ (0, X.jsx)("span", {
					className: Ee ? "settings-save-status unsaved" : "settings-save-status",
					children: Te ? "Saving settings…" : Ee ? "You have unsaved changes" : "All changes saved"
				}), /* @__PURE__ */ (0, X.jsxs)("button", {
					className: `button primary${Te ? " is-busy" : ""}`,
					disabled: !Ee || Te,
					onClick: () => void Ve(),
					children: [Te ? /* @__PURE__ */ (0, X.jsx)(rg, {
						size: 15,
						className: "spin"
					}) : /* @__PURE__ */ (0, X.jsx)(cg, { size: 15 }), Te ? "Saving…" : "Save changes"]
				})]
			})
		]
	});
