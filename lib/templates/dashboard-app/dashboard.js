...
//#endregion
//#region package.json
var bl = _(), xl = "1.22.1", Sl = (...e) => e.filter((e, t, n) => !!e && e.trim() !== "" && n.indexOf(e) === t).join(" ").trim(), Cl = (e) => e.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase(), wl = (e) => e.replace(/^([A-Z])|[\s-_]+(\w)/g, (e, t, n) => n ? n.toUpperCase() : t.toLowerCase()), Tl = (e) => {
	let t = wl(e);
			...
			/* @__PURE__ */ (0, V.jsxs)("aside", {
				...
				children: [
					...
					/* @__PURE__ */ (0, V.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, V.jsx)("small", { children: f ? "" : `Version ${xl}` })
					})
				]
			}),
			/* @__PURE__ */ (0, V.jsx)(su, {
				...
				onClick: () => p((e) => !e),
				children: /* @__PURE__ */ (0, V.jsx)(Bl, { size: 14 })
			}),
...
function uu({ title: e, description: t, action: n }) {
		...
		/* @__PURE__ */ (0, V.jsxs)(cu, {
			...
			children: [/* @__PURE__ */ (0, V.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, V.jsxs)("table", { children: [/* @__PURE__ */ (0, V.jsx)("thead", { children: /* @__PURE__ */ (0, V.jsxs)("tr", { children: [
					...
					/* @__PURE__ */ (0, V.jsx)("td", { children: /* @__PURE__ */ (0, V.jsx)(ou, { value: e.status }) }),
			...
			children: [/* @__PURE__ */ (0, V.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, V.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, V.jsx)("h4", { children: eu(e.title, "Untitled finding") }), /* @__PURE__ */ (0, V.jsx)(ou, { value: i })]
					}),
...
function bu({ data: e, project: t }) {
	let n = e.delivery || {}, r = n.current || {}, i = n.runs || [], a = r.stages || [], [o, s] = (0, H.useState)(null), [c, l] = (0, H.useState)(null), [u, d] = (0, H.useState)(""), [f, p] = (0, H.useState)(""), [m, h] = (0, H.useState)(!1), g = async (e, n = r.run_id || "") => {
		s(e), d(""), p(""), h(!0);
		try {
			let e = await au(`/api/delivery/log?run_id=${encodeURIComponent(n)}`, t);
		...
		/* @__PURE__ */ (0, V.jsxs)(cu, {
			...
			children: [/* @__PURE__ */ (0, V.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, V.jsx)(wu, {
						label: "Status",
						value: /* @__PURE__ */ (0, V.jsx)(ou, { value: r.delivery_status || "not started" })
					}),
					/* @__PURE__ */ (0, V.jsx)(wu, {
						label: "Elapsed",
						value: nu(r.started_at, r.finished_at)
					}),
					/* @__PURE__ */ (0, V.jsx)(wu, {
						label: "Finished",
						value: tu(r.finished_at)
					})
				]
			}), /* @__PURE__ */ (0, V.jsx)(Su, {
				stages: a,
				...
				children: /* @__PURE__ */ (0, V.jsxs)("table", { children: [/* @__PURE__ */ (0, V.jsx)("thead", { children: /* @__PURE__ */ (0, V.jsxs)("tr", { children: [
					...
					return /* @__PURE__ */ (0, V.jsxs)("tr", { children: [
						...
						/* @__PURE__ */ (0, V.jsx)("td", { children: r ? /* @__PURE__ */ (0, V.jsx)("button", {
							...
							children: /* @__PURE__ */ (0, V.jsx)(ou, { value: e.status })
						}) : /* @__PURE__ */ (0, V.jsx)(ou, { value: e.status }) }),
...
function Su({ stages: e, deliveryStatus: t, startedAt: n, finishedAt: r, onStageClick: i }) {
	...
	return /* @__PURE__ */ (0, V.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, V.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, V.jsxs)("div", { children: [/* @__PURE__ */ (0, V.jsx)("span", { children: "Delivery Flow" }), /* @__PURE__ */ (0, V.jsx)("strong", { children: "Execution path" })] }), /* @__PURE__ */ (0, V.jsxs)("p", { children: [n ? `Started ${tu(n)}` : "Awaiting delivery trigger", r ? ` · Finished ${tu(r)}` : ""] })]
		}), /* @__PURE__ */ (0, V.jsxs)("div", {
...
function Nu({ data: e, project: t, interact: n, notify: r }) {
	let i = e.interactive?.prompts || [], [a, o] = (0, H.useState)("scan"), [s, c] = (0, H.useState)(null), [l, u] = (0, H.useState)(""), [d, f] = (0, H.useState)(1), p = i.filter((e) => e.mode === a), m = async (e) => {
		c(e);
		try {
		...
		o(e), c(null), u(""), f(1);
	}, g = (e) => f((t) => Math.max(.7, Math.min(1.3, Math.round((t + e) * 10) / 10))), _ = Mu(a);
	return /* @__PURE__ */ (0, V.jsxs)(V.Fragment, { children: [
		/* @__PURE__ */ (0, V.jsx)(uu, {
			title: "WORKFLOW",
		...
		/* @__PURE__ */ (0, V.jsx)(cu, {
			...
			action: /* @__PURE__ */ (0, V.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, V.jsxs)("span", { children: [Math.round(d * 100), "%"] }),
					/* @__PURE__ */ (0, V.jsx)(su, {
						label: "Zoom out",
						onClick: () => g(-.1),
						children: /* @__PURE__ */ (0, V.jsx)(Ql, { size: 14 })
					}),
					/* @__PURE__ */ (0, V.jsx)(su, {
						label: "Reset zoom",
						onClick: () => f(1),
						children: /* @__PURE__ */ (0, V.jsx)(Hl, { size: 13 })
					}),
					/* @__PURE__ */ (0, V.jsx)(su, {
						label: "Zoom in",
						onClick: () => g(.1),
						children: /* @__PURE__ */ (0, V.jsx)(Zl, { size: 14 })
					})
				]
			}),
			...
			children: /* @__PURE__ */ (0, V.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, V.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, V.jsx)("div", {
						...
						children: _.map((e, t) => {
							let n = p.filter((t) => e.layers.includes(ju(t, a))), r = [...e.scripts.map((e) => ({
								kind: "script",
								script: e
							})), ...n.map((e) => ({
								kind: "prompt",
							...
							return /* @__PURE__ */ (0, V.jsxs)("section", {
								...
								children: [
									...
									t < _.length - 1 && /* @__PURE__ */ (0, V.jsx)("span", {
						...
						children: [/* @__PURE__ */ (0, V.jsx)(Hl, { size: 14 }), /* @__PURE__ */ (0, V.jsxs)("span", { children: [/* @__PURE__ */ (0, V.jsx)("strong", { children: a === "delivery" ? "Remediation retry" : "Safe-fix re-review" }), /* @__PURE__ */ (0, V.jsx)("small", { children: a === "delivery" ? "Verification failure → prepare_delivery_remediation.py → implementation agent → verification" : "High-confidence finding → auto_fix_sync.py → focused validation → pull request" })] })]
					})]
				})
			})
		}),
		...
		children: /* @__PURE__ */ (0, V.jsxs)("section", {
			...
			children: [
				...
				/* @__PURE__ */ (0, V.jsxs)("footer", { children: [/* @__PURE__ */ (0, V.jsx)("button", {
					...
					className: "button primary",
					onClick: i,
					children: [/* @__PURE__ */ (0, V.jsx)(Ul, { size: 14 }), "Save prompt"]
				})] })
			]
		})
	});
...
function Fu({ data: e, project: t, interact: n, notify: r }) {
	...
	return /* @__PURE__ */ (0, V.jsxs)(V.Fragment, { children: [/* @__PURE__ */ (0, V.jsx)(uu, {
		title: "SETTINGS",
		...
		children: [
			/* @__PURE__ */ (0, V.jsxs)(cu, {
				...
				children: [/* @__PURE__ */ (0, V.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, V.jsx)(Tu, {
						label: "Workspace",
						value: /* @__PURE__ */ (0, V.jsx)("code", { children: eu(i.path) })
					}), /* @__PURE__ */ (0, V.jsx)(Tu, {
			...
			/* @__PURE__ */ (0, V.jsxs)(cu, {
				...
				children: [/* @__PURE__ */ (0, V.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, V.jsxs)("div", {
						className: "settings-copy",
						children: [/* @__PURE__ */ (0, V.jsx)("h4", { children: "Auto Scan" }), /* @__PURE__ */ (0, V.jsx)("p", { children: eu(a.scan?.description, "No recurring scan is configured.") })]
					}), /* @__PURE__ */ (0, V.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, V.jsxs)("div", {
						className: "settings-copy",
						children: [/* @__PURE__ */ (0, V.jsx)("h4", { children: "Auto Delivery" }), /* @__PURE__ */ (0, V.jsx)("p", { children: eu(a.delivery?.description, "No delivery polling is configured.") })]
					}), /* @__PURE__ */ (0, V.jsxs)("div", {
						className: "settings-control wide",
						children: [/* @__PURE__ */ (0, V.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, V.jsxs)("div", { children: [
										...
										/* @__PURE__ */ (0, V.jsx)(su, {
											label: "Edit value",
											onClick: () => void S(e),
											children: /* @__PURE__ */ (0, V.jsx)(Vl, { size: 15 })
										})
									] })
								]
...
(0, bl.createRoot)(document.getElementById("root")).render(/* @__PURE__ */ (0, V.jsx)(lu, {}));
//#endregion
