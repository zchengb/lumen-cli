...
var bg = /* @__PURE__ */ new Map(), xg = /* @__PURE__ */ new Map(), Sg = 0, Cg = .5, wg = 3, Tg = .25, Eg = [
	{
		id: "scan",
		label: "AUTO SCAN",
		icon: cg
...
function Ng(e) {
	let t = kg(e, "unknown").toLowerCase().replaceAll("_", " ");
	return {
...
function Fg({ value: e }) {
	return /* @__PURE__ */ (0, Y.jsx)("span", {
		className: `badge ${Mg(e)}`,
		children: Ng(e)
	});
}
function Ig({ business: e, technical: t, compact: n = !1 }) {
	return /* @__PURE__ */ (0, Y.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, Y.jsxs)("span", {
			...
			children: [/* @__PURE__ */ (0, Y.jsx)("em", { children: "Business" }), /* @__PURE__ */ (0, Y.jsx)(Fg, { value: e || "draft" })]
		}), /* @__PURE__ */ (0, Y.jsxs)("span", {
			className: "observatory-meta-item",
			children: [/* @__PURE__ */ (0, Y.jsx)("em", { children: "Technical" }), /* @__PURE__ */ (0, Y.jsx)(Fg, { value: t || "draft" })]
		})]
	});
}
function Lg({ business: e, technical: t }) {
	let n = Mg(e || "draft"), r = Mg(t || "draft");
	return /* @__PURE__ */ (0, Y.jsxs)("div", {
		className: "observatory-story-status",
		children: [/* @__PURE__ */ (0, Y.jsxs)("span", {
			className: `observatory-story-status-item ${n}`,
			children: [
				n === "success" ? /* @__PURE__ */ (0, Y.jsx)("i", { className: "observatory-status-dot" }) : /* @__PURE__ */ (0, Y.jsx)(Vh, { size: 11 }),
				"Business ",
				Ng(e || "draft")
			]
		}), /* @__PURE__ */ (0, Y.jsxs)("span", {
			...
			children: [
				r === "success" ? /* @__PURE__ */ (0, Y.jsx)(Bh, { size: 12 }) : /* @__PURE__ */ (0, Y.jsx)(Vh, { size: 11 }),
				"Technical ",
				Ng(t || "draft")
			]
		})]
...
function Rg({ label: e, onClose: t, children: n }) {
	let [r, i] = (0, M.useState)(1), [a, o] = (0, M.useState)({
		x: 0,
		y: 0
	}), [s, c] = (0, M.useState)(!1), l = (0, M.useRef)(null), u = (e) => Math.min(wg, Math.max(Cg, Number(e.toFixed(2)))), d = () => {
		i(1), o({
			x: 0,
			y: 0
		});
	...
	(0, M.useEffect)(() => {
		let e = (e) => {
			e.key === "Escape" && t(), (e.key === "+" || e.key === "=") && i((e) => u(e + Tg)), (e.key === "-" || e.key === "_") && i((e) => u(e - Tg)), e.key === "0" && d();
		};
		...
		children: [/* @__PURE__ */ (0, Y.jsxs)("header", { children: [/* @__PURE__ */ (0, Y.jsx)("span", { children: e }), /* @__PURE__ */ (0, Y.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, Y.jsx)("button", {
					...
					"aria-label": "Zoom in",
					onClick: () => i((e) => u(e + Tg)),
					children: /* @__PURE__ */ (0, Y.jsx)(vg, { size: 14 })
				}),
				/* @__PURE__ */ (0, Y.jsx)("button", {
					type: "button",
					className: "button secondary",
...
async function zg(e) {
	let t = bg.get(e);
	if (t) return t;
	let n = `mmd-${++Sg}`, { svg: r } = await $i.render(n, e);
	return bg.set(e, r), r;
}
var Bg = (0, M.memo)(function({ chart: e }) {
	...
	}), n && /* @__PURE__ */ (0, Y.jsx)(Rg, {
		label: "Diagram",
		onClose: () => r(!1),
		children: /* @__PURE__ */ (0, Y.jsx)("div", {
			className: "mermaid-block mermaid-block-fullscreen",
			dangerouslySetInnerHTML: { __html: bg.get(e) || t.current?.innerHTML || "" }
		})
	})] });
});
function Vg({ src: e, alt: t }) {
...
function Hg({ className: e, children: t }) {
	let n = String(t).replace(/\n$/, ""), [r, i] = (0, M.useState)(!1);
	return /language-mermaid/.test(e || "") ? /* @__PURE__ */ (0, Y.jsx)(Bg, { chart: n }) : !n.includes("\n") && !e ? /* @__PURE__ */ (0, Y.jsx)("code", {
		className: e,
		children: t
...
var Ug = {
	...
	img({ src: e, alt: t }) {
		return /* @__PURE__ */ (0, Y.jsx)(Vg, {
			src: e,
			alt: t
		});
	},
	code({ className: e, children: t }) {
		return /* @__PURE__ */ (0, Y.jsx)(Hg, {
			className: e,
			children: t
		});
	}
};
function Wg({ content: e }) {
...
var qg = "<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"14\" height=\"14\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><rect width=\"14\" height=\"14\" x=\"8\" y=\"8\" rx=\"2\" ry=\"2\"/><path d=\"M4 16V4a2 2 0 0 1 2-2h12\"/></svg>";
function Jg(e) {
	for (let t of Array.from(e.querySelectorAll("pre"))) {
		...
		o.type = "button", o.className = "md-code-copy", o.title = "Copy code", o.setAttribute("aria-label", "Copy code"), o.innerHTML = qg, o.onclick = (n) => {
...
async function Zg(e) {
	...
	await Promise.all(t.map(async (e) => {
		let t = e.closest(".mermaid-wrap")?.getAttribute("data-mm-id") || "", n = xg.get(t);
		if (n) try {
			e.innerHTML = await zg(n);
		} catch (t) {
...
function $g({ value: e, onChange: t }) {
	let { frontmatter: n, body: r } = Gg(e), i = (0, M.useRef)(null), a = (0, M.useRef)(!1), o = (0, M.useRef)(!1), s = (0, M.useRef)(r), c = (0, M.useRef)(Xg()), [l, u] = (0, M.useState)(null);
	s.current = r;
	let d = (e) => t(Kg(n, e)), f = () => {
		let e = i.current;
		if (!e) return;
		let t = c.current.turndown(e);
		Qg(o.current, t, s.current) && d(t);
	}, p = (0, M.useCallback)(async (e) => {
		let t = i.current;
		if (!t) return;
		o.current = !1, t.innerHTML = Yg(e), Jg(t), t.querySelectorAll("a[href]").forEach((e) => {
...
function e_({ label: e, children: t, onClick: n, danger: r = !1, disabled: i = !1, className: a = "" }) {
...
function t_({ title: e, action: t, children: n, className: r = "" }) {
...
function n_() {
	let [e, t] = (0, M.useState)(new URLSearchParams(window.location.search).get("project") || window.DASHBOARD_DATA?.interactive?.project || ""), [n, r] = (0, M.useState)(null), [i, a] = (0, M.useState)(Eg.find((e) => `/${e.id}` === window.location.pathname)?.id || "scan"), [o, s] = (0, M.useState)(""), [c, l] = (0, M.useState)(null), [u, d] = (0, M.useState)(!0), [f, p] = (0, M.useState)(() => window.localStorage.getItem("lumen-sidebar-collapsed") === "true"), [m, h] = (0, M.useState)(null), [g, _] = (0, M.useState)(!1), [v, y] = (0, M.useState)(!1), b = (0, M.useCallback)((e, t = "info") => l({
		message: e,
		tone: t
	}), []), x = async () => {
		d(!0);
		try {
			let n = await Pg("/api/state", e);
	...
	(0, M.useEffect)(() => {
		...
		let e = () => a(Eg.find((e) => `/${e.id}` === window.location.pathname)?.id || "scan");
	...
	}, E = n?.interactive?.projects || [], ee = n?.product?.tagline || "Engineering, made legible.", D = Dg[i];
				...
				children: [/* @__PURE__ */ (0, Y.jsxs)("header", {
					...
					children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, Y.jsx)("span", {
							...
							children: m ? `Updated ${Ag(m.toISOString())}` : "Syncing…"
					...
					children: [
						...
						!n && u ? /* @__PURE__ */ (0, Y.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, Y.jsx)(ng, {
								size: 22,
								className: "spin"
							}), " Loading local workspace state…"]
						}) : null,
						n && i === "scan" && /* @__PURE__ */ (0, Y.jsx)(r_, {
							data: n,
							project: e,
							interact: T
						}),
						n && i === "delivery" && /* @__PURE__ */ (0, Y.jsx)(d_, {
							data: n,
							project: e,
							notify: b,
							reload: x
						}),
						n && i === "observatory" && /* @__PURE__ */ (0, Y.jsx)(h_, {
							project: e,
							notify: b,
							onDirtyChange: y
						}),
						...
						n && i === "prompts" && /* @__PURE__ */ (0, Y.jsx)(D_, {
							data: n,
							project: e,
							interact: T,
							notify: b
						}),
						n && i === "settings" && /* @__PURE__ */ (0, Y.jsx)(N_, {
							data: n,
							project: e,
							notify: b,
							onDirtyChange: _,
...
function r_({ data: e, project: t, interact: n }) {
	...
	return /* @__PURE__ */ (0, Y.jsxs)(Y.Fragment, { children: [
		...
		/* @__PURE__ */ (0, Y.jsxs)(t_, {
			...
			children: [/* @__PURE__ */ (0, Y.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, Y.jsxs)("table", { children: [/* @__PURE__ */ (0, Y.jsx)("thead", { children: /* @__PURE__ */ (0, Y.jsxs)("tr", { children: [
					...
					/* @__PURE__ */ (0, Y.jsx)("td", { children: Ag(e.started_at || e.finished_at) }),
					/* @__PURE__ */ (0, Y.jsx)("td", { children: /* @__PURE__ */ (0, Y.jsx)(Fg, { value: e.status }) }),
					/* @__PURE__ */ (0, Y.jsx)("td", { children: /* @__PURE__ */ (0, Y.jsx)(o_, { run: e }) }),
					/* @__PURE__ */ (0, Y.jsx)("td", { children: kg(e.duration) }),
			...
			}), a.length > 10 && /* @__PURE__ */ (0, Y.jsx)(s_, {
				page: u,
		...
		/* @__PURE__ */ (0, Y.jsxs)(t_, {
			...
			children: [/* @__PURE__ */ (0, Y.jsx)("div", {
				...
				id: "tracked-findings",
				className: "findings",
				children: p.length ? p.map((e) => /* @__PURE__ */ (0, Y.jsx)(c_, {
					issue: e,
					onIgnore: () => s(e)
				}, e.id)) : /* @__PURE__ */ (0, Y.jsx)(a_, { label: "No findings match this status." })
			})]
		}),
		o && /* @__PURE__ */ (0, Y.jsx)(u_, {
			onClose: () => s(null),
			onConfirm: (e) => {
				n("/api/issue/ignore", {
					issue_id: o.id,
...
function i_({ label: e, value: t, onClick: n }) {
	return /* @__PURE__ */ (0, Y.jsxs)("div", {
...
function a_({ label: e }) {
	return /* @__PURE__ */ (0, Y.jsxs)("div", {
		className: "empty",
		children: [/* @__PURE__ */ (0, Y.jsx)(dg, { size: 20 }), e]
	});
}
function o_({ run: e }) {
	let t = [
...
function s_({ page: e, pageCount: t, onChange: n }) {
...
function c_({ issue: e, onIgnore: t }) {
			...
			children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, Y.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, Y.jsx)("h4", { children: kg(e.title, "Untitled finding") }), /* @__PURE__ */ (0, Y.jsx)(Fg, { value: i })]
					}),
					/* @__PURE__ */ (0, Y.jsxs)("p", {
						...
						children: [
							...
							kg(e.repository, "Unknown repository"),
							" ",
							/* @__PURE__ */ (0, Y.jsx)("i", { children: "|" }),
							" ",
							Ag(e.last_seen_at)
...
function l_({ label: e, value: t, code: n = !1 }) {
	return /* @__PURE__ */ (0, Y.jsxs)("section", {
		className: "finding-detail-row",
		children: [/* @__PURE__ */ (0, Y.jsx)("h5", { children: e }), n ? /* @__PURE__ */ (0, Y.jsx)("pre", { children: /* @__PURE__ */ (0, Y.jsx)("code", { children: kg(t, "No code snippet was captured for this historical finding.") }) }) : /* @__PURE__ */ (0, Y.jsx)("p", { children: kg(t, "Not recorded.") })]
	});
}
function u_({ onClose: e, onConfirm: t }) {
...
function d_({ data: e, project: t, notify: n, reload: r }) {
	let i = e.delivery || {}, a = i.current || {}, o = i.runs || [], s = a.stages || [], c = i.scheduler_activity || [], l = i.available_stories || [], [u, d] = (0, M.useState)(null), [f, p] = (0, M.useState)(null), [m, h] = (0, M.useState)(""), [g, _] = (0, M.useState)(""), [v, y] = (0, M.useState)(!1), [b, x] = (0, M.useState)(!1), [S, C] = (0, M.useState)(!1), [w, T] = (0, M.useState)(!1), [E, ee] = (0, M.useState)(""), [D, te] = (0, M.useState)(!1), [ne, re] = (0, M.useState)(""), [ie, O] = (0, M.useState)(!1), [k, ae] = (0, M.useState)(""), [oe, se] = (0, M.useState)(null), [ce, le] = (0, M.useState)(""), [A, ue] = (0, M.useState)(Date.now()), de = /in_progress|running/i.test(String(a.delivery_status || "")), j = (() => {
		...
		n || y(!0);
		try {
			let n = await Pg(`/api/delivery/log?run_id=${encodeURIComponent(e)}`, t);
	...
	let me = async (e, t = a.run_id || "") => {
		...
		x(!0), h(""), _(""), y(!0);
		try {
			let e = await Pg("/api/delivery/scheduler-log", t);
		...
		try {
			let n = await Pg(`/api/delivery/trace?run_id=${encodeURIComponent(e)}`, t);
			d({
				label: "Trace",
		...
		if (e) {
			le(e), ae("");
			try {
				await Pg("/api/delivery/history/delete", t, {
					method: "POST",
					json: { run_id: e }
	...
	return /* @__PURE__ */ (0, Y.jsxs)(Y.Fragment, { children: [
			...
			action: /* @__PURE__ */ (0, Y.jsxs)("span", {
				...
				children: [
					!de && j.length > 0 && /* @__PURE__ */ (0, Y.jsxs)("button", {
						...
						disabled: ie,
						onClick: _e,
						children: [/* @__PURE__ */ (0, Y.jsx)(ag, { size: 14 }), "Start"]
					}),
					...
					Se && /* @__PURE__ */ (0, Y.jsxs)("button", {
						className: "button secondary",
						onClick: () => C(!0),
						children: [/* @__PURE__ */ (0, Y.jsx)(og, { size: 14 }), "Retry"]
					})
				]
			}),
			children: [
				/* @__PURE__ */ (0, Y.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, Y.jsx)(y_, {
							label: "Status",
							value: /* @__PURE__ */ (0, Y.jsx)(Fg, { value: a.delivery_status || "not started" })
						}),
						/* @__PURE__ */ (0, Y.jsx)(y_, {
							label: "Elapsed",
							value: jg(a.started_at, a.finished_at || (de ? new Date(A).toISOString() : void 0))
						}),
						/* @__PURE__ */ (0, Y.jsx)(y_, {
							label: "Finished",
							value: de ? "Running" : Ag(a.finished_at)
						})
					]
				}),
					...
					return /* @__PURE__ */ (0, Y.jsxs)("tr", { children: [
						/* @__PURE__ */ (0, Y.jsx)("td", { children: /* @__PURE__ */ (0, Y.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, Y.jsxs)("span", {
								...
								children: [/* @__PURE__ */ (0, Y.jsx)("code", { children: kg(e.jira_key || e.story || e.run_id) }), e.story_title && /* @__PURE__ */ (0, Y.jsx)("span", {
									className: "history-story-title",
									children: e.story_title
								})]
							}), /* @__PURE__ */ (0, Y.jsx)("small", { children: kg(e.branch, "") })]
						}) }),
						/* @__PURE__ */ (0, Y.jsx)("td", { children: Ag(e.finished_at || e.started_at) }),
						/* @__PURE__ */ (0, Y.jsx)("td", { children: r ? /* @__PURE__ */ (0, Y.jsx)("button", {
							...
							onClick: () => void me({
								...
								duration: jg(e.started_at, e.finished_at),
								detail: n.map((e) => e.summary || e.label).filter(Boolean).join(" · ") || "Open the delivery log for details."
							}, e.run_id),
							children: /* @__PURE__ */ (0, Y.jsx)(Fg, { value: e.status })
						}) : /* @__PURE__ */ (0, Y.jsx)(Fg, { value: e.status }) }),
						/* @__PURE__ */ (0, Y.jsx)("td", { children: /* @__PURE__ */ (0, Y.jsx)(b_, { items: e.pull_requests || [] }) }),
						/* @__PURE__ */ (0, Y.jsx)("td", { children: /* @__PURE__ */ (0, Y.jsx)(x_, {
							checks: t,
							onClick: () => p(t)
						}) }),
						/* @__PURE__ */ (0, Y.jsx)("td", { children: jg(e.started_at, e.finished_at) }),
						/* @__PURE__ */ (0, Y.jsx)("td", { children: e.agent_trace && /* @__PURE__ */ (0, Y.jsx)("button", {
							className: "text-button",
							onClick: () => void be(e.run_id),
							children: "View trace"
						}) }),
						/* @__PURE__ */ (0, Y.jsx)("td", { children: /* @__PURE__ */ (0, Y.jsx)(e_, {
							label: "Delete delivery record",
							danger: !0,
							disabled: ce === e.run_id,
							onClick: () => se(e),
							children: /* @__PURE__ */ (0, Y.jsx)(mg, { size: 15 })
						}) })
					] }, e.run_id);
				}) : /* @__PURE__ */ (0, Y.jsx)("tr", { children: /* @__PURE__ */ (0, Y.jsx)("td", {
					colSpan: 8,
					children: /* @__PURE__ */ (0, Y.jsx)(a_, { label: "No delivery history yet." })
				}) }) })] })
			})
		}),
		/* @__PURE__ */ (0, Y.jsx)(t_, {
			...
			action: /* @__PURE__ */ (0, Y.jsxs)("span", {
				...
				children: [/* @__PURE__ */ (0, Y.jsxs)("span", {
					...
					className: "button secondary",
					onClick: () => void he(),
					children: [/* @__PURE__ */ (0, Y.jsx)(pg, { size: 14 }), "View raw log"]
				})]
			}),
			children: /* @__PURE__ */ (0, Y.jsx)("div", {
				...
				children: c.length ? c.map((e, t) => /* @__PURE__ */ (0, Y.jsxs)("article", {
					...
					children: [
						/* @__PURE__ */ (0, Y.jsx)(Fg, { value: e.outcome }),
						/* @__PURE__ */ (0, Y.jsxs)("div", { children: [/* @__PURE__ */ (0, Y.jsx)("strong", { children: kg(e.story_id || e.jira_key, "Workspace") }), /* @__PURE__ */ (0, Y.jsx)("p", { children: kg(e.message) })] }),
						/* @__PURE__ */ (0, Y.jsx)("time", { children: Ag(e.at) })
					]
				}, `${e.at}-${t}`)) : /* @__PURE__ */ (0, Y.jsx)(a_, { label: "No scheduled delivery activity recorded yet." })
			})
		}),
		u && /* @__PURE__ */ (0, Y.jsx)(v_, {
			stage: u,
			content: m,
			error: g,
			loading: v,
		...
		f && /* @__PURE__ */ (0, Y.jsx)(S_, {
			checks: f,
			onClose: () => p(null)
		}),
		S && /* @__PURE__ */ (0, Y.jsx)(p_, {
			story: kg(a.jira_key || a.story_id),
			busy: w,
			error: E,
			onClose: () => C(!1),
			onConfirm: () => void ge()
		}),
		D && /* @__PURE__ */ (0, Y.jsx)(f_, {
			stories: j,
			value: ne,
			onChange: re,
			busy: ie,
...
function f_({ stories: e, value: t, onChange: n, busy: r, error: i, onClose: a, onConfirm: o }) {
	return /* @__PURE__ */ (0, Y.jsx)("div", {
		className: "modal-backdrop",
		role: "presentation",
		...
		children: /* @__PURE__ */ (0, Y.jsxs)("section", {
			...
			children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
				...
				disabled: r || !t,
				onClick: o,
				children: [/* @__PURE__ */ (0, Y.jsx)(ag, { size: 14 }), r ? "Starting…" : "Start"]
			})] })]
		})
	});
}
function p_({ story: e, busy: t, error: n, onClose: r, onConfirm: i }) {
	return /* @__PURE__ */ (0, Y.jsx)("div", {
		className: "modal-backdrop",
		role: "presentation",
		...
		children: /* @__PURE__ */ (0, Y.jsxs)("section", {
			...
			children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
				...
				disabled: t,
				onClick: i,
				children: [/* @__PURE__ */ (0, Y.jsx)(og, { size: 14 }), t ? "Starting…" : "Retry"]
			})] })]
		})
	});
}
function m_({ run: e, busy: t, onClose: n, onConfirm: r }) {
	let i = kg(e.jira_key || e.story || e.run_id);
	return /* @__PURE__ */ (0, Y.jsx)("div", {
		className: "modal-backdrop",
		role: "presentation",
		...
		children: /* @__PURE__ */ (0, Y.jsxs)("section", {
			...
			children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
				...
				disabled: t,
				onClick: r,
				children: [/* @__PURE__ */ (0, Y.jsx)(mg, { size: 14 }), t ? "Deleting…" : "Delete record"]
			})] })]
		})
	});
}
function h_({ project: e, notify: t, onDirtyChange: n }) {
	let r = new URLSearchParams(window.location.search).get("story") || "", [i, a] = (0, M.useState)([]), [o, s] = (0, M.useState)(r), [c, l] = (0, M.useState)(""), [u, d] = (0, M.useState)(""), [f, p] = (0, M.useState)(""), [m, h] = (0, M.useState)(""), [g, _] = (0, M.useState)(""), [v, y] = (0, M.useState)(""), [b, x] = (0, M.useState)(""), [S, C] = (0, M.useState)({
		story: "",
		plan: ""
	}), [w, T] = (0, M.useState)("story"), [E, ee] = (0, M.useState)(!0), [D, te] = (0, M.useState)(!1), [ne, re] = (0, M.useState)(!1), [ie, O] = (0, M.useState)(""), [k, ae] = (0, M.useState)(!1), [oe, se] = (0, M.useState)(!1), ce = v !== S.story || b !== S.plan;
	(0, M.useEffect)(() => {
		n(ce);
	}, [ce, n]), (0, M.useEffect)(() => {
		let e = (e) => {
			ce && (e.preventDefault(), e.returnValue = "");
		};
		return window.addEventListener("beforeunload", e), () => window.removeEventListener("beforeunload", e);
	}, [ce]);
	let le = (0, M.useCallback)(async () => {
		ee(!0);
		try {
			let t = await Pg("/api/stories", e), n = Array.isArray(t.stories) ? t.stories : [];
		...
		if (n) {
			te(!0), T("story");
			try {
				let t = await Pg(`/api/stories/content?story=${encodeURIComponent(n)}`, e), r = String(t.story_markdown || ""), i = String(t.plan_markdown || "");
	...
	let ue = (e) => {
		e !== o && (ce && !window.confirm("You have unsaved Observatory changes. Switch stories without saving?") || s(e));
	}, de = async () => {
		if (!(!o || !ce)) {
			re(!0);
			try {
				let n = await Pg("/api/stories/content", e, {
					method: "POST",
					json: {
						story: o,
						story_markdown: v,
				...
				C({
					story: v,
					plan: b
				}), t(String(n.subject || "Story docs saved"), "success"), await le();
			} catch (e) {
	...
	}, j = kg(u || o), fe = kg(c, o), pe = i.filter((e) => {
		if (oe && String(e.businessStatus || "").toLowerCase() !== "ready") return !1;
		let t = ie.trim().toLowerCase();
		return !t || `${e.jira_key || ""} ${e.title || ""} ${e.story || ""}`.toLowerCase().includes(t);
	});
	return /* @__PURE__ */ (0, Y.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, Y.jsxs)("aside", {
			...
			children: [
				/* @__PURE__ */ (0, Y.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, Y.jsx)("h3", { children: "Stories" }), /* @__PURE__ */ (0, Y.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, Y.jsx)("button", {
							...
							"aria-pressed": k,
							onClick: () => ae((e) => !e),
							children: /* @__PURE__ */ (0, Y.jsx)(lg, { size: 15 })
						}), /* @__PURE__ */ (0, Y.jsx)("button", {
							type: "button",
							...
							"aria-pressed": oe,
							onClick: () => se((e) => !e),
							children: /* @__PURE__ */ (0, Y.jsx)(eg, { size: 15 })
						})]
					})]
				}),
				k && /* @__PURE__ */ (0, Y.jsx)("div", {
				...
				/* @__PURE__ */ (0, Y.jsxs)("div", {
					...
					children: [
						...
						!E && !pe.length ? /* @__PURE__ */ (0, Y.jsx)(a_, { label: i.length ? "No stories match this filter." : "No stories found in the docs repository." }) : null,
						pe.map((e) => {
							let t = kg(e.jira_key || e.story), n = kg(e.title, e.story);
							return /* @__PURE__ */ (0, Y.jsxs)("button", {
								className: `observatory-story ${o === e.story ? "selected" : ""}`,
								onClick: () => ue(String(e.story)),
								children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
			...
			children: o ? /* @__PURE__ */ (0, Y.jsxs)(Y.Fragment, { children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, Y.jsx)("h2", { children: f ? /* @__PURE__ */ (0, Y.jsxs)("a", {
						...
						children: [/* @__PURE__ */ (0, Y.jsx)("span", {
							className: ce ? "settings-save-status unsaved" : "settings-save-status",
							children: ce ? "Unsaved" : "Saved"
						}), /* @__PURE__ */ (0, Y.jsxs)("button", {
							type: "button",
							className: `button primary${ne ? " is-busy" : ""}`,
							disabled: !ce || ne || D,
							onClick: () => void de(),
							children: [/* @__PURE__ */ (0, Y.jsx)(sg, { size: 14 }), ne ? "Saving…" : "Save"]
						})]
					})]
				}), /* @__PURE__ */ (0, Y.jsx)("div", {
			...
			}), w === "story" ? /* @__PURE__ */ (0, Y.jsx)($g, {
				value: v,
				onChange: y
			}, `${o || "none"}-story`) : /* @__PURE__ */ (0, Y.jsx)($g, {
				value: b,
				onChange: x
			}, `${o || "none"}-plan`)] })] }) : /* @__PURE__ */ (0, Y.jsx)(a_, { label: "Select a story to inspect." })
		})]
	});
}
function g_({ jiraKey: e, title: t }) {
	return /* @__PURE__ */ (0, Y.jsx)("span", {
		className: "story-reference",
		children: t ? /* @__PURE__ */ (0, Y.jsxs)(Y.Fragment, { children: [/* @__PURE__ */ (0, Y.jsx)("code", { children: kg(e) }), /* @__PURE__ */ (0, Y.jsx)("span", {
			className: "story-reference-title",
			children: t
		})] }) : /* @__PURE__ */ (0, Y.jsx)("code", { children: kg(e, "No active delivery") })
	});
}
function __({ stages: e, deliveryStatus: t, currentStep: n, startedAt: r, finishedAt: i, remediation: a, now: o, onStageClick: s }) {
	...
	return /* @__PURE__ */ (0, Y.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, Y.jsxs)("div", { children: [/* @__PURE__ */ (0, Y.jsx)("span", {
				...
				children: [
					/* @__PURE__ */ (0, Y.jsx)(og, { size: 13 }),
					"Verification failed · Remediation retry ",
					d
				]
			})] }), /* @__PURE__ */ (0, Y.jsxs)("p", { children: [r ? `Started ${Ag(r)}` : "Awaiting delivery trigger", i ? ` · Finished ${Ag(i)}` : ""] })]
		}), /* @__PURE__ */ (0, Y.jsxs)("div", {
					...
					return /* @__PURE__ */ (0, Y.jsx)("li", {
						...
						children: /* @__PURE__ */ (0, Y.jsxs)("button", {
							...
							children: [/* @__PURE__ */ (0, Y.jsx)("span", {
								...
								className: "flow-copy",
								children: [/* @__PURE__ */ (0, Y.jsx)("strong", { children: kg(e.label) }), /* @__PURE__ */ (0, Y.jsx)("span", { children: f })]
							})]
						})
					}, `${e.label}-${t}`);
				})
...
function v_({ stage: e, content: t, error: n, loading: r, live: i = !1, onClose: a }) {
...
function x_({ checks: e, onClick: t }) {
...
function S_({ checks: e, onClose: t }) {
	return /* @__PURE__ */ (0, Y.jsx)("div", {
		className: "modal-backdrop",
		role: "presentation",
		onMouseDown: t,
		children: /* @__PURE__ */ (0, Y.jsxs)("section", {
			...
			children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
				...
				children: e.map((e, t) => /* @__PURE__ */ (0, Y.jsxs)("article", {
					...
					children: [
						/* @__PURE__ */ (0, Y.jsxs)("div", { children: [/* @__PURE__ */ (0, Y.jsx)("strong", { children: kg(e.label) }), /* @__PURE__ */ (0, Y.jsx)("span", { children: kg(e.repository, "Workspace") })] }),
						/* @__PURE__ */ (0, Y.jsx)(Fg, { value: e.status }),
						/* @__PURE__ */ (0, Y.jsx)("p", { children: kg(e.summary, "No summary recorded.") }),
...
function D_({ data: e, project: t, interact: n, notify: r }) {
	let i = e.interactive?.prompts || [], [a, o] = (0, M.useState)("scan"), [s, c] = (0, M.useState)(null), [l, u] = (0, M.useState)(""), [d, f] = (0, M.useState)({
		...
		c(e);
		try {
			let n = await Pg(`/api/prompt?mode=${encodeURIComponent(e.mode)}&path=${encodeURIComponent(e.path)}`, t);
			u(n.content);
		} catch (e) {
	...
	return /* @__PURE__ */ (0, Y.jsxs)(Y.Fragment, { children: [
		...
		/* @__PURE__ */ (0, Y.jsx)(t_, {
			...
			action: /* @__PURE__ */ (0, Y.jsx)(e_, {
				label: p ? "Exit full screen" : "View full screen",
				onClick: () => m((e) => !e),
				children: p ? /* @__PURE__ */ (0, Y.jsx)(ig, { size: 14 }) : /* @__PURE__ */ (0, Y.jsx)(rg, { size: 14 })
			}),
			...
			children: /* @__PURE__ */ (0, Y.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, Y.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, Y.jsx)("div", {
						...
						children: w.map((e, t) => {
							let n = _.filter((t) => e.layers.includes(T_(t, a))), r = [...e.scripts.map((e) => ({
								kind: "script",
								script: e
							})), ...n.map((e) => ({
								kind: "prompt",
...
function O_({ item: e, content: t, onChange: n, onClose: r, onSave: i }) {
	let a = w_(e);
	return /* @__PURE__ */ (0, Y.jsx)("div", {
		className: "modal-backdrop",
		role: "presentation",
				...
				/* @__PURE__ */ (0, Y.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, Y.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, Y.jsxs)("label", {
							...
							children: [/* @__PURE__ */ (0, Y.jsx)("span", { children: "Preview" }), /* @__PURE__ */ (0, Y.jsx)(Wg, { content: t })]
						})]
					})
				}),
				/* @__PURE__ */ (0, Y.jsxs)("footer", { children: [/* @__PURE__ */ (0, Y.jsx)("button", {
					...
					className: "button primary",
					onClick: i,
					children: [/* @__PURE__ */ (0, Y.jsx)(sg, { size: 14 }), "Save prompt"]
				})] })
			]
		})
	});
}
function k_({ children: e }) {
...
function $({ label: e, help: t, children: n }) {
	return /* @__PURE__ */ (0, Y.jsxs)("label", {
		...
		children: [/* @__PURE__ */ (0, Y.jsxs)("span", {
			...
			children: [e, t && /* @__PURE__ */ (0, Y.jsx)(k_, { children: t })]
		}), n]
	});
}
function A_({ runtime: e, onChange: t }) {
			...
			children: [
				...
				/* @__PURE__ */ (0, Y.jsx)("footer", {
					...
					children: /* @__PURE__ */ (0, Y.jsxs)("button", {
						...
						children: [/* @__PURE__ */ (0, Y.jsx)(sg, { size: 15 }), "Save repositories"]
					})
				})
			]
		}), l && /* @__PURE__ */ (0, Y.jsx)(M_, {
			onClose: () => u(!1),
			onAdd: (e) => {
...
function N_({ data: e, project: t, notify: n, onDirtyChange: r, reload: i }) {
	...
	(0, M.useEffect)(() => {
		Pg("/api/delivery/status-options", t).then((e) => ne(Array.isArray(e.options) ? e.options.map(String) : [])).catch(() => ne([]));
	}, [t]), (0, M.useEffect)(() => {
	...
	let fe = async (e) => {
		let n = await Pg(`/api/integration?key=${encodeURIComponent(e)}`, t);
		...
		try {
			await Promise.all([
				...
				...Object.entries(O).map(([e, n]) => Pg("/api/integration", t, {
					method: "POST",
					json: {
						key: e,
						value: n
		...
		children: [
				...
				children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, Y.jsxs)("div", {
							...
							}), /* @__PURE__ */ (0, Y.jsx)("p", { children: kg(o.scan?.description, "No recurring scan is configured.") })]
						}),
						/* @__PURE__ */ (0, Y.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, Y.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
							...
							children: Og.map((e) => /* @__PURE__ */ (0, Y.jsx)("option", {
								value: e.value,
								label: e.label
							}, e.value))
						})]
				...
				children: /* @__PURE__ */ (0, Y.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
						...
						children: /* @__PURE__ */ (0, Y.jsx)("div", {
							...
							children: he.length ? he.map((e) => {
								...
								return /* @__PURE__ */ (0, Y.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, Y.jsxs)("div", { children: [/* @__PURE__ */ (0, Y.jsx)(e_, {
											label: "Reveal value",
											onClick: () => void pe(e),
							...
							}) : /* @__PURE__ */ (0, Y.jsx)(a_, { label: "No local integration keys configured." })
						})
					})]
				})
			}),
			/* @__PURE__ */ (0, Y.jsxs)("footer", {
				...
				children: [/* @__PURE__ */ (0, Y.jsx)("span", {
					...
					disabled: !ue,
					onClick: () => void _e(),
					children: [/* @__PURE__ */ (0, Y.jsx)(sg, { size: 15 }), "Save changes"]
				})]
			})
		]
	});
}
function P_({ enabled: e, onChange: t }) {
	return /* @__PURE__ */ (0, Y.jsxs)("label", {
...
(0, be.createRoot)(document.getElementById("root")).render(/* @__PURE__ */ (0, Y.jsx)(n_, {}));
//#endregion
