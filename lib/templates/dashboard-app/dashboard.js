...
//#endregion
//#region package.json
var wh = "1.24.38", Th = (...e) => e.filter((e, t, n) => !!e && e.trim() !== "" && n.indexOf(e) === t).join(" ").trim(), Eh = (e) => e.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase(), Dh = (e) => e.replace(/^([A-Z])|[\s-_]+(\w)/g, (e, t, n) => n ? n.toUpperCase() : t.toLowerCase()), Oh = (e) => {
	let t = Dh(e);
...
function Fg({ label: e, onClose: t, children: n }) {
	...
	return (0, N.useEffect)(() => {
		let e = (e) => {
			e.key === "Escape" && t(), (e.key === "+" || e.key === "=") && i((e) => Math.min(Sg, Number((e + Cg).toFixed(2)))), (e.key === "-" || e.key === "_") && i((e) => Math.max(xg, Number((e - Cg).toFixed(2)))), e.key === "0" && i(1);
		};
			...
			children: [/* @__PURE__ */ (0, X.jsxs)("header", { children: [/* @__PURE__ */ (0, X.jsx)("span", { children: e }), /* @__PURE__ */ (0, X.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, X.jsx)("button", {
						...
						title: "Zoom out",
						"aria-label": "Zoom out",
						onClick: () => i((e) => Math.max(xg, Number((e - Cg).toFixed(2)))),
					...
					/* @__PURE__ */ (0, X.jsx)("button", {
						...
						title: "Zoom in",
						"aria-label": "Zoom in",
						onClick: () => i((e) => Math.min(Sg, Number((e + Cg).toFixed(2)))),
				...
				children: /* @__PURE__ */ (0, X.jsx)("div", {
					className: "media-fullscreen-zoom",
...
function qg({ value: e, onChange: t }) {
	let { frontmatter: n, body: r } = Vg(e), i = (0, N.useRef)(null), a = (0, N.useRef)(!1), o = (0, N.useRef)(!1), s = (0, N.useRef)(r), c = (0, N.useRef)(Wg()), [l, u] = (0, N.useState)(null);
	s.current = r;
	let d = (e) => t(Hg(n, e)), f = () => {
		let e = i.current;
		if (!e) return;
		let t = c.current.turndown(e);
		Kg(o.current, t, s.current) && d(t);
	}, p = (0, N.useCallback)(async (e) => {
		let t = i.current;
		if (!t) return;
		o.current = !1, t.innerHTML = Ug(e), t.querySelectorAll("a[href]").forEach((e) => {
...
function Jg({ label: e, children: t, onClick: n, danger: r = !1, disabled: i = !1, className: a = "" }) {
...
function Yg({ title: e, action: t, children: n, className: r = "" }) {
			...
			/* @__PURE__ */ (0, X.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, X.jsxs)("header", {
					...
					children: [
						...
						n && i === "scan" && /* @__PURE__ */ (0, X.jsx)(Zg, {
							data: n,
							project: e,
							interact: T
						}),
						n && i === "delivery" && /* @__PURE__ */ (0, X.jsx)(a_, {
							data: n,
							project: e,
							notify: b,
							reload: x
						}),
						n && i === "observatory" && /* @__PURE__ */ (0, X.jsx)(l_, {
							project: e,
							notify: b,
							onDirtyChange: y
						}),
						n && i === "repositories" && /* @__PURE__ */ (0, X.jsx)(T_, {
							data: n,
							interact: T
						}),
						n && i === "prompts" && /* @__PURE__ */ (0, X.jsx)(x_, {
							data: n,
							project: e,
							interact: T,
							notify: b
						}),
						n && i === "settings" && /* @__PURE__ */ (0, X.jsx)(D_, {
							data: n,
							project: e,
							notify: b,
							onDirtyChange: _,
...
function Zg({ data: e, project: t, interact: n }) {
	...
	return /* @__PURE__ */ (0, X.jsxs)(X.Fragment, { children: [
		...
		/* @__PURE__ */ (0, X.jsxs)(Yg, {
			...
			children: [/* @__PURE__ */ (0, X.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, X.jsxs)("table", { children: [/* @__PURE__ */ (0, X.jsx)("thead", { children: /* @__PURE__ */ (0, X.jsxs)("tr", { children: [
					...
					/* @__PURE__ */ (0, X.jsx)("td", { children: /* @__PURE__ */ (0, X.jsx)(e_, { run: e }) }),
			...
			}), a.length > 10 && /* @__PURE__ */ (0, X.jsx)(t_, {
				page: u,
		...
		/* @__PURE__ */ (0, X.jsxs)(Yg, {
			...
			children: [/* @__PURE__ */ (0, X.jsx)("div", {
				...
				id: "tracked-findings",
				className: "findings",
				children: p.length ? p.map((e) => /* @__PURE__ */ (0, X.jsx)(n_, {
					issue: e,
					onIgnore: () => s(e)
				}, e.id)) : /* @__PURE__ */ (0, X.jsx)($g, { label: "No findings match this status." })
			})]
		}),
		o && /* @__PURE__ */ (0, X.jsx)(i_, {
			onClose: () => s(null),
			onConfirm: (e) => {
				n("/api/issue/ignore", {
					issue_id: o.id,
...
function t_({ page: e, pageCount: t, onChange: n }) {
...
function n_({ issue: e, onIgnore: t }) {
...
function r_({ label: e, value: t, code: n = !1 }) {
	return /* @__PURE__ */ (0, X.jsxs)("section", {
...
function i_({ onClose: e, onConfirm: t }) {
...
function a_({ data: e, project: t, notify: n, reload: r }) {
	...
	return /* @__PURE__ */ (0, X.jsxs)(X.Fragment, { children: [
			...
			children: /* @__PURE__ */ (0, X.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, X.jsxs)("table", { children: [/* @__PURE__ */ (0, X.jsx)("thead", { children: /* @__PURE__ */ (0, X.jsxs)("tr", { children: [
					...
					return /* @__PURE__ */ (0, X.jsxs)("tr", { children: [
						...
						/* @__PURE__ */ (0, X.jsx)("td", { children: /* @__PURE__ */ (0, X.jsx)(m_, { items: e.pull_requests || [] }) }),
						/* @__PURE__ */ (0, X.jsx)("td", { children: /* @__PURE__ */ (0, X.jsx)(h_, {
							checks: t,
							onClick: () => p(t)
						}) }),
						...
						/* @__PURE__ */ (0, X.jsx)("td", { children: /* @__PURE__ */ (0, X.jsx)(Jg, {
					...
					colSpan: 8,
					children: /* @__PURE__ */ (0, X.jsx)($g, { label: "No delivery history yet." })
				}) }) })] })
			})
		}),
		/* @__PURE__ */ (0, X.jsx)(Yg, {
			...
			children: /* @__PURE__ */ (0, X.jsx)("div", {
				...
				}, `${e.at}-${t}`)) : /* @__PURE__ */ (0, X.jsx)($g, { label: "No scheduled delivery activity recorded yet." })
			})
		}),
		u && /* @__PURE__ */ (0, X.jsx)(f_, {
			stage: u,
			content: m,
			error: g,
			loading: v,
		...
		f && /* @__PURE__ */ (0, X.jsx)(g_, {
			checks: f,
			onClose: () => p(null)
		}),
		S && /* @__PURE__ */ (0, X.jsx)(s_, {
...
function o_({ stories: e, value: t, onChange: n, busy: r, error: i, onClose: a, onConfirm: o }) {
	return /* @__PURE__ */ (0, X.jsx)("div", {
		className: "modal-backdrop",
		role: "presentation",
...
function s_({ story: e, busy: t, error: n, onClose: r, onConfirm: i }) {
	return /* @__PURE__ */ (0, X.jsx)("div", {
		className: "modal-backdrop",
		role: "presentation",
...
function c_({ run: e, busy: t, onClose: n, onConfirm: r }) {
...
function l_({ project: e, notify: t, onDirtyChange: n }) {
		...
		children: [/* @__PURE__ */ (0, X.jsxs)("aside", {
			...
			children: [/* @__PURE__ */ (0, X.jsxs)("div", {
				...
				children: [
					...
					!E && !i.length ? /* @__PURE__ */ (0, X.jsx)($g, { label: "No stories found in the docs repository." }) : null,
					i.map((e) => {
			...
			children: o ? /* @__PURE__ */ (0, X.jsxs)(X.Fragment, { children: [/* @__PURE__ */ (0, X.jsx)("div", {
				...
				}), w === "story" ? /* @__PURE__ */ (0, X.jsx)(qg, {
					value: v,
					onChange: y
				}, `${o || "none"}-story`) : /* @__PURE__ */ (0, X.jsx)(qg, {
					value: b,
					onChange: x
				}, `${o || "none"}-plan`)]
			})] }) : /* @__PURE__ */ (0, X.jsx)($g, { label: "Select a story to inspect." })
		})]
	});
}
function u_({ jiraKey: e, title: t }) {
	return /* @__PURE__ */ (0, X.jsx)("span", {
...
function h_({ checks: e, onClick: t }) {
...
function g_({ checks: e, onClose: t }) {
	return /* @__PURE__ */ (0, X.jsx)("div", {
		className: "modal-backdrop",
		role: "presentation",
		onMouseDown: t,
...
function x_({ data: e, project: t, interact: n, notify: r }) {
			...
			children: /* @__PURE__ */ (0, X.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, X.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, X.jsx)("div", {
						...
						children: w.map((e, t) => {
							let n = _.filter((t) => e.layers.includes(y_(t, a))), r = [...e.scripts.map((e) => ({
								kind: "script",
								script: e
							})), ...n.map((e) => ({
								kind: "prompt",
...
function S_({ item: e, content: t, onChange: n, onClose: r, onSave: i }) {
	let a = v_(e);
	return /* @__PURE__ */ (0, X.jsx)("div", {
		className: "modal-backdrop",
		role: "presentation",
				...
				/* @__PURE__ */ (0, X.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, X.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, X.jsxs)("label", {
							...
							children: [/* @__PURE__ */ (0, X.jsx)("span", { children: "Preview" }), /* @__PURE__ */ (0, X.jsx)(Bg, { content: t })]
						})]
					})
				}),
				/* @__PURE__ */ (0, X.jsxs)("footer", { children: [/* @__PURE__ */ (0, X.jsx)("button", {
...
function $({ label: e, help: t, children: n }) {
	return /* @__PURE__ */ (0, X.jsxs)("label", {
		...
		children: [/* @__PURE__ */ (0, X.jsxs)("span", {
			...
			children: [e, t && /* @__PURE__ */ (0, X.jsx)(C_, { children: t })]
		}), n]
	});
}
function w_({ runtime: e, onChange: t }) {
	...
	return /* @__PURE__ */ (0, X.jsxs)("section", {
		...
		children: [
			/* @__PURE__ */ (0, X.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, X.jsxs)("div", { children: [/* @__PURE__ */ (0, X.jsxs)("strong", { children: ["Visual runtime ", /* @__PURE__ */ (0, X.jsx)(C_, { children: "These settings tell Lumen how to start the repository, reach its page, authenticate, and provide mock data during visual verification." })] }), /* @__PURE__ */ (0, X.jsx)("span", { children: "Only the runtime inputs needed for visual verification are shown first." })] }), /* @__PURE__ */ (0, X.jsx)("code", { children: e.runtime_profile || n })]
			}),
			/* @__PURE__ */ (0, X.jsxs)("div", {
...
function D_({ data: e, project: t, notify: n, onDirtyChange: r, reload: i }) {
				...
				children: /* @__PURE__ */ (0, X.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, X.jsxs)("div", {
						...
						children: /* @__PURE__ */ (0, X.jsx)("div", {
							...
							children: me.length ? me.map((e) => {
								...
								return /* @__PURE__ */ (0, X.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, X.jsxs)("div", { children: [/* @__PURE__ */ (0, X.jsx)(Jg, {
											label: "Reveal value",
											onClick: () => void fe(e),
							...
							}) : /* @__PURE__ */ (0, X.jsx)($g, { label: "No local integration keys configured." })
						})
					})]
				})
			}),
...
function O_({ enabled: e, onChange: t }) {
	return /* @__PURE__ */ (0, X.jsxs)("label", {
...
(0, ye.createRoot)(document.getElementById("root")).render(/* @__PURE__ */ (0, X.jsx)(Xg, {}));
//#endregion
