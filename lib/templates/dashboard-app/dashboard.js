...
//#endregion
//#region package.json
var Xf = "1.24.31", Zf = (...e) => e.filter((e, t, n) => !!e && e.trim() !== "" && n.indexOf(e) === t).join(" ").trim(), Qf = (e) => e.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase(), $f = (e) => e.replace(/^([A-Z])|[\s-_]+(\w)/g, (e, t, n) => n ? n.toUpperCase() : t.toLowerCase()), ep = (e) => {
	let t = $f(e);
...
function Hp(e) {
	let t = Rp(e, "unknown").toLowerCase().replaceAll("_", " ");
	return {
...
function Wp({ value: e }) {
	return /* @__PURE__ */ (0, Y.jsx)("span", {
		className: `badge ${Vp(e)}`,
		children: Hp(e)
	});
}
function Gp({ business: e, technical: t, delivery: n }) {
	return /* @__PURE__ */ (0, Y.jsxs)("div", {
		className: "observatory-meta",
		children: [
			/* @__PURE__ */ (0, Y.jsxs)("span", {
				className: "observatory-meta-item",
				children: [/* @__PURE__ */ (0, Y.jsx)("em", { children: "Business" }), /* @__PURE__ */ (0, Y.jsx)(Wp, { value: e || "draft" })]
			}),
			/* @__PURE__ */ (0, Y.jsxs)("span", {
				className: "observatory-meta-item",
				children: [/* @__PURE__ */ (0, Y.jsx)("em", { children: "Technical" }), /* @__PURE__ */ (0, Y.jsx)(Wp, { value: t || "draft" })]
			}),
			/* @__PURE__ */ (0, Y.jsxs)("span", {
				className: "observatory-meta-item",
				children: [/* @__PURE__ */ (0, Y.jsx)("em", { children: "Delivery" }), /* @__PURE__ */ (0, Y.jsx)(Wp, { value: n || "not_started" })]
			})
		]
	});
}
function Kp({ business: e, technical: t, delivery: n }) {
	return /* @__PURE__ */ (0, Y.jsxs)("span", {
		className: "observatory-pills",
		title: `Business ${Hp(e || "draft")} · Technical ${Hp(t || "draft")} · Delivery ${Hp(n || "not_started")}`,
		children: [
			/* @__PURE__ */ (0, Y.jsx)(Wp, { value: e || "draft" }),
			/* @__PURE__ */ (0, Y.jsx)(Wp, { value: t || "draft" }),
			/* @__PURE__ */ (0, Y.jsx)(Wp, { value: n || "not_started" })
		]
	});
}
function qp({ chart: e }) {
...
function Zp({ value: e, onChange: t, editing: n }) {
	let { frontmatter: r, body: i } = Yp(e), a = (e) => t(Xp(r, e));
	return n ? /* @__PURE__ */ (0, Y.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, Y.jsx)("div", {
			...
			children: /* @__PURE__ */ (0, Y.jsx)(Jp, { content: i })
...
function Qp({ label: e, children: t, onClick: n, danger: r = !1, disabled: i = !1, className: a = "" }) {
...
function $p({ title: e, action: t, children: n, className: r = "" }) {
...
function em() {
	let [e, t] = (0, M.useState)(new URLSearchParams(window.location.search).get("project") || window.DASHBOARD_DATA?.interactive?.project || ""), [n, r] = (0, M.useState)(null), [i, a] = (0, M.useState)(Fp.find((e) => `/${e.id}` === window.location.pathname)?.id || "scan"), [o, s] = (0, M.useState)(""), [c, l] = (0, M.useState)(null), [u, d] = (0, M.useState)(!0), [f, p] = (0, M.useState)(() => window.localStorage.getItem("lumen-sidebar-collapsed") === "true"), [m, h] = (0, M.useState)(null), [g, _] = (0, M.useState)(!1), [v, y] = (0, M.useState)(!1), b = (0, M.useCallback)((e, t = "info") => l({
		message: e,
		tone: t
	}), []), x = async () => {
		d(!0);
		try {
			let n = await Up("/api/state", e);
	...
	(0, M.useEffect)(() => {
		...
		let e = () => a(Fp.find((e) => `/${e.id}` === window.location.pathname)?.id || "scan");
	...
	}, E = n?.interactive?.projects || [], ee = n?.product?.tagline || "Engineering, made legible.", D = Ip[i];
	return /* @__PURE__ */ (0, Y.jsxs)("main", {
		...
		children: [
				...
				children: [/* @__PURE__ */ (0, Y.jsxs)("header", {
					...
					children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, Y.jsx)("span", {
							...
							children: m ? `Updated ${zp(m.toISOString())}` : "Syncing…"
					...
					children: [
						...
						!n && u ? /* @__PURE__ */ (0, Y.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, Y.jsx)(bp, {
								size: 22,
								className: "spin"
							}), " Loading local workspace state…"]
						}) : null,
						n && i === "scan" && /* @__PURE__ */ (0, Y.jsx)(tm, {
							data: n,
							project: e,
							interact: T
						}),
						n && i === "delivery" && /* @__PURE__ */ (0, Y.jsx)(lm, {
							data: n,
							project: e,
							notify: b,
							reload: x
						}),
						n && i === "observatory" && /* @__PURE__ */ (0, Y.jsx)(pm, {
							project: e,
							notify: b,
							onDirtyChange: y
						}),
						n && i === "repositories" && /* @__PURE__ */ (0, Y.jsx)(km, {
							data: n,
							interact: T
						}),
						n && i === "prompts" && /* @__PURE__ */ (0, Y.jsx)(Tm, {
							data: n,
							project: e,
							interact: T,
							notify: b
						}),
						n && i === "settings" && /* @__PURE__ */ (0, Y.jsx)(jm, {
							data: n,
							project: e,
							notify: b,
							onDirtyChange: _,
			...
			c && /* @__PURE__ */ (0, Y.jsxs)("div", {
				...
				role: "status",
				children: [c.tone === "success" ? /* @__PURE__ */ (0, Y.jsx)(lp, { size: 16 }) : c.tone === "error" ? /* @__PURE__ */ (0, Y.jsx)(cp, { size: 16 }) : /* @__PURE__ */ (0, Y.jsx)(up, { size: 16 }), /* @__PURE__ */ (0, Y.jsx)("span", { children: c.message })]
			})
		]
	});
}
function tm({ data: e, project: t, interact: n }) {
	...
	return /* @__PURE__ */ (0, Y.jsxs)(Y.Fragment, { children: [
		...
		/* @__PURE__ */ (0, Y.jsxs)($p, {
			...
			children: [/* @__PURE__ */ (0, Y.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, Y.jsxs)("table", { children: [/* @__PURE__ */ (0, Y.jsx)("thead", { children: /* @__PURE__ */ (0, Y.jsxs)("tr", { children: [
					...
					/* @__PURE__ */ (0, Y.jsx)("td", { children: zp(e.started_at || e.finished_at) }),
					/* @__PURE__ */ (0, Y.jsx)("td", { children: /* @__PURE__ */ (0, Y.jsx)(Wp, { value: e.status }) }),
					/* @__PURE__ */ (0, Y.jsx)("td", { children: /* @__PURE__ */ (0, Y.jsx)(im, { run: e }) }),
					/* @__PURE__ */ (0, Y.jsx)("td", { children: Rp(e.duration) }),
			...
			}), a.length > 10 && /* @__PURE__ */ (0, Y.jsx)(am, {
				page: u,
		...
		/* @__PURE__ */ (0, Y.jsxs)($p, {
			...
			children: [/* @__PURE__ */ (0, Y.jsx)("div", {
				...
				id: "tracked-findings",
				className: "findings",
				children: p.length ? p.map((e) => /* @__PURE__ */ (0, Y.jsx)(om, {
					issue: e,
					onIgnore: () => s(e)
				}, e.id)) : /* @__PURE__ */ (0, Y.jsx)(rm, { label: "No findings match this status." })
			})]
		}),
		o && /* @__PURE__ */ (0, Y.jsx)(cm, {
			onClose: () => s(null),
			onConfirm: (e) => {
				n("/api/issue/ignore", {
					issue_id: o.id,
...
function nm({ label: e, value: t, onClick: n }) {
	return /* @__PURE__ */ (0, Y.jsxs)("div", {
...
function rm({ label: e }) {
	return /* @__PURE__ */ (0, Y.jsxs)("div", {
		className: "empty",
		children: [/* @__PURE__ */ (0, Y.jsx)(kp, { size: 20 }), e]
	});
}
function im({ run: e }) {
	let t = [
...
function am({ page: e, pageCount: t, onChange: n }) {
...
function om({ issue: e, onIgnore: t }) {
			...
			children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, Y.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, Y.jsx)("h4", { children: Rp(e.title, "Untitled finding") }), /* @__PURE__ */ (0, Y.jsx)(Wp, { value: i })]
					}),
					/* @__PURE__ */ (0, Y.jsxs)("p", {
						...
						children: [
							...
							Rp(e.repository, "Unknown repository"),
							" ",
							/* @__PURE__ */ (0, Y.jsx)("i", { children: "|" }),
							" ",
							zp(e.last_seen_at)
					...
					/* @__PURE__ */ (0, Y.jsxs)("div", {
						...
						children: [
							...
							e.jira_key && e.jira_url && /* @__PURE__ */ (0, Y.jsxs)("a", {
								...
								target: "_blank",
								rel: "noreferrer",
								children: [e.jira_key, /* @__PURE__ */ (0, Y.jsx)(mp, { size: 12 })]
							}),
							e.pr_url && /* @__PURE__ */ (0, Y.jsxs)("a", {
								...
								target: "_blank",
								rel: "noreferrer",
								children: ["Pull request", /* @__PURE__ */ (0, Y.jsx)(mp, { size: 12 })]
							})
						]
					})
				]
...
function sm({ label: e, value: t, code: n = !1 }) {
	return /* @__PURE__ */ (0, Y.jsxs)("section", {
		className: "finding-detail-row",
		children: [/* @__PURE__ */ (0, Y.jsx)("h5", { children: e }), n ? /* @__PURE__ */ (0, Y.jsx)("pre", { children: /* @__PURE__ */ (0, Y.jsx)("code", { children: Rp(t, "No code snippet was captured for this historical finding.") }) }) : /* @__PURE__ */ (0, Y.jsx)("p", { children: Rp(t, "Not recorded.") })]
	});
}
function cm({ onClose: e, onConfirm: t }) {
...
function lm({ data: e, project: t, notify: n, reload: r }) {
	let i = e.delivery || {}, a = i.current || {}, o = i.runs || [], s = a.stages || [], c = i.scheduler_activity || [], l = i.available_stories || [], [u, d] = (0, M.useState)(null), [f, p] = (0, M.useState)(null), [m, h] = (0, M.useState)(""), [g, _] = (0, M.useState)(""), [v, y] = (0, M.useState)(!1), [b, x] = (0, M.useState)(!1), [S, C] = (0, M.useState)(!1), [w, T] = (0, M.useState)(!1), [E, ee] = (0, M.useState)(""), [D, te] = (0, M.useState)(!1), [ne, re] = (0, M.useState)(""), [ie, O] = (0, M.useState)(!1), [k, ae] = (0, M.useState)(""), [oe, se] = (0, M.useState)(null), [ce, le] = (0, M.useState)(""), [A, ue] = (0, M.useState)(Date.now()), de = /in_progress|running/i.test(String(a.delivery_status || "")), j = (() => {
		...
		n || y(!0);
		try {
			let n = await Up(`/api/delivery/log?run_id=${encodeURIComponent(e)}`, t);
	...
	let me = async (e, t = a.run_id || "") => {
		...
		x(!0), h(""), _(""), y(!0);
		try {
			let e = await Up("/api/delivery/scheduler-log", t);
		...
		try {
			let n = await Up(`/api/delivery/trace?run_id=${encodeURIComponent(e)}`, t);
			d({
				label: "Trace",
		...
		if (e) {
			le(e), ae("");
			try {
				await Up("/api/delivery/history/delete", t, {
					method: "POST",
					json: { run_id: e }
	...
	return /* @__PURE__ */ (0, Y.jsxs)(Y.Fragment, { children: [
			...
			action: /* @__PURE__ */ (0, Y.jsxs)("span", {
				...
				children: [
					!de && j.length > 0 && /* @__PURE__ */ (0, Y.jsxs)("button", {
						...
						disabled: ie,
						onClick: _e,
						children: [/* @__PURE__ */ (0, Y.jsx)(wp, { size: 14 }), "Start"]
					}),
					...
					Se && /* @__PURE__ */ (0, Y.jsxs)("button", {
						className: "button secondary",
						onClick: () => C(!0),
						children: [/* @__PURE__ */ (0, Y.jsx)(Tp, { size: 14 }), "Retry"]
					})
				]
			}),
			children: [
				/* @__PURE__ */ (0, Y.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, Y.jsx)(_m, {
							label: "Status",
							value: /* @__PURE__ */ (0, Y.jsx)(Wp, { value: a.delivery_status || "not started" })
						}),
						/* @__PURE__ */ (0, Y.jsx)(_m, {
							label: "Elapsed",
							value: Bp(a.started_at, a.finished_at || (de ? new Date(A).toISOString() : void 0))
						}),
						/* @__PURE__ */ (0, Y.jsx)(_m, {
							label: "Finished",
							value: de ? "Running" : zp(a.finished_at)
						})
					]
				}),
					...
					return /* @__PURE__ */ (0, Y.jsxs)("tr", { children: [
						/* @__PURE__ */ (0, Y.jsx)("td", { children: /* @__PURE__ */ (0, Y.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, Y.jsxs)("span", {
								...
								children: [/* @__PURE__ */ (0, Y.jsx)("code", { children: Rp(e.jira_key || e.story || e.run_id) }), e.story_title && /* @__PURE__ */ (0, Y.jsx)("span", {
									className: "history-story-title",
									children: e.story_title
								})]
							}), /* @__PURE__ */ (0, Y.jsx)("small", { children: Rp(e.branch, "") })]
						}) }),
						/* @__PURE__ */ (0, Y.jsx)("td", { children: zp(e.finished_at || e.started_at) }),
						/* @__PURE__ */ (0, Y.jsx)("td", { children: r ? /* @__PURE__ */ (0, Y.jsx)("button", {
							...
							onClick: () => void me({
								...
								duration: Bp(e.started_at, e.finished_at),
								detail: n.map((e) => e.summary || e.label).filter(Boolean).join(" · ") || "Open the delivery log for details."
							}, e.run_id),
							children: /* @__PURE__ */ (0, Y.jsx)(Wp, { value: e.status })
						}) : /* @__PURE__ */ (0, Y.jsx)(Wp, { value: e.status }) }),
						/* @__PURE__ */ (0, Y.jsx)("td", { children: /* @__PURE__ */ (0, Y.jsx)(vm, { items: e.pull_requests || [] }) }),
						/* @__PURE__ */ (0, Y.jsx)("td", { children: /* @__PURE__ */ (0, Y.jsx)(ym, {
							checks: t,
							onClick: () => p(t)
						}) }),
						...
						/* @__PURE__ */ (0, Y.jsx)("td", { children: /* @__PURE__ */ (0, Y.jsx)(Qp, {
							label: "Delete delivery record",
							danger: !0,
							disabled: ce === e.run_id,
							onClick: () => se(e),
							children: /* @__PURE__ */ (0, Y.jsx)(Mp, { size: 15 })
						}) })
					] }, e.run_id);
				}) : /* @__PURE__ */ (0, Y.jsx)("tr", { children: /* @__PURE__ */ (0, Y.jsx)("td", {
					colSpan: 8,
					children: /* @__PURE__ */ (0, Y.jsx)(rm, { label: "No delivery history yet." })
				}) }) })] })
			})
		}),
		/* @__PURE__ */ (0, Y.jsx)($p, {
			...
			action: /* @__PURE__ */ (0, Y.jsxs)("span", {
				...
				children: [/* @__PURE__ */ (0, Y.jsxs)("span", {
					...
					className: "button secondary",
					onClick: () => void he(),
					children: [/* @__PURE__ */ (0, Y.jsx)(jp, { size: 14 }), "View raw log"]
				})]
			}),
			children: /* @__PURE__ */ (0, Y.jsx)("div", {
				...
				children: c.length ? c.map((e, t) => /* @__PURE__ */ (0, Y.jsxs)("article", {
					...
					children: [
						/* @__PURE__ */ (0, Y.jsx)(Wp, { value: e.outcome }),
						/* @__PURE__ */ (0, Y.jsxs)("div", { children: [/* @__PURE__ */ (0, Y.jsx)("strong", { children: Rp(e.story_id || e.jira_key, "Workspace") }), /* @__PURE__ */ (0, Y.jsx)("p", { children: Rp(e.message) })] }),
						/* @__PURE__ */ (0, Y.jsx)("time", { children: zp(e.at) })
					]
				}, `${e.at}-${t}`)) : /* @__PURE__ */ (0, Y.jsx)(rm, { label: "No scheduled delivery activity recorded yet." })
			})
		}),
		u && /* @__PURE__ */ (0, Y.jsx)(gm, {
			stage: u,
			content: m,
			error: g,
			loading: v,
		...
		f && /* @__PURE__ */ (0, Y.jsx)(bm, {
			checks: f,
			onClose: () => p(null)
		}),
		S && /* @__PURE__ */ (0, Y.jsx)(dm, {
			story: Rp(a.jira_key || a.story_id),
			busy: w,
			error: E,
			onClose: () => C(!1),
			onConfirm: () => void ge()
		}),
		D && /* @__PURE__ */ (0, Y.jsx)(um, {
			stories: j,
			value: ne,
			onChange: re,
			busy: ie,
...
function um({ stories: e, value: t, onChange: n, busy: r, error: i, onClose: a, onConfirm: o }) {
	return /* @__PURE__ */ (0, Y.jsx)("div", {
		className: "modal-backdrop",
		role: "presentation",
		...
		children: /* @__PURE__ */ (0, Y.jsxs)("section", {
			...
			children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
				...
				disabled: r || !t,
				onClick: o,
				children: [/* @__PURE__ */ (0, Y.jsx)(wp, { size: 14 }), r ? "Starting…" : "Start"]
			})] })]
		})
	});
}
function dm({ story: e, busy: t, error: n, onClose: r, onConfirm: i }) {
	return /* @__PURE__ */ (0, Y.jsx)("div", {
		className: "modal-backdrop",
		role: "presentation",
		...
		children: /* @__PURE__ */ (0, Y.jsxs)("section", {
			...
			children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
				...
				disabled: t,
				onClick: i,
				children: [/* @__PURE__ */ (0, Y.jsx)(Tp, { size: 14 }), t ? "Starting…" : "Retry"]
			})] })]
		})
	});
}
function fm({ run: e, busy: t, onClose: n, onConfirm: r }) {
	let i = Rp(e.jira_key || e.story || e.run_id);
	return /* @__PURE__ */ (0, Y.jsx)("div", {
		className: "modal-backdrop",
		role: "presentation",
		...
		children: /* @__PURE__ */ (0, Y.jsxs)("section", {
			...
			children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
				...
				disabled: t,
				onClick: r,
				children: [/* @__PURE__ */ (0, Y.jsx)(Mp, { size: 14 }), t ? "Deleting…" : "Delete record"]
			})] })]
		})
	});
}
function pm({ project: e, notify: t, onDirtyChange: n }) {
	let r = new URLSearchParams(window.location.search).get("story") || "", [i, a] = (0, M.useState)([]), [o, s] = (0, M.useState)(r), [c, l] = (0, M.useState)(""), [u, d] = (0, M.useState)(""), [f, p] = (0, M.useState)(""), [m, h] = (0, M.useState)(""), [g, _] = (0, M.useState)(""), [v, y] = (0, M.useState)(""), [b, x] = (0, M.useState)(""), [S, C] = (0, M.useState)(""), [w, T] = (0, M.useState)({
		story: "",
		plan: ""
	}), [E, ee] = (0, M.useState)("story"), [D, te] = (0, M.useState)(!1), [ne, re] = (0, M.useState)(!0), [ie, O] = (0, M.useState)(!1), [k, ae] = (0, M.useState)(!1), oe = b !== w.story || S !== w.plan;
	(0, M.useEffect)(() => {
		n(oe);
	}, [oe, n]), (0, M.useEffect)(() => {
		let e = (e) => {
	...
	let se = (0, M.useCallback)(async () => {
		re(!0);
		try {
			let t = await Up("/api/stories", e), n = Array.isArray(t.stories) ? t.stories : [];
	...
	}, [e, t]), ce = (0, M.useCallback)(async (n) => {
		if (n) {
			O(!0), te(!1), ee("story");
			try {
				let t = await Up(`/api/stories/content?story=${encodeURIComponent(n)}`, e), r = String(t.story_markdown || ""), i = String(t.plan_markdown || "");
				l(String(t.title || n)), d(String(t.jira_key || "")), p(String(t.jira_url || "")), h(String(t.businessStatus || "")), _(String(t.technicalStatus || "")), y(String(t.deliveryStatus || "")), x(r), C(i), T({
					story: r,
					plan: i
				});
	...
	let le = (e) => {
		e !== o && (oe && !window.confirm("You have unsaved Observatory changes. Switch stories without saving?") || s(e));
	}, A = async () => {
		if (!(!o || !oe)) {
			ae(!0);
			try {
				let n = await Up("/api/stories/content", e, {
					method: "POST",
					json: {
						story: o,
						story_markdown: b,
				...
				T({
					story: b,
					plan: S
				}), te(!1), t(String(n.subject || "Story docs saved"), "success"), await se();
			} catch (e) {
		...
		children: [/* @__PURE__ */ (0, Y.jsxs)("aside", {
			...
			children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
				...
				children: [
					...
					!ne && !i.length ? /* @__PURE__ */ (0, Y.jsx)(rm, { label: "No stories found in the docs repository." }) : null,
					i.map((e) => /* @__PURE__ */ (0, Y.jsxs)("button", {
						className: `observatory-story ${o === e.story ? "selected" : ""}`,
						onClick: () => le(String(e.story)),
						children: [/* @__PURE__ */ (0, Y.jsx)("strong", { children: Rp(e.title, e.story) }), /* @__PURE__ */ (0, Y.jsxs)("span", { children: [Rp(e.jira_key || e.story), /* @__PURE__ */ (0, Y.jsx)(Kp, {
							business: String(e.businessStatus || "draft"),
							technical: String(e.technicalStatus || "draft"),
							delivery: String(e.deliveryStatus || "not_started")
						})] })]
					}, e.story))
				]
			})]
			...
			children: o ? /* @__PURE__ */ (0, Y.jsxs)(Y.Fragment, { children: [/* @__PURE__ */ (0, Y.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, Y.jsxs)("div", { children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, Y.jsx)("h2", { children: Rp(c, o) }), /* @__PURE__ */ (0, Y.jsxs)("div", {
						className: "panel-actions",
						children: [
							/* @__PURE__ */ (0, Y.jsx)("span", {
								className: oe ? "settings-save-status unsaved" : "settings-save-status",
								children: oe ? "Unsaved" : "Saved"
							}),
							/* @__PURE__ */ (0, Y.jsx)("button", {
								className: "button secondary",
								disabled: ie,
							...
							/* @__PURE__ */ (0, Y.jsxs)("button", {
								...
								disabled: !oe || k || ie,
								onClick: () => void A(),
								children: [/* @__PURE__ */ (0, Y.jsx)(Ep, { size: 14 }), k ? "Saving…" : "Save"]
							})
						]
					})]
				}), /* @__PURE__ */ (0, Y.jsxs)("div", {
					className: "observatory-subheader",
					children: [f ? /* @__PURE__ */ (0, Y.jsxs)("a", {
						href: f,
						target: "_blank",
						rel: "noreferrer",
						children: [
							Rp(u || o),
							" ",
							/* @__PURE__ */ (0, Y.jsx)(mp, { size: 12 })
						]
					}) : /* @__PURE__ */ (0, Y.jsx)("code", { children: Rp(u || o) }), /* @__PURE__ */ (0, Y.jsx)(Gp, {
						business: m || "draft",
						technical: g || "draft",
						delivery: v || "not_started"
					})]
				})] })
			}), ie ? /* @__PURE__ */ (0, Y.jsxs)("div", {
				className: "loading-state",
				children: [/* @__PURE__ */ (0, Y.jsx)(bp, {
					size: 20,
					className: "spin"
				...
				children: [/* @__PURE__ */ (0, Y.jsx)("header", {
					...
					children: /* @__PURE__ */ (0, Y.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, Y.jsx)("button", {
							type: "button",
							role: "tab",
							"aria-selected": E === "story",
							className: E === "story" ? "active" : "",
							onClick: () => ee("story"),
							children: "Story"
						}), /* @__PURE__ */ (0, Y.jsx)("button", {
							type: "button",
							role: "tab",
							"aria-selected": E === "plan",
							className: E === "plan" ? "active" : "",
							onClick: () => ee("plan"),
							children: "Technical plan"
						})]
					})
				}), E === "story" ? /* @__PURE__ */ (0, Y.jsx)(Zp, {
					value: b,
					onChange: x,
					editing: D
				}) : /* @__PURE__ */ (0, Y.jsx)(Zp, {
			...
			})] }) : /* @__PURE__ */ (0, Y.jsx)(rm, { label: "Select a story to inspect." })
		})]
	});
}
function mm({ jiraKey: e, title: t }) {
	return /* @__PURE__ */ (0, Y.jsx)("span", {
		className: "story-reference",
		children: t ? /* @__PURE__ */ (0, Y.jsxs)(Y.Fragment, { children: [/* @__PURE__ */ (0, Y.jsx)("code", { children: Rp(e) }), /* @__PURE__ */ (0, Y.jsx)("span", {
			className: "story-reference-title",
			children: t
		})] }) : /* @__PURE__ */ (0, Y.jsx)("code", { children: Rp(e, "No active delivery") })
	});
}
function hm({ stages: e, deliveryStatus: t, currentStep: n, startedAt: r, finishedAt: i, remediation: a, now: o, onStageClick: s }) {
	...
	return /* @__PURE__ */ (0, Y.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, Y.jsxs)("div", { children: [/* @__PURE__ */ (0, Y.jsx)("span", {
				...
				children: [
					/* @__PURE__ */ (0, Y.jsx)(Tp, { size: 13 }),
					"Verification failed · Remediation retry ",
					d
				]
			})] }), /* @__PURE__ */ (0, Y.jsxs)("p", { children: [r ? `Started ${zp(r)}` : "Awaiting delivery trigger", i ? ` · Finished ${zp(i)}` : ""] })]
		}), /* @__PURE__ */ (0, Y.jsxs)("div", {
					...
					return /* @__PURE__ */ (0, Y.jsx)("li", {
						...
						children: /* @__PURE__ */ (0, Y.jsxs)("button", {
							...
							children: [/* @__PURE__ */ (0, Y.jsx)("span", {
								...
								className: "flow-copy",
								children: [/* @__PURE__ */ (0, Y.jsx)("strong", { children: Rp(e.label) }), /* @__PURE__ */ (0, Y.jsx)("span", { children: f })]
							})]
						})
					}, `${e.label}-${t}`);
				})
...
function gm({ stage: e, content: t, error: n, loading: r, live: i = !1, onClose: a }) {
...
function ym({ checks: e, onClick: t }) {
...
function bm({ checks: e, onClose: t }) {
	return /* @__PURE__ */ (0, Y.jsx)("div", {
		className: "modal-backdrop",
		role: "presentation",
		onMouseDown: t,
		children: /* @__PURE__ */ (0, Y.jsxs)("section", {
			...
			children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
				...
				children: e.map((e, t) => /* @__PURE__ */ (0, Y.jsxs)("article", {
					...
					children: [
						/* @__PURE__ */ (0, Y.jsxs)("div", { children: [/* @__PURE__ */ (0, Y.jsx)("strong", { children: Rp(e.label) }), /* @__PURE__ */ (0, Y.jsx)("span", { children: Rp(e.repository, "Workspace") })] }),
						/* @__PURE__ */ (0, Y.jsx)(Wp, { value: e.status }),
						/* @__PURE__ */ (0, Y.jsx)("p", { children: Rp(e.summary, "No summary recorded.") }),
...
function Tm({ data: e, project: t, interact: n, notify: r }) {
	let i = e.interactive?.prompts || [], [a, o] = (0, M.useState)("scan"), [s, c] = (0, M.useState)(null), [l, u] = (0, M.useState)(""), [d, f] = (0, M.useState)({
		...
		c(e);
		try {
			let n = await Up(`/api/prompt?mode=${encodeURIComponent(e.mode)}&path=${encodeURIComponent(e.path)}`, t);
			u(n.content);
		} catch (e) {
	...
	return /* @__PURE__ */ (0, Y.jsxs)(Y.Fragment, { children: [
		...
		/* @__PURE__ */ (0, Y.jsx)($p, {
			...
			action: /* @__PURE__ */ (0, Y.jsx)(Qp, {
				label: p ? "Exit full screen" : "View full screen",
				onClick: () => m((e) => !e),
				children: p ? /* @__PURE__ */ (0, Y.jsx)(Cp, { size: 14 }) : /* @__PURE__ */ (0, Y.jsx)(xp, { size: 14 })
			}),
			...
			children: /* @__PURE__ */ (0, Y.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, Y.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, Y.jsx)("div", {
						...
						children: w.map((e, t) => {
							let n = _.filter((t) => e.layers.includes(Cm(t, a))), r = [...e.scripts.map((e) => ({
								kind: "script",
								script: e
							})), ...n.map((e) => ({
								kind: "prompt",
								...
								children: [
									...
									/* @__PURE__ */ (0, Y.jsx)("div", {
										...
										children: r.map((e, n) => {
											...
											let i = e.prompt, a = Sm(i), o = a.icon;
											return /* @__PURE__ */ (0, Y.jsxs)("button", {
...
function Em({ item: e, content: t, onChange: n, onClose: r, onSave: i }) {
	let a = Sm(e);
	return /* @__PURE__ */ (0, Y.jsx)("div", {
		className: "modal-backdrop",
		role: "presentation",
				...
				/* @__PURE__ */ (0, Y.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, Y.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, Y.jsxs)("label", {
							...
							children: [/* @__PURE__ */ (0, Y.jsx)("span", { children: "Preview" }), /* @__PURE__ */ (0, Y.jsx)(Jp, { content: t })]
						})]
					})
				}),
				/* @__PURE__ */ (0, Y.jsxs)("footer", { children: [/* @__PURE__ */ (0, Y.jsx)("button", {
					...
					className: "button primary",
					onClick: i,
					children: [/* @__PURE__ */ (0, Y.jsx)(Ep, { size: 14 }), "Save prompt"]
				})] })
			]
		})
	});
...
function Dm({ children: e }) {
	return /* @__PURE__ */ (0, Y.jsxs)("details", {
		...
		children: [/* @__PURE__ */ (0, Y.jsx)("summary", {
			...
			children: /* @__PURE__ */ (0, Y.jsx)(dp, { size: 13 })
		}), /* @__PURE__ */ (0, Y.jsx)("span", {
			role: "tooltip",
			children: e
		})]
...
function $({ label: e, help: t, children: n }) {
	return /* @__PURE__ */ (0, Y.jsxs)("label", {
		...
		children: [/* @__PURE__ */ (0, Y.jsxs)("span", {
			...
			children: [e, t && /* @__PURE__ */ (0, Y.jsx)(Dm, { children: t })]
		}), n]
	});
}
function Om({ runtime: e, onChange: t }) {
			...
			children: [
				...
				/* @__PURE__ */ (0, Y.jsx)("footer", {
					...
					children: /* @__PURE__ */ (0, Y.jsxs)("button", {
						...
						children: [/* @__PURE__ */ (0, Y.jsx)(Ep, { size: 15 }), "Save repositories"]
					})
				})
			]
		}), l && /* @__PURE__ */ (0, Y.jsx)(Am, {
			onClose: () => u(!1),
			onAdd: (e) => {
...
function jm({ data: e, project: t, notify: n, onDirtyChange: r, reload: i }) {
	...
	(0, M.useEffect)(() => {
		Up("/api/delivery/status-options", t).then((e) => ne(Array.isArray(e.options) ? e.options.map(String) : [])).catch(() => ne([]));
	}, [t]), (0, M.useEffect)(() => {
	...
	let fe = async (e) => {
		let n = await Up(`/api/integration?key=${encodeURIComponent(e)}`, t);
		...
		try {
			await Promise.all([
				...
				...Object.entries(O).map(([e, n]) => Up("/api/integration", t, {
					method: "POST",
					json: {
						key: e,
						value: n
		...
		children: [
				...
				children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, Y.jsxs)("div", {
							...
							}), /* @__PURE__ */ (0, Y.jsx)("p", { children: Rp(o.scan?.description, "No recurring scan is configured.") })]
						}),
						/* @__PURE__ */ (0, Y.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, Y.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
							...
							children: Lp.map((e) => /* @__PURE__ */ (0, Y.jsx)("option", {
								value: e.value,
								label: e.label
							}, e.value))
						})]
							...
							children: he.length ? he.map((e) => {
								...
								return /* @__PURE__ */ (0, Y.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, Y.jsxs)("div", { children: [/* @__PURE__ */ (0, Y.jsx)(Qp, {
											label: "Reveal value",
											onClick: () => void pe(e),
											children: re[e] ? /* @__PURE__ */ (0, Y.jsx)(hp, { size: 15 }) : /* @__PURE__ */ (0, Y.jsx)(gp, { size: 15 })
										}), /* @__PURE__ */ (0, Y.jsx)(Qp, {
											label: "Copy value",
											onClick: () => void me(e),
											children: /* @__PURE__ */ (0, Y.jsx)(pp, { size: 15 })
										})] })
									]
								}, e);
							}) : /* @__PURE__ */ (0, Y.jsx)(rm, { label: "No local integration keys configured." })
						})
					})]
				})
			}),
			/* @__PURE__ */ (0, Y.jsxs)("footer", {
				...
				children: [/* @__PURE__ */ (0, Y.jsx)("span", {
					...
					disabled: !ue,
					onClick: () => void _e(),
					children: [/* @__PURE__ */ (0, Y.jsx)(Ep, { size: 15 }), "Save changes"]
				})]
			})
		]
	});
}
function Mm({ enabled: e, onChange: t }) {
	return /* @__PURE__ */ (0, Y.jsxs)("label", {
...
(0, dt.createRoot)(document.getElementById("root")).render(/* @__PURE__ */ (0, Y.jsx)(em, {}));
//#endregion
