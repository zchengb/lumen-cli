...
//#endregion
//#region package.json
var wh = "2.2.47", Th = (...e) => e.filter((e, t, n) => !!e && e.trim() !== "" && n.indexOf(e) === t).join(" ").trim(), Eh = (e) => e.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase(), Dh = (e) => e.replace(/^([A-Z])|[\s-_]+(\w)/g, (e, t, n) => n ? n.toUpperCase() : t.toLowerCase()), Oh = (e) => {
	let t = Dh(e);
...
function E_({ candidates: e, selected: t, loading: n, error: r, busy: i, onChange: a, onClose: o, onConfirm: s }) {
	...
	return /* @__PURE__ */ (0, X.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, X.jsxs)("section", {
			...
			role: "dialog",
			"aria-modal": "true",
			"aria-label": "Choose Auto Patch Jira card",
			onMouseDown: (e) => e.stopPropagation(),
			children: [/* @__PURE__ */ (0, X.jsxs)("div", {
				className: "modal-body compact",
				children: [
					/* @__PURE__ */ (0, X.jsx)("strong", { children: "Choose a Jira card to patch" }),
					/* @__PURE__ */ (0, X.jsx)("p", {
						className: "modal-copy",
					...
					!n && !r && !e.length && /* @__PURE__ */ (0, X.jsx)("div", {
						className: "patch-candidate-empty",
...
function D_({ phases: e, overallStatus: t }) {
	let n = e.filter((e) => !["screen", "context"].includes(String(e.id || "").toLowerCase())), r = String(t).toLowerCase() === "skipped", i = n.filter((e) => e.status === "completed" || r && e.id === "jira_notify" && e.status === "failed").length;
	return /* @__PURE__ */ (0, X.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, X.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, X.jsx)("span", {
				...
				children: /* @__PURE__ */ (0, X.jsx)("i", { style: { width: `${n.length ? Math.round(i / n.length * 100) : 0}%` } })
			}), /* @__PURE__ */ (0, X.jsx)("ol", {
				className: "flow-steps",
				style: { "--flow-count": Math.max(n.length, 1) },
				children: n.map((e, t) => {
					let n = String(e.status || "pending").toLowerCase(), i = n === "completed" ? "completed" : r && e.id === "jira_notify" && n === "failed" ? "skipped" : /in_progress|running/.test(n) ? "running" : /failed|blocked/.test(n) ? "failed" : "pending", a = $(e.detail || e.status, "Pending"), o = e.started_at ? Fg(e.started_at, e.finished_at || (/* @__PURE__ */ new Date()).toISOString()) : "—";
