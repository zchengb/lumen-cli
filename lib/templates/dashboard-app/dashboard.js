...
function Lg(e) {
	let t = e.match(/^【\s*Pkg\s*(\d+)\s*】\s*(.+)$/i) || e.match(/^\[\s*Pkg\s*(\d+)\s*\]\s*(.+)$/i);
	return t ? {
		pkg: `Pkg ${t[1].padStart(2, "0")}`,
		headline: t[2].trim()
	} : {
		pkg: "",
		headline: e
...
function Rg({ business: e, technical: t }) {
...
function zg({ label: e, onClose: t, children: n }) {
...
var Vg = (0, M.memo)(function({ chart: e }) {
...
function Ug({ className: e, children: t }) {
	let n = String(t).replace(/\n$/, ""), [r, i] = (0, M.useState)(!1);
	return /language-mermaid/.test(e || "") ? /* @__PURE__ */ (0, X.jsx)(Vg, { chart: n }) : !n.includes("\n") && !e ? /* @__PURE__ */ (0, X.jsx)("code", {
		className: e,
		children: t
...
var Jg = /^\s*(?:<(?:strong|b|em|span)[^>]*>\s*)?(Given|When|Then)\s*[:：]?\s*(?:<\/(?:strong|b|em|span)>\s*)?/i, Yg = "<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"14\" height=\"14\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><rect width=\"14\" height=\"14\" x=\"8\" y=\"8\" rx=\"2\" ry=\"2\"/><path d=\"M4 16V4a2 2 0 0 1 2-2h12\"/></svg>";
function Xg(e) {
	let t = e.match(Jg);
	return t ? {
...
function t_(e) {
	...
	for (let t of Array.from(new Set(Array.from(e.querySelectorAll(".ac-step, .md-code-block")).map((e) => e.parentElement).filter(Boolean)))) {
		...
		for (let r of Array.from(t.children)) $g(r) ? e.push(r) : (Zg(r), n());
		n();
	}
}
function n_(e) {
	for (let t of Array.from(e.querySelectorAll("pre"))) {
		...
		o.type = "button", o.className = "md-code-copy", o.title = "Copy code", o.setAttribute("aria-label", "Copy code"), o.innerHTML = Yg, o.onclick = (n) => {
...
function s_({ value: e, onChange: t }) {
	let { frontmatter: n, body: r } = Kg(e), i = (0, M.useRef)(null), a = (0, M.useRef)(!1), o = (0, M.useRef)(!1), s = (0, M.useRef)(r), c = (0, M.useRef)(i_()), [l, u] = (0, M.useState)(null);
	s.current = r;
	let d = (e) => t(qg(n, e)), f = () => {
		let e = i.current;
		if (!e) return;
		let t = c.current.turndown(e);
		o_(o.current, t, s.current) && d(t);
	}, p = (0, M.useCallback)(async (e) => {
		let t = i.current;
		if (!t) return;
		o.current = !1, t.innerHTML = r_(e), n_(t), t_(t), t.querySelectorAll("a[href]").forEach((e) => {
			...
			/* @__PURE__ */ (0, X.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, X.jsxs)("header", {
					...
					children: [
						...
						n && i === "scan" && /* @__PURE__ */ (0, X.jsx)(d_, {
							data: n,
							project: e,
							interact: T
						}),
						n && i === "delivery" && /* @__PURE__ */ (0, X.jsx)(y_, {
							data: n,
							project: e,
							notify: b,
							reload: x
						}),
						n && i === "observatory" && /* @__PURE__ */ (0, X.jsx)(C_, {
							project: e,
							notify: b,
							onDirtyChange: y
						}),
						n && i === "repositories" && /* @__PURE__ */ (0, X.jsx)(z_, {
							data: n,
							interact: T
						}),
						n && i === "prompts" && /* @__PURE__ */ (0, X.jsx)(F_, {
							data: n,
							project: e,
							interact: T,
							notify: b
						}),
						n && i === "settings" && /* @__PURE__ */ (0, X.jsx)(V_, {
							data: n,
							project: e,
							notify: b,
							onDirtyChange: _,
...
function d_({ data: e, project: t, interact: n }) {
	...
	return /* @__PURE__ */ (0, X.jsxs)(X.Fragment, { children: [
		...
		/* @__PURE__ */ (0, X.jsxs)(l_, {
			...
			children: [/* @__PURE__ */ (0, X.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, X.jsxs)("table", { children: [/* @__PURE__ */ (0, X.jsx)("thead", { children: /* @__PURE__ */ (0, X.jsxs)("tr", { children: [
					...
					/* @__PURE__ */ (0, X.jsx)("td", { children: /* @__PURE__ */ (0, X.jsx)(m_, { run: e }) }),
			...
			}), a.length > 10 && /* @__PURE__ */ (0, X.jsx)(h_, {
				page: u,
		...
		/* @__PURE__ */ (0, X.jsxs)(l_, {
			...
			children: [/* @__PURE__ */ (0, X.jsx)("div", {
				...
				id: "tracked-findings",
				className: "findings",
				children: p.length ? p.map((e) => /* @__PURE__ */ (0, X.jsx)(g_, {
					issue: e,
					onIgnore: () => s(e)
				}, e.id)) : /* @__PURE__ */ (0, X.jsx)(p_, { label: "No findings match this status." })
			})]
		}),
		o && /* @__PURE__ */ (0, X.jsx)(v_, {
			onClose: () => s(null),
			onConfirm: (e) => {
				n("/api/issue/ignore", {
					issue_id: o.id,
...
function y_({ data: e, project: t, notify: n, reload: r }) {
	...
	return /* @__PURE__ */ (0, X.jsxs)(X.Fragment, { children: [
			...
			children: /* @__PURE__ */ (0, X.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, X.jsxs)("table", { children: [/* @__PURE__ */ (0, X.jsx)("thead", { children: /* @__PURE__ */ (0, X.jsxs)("tr", { children: [
					...
					return /* @__PURE__ */ (0, X.jsxs)("tr", { children: [
						...
						/* @__PURE__ */ (0, X.jsx)("td", { children: /* @__PURE__ */ (0, X.jsx)(O_, { items: e.pull_requests || [] }) }),
						/* @__PURE__ */ (0, X.jsx)("td", { children: /* @__PURE__ */ (0, X.jsx)(k_, {
							checks: t,
							onClick: () => p(t)
						}) }),
					...
					colSpan: 8,
					children: /* @__PURE__ */ (0, X.jsx)(p_, { label: "No delivery history yet." })
				}) }) })] })
			})
		}),
		/* @__PURE__ */ (0, X.jsx)(l_, {
			...
			children: /* @__PURE__ */ (0, X.jsx)("div", {
				...
				}, `${e.at}-${t}`)) : /* @__PURE__ */ (0, X.jsx)(p_, { label: "No scheduled delivery activity recorded yet." })
			})
		}),
		u && /* @__PURE__ */ (0, X.jsx)(E_, {
			stage: u,
			content: m,
			error: g,
			loading: v,
		...
		f && /* @__PURE__ */ (0, X.jsx)(A_, {
			checks: f,
			onClose: () => p(null)
		}),
		S && /* @__PURE__ */ (0, X.jsx)(x_, {
	...
	return /* @__PURE__ */ (0, X.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, X.jsxs)("aside", {
			...
			children: [
				...
				/* @__PURE__ */ (0, X.jsxs)("div", {
					...
					children: [
						...
						!E && !pe.length ? /* @__PURE__ */ (0, X.jsx)(p_, { label: i.length ? "No stories match this filter." : "No stories found in the docs repository." }) : null,
						pe.map((e) => {
							let t = kg(e.jira_key || e.story), n = Lg(kg(e.title, e.story));
							return /* @__PURE__ */ (0, X.jsxs)("button", {
			...
			children: o ? /* @__PURE__ */ (0, X.jsxs)(X.Fragment, { children: [/* @__PURE__ */ (0, X.jsxs)("div", {
				...
				value: b,
				onChange: x
			}, `${o || "none"}-plan`)] })] }) : /* @__PURE__ */ (0, X.jsx)(p_, { label: "Select a story to inspect." })
		})]
	});
}
				...
				/* @__PURE__ */ (0, X.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, X.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, X.jsxs)("label", {
							...
							children: [/* @__PURE__ */ (0, X.jsx)("span", { children: "Preview" }), /* @__PURE__ */ (0, X.jsx)(Gg, { content: t })]
						})]
					})
				}),
				/* @__PURE__ */ (0, X.jsxs)("footer", { children: [/* @__PURE__ */ (0, X.jsx)("button", {
...
function $({ label: e, help: t, children: n }) {
	return /* @__PURE__ */ (0, X.jsxs)("label", {
		...
		children: [/* @__PURE__ */ (0, X.jsxs)("span", {
			...
			children: [e, t && /* @__PURE__ */ (0, X.jsx)(L_, { children: t })]
		}), n]
	});
}
	...
	return /* @__PURE__ */ (0, X.jsxs)("section", {
		...
		children: [
			/* @__PURE__ */ (0, X.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, X.jsxs)("div", { children: [/* @__PURE__ */ (0, X.jsxs)("strong", { children: ["Visual runtime ", /* @__PURE__ */ (0, X.jsx)(L_, { children: "These settings tell Lumen how to start the repository, reach its page, authenticate, and provide mock data during visual verification." })] }), /* @__PURE__ */ (0, X.jsx)("span", { children: "Only the runtime inputs needed for visual verification are shown first." })] }), /* @__PURE__ */ (0, X.jsx)("code", { children: e.runtime_profile || n })]
			}),
			/* @__PURE__ */ (0, X.jsxs)("div", {
				...
				children: /* @__PURE__ */ (0, X.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, X.jsxs)("div", {
						...
						children: /* @__PURE__ */ (0, X.jsx)("div", {
							...
							}) : /* @__PURE__ */ (0, X.jsx)(p_, { label: "No local integration keys configured." })
						})
					})]
				})
			}),
...
(0, be.createRoot)(document.getElementById("root")).render(/* @__PURE__ */ (0, X.jsx)(u_, {}));
//#endregion
