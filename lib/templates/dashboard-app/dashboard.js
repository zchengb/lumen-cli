...
//#endregion
//#region package.json
var wh = "2.2.37", Th = (...e) => e.filter((e, t, n) => !!e && e.trim() !== "" && n.indexOf(e) === t).join(" ").trim(), Eh = (e) => e.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase(), Dh = (e) => e.replace(/^([A-Z])|[\s-_]+(\w)/g, (e, t, n) => n ? n.toUpperCase() : t.toLowerCase()), Oh = (e) => {
	let t = Dh(e);
...
function T_({ data: e, project: t, notify: n, reload: r }) {
	let i = e.patch || {}, a = i.current || {}, o = i.runs || [], s = i.scheduler_activity || [], c = !!a.active || /in_progress|running/i.test(String(a.patch_status || "")), [l, u] = (0, F.useState)(""), [d, f] = (0, F.useState)(""), [p, m] = (0, F.useState)(!1), [h, g] = (0, F.useState)(!1), [_, v] = (0, F.useState)(null), [y, b] = (0, F.useState)(""), [x, S] = (0, F.useState)(""), C = async (e = String(a.run_id || "")) => {
		m(!0), u(""), f("");
		try {
...
function E_({ phases: e }) {
	let t = e.filter((e) => !["screen", "context"].includes(String(e.id || "").toLowerCase())), n = t.filter((e) => e.status === "completed").length;
	return /* @__PURE__ */ (0, X.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, X.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, X.jsx)("span", {
				...
				children: /* @__PURE__ */ (0, X.jsx)("i", { style: { width: `${t.length ? Math.round(n / t.length * 100) : 0}%` } })
			}), /* @__PURE__ */ (0, X.jsx)("ol", {
				className: "flow-steps",
				style: { "--flow-count": Math.max(t.length, 1) },
				children: t.map((e, t) => {
					let n = String(e.status || "pending").toLowerCase(), r = n === "completed" ? "completed" : /in_progress|running/.test(n) ? "running" : /failed|blocked/.test(n) ? "failed" : "pending", i = $(e.detail || e.status, "Pending"), a = e.started_at ? Fg(e.started_at, e.finished_at || (/* @__PURE__ */ new Date()).toISOString()) : "—";
							...
							children: /* @__PURE__ */ (0, X.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, X.jsxs)("section", {
										className: "repository-section",
										children: [
											/* @__PURE__ */ (0, X.jsx)("div", { children: /* @__PURE__ */ (0, X.jsx)("strong", { children: "Automation permissions" }) }),
											/* @__PURE__ */ (0, X.jsxs)("div", {
									...
									/* @__PURE__ */ (0, X.jsxs)("section", {
										className: "repository-section",
										children: [
											/* @__PURE__ */ (0, X.jsxs)("div", { children: [/* @__PURE__ */ (0, X.jsxs)("strong", { children: ["Delivery verification · ", k.name || "Repository"] }), /* @__PURE__ */ (0, X.jsx)("span", { children: "Choose whether Lumen should verify this repository after implementation. Automatic verification can run compile/static checks and tests independently." })] }),
											/* @__PURE__ */ (0, X.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, X.jsxs)("label", {
													...
													}), /* @__PURE__ */ (0, X.jsxs)("span", { children: [/* @__PURE__ */ (0, X.jsx)("strong", { children: "Run verification" }), /* @__PURE__ */ (0, X.jsx)("small", { children: "Use the selected automatic profile or custom commands." })] })]
												}), /* @__PURE__ */ (0, X.jsxs)("label", {
													className: `verification-mode-card${N.mode === "skip" ? " selected" : ""}`,
													children: [/* @__PURE__ */ (0, X.jsx)("input", {
														type: "radio",
													...
													}), /* @__PURE__ */ (0, X.jsxs)("span", { children: [/* @__PURE__ */ (0, X.jsx)("strong", { children: "Skip verification" }), /* @__PURE__ */ (0, X.jsx)("small", { children: "Do not run compile, static checks, or tests for this repository." })] })]
												})]
											}),
											N.mode !== "skip" && /* @__PURE__ */ (0, X.jsxs)(X.Fragment, { children: [/* @__PURE__ */ (0, X.jsxs)("div", {
												...
												}), /* @__PURE__ */ (0, X.jsxs)("span", { children: [/* @__PURE__ */ (0, X.jsx)("strong", { children: "Automatic profile" }), /* @__PURE__ */ (0, X.jsx)("small", { children: "Detect commands from the repository at runtime." })] })] }), /* @__PURE__ */ (0, X.jsxs)("label", { children: [/* @__PURE__ */ (0, X.jsx)("input", {
													type: "radio",
													name: `verification-source-${k.name}`,
												...
												}), /* @__PURE__ */ (0, X.jsxs)("span", { children: [/* @__PURE__ */ (0, X.jsx)("strong", { children: "Compile & static checks" }), /* @__PURE__ */ (0, X.jsx)("small", { children: "Compile, syntax, typecheck, lint, or PMD checks detected for this repository." })] })] }), /* @__PURE__ */ (0, X.jsxs)("label", { children: [/* @__PURE__ */ (0, X.jsx)("input", {
													type: "checkbox",
													checked: N.tests,
													onChange: (e) => b(A, { tests: e.target.checked })
												}), /* @__PURE__ */ (0, X.jsxs)("span", { children: [/* @__PURE__ */ (0, X.jsx)("strong", { children: "Tests" }), /* @__PURE__ */ (0, X.jsx)("small", { children: "Unit, integration, and test-suite commands detected for this repository." })] })] })]
											}) : /* @__PURE__ */ (0, X.jsxs)(X.Fragment, { children: [j.suggested_commands?.length > 0 && /* @__PURE__ */ (0, X.jsxs)("button", {
												className: "text-button",
