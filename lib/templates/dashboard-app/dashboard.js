...
function vu({ data: e, project: t }) {
	...
	let C = !!(s && x && s.run_id === r.run_id);
	(0, U.useEffect)(() => {
		if (!C || !s) return;
		let e = window.setInterval(() => void S(s.run_id, !0), 1e3);
		return () => window.clearInterval(e);
	}, [
		s,
		C,
...
function bu({ stages: e, deliveryStatus: t, startedAt: n, finishedAt: r, remediation: i, now: a, onStageClick: o }) {
					...
					return /* @__PURE__ */ (0, H.jsx)("li", {
						...
						children: /* @__PURE__ */ (0, H.jsxs)("button", {
							...
							children: [/* @__PURE__ */ (0, H.jsx)("span", {
								...
								className: "flow-copy",
								children: [/* @__PURE__ */ (0, H.jsx)("strong", { children: eu(e.label) }), /* @__PURE__ */ (0, H.jsx)("span", { children: u })]
							})]
						})
					}, `${e.label}-${t}`);
				})
...
function xu({ stage: e, content: t, error: n, loading: r, live: i = !1, onClose: a }) {
