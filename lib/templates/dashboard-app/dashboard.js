...
//#endregion
//#region package.json
var bl = _(), xl = "1.23.0", Sl = (...e) => e.filter((e, t, n) => !!e && e.trim() !== "" && n.indexOf(e) === t).join(" ").trim(), Cl = (e) => e.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase(), wl = (e) => e.replace(/^([A-Z])|[\s-_]+(\w)/g, (e, t, n) => n ? n.toUpperCase() : t.toLowerCase()), Tl = (e) => {
	let t = wl(e);
				...
				children: [
					...
					/* @__PURE__ */ (0, V.jsxs)("div", {
						...
						children: [!f && /* @__PURE__ */ (0, V.jsx)("img", {
							...
							alt: "INSPIRE GROUP"
						}), /* @__PURE__ */ (0, V.jsx)("small", { children: f ? "" : `Version ${xl}` })]
					})
				]
			}),
			/* @__PURE__ */ (0, V.jsx)(cu, {
				...
				children: [
					/* @__PURE__ */ (0, V.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, V.jsx)("h4", { children: tu(e.title, "Untitled finding") }),
							/* @__PURE__ */ (0, V.jsx)(su, { value: i })
						]
					}),
...
function Nu({ data: e, project: t, interact: n, notify: r }) {
	...
	let y = (e) => {
		if (e.preventDefault(), e.ctrlKey || e.metaKey) {
			let t = Math.max(.65, Math.min(1.55, d.scale * (e.deltaY > 0 ? .92 : 1.08)));
			f((e) => ({
				...e,
				scale: t
			}));
