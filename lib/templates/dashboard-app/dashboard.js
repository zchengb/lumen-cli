...
var e = Object.create, t = Object.defineProperty, n = Object.getOwnPropertyDescriptor, r = Object.getOwnPropertyNames, i = Object.getPrototypeOf, a = Object.prototype.hasOwnProperty, o = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), s = (e, n) => {
	...
	function pu() {
		return G & 2 && J !== 0 ? J & -J : M.T === null ? at() : ud();
	}
	function mu() {
...
//#endregion
//#region package.json
var xl = _(), Sl = "1.24.28", Cl = (...e) => e.filter((e, t, n) => !!e && e.trim() !== "" && n.indexOf(e) === t).join(" ").trim(), wl = (e) => e.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase(), Tl = (e) => e.replace(/^([A-Z])|[\s-_]+(\w)/g, (e, t, n) => n ? n.toUpperCase() : t.toLowerCase()), El = (e) => {
	let t = Tl(e);
			...
			/* @__PURE__ */ (0, H.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, H.jsxs)("header", {
					...
					children: [
						...
						n && i === "repositories" && /* @__PURE__ */ (0, H.jsx)(Bu, {
							data: n,
							interact: S
						}),
						n && i === "prompts" && /* @__PURE__ */ (0, H.jsx)(Iu, {
							data: n,
							project: e,
							interact: S,
							notify: l
						}),
						n && i === "settings" && /* @__PURE__ */ (0, H.jsx)(Hu, {
							data: n,
							project: e,
							notify: l,
							onDirtyChange: _,
...
function Su({ data: e, project: t, notify: n, reload: r }) {
	...
	}, de = /failed|blocked/i.test(String(a.delivery_status || "")), fe = !N && !!(a.story_id || a.jira_key || (i.available_stories || []).length);
	return /stopped from dashboard/i.test(String(a.current_step || "")), /* @__PURE__ */ (0, H.jsxs)(H.Fragment, { children: [
		/* @__PURE__ */ (0, H.jsxs)(fu, {
			...
			children: /* @__PURE__ */ (0, H.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, H.jsxs)("table", { children: [/* @__PURE__ */ (0, H.jsx)("thead", { children: /* @__PURE__ */ (0, H.jsxs)("tr", { children: [
					...
					return /* @__PURE__ */ (0, H.jsxs)("tr", { children: [
						...
						/* @__PURE__ */ (0, H.jsx)("td", { children: /* @__PURE__ */ (0, H.jsx)(ku, { items: e.pull_requests || [] }) }),
						/* @__PURE__ */ (0, H.jsx)("td", { children: /* @__PURE__ */ (0, H.jsx)(Au, {
							checks: t,
							onClick: () => f(t)
						}) }),
		...
		d && /* @__PURE__ */ (0, H.jsx)(ju, {
			checks: d,
			onClose: () => f(null)
		}),
		x && /* @__PURE__ */ (0, H.jsx)(Cu, {
...
function Tu({ jiraKey: e, title: t }) {
	return /* @__PURE__ */ (0, H.jsxs)("span", {
		...
		children: [/* @__PURE__ */ (0, H.jsx)("code", { children: X(e, "No active delivery") }), t ? /* @__PURE__ */ (0, H.jsx)("span", {
...
function Z({ label: e, help: t, children: n }) {
	return /* @__PURE__ */ (0, H.jsxs)("label", {
		...
		children: [/* @__PURE__ */ (0, H.jsxs)("span", {
			...
			children: [e, t && /* @__PURE__ */ (0, H.jsx)(Ru, { children: t })]
		}), n]
	});
}
	...
	return /* @__PURE__ */ (0, H.jsxs)("section", {
		...
		children: [
			/* @__PURE__ */ (0, H.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, H.jsxs)("div", { children: [/* @__PURE__ */ (0, H.jsxs)("strong", { children: ["Visual runtime ", /* @__PURE__ */ (0, H.jsx)(Ru, { children: "These settings tell Lumen how to start the repository, reach its page, authenticate, and provide mock data during visual verification." })] }), /* @__PURE__ */ (0, H.jsx)("span", { children: "Only the runtime inputs needed for visual verification are shown first." })] }), /* @__PURE__ */ (0, H.jsx)("code", { children: e.runtime_profile || n })]
			}),
			/* @__PURE__ */ (0, H.jsxs)("div", {
...
function Hu({ data: e, project: t, notify: n, onDirtyChange: r, reload: i }) {
	...
	let ce = async (e) => {
		...
		try {
			await Promise.all([
				lu("/api/workspace", t, {
					...
					json: {
						...
						scan_model: T,
						delivery_model: ee,
						feishu_notifications_enabled: ie
					}
				}),
				lu("/api/schedule", t, {
					method: "POST",
			...
			]), re({}), se(!1), r(!1), n("Settings saved"), await i();
		} catch (e) {
	...
	return /* @__PURE__ */ (0, H.jsxs)("div", {
		...
		children: [
				...
				children: [/* @__PURE__ */ (0, H.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, H.jsxs)("div", {
							...
							}), /* @__PURE__ */ (0, H.jsx)("p", { children: C ? `Polling every ${p} minute(s).` : "Delivery polling is paused." })]
						}),
						/* @__PURE__ */ (0, H.jsxs)("div", {
							className: "settings-control wide",
							children: [/* @__PURE__ */ (0, H.jsxs)("div", {
								...
								return /* @__PURE__ */ (0, H.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, H.jsxs)("div", { children: [/* @__PURE__ */ (0, H.jsx)(du, {
											label: "Reveal value",
											onClick: () => void le(e),
											children: ne[e] ? /* @__PURE__ */ (0, H.jsx)(K, { size: 15 }) : /* @__PURE__ */ (0, H.jsx)(q, { size: 15 })
										}), /* @__PURE__ */ (0, H.jsx)(du, {
											label: "Copy value",
											onClick: () => void ue(e),
			...
			/* @__PURE__ */ (0, H.jsxs)("footer", {
				...
				children: [/* @__PURE__ */ (0, H.jsx)("span", {
					className: oe ? "settings-save-status unsaved" : "settings-save-status",
					children: oe ? "You have unsaved changes" : "All changes saved"
				}), /* @__PURE__ */ (0, H.jsxs)("button", {
					className: "button primary",
					disabled: !oe,
					onClick: () => void pe(),
