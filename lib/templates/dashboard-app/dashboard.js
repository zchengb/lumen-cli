...
function Fg(e) {
	let t = jg(e, "unknown").toLowerCase().replaceAll("_", " ");
	return {
...
function Lg({ value: e }) {
	return /* @__PURE__ */ (0, Y.jsx)("span", {
		className: `badge ${Pg(e)}`,
		children: Fg(e)
	});
}
function Rg({ business: e, technical: t, compact: n = !1 }) {
	return /* @__PURE__ */ (0, Y.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, Y.jsxs)("span", {
			...
			children: [/* @__PURE__ */ (0, Y.jsx)("em", { children: "Business" }), /* @__PURE__ */ (0, Y.jsx)(Lg, { value: e || "draft" })]
		}), /* @__PURE__ */ (0, Y.jsxs)("span", {
			className: "observatory-meta-item",
			children: [/* @__PURE__ */ (0, Y.jsx)("em", { children: "Technical" }), /* @__PURE__ */ (0, Y.jsx)(Lg, { value: t || "draft" })]
		})]
	});
}
function zg(e) {
...
function Bg({ date: e, assignee: t }) {
	let n = zg(e), r = String(t || "").trim();
...
function Vg({ business: e, technical: t }) {
	let n = Pg(e || "draft"), r = Pg(t || "draft"), i = (e) => e === "success" ? /* @__PURE__ */ (0, Y.jsx)("i", { className: "observatory-status-dot" }) : /* @__PURE__ */ (0, Y.jsx)(Hh, { size: 11 });
	return /* @__PURE__ */ (0, Y.jsxs)("div", {
...
function Hg({ label: e, onClose: t, children: n }) {
...
var Wg = (0, M.memo)(function({ chart: e }) {
...
function Kg({ className: e, children: t }) {
	let n = String(t).replace(/\n$/, ""), [r, i] = (0, M.useState)(!1);
	return /language-mermaid/.test(e || "") ? /* @__PURE__ */ (0, Y.jsx)(Wg, { chart: n }) : !n.includes("\n") && !e ? /* @__PURE__ */ (0, Y.jsx)("code", {
		className: e,
		children: t
...
var qg = {
	...
	img({ src: e, alt: t }) {
		return /* @__PURE__ */ (0, Y.jsx)(Gg, {
			src: e,
			alt: t
		});
	},
	code({ className: e, children: t }) {
		return /* @__PURE__ */ (0, Y.jsx)(Kg, {
			className: e,
			children: t
		});
	}
};
function Jg({ content: e }) {
...
var Zg = "<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"14\" height=\"14\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><rect width=\"14\" height=\"14\" x=\"8\" y=\"8\" rx=\"2\" ry=\"2\"/><path d=\"M4 16V4a2 2 0 0 1 2-2h12\"/></svg>";
function Qg(e) {
	for (let t of Array.from(e.querySelectorAll("pre"))) {
		...
		o.type = "button", o.className = "md-code-copy", o.title = "Copy code", o.setAttribute("aria-label", "Copy code"), o.innerHTML = Zg, o.onclick = (n) => {
...
function r_({ value: e, onChange: t }) {
	let { frontmatter: n, body: r } = Yg(e), i = (0, M.useRef)(null), a = (0, M.useRef)(!1), o = (0, M.useRef)(!1), s = (0, M.useRef)(r), c = (0, M.useRef)(e_()), [l, u] = (0, M.useState)(null);
	s.current = r;
	let d = (e) => t(Xg(n, e)), f = () => {
		let e = i.current;
		if (!e) return;
		...
		let t = i.current;
		if (!t) return;
		o.current = !1, t.innerHTML = $g(e), Qg(t), t.querySelectorAll("a[href]").forEach((e) => {
...
function o_() {
	let [e, t] = (0, M.useState)(new URLSearchParams(window.location.search).get("project") || window.DASHBOARD_DATA?.interactive?.project || ""), [n, r] = (0, M.useState)(null), [i, a] = (0, M.useState)(Og.find((e) => `/${e.id}` === window.location.pathname)?.id || "scan"), [o, s] = (0, M.useState)(""), [c, l] = (0, M.useState)(null), [u, d] = (0, M.useState)(!0), [f, p] = (0, M.useState)(() => window.localStorage.getItem("lumen-sidebar-collapsed") === "true"), [m, h] = (0, M.useState)(null), [g, _] = (0, M.useState)(!1), [v, y] = (0, M.useState)(!1), b = (0, M.useCallback)((e, t = "info") => l({
		message: e,
		tone: t
	}), []), x = async () => {
		d(!0);
		try {
			let n = await Ig("/api/state", e);
	...
	}, E = n?.interactive?.projects || [], ee = n?.product?.tagline || "Engineering, made legible.", D = kg[i];
				...
				children: [/* @__PURE__ */ (0, Y.jsxs)("header", {
					...
					children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, Y.jsx)("span", {
							...
							children: m ? `Updated ${Mg(m.toISOString())}` : "Syncing…"
					...
					children: [
						...
						n && i === "scan" && /* @__PURE__ */ (0, Y.jsx)(l_, {
							data: n,
							project: e,
							notify: b,
							reload: x
						}),
						n && i === "delivery" && /* @__PURE__ */ (0, Y.jsx)(y_, {
							data: n,
							project: e,
							notify: b,
							reload: x
						}),
						n && i === "observatory" && /* @__PURE__ */ (0, Y.jsx)(C_, {
							project: e,
							notify: b,
							onDirtyChange: y
						}),
						n && i === "repositories" && /* @__PURE__ */ (0, Y.jsx)(z_, {
							data: n,
							interact: T
						}),
						n && i === "prompts" && /* @__PURE__ */ (0, Y.jsx)(F_, {
							data: n,
							project: e,
							interact: T,
							notify: b
						}),
						n && i === "settings" && /* @__PURE__ */ (0, Y.jsx)(V_, {
							data: n,
							project: e,
							notify: b,
							onDirtyChange: _,
...
function l_({ data: e, project: t, notify: n, reload: r }) {
	let i = e.run_stats || {}, a = e.issues || [], o = e.runs || [], [s, c] = (0, M.useState)(null), [l, u] = (0, M.useState)("all"), [d, f] = (0, M.useState)(0), [p, m] = (0, M.useState)(0), [h, g] = (0, M.useState)(!1), [_, v] = (0, M.useState)(""), y = a.filter((e) => [
		...
		g(!0), v("");
		try {
			await Ig("/api/scan/start", t, {
				method: "POST",
				json: {}
			}), m(0), n(`Scan started for ${t}`, "success"), await r().catch(() => void 0);
		} catch (e) {
			let t = e instanceof Error ? e.message : "Unable to start scan";
			v(t), n(t, "error");
		} finally {
			g(!1);
		}
	...
	return /* @__PURE__ */ (0, Y.jsxs)(Y.Fragment, { children: [
		...
		/* @__PURE__ */ (0, Y.jsxs)(a_, {
			...
			children: [/* @__PURE__ */ (0, Y.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, Y.jsxs)("table", { children: [/* @__PURE__ */ (0, Y.jsx)("thead", { children: /* @__PURE__ */ (0, Y.jsxs)("tr", { children: [
					...
					/* @__PURE__ */ (0, Y.jsx)("td", { children: Mg(e.started_at || e.finished_at) }),
					/* @__PURE__ */ (0, Y.jsx)("td", { children: /* @__PURE__ */ (0, Y.jsx)(Lg, { value: e.status }) }),
					/* @__PURE__ */ (0, Y.jsx)("td", { children: /* @__PURE__ */ (0, Y.jsx)(m_, { run: e }) }),
					/* @__PURE__ */ (0, Y.jsx)("td", { children: jg(e.duration) }),
			...
			}), o.length > 10 && /* @__PURE__ */ (0, Y.jsx)(h_, {
				page: d,
		...
		/* @__PURE__ */ (0, Y.jsxs)(a_, {
			...
			children: [/* @__PURE__ */ (0, Y.jsx)("div", {
				...
				id: "tracked-findings",
				className: "findings",
				children: b.length ? b.map((e) => /* @__PURE__ */ (0, Y.jsx)(g_, {
					issue: e,
					onIgnore: () => c(e)
				}, e.id)) : /* @__PURE__ */ (0, Y.jsx)(p_, { label: "No findings match this status." })
			})]
		}),
		s && /* @__PURE__ */ (0, Y.jsx)(v_, {
			onClose: () => c(null),
			onConfirm: (e) => {
				u_(t, n, r, s.id, e), c(null);
			}
		}),
		p > 0 && /* @__PURE__ */ (0, Y.jsx)(d_, {
			project: t,
			step: p === 1 ? 1 : 2,
			busy: h,
			error: _,
...
function d_({ project: e, step: t, busy: n, error: r, onClose: i, onContinue: a, onConfirm: o }) {
	let s = t === 1;
	return /* @__PURE__ */ (0, Y.jsx)("div", {
...
function f_({ label: e, value: t, onClick: n }) {
	return /* @__PURE__ */ (0, Y.jsxs)("div", {
...
function h_({ page: e, pageCount: t, onChange: n }) {
			...
			children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, Y.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, Y.jsx)("h4", { children: jg(e.title, "Untitled finding") }), /* @__PURE__ */ (0, Y.jsx)(Lg, { value: i })]
					}),
					/* @__PURE__ */ (0, Y.jsxs)("p", {
						...
						children: [
							...
							jg(e.repository, "Unknown repository"),
							" ",
							/* @__PURE__ */ (0, Y.jsx)("i", { children: "|" }),
							" ",
							Mg(e.last_seen_at)
...
function __({ label: e, value: t, code: n = !1 }) {
	return /* @__PURE__ */ (0, Y.jsxs)("section", {
		className: "finding-detail-row",
		children: [/* @__PURE__ */ (0, Y.jsx)("h5", { children: e }), n ? /* @__PURE__ */ (0, Y.jsx)("pre", { children: /* @__PURE__ */ (0, Y.jsx)("code", { children: jg(t, "No code snippet was captured for this historical finding.") }) }) : /* @__PURE__ */ (0, Y.jsx)("p", { children: jg(t, "Not recorded.") })]
	});
}
function v_({ onClose: e, onConfirm: t }) {
...
function y_({ data: e, project: t, notify: n, reload: r }) {
	let i = e.delivery || {}, a = i.current || {}, o = i.runs || [], s = a.stages || [], c = i.scheduler_activity || [], l = i.available_stories || [], [u, d] = (0, M.useState)(null), [f, p] = (0, M.useState)(null), [m, h] = (0, M.useState)(""), [g, _] = (0, M.useState)(""), [v, y] = (0, M.useState)(!1), [b, x] = (0, M.useState)(!1), [S, C] = (0, M.useState)(!1), [w, T] = (0, M.useState)(!1), [E, ee] = (0, M.useState)(""), [D, te] = (0, M.useState)(!1), [ne, re] = (0, M.useState)(""), [ie, O] = (0, M.useState)(!1), [k, ae] = (0, M.useState)(""), [oe, se] = (0, M.useState)(null), [ce, le] = (0, M.useState)(""), [A, ue] = (0, M.useState)(Date.now()), de = /in_progress|running/i.test(String(a.delivery_status || "")), j = s_(l, a), fe = (0, M.useCallback)(async (e = a.run_id || "", n = !1) => {
		n || y(!0);
		try {
			let n = await Ig(`/api/delivery/log?run_id=${encodeURIComponent(e)}`, t);
	...
	let me = async (e, t = a.run_id || "") => {
		...
		x(!0), h(""), _(""), y(!0);
		try {
			let e = await Ig("/api/delivery/scheduler-log", t);
		...
		try {
			let n = await Ig(`/api/delivery/trace?run_id=${encodeURIComponent(e)}`, t);
			d({
				label: "Trace",
		...
		if (e) {
			le(e), ae("");
			try {
				await Ig("/api/delivery/history/delete", t, {
					method: "POST",
					json: { run_id: e }
	...
	return /* @__PURE__ */ (0, Y.jsxs)(Y.Fragment, { children: [
			...
			children: [
				/* @__PURE__ */ (0, Y.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, Y.jsx)(D_, {
							label: "Status",
							value: /* @__PURE__ */ (0, Y.jsx)(Lg, { value: a.delivery_status || "not started" })
						}),
						/* @__PURE__ */ (0, Y.jsx)(D_, {
							label: "Elapsed",
							value: Ng(a.started_at, a.finished_at || (de ? new Date(A).toISOString() : void 0))
						}),
						/* @__PURE__ */ (0, Y.jsx)(D_, {
							label: "Finished",
							value: de ? "Running" : Mg(a.finished_at)
						})
					]
				}),
		...
		/* @__PURE__ */ (0, Y.jsx)(a_, {
			...
			children: /* @__PURE__ */ (0, Y.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, Y.jsxs)("table", { children: [/* @__PURE__ */ (0, Y.jsx)("thead", { children: /* @__PURE__ */ (0, Y.jsxs)("tr", { children: [
					...
					return /* @__PURE__ */ (0, Y.jsxs)("tr", { children: [
						/* @__PURE__ */ (0, Y.jsx)("td", { children: /* @__PURE__ */ (0, Y.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, Y.jsxs)("span", {
								...
								children: [/* @__PURE__ */ (0, Y.jsx)("code", { children: jg(e.jira_key || e.story || e.run_id) }), e.story_title && /* @__PURE__ */ (0, Y.jsx)("span", {
									className: "history-story-title",
									children: e.story_title
								})]
							}), /* @__PURE__ */ (0, Y.jsx)("small", { children: jg(e.branch, "") })]
						}) }),
						/* @__PURE__ */ (0, Y.jsx)("td", { children: Mg(e.finished_at || e.started_at) }),
						/* @__PURE__ */ (0, Y.jsx)("td", { children: r ? /* @__PURE__ */ (0, Y.jsx)("button", {
							...
							onClick: () => void me({
								...
								duration: Ng(e.started_at, e.finished_at),
								detail: n.map((e) => e.summary || e.label).filter(Boolean).join(" · ") || "Open the delivery log for details."
							}, e.run_id),
							children: /* @__PURE__ */ (0, Y.jsx)(Lg, { value: e.status })
						}) : /* @__PURE__ */ (0, Y.jsx)(Lg, { value: e.status }) }),
						/* @__PURE__ */ (0, Y.jsx)("td", { children: /* @__PURE__ */ (0, Y.jsx)(O_, { items: e.pull_requests || [] }) }),
						/* @__PURE__ */ (0, Y.jsx)("td", { children: /* @__PURE__ */ (0, Y.jsx)(k_, {
							checks: t,
							onClick: () => p(t)
						}) }),
						/* @__PURE__ */ (0, Y.jsx)("td", { children: Ng(e.started_at, e.finished_at) }),
					...
					colSpan: 8,
					children: /* @__PURE__ */ (0, Y.jsx)(p_, { label: "No delivery history yet." })
				}) }) })] })
			})
		}),
		/* @__PURE__ */ (0, Y.jsx)(a_, {
			...
			children: /* @__PURE__ */ (0, Y.jsx)("div", {
				...
				children: c.length ? c.map((e, t) => /* @__PURE__ */ (0, Y.jsxs)("article", {
					...
					children: [
						/* @__PURE__ */ (0, Y.jsx)(Lg, { value: e.outcome }),
						/* @__PURE__ */ (0, Y.jsxs)("div", { children: [/* @__PURE__ */ (0, Y.jsx)("strong", { children: jg(e.story_id || e.jira_key, "Workspace") }), /* @__PURE__ */ (0, Y.jsx)("p", { children: jg(e.message) })] }),
						/* @__PURE__ */ (0, Y.jsx)("time", { children: Mg(e.at) })
					]
				}, `${e.at}-${t}`)) : /* @__PURE__ */ (0, Y.jsx)(p_, { label: "No scheduled delivery activity recorded yet." })
			})
		}),
		u && /* @__PURE__ */ (0, Y.jsx)(E_, {
			stage: u,
			content: m,
			error: g,
			loading: v,
		...
		f && /* @__PURE__ */ (0, Y.jsx)(A_, {
			checks: f,
			onClose: () => p(null)
		}),
		S && /* @__PURE__ */ (0, Y.jsx)(x_, {
			story: jg(a.jira_key || a.story_id),
			busy: w,
			error: E,
			onClose: () => C(!1),
			onConfirm: () => void ge()
		}),
		D && /* @__PURE__ */ (0, Y.jsx)(b_, {
			stories: j,
			value: ne,
			onChange: re,
			busy: ie,
...
function b_({ stories: e, value: t, onChange: n, busy: r, error: i, onClose: a, onConfirm: o }) {
	return /* @__PURE__ */ (0, Y.jsx)("div", {
		className: "modal-backdrop",
		role: "presentation",
		...
		children: /* @__PURE__ */ (0, Y.jsxs)("section", {
			...
			children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
				...
				disabled: r || !t,
				onClick: o,
				children: [/* @__PURE__ */ (0, Y.jsx)(og, { size: 14 }), r ? "Starting…" : "Start"]
			})] })]
		})
	});
}
function x_({ story: e, busy: t, error: n, onClose: r, onConfirm: i }) {
	return /* @__PURE__ */ (0, Y.jsx)("div", {
		className: "modal-backdrop",
		role: "presentation",
...
function S_({ run: e, busy: t, onClose: n, onConfirm: r }) {
	let i = jg(e.jira_key || e.story || e.run_id);
	return /* @__PURE__ */ (0, Y.jsx)("div", {
		className: "modal-backdrop",
		role: "presentation",
...
function C_({ project: e, notify: t, onDirtyChange: n }) {
	let r = new URLSearchParams(window.location.search).get("story") || "", [i, a] = (0, M.useState)([]), [o, s] = (0, M.useState)(r), [c, l] = (0, M.useState)(""), [u, d] = (0, M.useState)(""), [f, p] = (0, M.useState)(""), [m, h] = (0, M.useState)(""), [g, _] = (0, M.useState)(""), [v, y] = (0, M.useState)(""), [b, x] = (0, M.useState)(""), [S, C] = (0, M.useState)({
		story: "",
		plan: ""
	}), [w, T] = (0, M.useState)("story"), [E, ee] = (0, M.useState)(!0), [D, te] = (0, M.useState)(!1), [ne, re] = (0, M.useState)(!1), [ie, O] = (0, M.useState)(""), [k, ae] = (0, M.useState)(!1), [oe, se] = (0, M.useState)(!1), [ce, le] = (0, M.useState)(!1), [A, ue] = (0, M.useState)(""), [de, j] = (0, M.useState)(!1), [fe, pe] = (0, M.useState)(""), me = v !== S.story || b !== S.plan, he = s_(i.filter(c_)), ge = he.length > 0;
	(0, M.useEffect)(() => {
		n(me);
	}, [me, n]), (0, M.useEffect)(() => {
		let e = (e) => {
	...
	let _e = (0, M.useCallback)(async () => {
		ee(!0);
		try {
			let t = await Ig("/api/stories", e), n = Array.isArray(t.stories) ? t.stories : [];
		...
		if (n) {
			te(!0), T("story");
			try {
				let t = await Ig(`/api/stories/content?story=${encodeURIComponent(n)}`, e);
	...
	let ye = (e) => {
		...
		if (!(me && !window.confirm("You have unsaved Observatory changes. Start delivery without saving?"))) {
			j(!0), pe("");
			try {
				await Ig("/api/delivery/start", e, {
					method: "POST",
					json: { story: n }
				}), le(!1), t(`Delivery started for ${n}`, "success"), await _e();
			} catch (e) {
		...
		if (!(!o || !me)) {
			re(!0);
			try {
				let n = await Ig("/api/stories/content", e, {
					method: "POST",
					json: {
						story: o,
						story_markdown: v,
	...
	}, Ce = jg(u || o), we = jg(c, o), Te = i.filter((e) => {
		...
		children: [
				...
				children: [
					...
					/* @__PURE__ */ (0, Y.jsxs)("div", {
						...
						children: [
							...
							!E && !Te.length ? /* @__PURE__ */ (0, Y.jsx)(p_, { label: i.length ? "No stories match this filter." : "No stories found in the docs repository." }) : null,
							Te.map((e) => {
								let t = jg(e.jira_key || e.story), n = jg(e.title, e.story);
								return /* @__PURE__ */ (0, Y.jsxs)("button", {
			...
			/* @__PURE__ */ (0, Y.jsx)("section", {
				...
				children: o ? /* @__PURE__ */ (0, Y.jsxs)(Y.Fragment, { children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, Y.jsx)("h2", { children: f ? /* @__PURE__ */ (0, Y.jsxs)("a", {
							...
							children: [
								...
								/* @__PURE__ */ (0, Y.jsx)("span", {
									className: me ? "settings-save-status unsaved" : "settings-save-status",
									children: me ? "Unsaved" : "Saved"
								}),
								/* @__PURE__ */ (0, Y.jsxs)("button", {
									type: "button",
					...
					value: b,
					onChange: x
				}, `${o || "none"}-plan`)] })] }) : /* @__PURE__ */ (0, Y.jsx)(p_, { label: "Select a story to inspect." })
			}),
			ce && /* @__PURE__ */ (0, Y.jsx)(b_, {
				stories: he,
				value: A,
				onChange: ue,
				busy: de,
...
function w_({ jiraKey: e, title: t }) {
	return /* @__PURE__ */ (0, Y.jsx)("span", {
		className: "story-reference",
		children: t ? /* @__PURE__ */ (0, Y.jsxs)(Y.Fragment, { children: [/* @__PURE__ */ (0, Y.jsx)("code", { children: jg(e) }), /* @__PURE__ */ (0, Y.jsx)("span", {
			className: "story-reference-title",
			children: t
		})] }) : /* @__PURE__ */ (0, Y.jsx)("code", { children: jg(e, "No active delivery") })
	});
}
function T_({ stages: e, deliveryStatus: t, currentStep: n, startedAt: r, finishedAt: i, remediation: a, now: o, onStageClick: s }) {
	...
	return /* @__PURE__ */ (0, Y.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
			...
			})] }), /* @__PURE__ */ (0, Y.jsxs)("p", { children: [r ? `Started ${Mg(r)}` : "Awaiting delivery trigger", i ? ` · Finished ${Mg(i)}` : ""] })]
		}), /* @__PURE__ */ (0, Y.jsxs)("div", {
					...
					return /* @__PURE__ */ (0, Y.jsx)("li", {
						...
						children: /* @__PURE__ */ (0, Y.jsxs)("button", {
							...
							children: [/* @__PURE__ */ (0, Y.jsx)("span", {
								...
								className: "flow-copy",
								children: [/* @__PURE__ */ (0, Y.jsx)("strong", { children: jg(e.label) }), /* @__PURE__ */ (0, Y.jsx)("span", { children: f })]
							})]
						})
					}, `${e.label}-${t}`);
				})
...
function E_({ stage: e, content: t, error: n, loading: r, live: i = !1, onClose: a }) {
...
function k_({ checks: e, onClick: t }) {
...
function A_({ checks: e, onClose: t }) {
	return /* @__PURE__ */ (0, Y.jsx)("div", {
		className: "modal-backdrop",
		role: "presentation",
		onMouseDown: t,
		children: /* @__PURE__ */ (0, Y.jsxs)("section", {
			...
			children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
				...
				children: e.map((e, t) => /* @__PURE__ */ (0, Y.jsxs)("article", {
					...
					children: [
						/* @__PURE__ */ (0, Y.jsxs)("div", { children: [/* @__PURE__ */ (0, Y.jsx)("strong", { children: jg(e.label) }), /* @__PURE__ */ (0, Y.jsx)("span", { children: jg(e.repository, "Workspace") })] }),
						/* @__PURE__ */ (0, Y.jsx)(Lg, { value: e.status }),
						/* @__PURE__ */ (0, Y.jsx)("p", { children: jg(e.summary, "No summary recorded.") }),
...
function F_({ data: e, project: t, interact: n, notify: r }) {
	let i = e.interactive?.prompts || [], [a, o] = (0, M.useState)("scan"), [s, c] = (0, M.useState)(null), [l, u] = (0, M.useState)(""), [d, f] = (0, M.useState)({
		...
		c(e);
		try {
			let n = await Ig(`/api/prompt?mode=${encodeURIComponent(e.mode)}&path=${encodeURIComponent(e.path)}`, t);
			u(n.content);
		} catch (e) {
			...
			children: /* @__PURE__ */ (0, Y.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, Y.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, Y.jsx)("div", {
						...
						children: w.map((e, t) => {
							let n = _.filter((t) => e.layers.includes(N_(t, a))), r = [...e.scripts.map((e) => ({
								kind: "script",
								script: e
							})), ...n.map((e) => ({
								kind: "prompt",
								...
								children: [
									...
									/* @__PURE__ */ (0, Y.jsx)("div", {
										...
										children: r.map((e, n) => {
											...
											let i = e.prompt, a = M_(i), o = a.icon;
											return /* @__PURE__ */ (0, Y.jsxs)("button", {
...
function I_({ item: e, content: t, onChange: n, onClose: r, onSave: i }) {
	let a = M_(e);
	return /* @__PURE__ */ (0, Y.jsx)("div", {
		className: "modal-backdrop",
		role: "presentation",
				...
				/* @__PURE__ */ (0, Y.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, Y.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, Y.jsxs)("label", {
							...
							children: [/* @__PURE__ */ (0, Y.jsx)("span", { children: "Preview" }), /* @__PURE__ */ (0, Y.jsx)(Jg, { content: t })]
						})]
					})
				}),
				/* @__PURE__ */ (0, Y.jsxs)("footer", { children: [/* @__PURE__ */ (0, Y.jsx)("button", {
...
function $({ label: e, help: t, children: n }) {
	return /* @__PURE__ */ (0, Y.jsxs)("label", {
		...
		children: [/* @__PURE__ */ (0, Y.jsxs)("span", {
			...
			children: [e, t && /* @__PURE__ */ (0, Y.jsx)(L_, { children: t })]
		}), n]
	});
}
function R_({ runtime: e, onChange: t }) {
...
function V_({ data: e, project: t, notify: n, onDirtyChange: r, reload: i }) {
	...
	(0, M.useEffect)(() => {
		Ig("/api/delivery/status-options", t).then((e) => ne(Array.isArray(e.options) ? e.options.map(String) : [])).catch(() => ne([]));
	}, [t]), (0, M.useEffect)(() => {
	...
	let fe = async (e) => {
		let n = await Ig(`/api/integration?key=${encodeURIComponent(e)}`, t);
		...
		try {
			await Promise.all([
				...
				...Object.entries(O).map(([e, n]) => Ig("/api/integration", t, {
					method: "POST",
					json: {
						key: e,
						value: n
				...
				children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, Y.jsxs)("div", {
							...
							}), /* @__PURE__ */ (0, Y.jsx)("p", { children: jg(o.scan?.description, "No recurring scan is configured.") })]
						}),
						/* @__PURE__ */ (0, Y.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, Y.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
						...
						children: /* @__PURE__ */ (0, Y.jsx)("div", {
							...
							}) : /* @__PURE__ */ (0, Y.jsx)(p_, { label: "No local integration keys configured." })
						})
					})]
				})
			}),
...
function H_({ enabled: e, onChange: t }) {
	return /* @__PURE__ */ (0, Y.jsxs)("label", {
