...
function a_({ value: e, onChange: t }) {
	let { frontmatter: n, body: r } = Yg(e), i = (0, M.useRef)(null), a = (0, M.useRef)(!1), o = (0, M.useRef)(!1), s = (0, M.useRef)(r), c = (0, M.useRef)(e_()), [l, u] = (0, M.useState)(null), [d, f] = (0, M.useState)(!1);
	s.current = r;
	let p = (e) => t(Xg(n, e)), m = () => {
		let e = i.current;
		if (!e) return;
		let t = c.current.turndown(e);
		n_(o.current, t, s.current) && p(t);
	}, h = (e) => {
		...
		let t = i.current;
		if (!t) return;
		o.current = !1, t.innerHTML = $g(e), Qg(t), h(t);
				...
				children: [
					...
					/* @__PURE__ */ (0, Y.jsx)("button", {
						...
						onClick: () => {
							let e = i.current;
							e?.focus();
							let t = r_(e), n = t?.getAttribute("href") || "https://", r = window.prompt(t ? "Edit link URL" : "Link URL", n);
							if (r === null) return;
							let a = r.trim();
							if (t) {
								if (!a) {
			...
			/* @__PURE__ */ (0, Y.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, Y.jsx)("button", {
					...
					onClick: (e) => {
						...
						if (!(n instanceof HTMLAnchorElement) || !i.current?.contains(n) || !i_(e)) return;
...
function s_({ title: e, action: t, children: n, className: r = "" }) {
			...
			/* @__PURE__ */ (0, Y.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, Y.jsxs)("header", {
					...
					children: [
						...
						n && i === "scan" && /* @__PURE__ */ (0, Y.jsx)(d_, {
							data: n,
							project: e,
							notify: b,
							reload: x
						}),
						n && i === "delivery" && /* @__PURE__ */ (0, Y.jsx)(x_, {
							data: n,
							project: e,
							notify: b,
							reload: x
						}),
						n && i === "observatory" && /* @__PURE__ */ (0, Y.jsx)(T_, {
							project: e,
							notify: b,
							onDirtyChange: y
						}),
						n && i === "repositories" && /* @__PURE__ */ (0, Y.jsx)(V_, {
							data: n,
							interact: T
						}),
						n && i === "prompts" && /* @__PURE__ */ (0, Y.jsx)(L_, {
							data: n,
							project: e,
							interact: T,
							notify: b
						}),
						n && i === "settings" && /* @__PURE__ */ (0, Y.jsx)(U_, {
							data: n,
							project: e,
							notify: b,
							onDirtyChange: _,
...
function d_({ data: e, project: t, notify: n, reload: r }) {
	...
	return /* @__PURE__ */ (0, Y.jsxs)(Y.Fragment, { children: [
		...
		/* @__PURE__ */ (0, Y.jsxs)(s_, {
			...
			children: [/* @__PURE__ */ (0, Y.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, Y.jsxs)("table", { children: [/* @__PURE__ */ (0, Y.jsx)("thead", { children: /* @__PURE__ */ (0, Y.jsxs)("tr", { children: [
					...
					/* @__PURE__ */ (0, Y.jsx)("td", { children: /* @__PURE__ */ (0, Y.jsx)(g_, { run: e }) }),
			...
			}), o.length > 10 && /* @__PURE__ */ (0, Y.jsx)(__, {
				page: d,
		...
		/* @__PURE__ */ (0, Y.jsxs)(s_, {
			...
			children: [/* @__PURE__ */ (0, Y.jsx)("div", {
				...
				id: "tracked-findings",
				className: "findings",
				children: b.length ? b.map((e) => /* @__PURE__ */ (0, Y.jsx)(v_, {
					issue: e,
					onIgnore: () => c(e)
				}, e.id)) : /* @__PURE__ */ (0, Y.jsx)(h_, { label: "No findings match this status." })
			})]
		}),
		s && /* @__PURE__ */ (0, Y.jsx)(b_, {
			onClose: () => c(null),
			onConfirm: (e) => {
				f_(t, n, r, s.id, e), c(null);
			}
		}),
		p > 0 && /* @__PURE__ */ (0, Y.jsx)(p_, {
			project: t,
			step: p === 1 ? 1 : 2,
			busy: h,
			error: _,
...
function p_({ project: e, step: t, busy: n, error: r, onClose: i, onContinue: a, onConfirm: o }) {
	let s = t === 1;
	return /* @__PURE__ */ (0, Y.jsx)("div", {
...
function m_({ label: e, value: t, onClick: n }) {
	return /* @__PURE__ */ (0, Y.jsxs)("div", {
...
function __({ page: e, pageCount: t, onChange: n }) {
...
function v_({ issue: e, onIgnore: t }) {
...
function y_({ label: e, value: t, code: n = !1 }) {
	return /* @__PURE__ */ (0, Y.jsxs)("section", {
...
function b_({ onClose: e, onConfirm: t }) {
...
function x_({ data: e, project: t, notify: n, reload: r }) {
	let i = e.delivery || {}, a = i.current || {}, o = i.runs || [], s = a.stages || [], c = i.scheduler_activity || [], l = i.available_stories || [], [u, d] = (0, M.useState)(null), [f, p] = (0, M.useState)(null), [m, h] = (0, M.useState)(""), [g, _] = (0, M.useState)(""), [v, y] = (0, M.useState)(!1), [b, x] = (0, M.useState)(!1), [S, C] = (0, M.useState)(!1), [w, T] = (0, M.useState)(!1), [E, ee] = (0, M.useState)(""), [D, te] = (0, M.useState)(0), [ne, re] = (0, M.useState)(""), [ie, O] = (0, M.useState)(!1), [k, ae] = (0, M.useState)(""), [oe, se] = (0, M.useState)(null), [ce, le] = (0, M.useState)(""), [A, ue] = (0, M.useState)(Date.now()), de = /in_progress|running/i.test(String(a.delivery_status || "")), j = l_(l, a), fe = (0, M.useCallback)(async (e = a.run_id || "", n = !1) => {
		n || y(!0);
		try {
	...
	return /* @__PURE__ */ (0, Y.jsxs)(Y.Fragment, { children: [
			...
			children: /* @__PURE__ */ (0, Y.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, Y.jsxs)("table", { children: [/* @__PURE__ */ (0, Y.jsx)("thead", { children: /* @__PURE__ */ (0, Y.jsxs)("tr", { children: [
					...
					return /* @__PURE__ */ (0, Y.jsxs)("tr", { children: [
						...
						/* @__PURE__ */ (0, Y.jsx)("td", { children: /* @__PURE__ */ (0, Y.jsx)(A_, { items: e.pull_requests || [] }) }),
						/* @__PURE__ */ (0, Y.jsx)("td", { children: /* @__PURE__ */ (0, Y.jsx)(j_, {
							checks: t,
							onClick: () => p(t)
						}) }),
						...
						/* @__PURE__ */ (0, Y.jsx)("td", { children: /* @__PURE__ */ (0, Y.jsx)(o_, {
					...
					colSpan: 8,
					children: /* @__PURE__ */ (0, Y.jsx)(h_, { label: "No delivery history yet." })
				}) }) })] })
			})
		}),
		/* @__PURE__ */ (0, Y.jsx)(s_, {
			...
			children: /* @__PURE__ */ (0, Y.jsx)("div", {
				...
				}, `${e.at}-${t}`)) : /* @__PURE__ */ (0, Y.jsx)(h_, { label: "No scheduled delivery activity recorded yet." })
			})
		}),
		u && /* @__PURE__ */ (0, Y.jsx)(O_, {
			stage: u,
			content: m,
			error: g,
			loading: v,
		...
		f && /* @__PURE__ */ (0, Y.jsx)(M_, {
			checks: f,
			onClose: () => p(null)
		}),
		S && /* @__PURE__ */ (0, Y.jsx)(C_, {
...
function S_({ stories: e, value: t, onChange: n, step: r, busy: i, error: a, onClose: o, onContinue: s, onConfirm: c }) {
...
function C_({ story: e, busy: t, error: n, onClose: r, onConfirm: i }) {
	return /* @__PURE__ */ (0, Y.jsx)("div", {
		className: "modal-backdrop",
		role: "presentation",
...
function w_({ run: e, busy: t, onClose: n, onConfirm: r }) {
...
function T_({ project: e, notify: t, onDirtyChange: n }) {
	let r = new URLSearchParams(window.location.search).get("story") || "", [i, a] = (0, M.useState)([]), [o, s] = (0, M.useState)(r), [c, l] = (0, M.useState)(""), [u, d] = (0, M.useState)(""), [f, p] = (0, M.useState)(""), [m, h] = (0, M.useState)(""), [g, _] = (0, M.useState)(""), [v, y] = (0, M.useState)(""), [b, x] = (0, M.useState)(""), [S, C] = (0, M.useState)({
		story: "",
		plan: ""
	}), [w, T] = (0, M.useState)("story"), [E, ee] = (0, M.useState)(!0), [D, te] = (0, M.useState)(!1), [ne, re] = (0, M.useState)(!1), [ie, O] = (0, M.useState)(""), [k, ae] = (0, M.useState)(!1), [oe, se] = (0, M.useState)(!1), [ce, le] = (0, M.useState)(0), [A, ue] = (0, M.useState)(""), [de, j] = (0, M.useState)(!1), [fe, pe] = (0, M.useState)(""), me = v !== S.story || b !== S.plan, he = l_(i.filter(u_)), ge = he.length > 0;
	(0, M.useEffect)(() => {
		n(me);
	}, [me, n]), (0, M.useEffect)(() => {
		let e = (e) => {
	...
	return /* @__PURE__ */ (0, Y.jsxs)("div", {
		...
		children: [
				...
				children: [
					...
					/* @__PURE__ */ (0, Y.jsxs)("div", {
						...
						children: [
							...
							!E && !Te.length ? /* @__PURE__ */ (0, Y.jsx)(h_, { label: i.length ? "No stories match this filter." : "No stories found in the docs repository." }) : null,
							Te.map((e) => {
			...
			/* @__PURE__ */ (0, Y.jsx)("section", {
				...
				}), w === "story" ? /* @__PURE__ */ (0, Y.jsx)(a_, {
					value: v,
					onChange: y
				}, `${o || "none"}-story`) : /* @__PURE__ */ (0, Y.jsx)(a_, {
					value: b,
					onChange: x
				}, `${o || "none"}-plan`)] })] }) : /* @__PURE__ */ (0, Y.jsx)(h_, { label: "Select a story to inspect." })
			}),
			ce > 0 && /* @__PURE__ */ (0, Y.jsx)(S_, {
				stories: he,
				value: A,
				onChange: ue,
				step: ce === 1 ? 1 : 2,
...
function D_({ stages: e, deliveryStatus: t, currentStep: n, startedAt: r, finishedAt: i, remediation: a, now: o, onStageClick: s }) {
...
function O_({ stage: e, content: t, error: n, loading: r, live: i = !1, onClose: a }) {
...
function j_({ checks: e, onClick: t }) {
...
function M_({ checks: e, onClose: t }) {
	return /* @__PURE__ */ (0, Y.jsx)("div", {
		className: "modal-backdrop",
		role: "presentation",
		onMouseDown: t,
...
function L_({ data: e, project: t, interact: n, notify: r }) {
			...
			children: /* @__PURE__ */ (0, Y.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, Y.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, Y.jsx)("div", {
						...
						children: w.map((e, t) => {
							let n = _.filter((t) => e.layers.includes(F_(t, a))), r = [...e.scripts.map((e) => ({
								kind: "script",
								script: e
							})), ...n.map((e) => ({
								kind: "prompt",
								...
								children: [
									...
									/* @__PURE__ */ (0, Y.jsx)("div", {
										...
										children: r.map((e, n) => {
											...
											let i = e.prompt, a = P_(i), o = a.icon;
											return /* @__PURE__ */ (0, Y.jsxs)("button", {
...
function R_({ item: e, content: t, onChange: n, onClose: r, onSave: i }) {
	let a = P_(e);
	return /* @__PURE__ */ (0, Y.jsx)("div", {
		className: "modal-backdrop",
		role: "presentation",
...
function $({ label: e, help: t, children: n }) {
	return /* @__PURE__ */ (0, Y.jsxs)("label", {
		...
		children: [/* @__PURE__ */ (0, Y.jsxs)("span", {
			...
			children: [e, t && /* @__PURE__ */ (0, Y.jsx)(z_, { children: t })]
		}), n]
	});
}
function B_({ runtime: e, onChange: t }) {
...
function U_({ data: e, project: t, notify: n, onDirtyChange: r, reload: i }) {
				...
				children: /* @__PURE__ */ (0, Y.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
						...
						children: /* @__PURE__ */ (0, Y.jsx)("div", {
							...
							children: he.length ? he.map((e) => {
								...
								return /* @__PURE__ */ (0, Y.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, Y.jsxs)("div", { children: [/* @__PURE__ */ (0, Y.jsx)(o_, {
											label: "Reveal value",
											onClick: () => void pe(e),
							...
							}) : /* @__PURE__ */ (0, Y.jsx)(h_, { label: "No local integration keys configured." })
						})
					})]
				})
			}),
...
function W_({ enabled: e, onChange: t }) {
	return /* @__PURE__ */ (0, Y.jsxs)("label", {
...
(0, be.createRoot)(document.getElementById("root")).render(/* @__PURE__ */ (0, Y.jsx)(c_, {}));
//#endregion
