...
var le = /* @__PURE__ */ n(((e) => {
	...
	function Le(e) {
		if (typeof Pe == "function" && Fe(e), Ie && typeof Ie.setStrictMode == "function") try {
			Ie.setStrictMode(L, e);
		} catch {}
	}
	...
	function Hu() {
		if (ou === 4 || ou === 3) {
			...
			if (i === 0 && (au = null), rt(n), t = t.stateNode, Ie && typeof Ie.onCommitFiberRoot == "function") try {
				Ie.onCommitFiberRoot(L, t, void 0, (t.current.flags & 128) == 128);
			} catch {}
			if (r !== null) {
...
async function Kg(e) {
	let t = Cg.get(e);
	if (t) return t;
	let n = `mmd-${++Tg}`, { svg: r } = await Yi.render(n, e);
	return Cg.set(e, r), r;
}
var qg = (0, F.memo)(function({ chart: e }) {
...
function c_({ value: e, onChange: t }) {
	let { frontmatter: n, body: r } = Qg(e), i = (0, F.useRef)(null), a = (0, F.useRef)(!1), o = (0, F.useRef)(!1), s = (0, F.useRef)(r), c = (0, F.useRef)(r_()), [l, u] = (0, F.useState)(null), [d, f] = (0, F.useState)(!1);
	s.current = r;
	let p = (e) => t($g(n, e)), m = () => {
		let e = i.current;
		if (!e) return;
...
function T_({ data: e, project: t, notify: n, reload: r }) {
	let i = e.delivery || {}, a = i.current || {}, o = i.runs || [], s = a.stages || [], c = i.scheduler_activity || [], l = i.available_stories || [], [u, d] = (0, F.useState)(null), [f, p] = (0, F.useState)(null), [m, h] = (0, F.useState)(""), [g, _] = (0, F.useState)(""), [v, y] = (0, F.useState)(!1), [b, x] = (0, F.useState)(!1), [S, C] = (0, F.useState)(!1), [w, T] = (0, F.useState)(!1), [E, ee] = (0, F.useState)(""), [D, O] = (0, F.useState)(0), [k, A] = (0, F.useState)(""), [j, M] = (0, F.useState)(!1), [N, te] = (0, F.useState)(""), [ne, re] = (0, F.useState)(null), [ie, ae] = (0, F.useState)(""), [P, oe] = (0, F.useState)(Date.now()), se = /in_progress|running/i.test(String(a.delivery_status || "")), ce = p_(l, a), le = (0, F.useCallback)(async (e = a.run_id || "", n = !1) => {
		n || y(!0);
		try {
...
function M_({ project: e, notify: t, onDirtyChange: n }) {
	let r = new URLSearchParams(window.location.search).get("story") || "", [i, a] = (0, F.useState)([]), [o, s] = (0, F.useState)(r), [c, l] = (0, F.useState)(""), [u, d] = (0, F.useState)(""), [f, p] = (0, F.useState)(""), [m, h] = (0, F.useState)(""), [g, _] = (0, F.useState)(""), [v, y] = (0, F.useState)(""), [b, x] = (0, F.useState)(""), [S, C] = (0, F.useState)({
		story: "",
		plan: ""
	}), [w, T] = (0, F.useState)("story"), [E, ee] = (0, F.useState)(!0), [D, O] = (0, F.useState)(!1), [k, A] = (0, F.useState)(!1), [j, M] = (0, F.useState)(""), [N, te] = (0, F.useState)(!1), [ne, re] = (0, F.useState)(!1), [ie, ae] = (0, F.useState)(0), [P, oe] = (0, F.useState)(""), [se, ce] = (0, F.useState)(!1), [le, ue] = (0, F.useState)(""), de = v !== S.story || b !== S.plan, fe = p_(i.filter(m_)), pe = fe.length > 0;
	(0, F.useEffect)(() => {
		n(de);
	}, [de, n]), (0, F.useEffect)(() => {
		let e = (e) => {
				...
				children: [
					...
					/* @__PURE__ */ (0, Y.jsxs)("div", {
						...
						children: [
							...
							!E && !Se.length ? /* @__PURE__ */ (0, Y.jsx)(y_, { label: i.length ? "No stories match this filter." : "No stories found in the docs repository." }) : null,
							Se.map((e) => {
				...
				children: [
					...
					/* @__PURE__ */ (0, Y.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, Y.jsxs)("div", {
							...
							}), O.length === 0 && /* @__PURE__ */ (0, Y.jsx)(y_, { label: "No repositories match this view." })]
						})
					})
				]
			}),
										...
										children: [
											...
											/* @__PURE__ */ (0, Y.jsxs)("div", {
												...
												children: [
													...
													/* @__PURE__ */ (0, Y.jsx)(I_, {
														label: "Git status",
														value: /* @__PURE__ */ (0, Y.jsx)(Bg, { value: j.git_status || "unknown" })
													}),
													/* @__PURE__ */ (0, Y.jsx)(I_, {
														label: "Branch sync",
														value: /* @__PURE__ */ (0, Y.jsx)(Bg, { value: j.sync_status || "unknown" })
													})
												]
											}),
											/* @__PURE__ */ (0, Y.jsx)("div", {
...
function Q_({ data: e, project: t, notify: n, onDirtyChange: r, reload: i }) {
	...
	}), [Me, Ne] = (0, F.useState)(!1), [Pe, Fe] = (0, F.useState)(!1), L = () => {
		Fe(!0), r(!0);
	}, Ie = (e) => {
	...
	(0, F.useEffect)(() => {
		zg("/api/delivery/status-options", t).then((e) => ue(Array.isArray(e.options) ? e.options.map(String) : [])).catch(() => ue([]));
	}, [t]), (0, F.useEffect)(() => {
		let e = !1;
	...
	let Be = async (e) => {
	...
	}, Ue = a.configured_integrations || [], We = Array.from(new Set([
		"To Do",
		"Backlog",
		"In Progress",
		"Done",
		...
		j,
		N
	].filter(Boolean))), Ge = Array.isArray(o.delivery?.jira_statuses) ? o.delivery.jira_statuses.map(String) : String(o.delivery?.jira_status || "To Do,Backlog,In Progress").split(",").map((e) => e.trim()).filter(Boolean), Ke = Array.isArray(o.patch?.jira_statuses) ? o.patch.jira_statuses.map(String) : ["To Do"], qe = (e, t) => e.length === t.length && e.every((e, n) => e === t[n]), Je = f !== !!o.scan || f && u !== String(o.scan?.cron || "0 12 * * 1-5"), Ye = w !== !!o.delivery?.enabled || w && (m !== String(Math.round((o.delivery?.interval_seconds || 300) / 60)) || !qe(g, Ge) || v !== String(o.delivery?.in_dev_status || "") || b !== String(o.delivery?.dev_done_status || "") || S !== String(o.delivery?.blocked_status || "Block")), Xe = ne !== !!o.patch?.enabled || ne && (E !== String(Math.round((o.patch?.interval_seconds || 300) / 60)) || !qe(D, Ke) || k !== String(o.patch?.in_progress_status || "In Progress") || j !== String(o.patch?.done_status || "Done") || N !== String(o.patch?.blocked_status || "Block")), Ze = he !== String(a.publish?.scan || "pr") || _e !== String(a.publish?.delivery || "pr") || ye !== String(a.publish?.patch || "pr"), Qe = I !== Ae.enabled || JSON.stringify(we) !== Ae.agents || JSON.stringify(Ee) !== Ae.access, $e = [
		...
		if (!Me) {
			...
			try {
				...
				}), ...Object.entries(pe).map(([e, n]) => () => zg("/api/integration", t, {
					method: "POST",
					json: {
						key: e,
						value: n
				...
				})), Ze && e.push(() => zg("/api/publish-policy", t, {
					method: "POST",
					json: {
						scan_mode: he,
						delivery_mode: _e,
				...
				me({}), Fe(!1), r(!1), n("Settings saved", "success"), i();
			} catch (e) {
	...
	return /* @__PURE__ */ (0, Y.jsxs)("div", {
		...
		children: [
									...
									children: [
										...
										/* @__PURE__ */ (0, Y.jsx)($, {
											...
											children: /* @__PURE__ */ (0, Y.jsx)("select", {
												...
												children: We.map((e) => /* @__PURE__ */ (0, Y.jsx)("option", {
													value: e,
													children: e
												}, e))
											})
										...
										/* @__PURE__ */ (0, Y.jsx)($, {
											...
											children: /* @__PURE__ */ (0, Y.jsx)("select", {
												...
												children: Array.from(/* @__PURE__ */ new Set([...We, "Block"])).map((e) => /* @__PURE__ */ (0, Y.jsx)("option", {
													value: e,
													children: e
												}, e))
											})
					...
					/* @__PURE__ */ (0, Y.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, Y.jsxs)("p", { children: [
									"Configure who may talk to agents and who may mutate (resolve findings, update scan schedule, start delivery). Save writes to ",
									Q(s.config_path, "~/.lumen/agents/config.json"),
									"."
								] }),
								/* @__PURE__ */ (0, Y.jsxs)("p", {
									...
									children: [
										...
										/* @__PURE__ */ (0, Y.jsx)("code", { children: "ou_…" }),
										" (open_id). Chat IDs look like ",
										/* @__PURE__ */ (0, Y.jsx)("code", { children: "oc_…" }),
										". Easiest: message Dylan/Mark once, then click a recent person below. Names resolve from Feishu contact when the app has permission; otherwise the raw ID still shows."
									]
								}),
							...
							children: [
								...
								$e.length > 0 && /* @__PURE__ */ (0, Y.jsxs)("div", {
									className: "schedule-note",
									style: { marginTop: 12 },
									children: [/* @__PURE__ */ (0, Y.jsx)("div", { children: "Person / chat mapping:" }), /* @__PURE__ */ (0, Y.jsx)("div", {
										style: {
											display: "grid",
											gap: 6,
											marginTop: 8
										},
										children: $e.map(([e, t]) => /* @__PURE__ */ (0, Y.jsxs)("div", { children: [
											/* @__PURE__ */ (0, Y.jsxs)("strong", { children: [e, ":"] }),
											" ",
											t.map((e) => Ie(e)).join(", ")
										] }, e))
									})]
								}),
								(Oe.user_ids.length > 0 || Oe.chat_ids.length > 0) && /* @__PURE__ */ (0, Y.jsxs)("div", {
									className: "schedule-note",
									style: { marginTop: 12 },
									children: [
										/* @__PURE__ */ (0, Y.jsx)("div", { children: "Recent Feishu people / chats from agent traffic — click to add:" }),
										/* @__PURE__ */ (0, Y.jsxs)("div", {
											style: {
												display: "flex",
												flexWrap: "wrap",
											...
											children: [Oe.user_ids.map((e) => /* @__PURE__ */ (0, Y.jsx)("button", {
												type: "button",
												className: "button ghost",
												onClick: () => Re("mutation_allowed_user_ids", e),
												title: `Add ${Ie(e)} to Mutation user IDs`,
												children: Ie(e)
											}, `user-${e}`)), Oe.chat_ids.map((e) => /* @__PURE__ */ (0, Y.jsx)("button", {
												type: "button",
												className: "button ghost",
												onClick: () => Re("allowed_chat_ids", e),
												title: `Add ${Ie(e)} to Allowed chat IDs`,
												children: Ie(e)
											}, `chat-${e}`))]
										}),
										Oe.user_ids[0] && /* @__PURE__ */ (0, Y.jsx)("div", {
											style: { marginTop: 8 },
											children: /* @__PURE__ */ (0, Y.jsxs)("button", {
												type: "button",
												className: "button ghost",
												onClick: () => {
													Re("mutation_allowed_user_ids", Oe.user_ids[0]), Re("admin_user_ids", Oe.user_ids[0]), Re("allowed_user_ids", Oe.user_ids[0]);
												},
												children: [
													"Use latest user as owner (",
													Ie(Oe.user_ids[0]),
													")"
												]
											})
								...
								Oe.user_ids.length === 0 && /* @__PURE__ */ (0, Y.jsx)("p", {
									className: "schedule-note",
									style: { marginTop: 12 },
									children: "No recent Feishu user IDs yet. Send any message to Dylan or Mark, refresh Settings, then click the person here."
								})
							]
						})]
					}),
						...
						children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, Y.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, Y.jsx)($, {
										...
										children: /* @__PURE__ */ (0, Y.jsx)("input", {
											...
											onChange: (t) => ze(e.id, { app_id: t.target.value })
										})
									}),
									/* @__PURE__ */ (0, Y.jsx)($, {
										...
										children: /* @__PURE__ */ (0, Y.jsx)("input", {
											...
											onChange: (t) => ze(e.id, { app_secret: t.target.value }),
									...
									/* @__PURE__ */ (0, Y.jsx)($, {
										...
										children: /* @__PURE__ */ (0, Y.jsxs)("select", {
											...
											onChange: (t) => ze(e.id, { conversation_enabled: t.target.value === "on" }),
									...
									/* @__PURE__ */ (0, Y.jsx)($, {
										...
										children: /* @__PURE__ */ (0, Y.jsx)("input", {
											...
											onChange: (t) => ze(e.id, { soft_timeout_seconds: Number(t.target.value) || 90 })
										})
									}),
									/* @__PURE__ */ (0, Y.jsx)($, {
										...
										children: /* @__PURE__ */ (0, Y.jsx)("input", {
											...
											onChange: (t) => ze(e.id, { hard_timeout_seconds: Number(t.target.value) || 300 })
										})
									}),
									/* @__PURE__ */ (0, Y.jsx)($, {
										...
										children: /* @__PURE__ */ (0, Y.jsxs)("select", {
											...
											onChange: (t) => ze(e.id, { reaction_enabled: t.target.value === "on" }),
											children: [/* @__PURE__ */ (0, Y.jsx)("option", {
												value: "on",
												children: "Enabled"
											}), /* @__PURE__ */ (0, Y.jsx)("option", {
									...
									/* @__PURE__ */ (0, Y.jsx)($, {
										...
										children: /* @__PURE__ */ (0, Y.jsx)("input", {
											...
											onChange: (t) => ze(e.id, { max_concurrent_jobs: Number(t.target.value) || 3 })
										})
									}),
									/* @__PURE__ */ (0, Y.jsx)($, {
										label: "SOUL version",
										children: /* @__PURE__ */ (0, Y.jsx)("input", {
											...
											onChange: (t) => ze(e.id, { soul_version: t.target.value })
										})
									}),
									/* @__PURE__ */ (0, Y.jsx)($, {
										label: "Role id",
										children: /* @__PURE__ */ (0, Y.jsx)("input", {
											value: e.role,
											onChange: (t) => ze(e.id, { role: t.target.value })
										})
									}),
									/* @__PURE__ */ (0, Y.jsx)($, {
										label: "Workflow",
										children: /* @__PURE__ */ (0, Y.jsx)("input", {
											value: e.workflow,
											onChange: (t) => ze(e.id, { workflow: t.target.value })
										})
									})
								]
							}), /* @__PURE__ */ (0, Y.jsxs)("label", {
								...
								children: [/* @__PURE__ */ (0, Y.jsx)("span", { children: "SOUL.md" }), /* @__PURE__ */ (0, Y.jsx)("textarea", {
									...
									value: e.soul,
									spellCheck: !1,
									onChange: (t) => ze(e.id, { soul: t.target.value })
								})]
							})]
						})]
					}, e.id)),
			...
			/* @__PURE__ */ (0, Y.jsxs)("footer", {
				...
				children: [/* @__PURE__ */ (0, Y.jsx)("span", {
					className: Pe ? "settings-save-status unsaved" : "settings-save-status",
					children: Me ? "Saving settings…" : Pe ? "You have unsaved changes" : "All changes saved"
				}), /* @__PURE__ */ (0, Y.jsxs)("button", {
					className: `button primary${Me ? " is-busy" : ""}`,
					disabled: !Pe || Me,
					onClick: () => void et(),
					children: [Me ? /* @__PURE__ */ (0, Y.jsx)(ig, {
						size: 15,
						className: "spin"
					}) : /* @__PURE__ */ (0, Y.jsx)(lg, { size: 15 }), Me ? "Saving…" : "Save changes"]
				})]
			})
		]
	});
...
(0, _e.createRoot)(document.getElementById("root")).render(/* @__PURE__ */ (0, Y.jsx)(d_, {}));
//#endregion
