			...
			children: /* @__PURE__ */ (0, V.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, V.jsxs)("table", { children: [/* @__PURE__ */ (0, V.jsx)("thead", { children: /* @__PURE__ */ (0, V.jsxs)("tr", { children: [
					...
					return /* @__PURE__ */ (0, V.jsxs)("tr", { children: [
						...
						/* @__PURE__ */ (0, V.jsx)("td", { children: e.agent_trace?.status === "available" ? /* @__PURE__ */ (0, V.jsxs)("button", {
							className: "trace-inspect-link",
							onClick: () => void O(e.agent_trace.trace_id || e.run_id),
							children: [/* @__PURE__ */ (0, V.jsx)(G, { size: 13 }), "Inspect"]
						}) : "—" })
					] }, e.run_id);
...
function Du({ trace: e, delivery: t, onOpen: n }) {
	...
	return /* @__PURE__ */ (0, V.jsxs)(lu, {
		...
		action: /* @__PURE__ */ (0, V.jsxs)("button", {
			className: "button secondary",
			onClick: n,
			children: [/* @__PURE__ */ (0, V.jsx)(Nl, { size: 14 }), "View trace"]
		}),
		children: [
			/* @__PURE__ */ (0, V.jsxs)("p", {
			...
			/* @__PURE__ */ (0, V.jsx)("div", {
				...
				children: r.map((e, t) => /* @__PURE__ */ (0, V.jsxs)("article", { children: [
					/* @__PURE__ */ (0, V.jsx)("span", { children: t + 1 }),
					/* @__PURE__ */ (0, V.jsx)("strong", { children: au(e.stage || e.invocation_id) }),
					/* @__PURE__ */ (0, V.jsx)(su, { value: e.status }),
					/* @__PURE__ */ (0, V.jsx)("small", { children: ru(e.duration_ms) })
				] }, e.invocation_id))
			}),
			!r.length && /* @__PURE__ */ (0, V.jsx)(pu, { label: `No agent stages were captured during this ${nu(t.started_at, t.finished_at)} delivery.` })
		]
	});
}
function Ou({ payload: e, error: t, loading: n, onClose: r }) {
	let i = e.invocations || [], [a, o] = (0, H.useState)(""), [s, c] = (0, H.useState)(""), l = i.find((e) => e.invocation_id === a) || i[0] || {}, u = [...(e.spans || []).map((e) => ({
	...
	return /* @__PURE__ */ (0, V.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, V.jsxs)("section", {
			...
			children: [/* @__PURE__ */ (0, V.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, V.jsxs)("div", { children: [
					/* @__PURE__ */ (0, V.jsx)("span", { children: "Agent Trace" }),
					/* @__PURE__ */ (0, V.jsx)("strong", { children: "Stage-by-stage execution" }),
					/* @__PURE__ */ (0, V.jsxs)("p", { children: [
						i.length,
						" stage",
						i.length === 1 ? "" : "s",
				...
				children: [/* @__PURE__ */ (0, V.jsx)("nav", {
					...
					children: i.map((e, t) => /* @__PURE__ */ (0, V.jsxs)("button", {
						...
						children: [
							...
							/* @__PURE__ */ (0, V.jsxs)("span", { children: [/* @__PURE__ */ (0, V.jsx)("strong", { children: au(e.request?.stage || e.stage || e.invocation_id) }), /* @__PURE__ */ (0, V.jsxs)("small", { children: ["Attempt ", X(e.request?.attempt || e.attempt, "1")] })] }),
							/* @__PURE__ */ (0, V.jsxs)("span", { children: [/* @__PURE__ */ (0, V.jsx)(su, { value: e.result?.status || e.status }), /* @__PURE__ */ (0, V.jsx)("small", { children: ru(e.result?.duration_ms ?? e.duration_ms) })] })
						]
					}, e.invocation_id))
					...
					children: [/* @__PURE__ */ (0, V.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, V.jsxs)("article", {
							...
							children: [/* @__PURE__ */ (0, V.jsxs)("header", { children: [/* @__PURE__ */ (0, V.jsxs)("div", { children: [/* @__PURE__ */ (0, V.jsx)("span", { children: "Input" }), /* @__PURE__ */ (0, V.jsx)("strong", { children: "Instructions and context" })] }), /* @__PURE__ */ (0, V.jsxs)("small", { children: [
								Number(d.prompt_characters || m.length).toLocaleString(),
								" chars",
								l.truncated?.prompt ? " · truncated" : ""
							] })] }), /* @__PURE__ */ (0, V.jsx)("div", {
								className: "markdown-content",
								children: m ? /* @__PURE__ */ (0, V.jsx)(_o, {
									remarkPlugins: [xl],
									children: m
								}) : /* @__PURE__ */ (0, V.jsx)(pu, { label: "Input body is available only in full capture mode." })
							})]
						}), /* @__PURE__ */ (0, V.jsxs)("article", {
							className: "trace-document",
							children: [/* @__PURE__ */ (0, V.jsxs)("header", { children: [/* @__PURE__ */ (0, V.jsxs)("div", { children: [/* @__PURE__ */ (0, V.jsx)("span", { children: "Output" }), /* @__PURE__ */ (0, V.jsx)("strong", { children: "Agent response" })] }), /* @__PURE__ */ (0, V.jsxs)("small", { children: [
								ru(f.time_to_first_output_ms),
								" to first output",
								l.truncated?.final_output ? " · truncated" : ""
							] })] }), /* @__PURE__ */ (0, V.jsx)("div", {
								className: "markdown-content",
								children: h ? /* @__PURE__ */ (0, V.jsx)(_o, {
									remarkPlugins: [xl],
									children: h
								}) : /* @__PURE__ */ (0, V.jsx)(pu, { label: "No agent response was captured." })
							})]
						})]
					}), /* @__PURE__ */ (0, V.jsxs)("details", {
						className: "trace-technical",
						children: [/* @__PURE__ */ (0, V.jsxs)("summary", { children: [/* @__PURE__ */ (0, V.jsx)("span", { children: "Technical details" }), /* @__PURE__ */ (0, V.jsxs)("small", { children: [
							u.length,
							" events · ",
							p.length,
							" files · ",
							...
							/* @__PURE__ */ (0, V.jsxs)("section", {
								...
								children: [
									...
									/* @__PURE__ */ (0, V.jsx)(Cu, {
										label: "Session",
										value: /* @__PURE__ */ (0, V.jsx)("code", { children: X(f.session_id) })
									})
								]
							}),
							/* @__PURE__ */ (0, V.jsxs)("details", { children: [/* @__PURE__ */ (0, V.jsxs)("summary", { children: ["Context sources · ", (l.context_manifest?.sources || []).length] }), /* @__PURE__ */ (0, V.jsx)("div", {
								className: "trace-sources",
								children: (l.context_manifest?.sources || []).map((e, t) => /* @__PURE__ */ (0, V.jsxs)("span", { children: [
							...
							/* @__PURE__ */ (0, V.jsxs)("details", { children: [/* @__PURE__ */ (0, V.jsxs)("summary", { children: ["Events · ", u.length] }), /* @__PURE__ */ (0, V.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, V.jsx)("input", {
									...
									children: u.map((e) => /* @__PURE__ */ (0, V.jsxs)("article", { children: [
							...
							/* @__PURE__ */ (0, V.jsxs)("details", { children: [/* @__PURE__ */ (0, V.jsxs)("summary", { children: ["Changed files · ", p.length] }), /* @__PURE__ */ (0, V.jsx)("div", {
								className: "trace-files",
								children: p.length ? p.map((e) => /* @__PURE__ */ (0, V.jsxs)("article", { children: [
									/* @__PURE__ */ (0, V.jsx)(su, { value: e.status }),
								...
								] }, `${e.repository}-${e.path}`)) : /* @__PURE__ */ (0, V.jsx)(pu, { label: "No files were attributed to this stage." })
							})] }),
							(l.stderr || l.stdout && l.final_output) && /* @__PURE__ */ (0, V.jsxs)("details", { children: [/* @__PURE__ */ (0, V.jsx)("summary", { children: "Raw logs" }), [[
								"stdout",
								l.stdout,
								"stdout"
							], [
								...
								l.stderr,
								"stderr"
							]].map(([e, t, n]) => t ? /* @__PURE__ */ (0, V.jsxs)("details", { children: [/* @__PURE__ */ (0, V.jsxs)("summary", { children: [String(e), l.truncated?.[String(n)] ? " · truncated" : ""] }), /* @__PURE__ */ (0, V.jsx)("pre", { children: /* @__PURE__ */ (0, V.jsx)("code", { children: String(t) }) })] }, String(n)) : null)] })
						] })]
					})]
				})]
			})]
