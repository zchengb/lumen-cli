...
//#endregion
//#region package.json
var xl = _(), Sl = "1.21.1", Cl = (...e) => e.filter((e, t, n) => !!e && e.trim() !== "" && n.indexOf(e) === t).join(" ").trim(), wl = (e) => e.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase(), Tl = (e) => e.replace(/^([A-Z])|[\s-_]+(\w)/g, (e, t, n) => n ? n.toUpperCase() : t.toLowerCase()), El = (e) => {
	let t = Tl(e);
			...
			/* @__PURE__ */ (0, V.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, V.jsxs)("header", {
					...
					children: [
						...
						n && i === "prompts" && /* @__PURE__ */ (0, V.jsx)(Ou, {
							data: n,
							project: e,
							interact: v,
							notify: l
						}),
						n && i === "settings" && /* @__PURE__ */ (0, V.jsx)(ku, {
							data: n,
							project: e,
							interact: v,
							notify: l
...
function hu({ onClose: e, onConfirm: t }) {
	...
	return /* @__PURE__ */ (0, V.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, V.jsxs)("section", {
			...
			children: [/* @__PURE__ */ (0, V.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, V.jsx)("strong", { children: "Mark this finding as ignored?" }), /* @__PURE__ */ (0, V.jsx)(Au, {
...
function gu({ data: e, project: t }) {
	let n = e.delivery || {}, r = n.current || {}, i = n.runs || [], a = r.stages || [], [o, s] = (0, H.useState)(null), [c, l] = (0, H.useState)(null), [u, d] = (0, H.useState)(""), [f, p] = (0, H.useState)(""), [m, h] = (0, H.useState)(!1), g = async (e, n = r.run_id || "") => {
		s(e), d(""), p(""), h(!0);
		try {
			let e = await nu(`/api/delivery/log?run_id=${encodeURIComponent(n)}`, t);
		...
		/* @__PURE__ */ (0, V.jsx)(X, {
			...
			children: /* @__PURE__ */ (0, V.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, V.jsxs)("table", { children: [/* @__PURE__ */ (0, V.jsx)("thead", { children: /* @__PURE__ */ (0, V.jsxs)("tr", { children: [
					...
					let t = e.verification || [], n = t.filter((e) => e.status === "failed");
					return /* @__PURE__ */ (0, V.jsxs)("tr", { children: [
						/* @__PURE__ */ (0, V.jsx)("td", { children: /* @__PURE__ */ (0, V.jsxs)("div", {
							className: "history-story",
							children: [
								/* @__PURE__ */ (0, V.jsx)("code", { children: Zl(e.jira_key || e.story || e.run_id) }),
								e.story_title && /* @__PURE__ */ (0, V.jsx)("span", {
						...
						/* @__PURE__ */ (0, V.jsx)("td", { children: Ql(e.finished_at || e.started_at) }),
						/* @__PURE__ */ (0, V.jsx)("td", { children: n.length || /failed|blocked/i.test(String(e.status)) ? /* @__PURE__ */ (0, V.jsxs)("button", {
							className: "history-status-link",
							onClick: () => void g({
								label: "Delivery failure",
								duration: $l(e.started_at, e.finished_at),
								detail: n.map((e) => e.summary || e.label).filter(Boolean).join(" · ") || "Open the delivery log for details."
							}, e.run_id),
							children: [/* @__PURE__ */ (0, V.jsx)(ru, { value: e.status }), /* @__PURE__ */ (0, V.jsx)("span", { children: "View cause" })]
						}) : /* @__PURE__ */ (0, V.jsx)(ru, { value: e.status }) }),
						...
						children: [/* @__PURE__ */ (0, V.jsx)("span", {
							...
							children: [/* @__PURE__ */ (0, V.jsxs)("span", {
								...
								children: [/* @__PURE__ */ (0, V.jsx)("span", {
									...
									children: r === "completed" ? "✓" : r === "running" ? "•" : t + 1
								}), /* @__PURE__ */ (0, V.jsx)("strong", { children: Zl(e.label) })]
							}), /* @__PURE__ */ (0, V.jsx)("span", { children: r === "running" ? "In progress" : r === "failed" ? "Needs attention" : e.duration || "Pending" })]
						})]
					})
				}, `${e.label}-${t}`);
			})
...
function Cu({ checks: e, onClick: t }) {
	...
	return e.length ? /* @__PURE__ */ (0, V.jsxs)("button", {
		className: `check-summary ${n ? "failed" : ""}`,
		onClick: t,
		children: [n ? `${n} failed` : `${r}/${e.length} passed`, /* @__PURE__ */ (0, V.jsx)("span", { children: "View" })]
	}) : /* @__PURE__ */ (0, V.jsx)(V.Fragment, { children: "—" });
}
		...
		children: /* @__PURE__ */ (0, V.jsxs)("section", {
			...
			children: [/* @__PURE__ */ (0, V.jsxs)("div", {
				...
				children: e.map((e, t) => /* @__PURE__ */ (0, V.jsxs)("article", {
					...
					children: [
						/* @__PURE__ */ (0, V.jsxs)("div", { children: [/* @__PURE__ */ (0, V.jsx)("strong", { children: Zl(e.label) }), /* @__PURE__ */ (0, V.jsx)("span", { children: Zl(e.repository, "Workspace") })] }),
						/* @__PURE__ */ (0, V.jsx)(ru, { value: e.status }),
						/* @__PURE__ */ (0, V.jsx)("p", { children: Zl(e.summary, "No summary recorded.") }),
...
function Ou({ data: e, project: t, interact: n, notify: r }) {
	let i = e.interactive?.prompts || [], [a, o] = (0, H.useState)("scan"), [s, c] = (0, H.useState)(null), [l, u] = (0, H.useState)(""), d = i.filter((e) => e.mode === a), f = async (e) => {
		...
		"Inputs & Governance",
		a === "scan" ? "Review Execution" : "Implementation",
		...a === "scan" ? ["Operational Controls"] : [],
		"Delivery Outputs"
	];
	return /* @__PURE__ */ (0, V.jsxs)(V.Fragment, { children: [
		/* @__PURE__ */ (0, V.jsx)(ou, {
			title: "PROMPTS",
			description: "A layered view of the instructions that govern each local automation workflow."
		}),
		/* @__PURE__ */ (0, V.jsxs)("div", {
		...
		/* @__PURE__ */ (0, V.jsx)(X, {
			title: a === "scan" ? "Auto Scan Architecture" : "Auto Delivery Architecture",
			action: /* @__PURE__ */ (0, V.jsx)("span", {
				className: "muted",
				children: "Select a node to inspect its prompt"
			}),
			...
			children: /* @__PURE__ */ (0, V.jsx)("div", {
				...
				children: m.map((e, t) => /* @__PURE__ */ (0, V.jsxs)("section", {
					...
					children: [/* @__PURE__ */ (0, V.jsxs)("header", { children: [/* @__PURE__ */ (0, V.jsx)("span", { children: String(t + 1).padStart(2, "0") }), /* @__PURE__ */ (0, V.jsx)("h4", { children: e })] }), /* @__PURE__ */ (0, V.jsx)("div", {
						className: "architecture-nodes",
						children: d.filter((t) => Du(t, a) === e).map((e) => {
							let t = Eu(e), n = t.icon;
							return /* @__PURE__ */ (0, V.jsxs)("button", {
								className: `architecture-node ${s?.mode === e.mode && s.path === e.path ? "selected" : ""}`,
								onClick: () => void f(e),
								children: [/* @__PURE__ */ (0, V.jsx)(n, { size: 16 }), /* @__PURE__ */ (0, V.jsxs)("span", { children: [/* @__PURE__ */ (0, V.jsx)("strong", { children: t.title }), /* @__PURE__ */ (0, V.jsx)("small", { children: t.description })] })]
							}, `${e.mode}/${e.path}`);
						})
					})]
				}, e))
		...
		/* @__PURE__ */ (0, V.jsx)(X, {
			...
			children: /* @__PURE__ */ (0, V.jsx)("div", {
				...
				children: s ? /* @__PURE__ */ (0, V.jsxs)(V.Fragment, { children: [/* @__PURE__ */ (0, V.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, V.jsxs)("div", { children: [/* @__PURE__ */ (0, V.jsx)("h3", { children: Eu(s).title }), /* @__PURE__ */ (0, V.jsxs)("p", { children: [/* @__PURE__ */ (0, V.jsx)("code", { children: s.path }), " · injected during the selected workflow stage"] })] })
				}), /* @__PURE__ */ (0, V.jsxs)("div", {
				...
				})] }) : /* @__PURE__ */ (0, V.jsx)(lu, { label: "Select an architecture node to inspect and edit its prompt." })
			})
		})
	] });
}
...
function Au({ label: e, children: t }) {
