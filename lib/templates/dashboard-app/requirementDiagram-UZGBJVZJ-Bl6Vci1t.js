import { g as e, h as t, m as n } from "./src-B53NoQT1.js";
import { B as r, C as i, U as a, _ as o, a as s, b as c, v as l, z as u } from "./chunk-ABZYJK2D-CVevQ3ur.js";
import { h as d } from "./chunk-S3R3BYOJ-BtVK2Rr4.js";
...
import { r as f, t as p } from "./chunk-N4CR4FBY-C3Oe3dWX.js";
...
var g = (function() {
	...
	return t(ue, "Parser"), ue.prototype = le, le.Parser = ue, new ue();
})();
g.parser = g;
var _ = g, v = class {
	constructor() {
	...
	clear() {
		this.relations = [], this.resetLatestRequirement(), this.requirements = /* @__PURE__ */ new Map(), this.resetLatestElement(), this.elements = /* @__PURE__ */ new Map(), this.classes = /* @__PURE__ */ new Map(), s();
	}
	setCssStyle(e, t) {
		for (let n of e) {
...
`, "getStyles"), b = {};
n(b, { draw: () => x });
var x = /* @__PURE__ */ t(async function(t, n, r, i) {
	e.info("REF0:"), e.info("Drawing requirement diagram (unified)", n);
	let { securityLevel: a, state: o, layout: s } = c(), l = i.db.getData(), u = m(n, a);
	l.type = i.type, l.layoutAlgorithm = p(s), l.nodeSpacing = o?.nodeSpacing ?? 50, l.rankSpacing = o?.rankSpacing ?? 50, l.markers = ["requirement_contains", "requirement_arrow"], l.diagramId = n, await f(l, u), d.insertTitle(u, "requirementDiagramTitleText", o?.titleTopMargin ?? 25, i.db.getDiagramTitle()), h(u, 8, "requirementDiagram", o?.useMaxWidth ?? !0);
}, "draw"), S = {
	parser: _,
	get db() {
		return new v();
