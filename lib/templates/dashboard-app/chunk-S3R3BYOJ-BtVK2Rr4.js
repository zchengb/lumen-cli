...
import { F as r, f as i, m as a, r as o, s } from "./chunk-ABZYJK2D-CVevQ3ur.js";
import "./math-C5EhTgJw.js";
import { t as c } from "./dist-DkhStvw3.js";
import { E as l, O as u, S as d, T as f, _ as p, c as m, d as ee, f as h, g as te, h as ne, i as re, m as ie, n as ae, p as oe, r as se, s as ce, t as g, u as le, v as _, w as ue, x as v } from "./identity-7Us_sWsB.js";
...
var Dt = Et(function(e, t, n) {
	...
	curveStepAfter: ze,
	curveStepBefore: Re
}, kt = /\s*(?:(\w+)(?=:):|(\w+))\s*(?:(\w+)|((?:(?!}%{2}).|\r?\n)*))?\s*(?:}%{2})?/gi, At = /* @__PURE__ */ t(function(e, t) {
	let n = jt(e, /(?:init\b)|(?:initialize\b)/), a = {};
	if (Array.isArray(n)) {
		let e = n.map((e) => e.args);
		r(e), a = o(a, [...e]);
	} else a = n.args;
	if (!a) return;
	let s = i(e, t), c = "config";
	return a[c] !== void 0 && (s === "flowchart-v2" && (s = "flowchart"), a[s] = a[c], delete a[c]), a;
}, "detectInit"), jt = /* @__PURE__ */ t(function(t, n = null) {
	try {
		let r = RegExp(`[%]{2}(?![{]${kt.source})(?=[}][%]{2}).*
`, "ig");
		t = t.trim().replace(r, "").replace(/'/gm, "\""), e.debug(`Detecting diagram directive${n === null ? "" : " type:" + n} based on the text:${t}`);
		let i, o = [];
		for (; (i = a.exec(t)) !== null;) if (i.index === a.lastIndex && a.lastIndex++, i && !n || n && i[1]?.match(n) || n && i[2]?.match(n)) {
...
}, "detectDirective"), Mt = /* @__PURE__ */ t(function(e) {
	return e.replace(a, "");
}, "removeDirectives"), Nt = /* @__PURE__ */ t(function(e, t) {
...
t(Lt, "calcLabelPosition");
var Rt = /* @__PURE__ */ t((e, t = 2) => {
	let n = 10 ** t;
	return Math.round(e * n) / n;
}, "roundNumber"), K = /* @__PURE__ */ t((e, t) => {
	let n, r = t;
	for (let t of e) {
		if (n) {
			let e = G(t, n);
...
}, "calculatePoint"), zt = /* @__PURE__ */ t((t, n, r) => {
	e.info(`our points ${JSON.stringify(n)}`), n[0] !== r && (n = n.reverse());
	let i = K(n, 25), a = t ? 10 : 5, o = Math.atan2(n[0].y - i.y, n[0].x - i.x), s = {
		x: 0,
		y: 0
	};
...
function Bt(t, n, r) {
	...
	let a = K(i, 25 + t), o = 10 + t * .5, s = Math.atan2(i[0].y - a.y, i[0].x - a.x), c = {
		x: 0,
		y: 0
	};
...
var Vt = 0, Ht = /* @__PURE__ */ t(() => (Vt++, "id-" + Math.random().toString(36).substr(2, 12) + "-" + Vt), "generateId");
function Ut(e) {
	let t = "";
...
t(Ut, "makeRandomHex");
var Wt = /* @__PURE__ */ t((e) => Ut(e.length), "random"), Gt = /* @__PURE__ */ t(function() {
	return {
		x: 0,
		y: 0,
		fill: void 0,
...
}, "getTextObj"), Kt = /* @__PURE__ */ t(function(e, t) {
	let n = t.text.replace(s.lineBreakRegex, " "), [, r] = Q(t.fontSize), i = e.append("text");
	...
	return r.forEach((e, o) => {
		let s = Y(`${e} `, n), c = Y(a, n);
		if (s > t) {
			let { hyphenatedStrings: r, remainingWord: o } = Jt(e, t, "-", n);
			i.push(a, ...r), a = o;
...
var X = _((e, t) => {
	...
	let [, o] = Q(r), c = ["sans-serif", i], l = e.split(s.lineBreakRegex), u = [], d = n("body");
	if (!d.remove) return {
		width: 0,
		height: 0,
		lineHeight: 0
...
}, "encodeEntities"), tn = /* @__PURE__ */ t(function(e) {
	return e.replace(/ﬂ°°/g, "&#").replace(/ﬂ°/g, "&").replace(/¶ß/g, ";");
}, "decodeEntities"), nn = /* @__PURE__ */ t((e, t, { counter: n = 0, prefix: r, suffix: i }, a) => a || `${r ? `${r}_` : ""}${e}_${t}_${n}${i ? `_${i}` : ""}`, "getEdgeId");
function rn(e) {
	return e ?? null;
}
t(rn, "handleUndefinedAttr");
function an(e, t) {
