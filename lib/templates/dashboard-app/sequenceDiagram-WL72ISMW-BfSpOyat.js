import { g as e, h as t, p as n } from "./src-B53NoQT1.js";
import { B as r, C as i, E as a, H as o, I as s, N as c, O as l, U as u, _ as d, a as f, b as p, c as m, i as h, r as g, s as _, v, y, z as b } from "./chunk-ABZYJK2D-CVevQ3ur.js";
import { f as x, h as S } from "./chunk-S3R3BYOJ-BtVK2Rr4.js";
import { n as C, t as w } from "./chunk-MI3HLSF2-DVisFF9Y.js";
import { t as T } from "./dist-DkhStvw3.js";
import { i as E, n as D, o as O, r as k, s as A, t as j } from "./chunk-TZMSLE5B-9hZnkN8w.js";
import { t as M } from "./chunk-QZHKN3VN-BIp_Ru6S.js";
//#region node_modules/mermaid/dist/chunks/mermaid.core/sequenceDiagram-WL72ISMW.mjs
var N = T(), P = (function() {
	var e = /* @__PURE__ */ t(function(e, t, n, r) {
		for (n ||= {}, r = e.length; r--; n[e[r]] = t);
		return n;
	}, "o"), n = [1, 2], r = [1, 3], i = [1, 4], a = [2, 4], o = [1, 9], s = [1, 11], c = [1, 13], l = [1, 14], u = [1, 16], d = [1, 17], f = [1, 18], p = [1, 24], m = [1, 25], h = [1, 26], g = [1, 27], _ = [1, 28], v = [1, 29], y = [1, 30], b = [1, 31], x = [1, 32], S = [1, 33], C = [1, 34], w = [1, 35], T = [1, 36], E = [1, 37], D = [1, 38], O = [1, 39], k = [1, 41], A = [1, 42], j = [1, 43], M = [1, 44], N = [1, 45], P = [1, 46], F = [
		1,
		4,
		5,
		13,
		...
		return {
			...
			performAction: /* @__PURE__ */ t(function(e, t, n, r) {
				switch (n) {
					...
					case 10: return t.yytext = t.yytext.trim(), 71;
					case 11: return t.yytext = t.yytext.trim(), this.begin("ALIAS"), 71;
	...
	return t(U, "Parser"), U.prototype = H, H.Parser = U, new U();
})();
P.parser = P;
var F = P, I = {
	SOLID: 0,
	...
	constructor() {
		...
		})), this.setAccTitle = r, this.setAccDescription = b, this.setDiagramTitle = u, this.getAccTitle = v, this.getAccDescription = d, this.getDiagramTitle = i, this.apply = this.apply.bind(this), this.parseBoxData = this.parseBoxData.bind(this), this.parseMessage = this.parseMessage.bind(this), this.clear(), this.setWrap(p().wrap), this.LINETYPE = I, this.ARROWTYPE = L, this.PLACEMENT = R;
	}
	static {
		t(this, "SequenceDB");
	}
	...
	extractWrap(e) {
		if (e === void 0) return {};
		e = e.trim();
		let t = /^:?wrap:/.exec(e) !== null || /^:?nowrap:/.exec(e) === null && void 0;
		return {
	...
	autoWrap() {
		return this.state.records.wrapEnabled === void 0 ? p().sequence?.wrap ?? !1 : this.state.records.wrapEnabled;
	}
	clear() {
		this.state.reset(), f();
	}
	parseMessage(t) {
		let n = t.trim(), { wrap: r, cleanedText: i } = this.extractWrap(n), a = {
			text: i,
			wrap: r
		};
	...
	addALink(t, n) {
		let r = this.getActor(t);
		try {
			let e = {}, t = s(n.text, p()), i = t.indexOf("@");
	...
	addProperties(t, n) {
		let r = this.getActor(t);
		try {
			let e = s(n.text, p()), t = JSON.parse(e);
	...
	addDetails(t, n) {
		let r = this.getActor(t), i = document.getElementById(n.text);
		try {
...
`, "getStyles"), B = 36, V = "actor-top", H = "actor-bottom", U = "actor-box", W = "actor-man", ne = /* @__PURE__ */ t(function(e, t) {
	return E(e, t);
}, "drawRect"), re = /* @__PURE__ */ t(function(e, t, n, r, i) {
...
}, "drawPopup"), ie = /* @__PURE__ */ t(function(e) {
	return "var pu = document.getElementById('" + e + "'); if (pu != null) { pu.style.display = pu.style.display == 'block' ? 'none' : 'block'; }";
}, "popupMenuToggle"), ae = /* @__PURE__ */ t(async function(e, t, n = null) {
	let r = e.append("foreignObject"), i = await c(t.text, y()), a = r.append("xhtml:div").attr("style", "width: fit-content;").attr("xmlns", "http://www.w3.org/1999/xhtml").html(i).node().getBoundingClientRect();
	...
	let r = 0, i = 0, a = n.text.split(_.lineBreakRegex), [o, s] = x(n.fontSize), c = [], l = 0, u = /* @__PURE__ */ t(() => n.y, "yfunc");
	...
	return c;
}, "drawText"), oe = /* @__PURE__ */ t(function(e, n) {
...
}, "drawLabel"), K = -1, se = /* @__PURE__ */ t((e, t, n, r) => {
...
}, "fixLifeLineHeights"), ce = /* @__PURE__ */ t(function(e, t, n, r) {
	let i = r ? t.stopy : t.starty, a = t.x + t.width / 2, o = i + t.height, s = e.append("g").lower();
	var c = s;
	r || (K++, Object.keys(t.links || {}).length && !n.forceMenus && c.attr("onclick", ie(`actor${K}_popup`)).attr("cursor", "pointer"), c.append("line").attr("id", "actor" + K).attr("x1", a).attr("y1", o).attr("x2", a).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name), c = s.append("g"), t.actorCnt = K, t.links != null && c.attr("id", "root-" + K));
	let u = O();
	var d = "actor";
	t.properties?.class ? d = t.properties.class : u.fill = "#eaeaea", r ? d += ` ${H}` : d += ` ${V}`, u.x = t.x, u.y = i, u.width = t.width, u.height = t.height, u.class = d, u.rx = 3, u.ry = 3, u.name = t.name;
	let f = ne(c, u);
	if (t.rectData = u, t.properties?.icon) {
		let e = t.properties.icon.trim();
		e.charAt(0) === "@" ? D(c, u.x + u.width - 20, u.y + 10, e.substr(1)) : k(c, u.x + u.width - 20, u.y + 10, e);
	}
	q(n, l(t.description))(t.description, c, u.x, u.y, u.width, u.height, { class: `actor ${U}` }, n);
	let p = t.height;
	if (f.node) {
	...
	return p;
}, "drawActorTypeParticipant"), le = /* @__PURE__ */ t(function(e, t, n, r) {
	let i = r ? t.stopy : t.starty, a = t.x + t.width / 2, o = i + t.height, s = e.append("g").lower();
	var c = s;
	r || (K++, Object.keys(t.links || {}).length && !n.forceMenus && c.attr("onclick", ie(`actor${K}_popup`)).attr("cursor", "pointer"), c.append("line").attr("id", "actor" + K).attr("x1", a).attr("y1", o).attr("x2", a).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name), c = s.append("g"), t.actorCnt = K, t.links != null && c.attr("id", "root-" + K));
	let u = O();
	var d = "actor";
	t.properties?.class ? d = t.properties.class : u.fill = "#eaeaea", r ? d += ` ${H}` : d += ` ${V}`, u.x = t.x, u.y = i, u.width = t.width, u.height = t.height, u.class = d, u.name = t.name;
	let f = {
		...u,
		x: u.x + -6,
		y: u.y + 6,
	...
	if (ne(c, f), t.rectData = u, t.properties?.icon) {
		let e = t.properties.icon.trim();
		e.charAt(0) === "@" ? D(c, u.x + u.width - 20, u.y + 10, e.substr(1)) : k(c, u.x + u.width - 20, u.y + 10, e);
	}
	q(n, l(t.description))(t.description, c, u.x - 6, u.y + 6, u.width, u.height, { class: `actor ${U}` }, n);
	let m = t.height;
	if (p.node) {
	...
	return m;
}, "drawActorTypeCollections"), ue = /* @__PURE__ */ t(function(e, t, n, r) {
	let i = r ? t.stopy : t.starty, a = t.x + t.width / 2, o = i + t.height, s = e.append("g").lower(), c = s;
	r || (K++, Object.keys(t.links || {}).length && !n.forceMenus && c.attr("onclick", ie(`actor${K}_popup`)).attr("cursor", "pointer"), c.append("line").attr("id", "actor" + K).attr("x1", a).attr("y1", o).attr("x2", a).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name), c = s.append("g"), t.actorCnt = K, t.links != null && c.attr("id", "root-" + K));
	let u = O(), d = "actor";
	t.properties?.class ? d = t.properties.class : u.fill = "#eaeaea", r ? d += ` ${H}` : d += ` ${V}`, u.x = t.x, u.y = i, u.width = t.width, u.height = t.height, u.class = d, u.name = t.name;
	let f = u.height / 2, p = f / (2.5 + u.height / 50), m = c.append("g"), h = c.append("g");
	if (m.append("path").attr("d", `M ${u.x},${u.y + f}
    a ${p},${f} 0 0 0 0,${u.height}
    h ${u.width - 2 * p}
    a ${p},${f} 0 0 0 0,-${u.height}
    Z
  `).attr("class", d), h.append("path").attr("d", `M ${u.x},${u.y + f}
      a ${p},${f} 0 0 0 0,${u.height}`).attr("stroke", "#666").attr("stroke-width", "1px").attr("class", d), m.attr("transform", `translate(${p}, ${-(u.height / 2)})`), h.attr("transform", `translate(${u.width - p}, ${-u.height / 2})`), t.rectData = u, t.properties?.icon) {
		let e = t.properties.icon.trim(), n = u.x + u.width - 20, r = u.y + 10;
		e.charAt(0) === "@" ? D(c, n, r, e.substr(1)) : k(c, n, r, e);
	}
	q(n, l(t.description))(t.description, c, u.x, u.y, u.width, u.height, { class: `actor ${U}` }, n);
	let g = t.height, _ = m.select("path:last-child");
	if (_.node()) {
		let e = _.node().getBBox();
		t.height = e.height, g = e.height;
	}
	return g;
}, "drawActorTypeQueue"), de = /* @__PURE__ */ t(function(e, t, n, r) {
	let i = r ? t.stopy : t.starty, a = t.x + t.width / 2, o = i + 75, s = e.append("g").lower();
	r || (K++, s.append("line").attr("id", "actor" + K).attr("x1", a).attr("y1", o).attr("x2", a).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name), t.actorCnt = K);
	let c = e.append("g"), u = W;
	r ? u += ` ${H}` : u += ` ${V}`, c.attr("class", u), c.attr("name", t.name);
	let d = O();
	d.x = t.x, d.y = i, d.fill = "#eaeaea", d.width = t.width, d.height = t.height, d.class = "actor";
	let f = t.x + t.width / 2, p = i + 30;
	return c.append("defs").append("marker").attr("id", "filled-head-control").attr("refX", 11).attr("refY", 5.8).attr("markerWidth", 20).attr("markerHeight", 28).attr("orient", "172.5").append("path").attr("d", "M 14.4 5.6 L 7.2 10.4 L 8.8 5.6 L 7.2 0.8 Z"), c.append("circle").attr("cx", f).attr("cy", p).attr("r", 18).attr("fill", "#eaeaf7").attr("stroke", "#666").attr("stroke-width", 1.2), c.append("line").attr("marker-end", "url(#filled-head-control)").attr("transform", `translate(${f}, ${p - 18})`), t.height = c.node().getBBox().height + 2 * (n?.sequence?.labelBoxHeight ?? 0), q(n, l(t.description))(t.description, c, d.x, d.y + 18 + (r ? 5 : 10), d.width, d.height, { class: `actor ${W}` }, n), t.height;
}, "drawActorTypeControl"), fe = /* @__PURE__ */ t(function(e, t, n, r) {
	let i = r ? t.stopy : t.starty, a = t.x + t.width / 2, o = i + 75, s = e.append("g").lower(), c = e.append("g"), u = W;
	r ? u += ` ${H}` : u += ` ${V}`, c.attr("class", u), c.attr("name", t.name);
	let d = O();
	d.x = t.x, d.y = i, d.fill = "#eaeaea", d.width = t.width, d.height = t.height, d.class = "actor";
	let f = t.x + t.width / 2, p = i + (r ? 10 : 25);
	return c.append("circle").attr("cx", f).attr("cy", p).attr("r", 18).attr("width", t.width).attr("height", t.height), c.append("line").attr("x1", f - 18).attr("x2", f + 18).attr("y1", p + 18).attr("y2", p + 18).attr("stroke", "#333").attr("stroke-width", 2), t.height = c.node().getBBox().height + (n?.sequence?.labelBoxHeight ?? 0), r || (K++, s.append("line").attr("id", "actor" + K).attr("x1", a).attr("y1", o).attr("x2", a).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name), t.actorCnt = K), q(n, l(t.description))(t.description, c, d.x, d.y + (r ? (p - i + 18 - 5) / 2 : (p + 18 - i) / 2), d.width, d.height, { class: `actor ${W}` }, n), c.attr("transform", `translate(0, ${18 / 2})`), t.height;
}, "drawActorTypeEntity"), pe = /* @__PURE__ */ t(function(e, t, n, r) {
	let i = r ? t.stopy : t.starty, a = t.x + t.width / 2, o = i + t.height + 2 * n.boxTextMargin, s = e.append("g").lower(), c = s;
	r || (K++, Object.keys(t.links || {}).length && !n.forceMenus && c.attr("onclick", ie(`actor${K}_popup`)).attr("cursor", "pointer"), c.append("line").attr("id", "actor" + K).attr("x1", a).attr("y1", o).attr("x2", a).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name), c = s.append("g"), t.actorCnt = K, t.links != null && c.attr("id", "root-" + K));
	let u = O(), d = "actor";
	t.properties?.class ? d = t.properties.class : u.fill = "#eaeaea", r ? d += ` ${H}` : d += ` ${V}`, u.x = t.x, u.y = i, u.width = t.width, u.height = t.height, u.class = d, u.name = t.name, u.x = t.x, u.y = i;
	let f = u.width / 4, p = u.width / 4, m = f / 2, h = m / (2.5 + f / 50), g = c.append("g"), _ = `
  M ${u.x},${u.y + h}
  a ${m},${h} 0 0 0 ${f},0
  a ${m},${h} 0 0 0 -${f},0
  l 0,${p - 2 * h}
  ...
  l 0,-${p - 2 * h}
`;
	g.append("path").attr("d", _).attr("fill", "#eaeaea").attr("stroke", "#000").attr("stroke-width", 1).attr("class", d), r ? g.attr("transform", `translate(${f * 1.5}, ${u.height / 4 - 2 * h})`) : g.attr("transform", `translate(${f * 1.5}, ${(u.height + h) / 4})`), t.rectData = u, q(n, l(t.description))(t.description, c, u.x, u.y + (r ? (u.height + p) / 4 : (u.height + h) / 2), u.width, u.height, { class: `actor ${U}` }, n);
	let v = g.select("path:last-child");
	return v.node() && (t.height = v.node().getBBox().height + (n.sequence.labelBoxHeight ?? 0)), t.height;
}, "drawActorTypeDatabase"), me = /* @__PURE__ */ t(function(e, t, n, r) {
	let i = r ? t.stopy : t.starty, a = t.x + t.width / 2, o = i + 80, s = e.append("g").lower();
	r || (K++, s.append("line").attr("id", "actor" + K).attr("x1", a).attr("y1", o).attr("x2", a).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name), t.actorCnt = K);
	let c = e.append("g"), u = W;
	r ? u += ` ${H}` : u += ` ${V}`, c.attr("class", u), c.attr("name", t.name);
	let d = O();
	return d.x = t.x, d.y = i, d.fill = "#eaeaea", d.width = t.width, d.height = t.height, d.class = "actor", c.append("line").attr("id", "actor-man-torso" + K).attr("x1", t.x + t.width / 2 - 30 * 2.5).attr("y1", i + 10).attr("x2", t.x + t.width / 2 - 15).attr("y2", i + 10), c.append("line").attr("id", "actor-man-arms" + K).attr("x1", t.x + t.width / 2 - 30 * 2.5).attr("y1", i + 0).attr("x2", t.x + t.width / 2 - 30 * 2.5).attr("y2", i + 20), c.append("circle").attr("cx", t.x + t.width / 2).attr("cy", i + 10).attr("r", 30), t.height = c.node().getBBox().height + (n.sequence.labelBoxHeight ?? 0), q(n, l(t.description))(t.description, c, d.x, d.y + (r ? 30 / 2 - 4 : 18), d.width, d.height, { class: `actor ${W}` }, n), c.attr("transform", "translate(0,22)"), t.height;
}, "drawActorTypeBoundary"), he = /* @__PURE__ */ t(function(e, t, n, r) {
	let i = r ? t.stopy : t.starty, a = t.x + t.width / 2, o = i + 80, s = e.append("g").lower();
	r || (K++, s.append("line").attr("id", "actor" + K).attr("x1", a).attr("y1", o).attr("x2", a).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name), t.actorCnt = K);
	let c = e.append("g"), u = W;
	r ? u += ` ${H}` : u += ` ${V}`, c.attr("class", u), c.attr("name", t.name);
	let d = O();
	d.x = t.x, d.y = i, d.fill = "#eaeaea", d.width = t.width, d.height = t.height, d.class = "actor", d.rx = 3, d.ry = 3, c.append("line").attr("id", "actor-man-torso" + K).attr("x1", a).attr("y1", i + 25).attr("x2", a).attr("y2", i + 45), c.append("line").attr("id", "actor-man-arms" + K).attr("x1", a - B / 2).attr("y1", i + 33).attr("x2", a + B / 2).attr("y2", i + 33), c.append("line").attr("x1", a - B / 2).attr("y1", i + 60).attr("x2", a).attr("y2", i + 45), c.append("line").attr("x1", a).attr("y1", i + 45).attr("x2", a + B / 2 - 2).attr("y2", i + 60);
	let f = c.append("circle");
	return f.attr("cx", t.x + t.width / 2), f.attr("cy", i + 10), f.attr("r", 15), f.attr("width", t.width), f.attr("height", t.height), t.height = c.node().getBBox().height, q(n, l(t.description))(t.description, c, d.x, d.y + 35, d.width, d.height, { class: `actor ${W}` }, n), t.height;
}, "drawActorTypeActor"), ge = /* @__PURE__ */ t(async function(e, t, n, r) {
	switch (t.type) {
		case "actor": return await he(e, t, n, r);
		case "participant": return await ce(e, t, n, r);
		case "boundary": return await me(e, t, n, r);
		case "control": return await de(e, t, n, r);
		case "entity": return await fe(e, t, n, r);
		case "database": return await pe(e, t, n, r);
		case "collections": return await le(e, t, n, r);
		case "queue": return await ue(e, t, n, r);
	}
}, "drawActor"), _e = /* @__PURE__ */ t(function(e, t, n) {
	let r = e.append("g");
	xe(r, t), t.name && q(n)(t.name, r, t.x, t.y + n.boxTextMargin + (t.textMaxHeight || 0) / 2, t.width, 0, { class: "text" }, n), r.lower();
}, "drawBox"), ve = /* @__PURE__ */ t(function(e) {
	return e.append("g");
}, "anchorElement"), ye = /* @__PURE__ */ t(function(e, t, n, r, i) {
	let a = O(), o = t.anchored;
	a.x = t.startx, a.y = t.starty, a.class = "activation" + i % 3, a.width = t.stopx - t.startx, a.height = n - t.starty, ne(o, a);
}, "drawActivation"), be = /* @__PURE__ */ t(async function(e, n, r, i) {
	let { boxMargin: a, boxTextMargin: o, labelBoxHeight: s, labelBoxWidth: c, messageFontFamily: u, messageFontSize: d, messageFontWeight: f } = i, p = e.append("g"), m = /* @__PURE__ */ t(function(e, t, n, r) {
		return p.append("line").attr("x1", e).attr("y1", t).attr("x2", n).attr("y2", r).attr("class", "loopLine");
	}, "drawLoopLine");
	m(n.startx, n.starty, n.stopx, n.starty), m(n.stopx, n.starty, n.stopx, n.stopy), m(n.startx, n.stopy, n.stopx, n.stopy), m(n.startx, n.starty, n.startx, n.stopy), n.sections !== void 0 && n.sections.forEach(function(e) {
		m(n.startx, e.y, n.stopx, e.y).style("stroke-dasharray", "3, 3");
	});
	let h = A();
	h.text = r, h.x = n.startx, h.y = n.starty, h.fontFamily = u, h.fontSize = d, h.fontWeight = f, h.anchor = "middle", h.valign = "middle", h.tspan = !1, h.width = c || 50, h.height = s || 20, h.textMargin = o, h.class = "labelText", oe(p, h), h = ke(), h.text = n.title, h.x = n.startx + c / 2 + (n.stopx - n.startx) / 2, h.y = n.starty + a + o, h.anchor = "middle", h.valign = "middle", h.textMargin = o, h.class = "loopText", h.fontFamily = u, h.fontSize = d, h.fontWeight = f, h.wrap = !0;
	let g = l(h.text) ? await ae(p, h, n) : G(p, h);
	if (n.sectionTitles !== void 0) {
		for (let [e, t] of Object.entries(n.sectionTitles)) if (t.message) {
			h.text = t.message, h.x = n.startx + (n.stopx - n.startx) / 2, h.y = n.sections[e].y + a + o, h.class = "loopText", h.anchor = "middle", h.valign = "middle", h.tspan = !1, h.fontFamily = u, h.fontSize = d, h.fontWeight = f, h.wrap = n.wrap, l(h.text) ? (n.starty = n.sections[e].y, await ae(p, h, n)) : G(p, h);
			let r = Math.round(g.map((e) => (e._groups || e)[0][0].getBBox().height).reduce((e, t) => e + t));
			n.sections[e].height += r - (a + o);
		}
	}
	return n.height = Math.round(n.stopy - n.starty), p;
}, "drawLoop"), xe = /* @__PURE__ */ t(function(e, t) {
	j(e, t);
}, "drawBackgroundRect"), Se = /* @__PURE__ */ t(function(e) {
...
}, "insertDatabaseIcon"), Ce = /* @__PURE__ */ t(function(e) {
...
}, "insertComputerIcon"), we = /* @__PURE__ */ t(function(e) {
...
}, "insertClockIcon"), Te = /* @__PURE__ */ t(function(e) {
...
}, "insertArrowHead"), Ee = /* @__PURE__ */ t(function(e) {
...
}, "insertArrowFilledHead"), De = /* @__PURE__ */ t(function(e) {
...
}, "insertSequenceNumber"), Oe = /* @__PURE__ */ t(function(e) {
...
}, "insertArrowCrossHead"), ke = /* @__PURE__ */ t(function() {
	return {
		x: 0,
		y: 0,
		fill: void 0,
...
}, "getNoteRect"), q = /* @__PURE__ */ (function() {
	function e(e, t, n, r, i, o, s) {
		a(t.append("text").attr("x", n + i / 2).attr("y", r + o / 2 + 5).style("text-anchor", "middle").text(e), s);
	}
	t(e, "byText");
	function n(e, t, n, r, i, o, s, c) {
		let { actorFontSize: l, actorFontFamily: u, actorFontWeight: d } = c, [f, p] = x(l), m = e.split(_.lineBreakRegex);
	...
	t(n, "byTspan");
	function r(e, t, r, i, o, s, c, l) {
		let u = t.append("switch"), d = u.append("foreignObject").attr("x", r).attr("y", i).attr("width", o).attr("height", s).append("xhtml:div").style("display", "table").style("height", "100%").style("width", "100%");
		d.append("div").style("display", "table-cell").style("text-align", "center").style("vertical-align", "middle").text(e), n(e, u, r, i, o, s, c, l), a(d, c);
	}
	t(r, "byFo");
	async function i(e, t, r, i, o, s, l, u) {
		let d = await h(e, y()), f = t.append("switch"), p = f.append("foreignObject").attr("x", r + o / 2 - d.width / 2).attr("y", i + s / 2 - d.height / 2).attr("width", d.width).attr("height", d.height).append("xhtml:div").style("height", "100%").style("width", "100%");
		p.append("div").style("text-align", "center").style("vertical-align", "middle").html(await c(e, y())), n(e, f, r, i, o, s, l, u), a(p, l);
	}
	t(i, "byKatex");
	function a(e, t) {
		for (let n in t) t.hasOwnProperty(n) && e.attr(n, t[n]);
	}
	return t(a, "_setTextAttrs"), function(t, a = !1) {
		return a ? i : t.textPlacement === "fo" ? r : t.textPlacement === "old" ? e : n;
	};
	...
	function n(e, t, n, r, a, o, s, c) {
		let { actorFontSize: l, actorFontFamily: u, actorFontWeight: d } = c, f = e.split(_.lineBreakRegex);
	...
	drawActivation: ye,
	drawLoop: be,
	drawBackgroundRect: xe,
	insertArrowHead: Te,
	insertArrowFilledHead: Ee,
	insertSequenceNumber: De,
	insertArrowCrossHead: Oe,
	insertDatabaseIcon: Se,
	insertComputerIcon: Ce,
	insertClockIcon: we,
	getTextObj: ke,
	getNoteRect: Ae,
	...
	updateBounds: /* @__PURE__ */ t(function(e, n, r, i) {
		...
		function s(s) {
			return /* @__PURE__ */ t(function(t) {
				...
				a.updateVal(t, "starty", n - c * Y.boxMargin, Math.min), a.updateVal(t, "stopy", i + c * Y.boxMargin, Math.max), a.updateVal(X.data, "startx", e - c * Y.boxMargin, Math.min), a.updateVal(X.data, "stopx", r + c * Y.boxMargin, Math.max), s !== "activation" && (a.updateVal(t, "startx", e - c * Y.boxMargin, Math.min), a.updateVal(t, "stopx", r + c * Y.boxMargin, Math.max), a.updateVal(X.data, "starty", n - c * Y.boxMargin, Math.min), a.updateVal(X.data, "stopy", i + c * Y.boxMargin, Math.max));
			}, "updateItemBounds");
		}
		t(s, "updateFn"), this.sequenceItems.forEach(s()), this.activations.forEach(s("activation"));
	}, "updateBounds"),
	insert: /* @__PURE__ */ t(function(e, t, n, r) {
		let i = _.getMin(e, n), a = _.getMax(e, n), o = _.getMin(t, r), s = _.getMax(t, r);
		this.updateVal(X.data, "startx", i, Math.min), this.updateVal(X.data, "starty", o, Math.min), this.updateVal(X.data, "stopx", a, Math.max), this.updateVal(X.data, "stopy", s, Math.max), this.updateBounds(i, o, a, s);
	}, "insert"),
	newActivation: /* @__PURE__ */ t(function(e, t, n) {
		let r = n.get(e.from), i = Be(e.from).length || 0, a = r.x + r.width / 2 + (i - 1) * Y.activationWidth / 2;
		this.activations.push({
			startx: a,
			starty: this.verticalPos + 2,
			stopx: a + Y.activationWidth,
			stopy: void 0,
			actor: e.from,
			anchored: J.anchorElement(t)
		});
	}, "newActivation"),
	...
	bumpVerticalPos: /* @__PURE__ */ t(function(e) {
		this.verticalPos += e, this.data.stopy = _.getMax(this.data.stopy, this.verticalPos);
	}, "bumpVerticalPos"),
...
}, Me = /* @__PURE__ */ t(async function(e, t) {
	X.bumpVerticalPos(Y.boxMargin), t.height = Y.boxMargin, t.starty = X.getVerticalPos();
	let n = O();
	n.x = t.startx, n.y = t.starty, n.width = t.width || Y.width, n.class = "note";
	let r = e.append("g"), i = J.drawRect(r, n), a = A();
	a.x = t.startx, a.y = t.starty, a.width = n.width, a.dy = "1em", a.text = t.message, a.class = "noteText", a.fontFamily = Y.noteFontFamily, a.fontSize = Y.noteFontSize, a.fontWeight = Y.noteFontWeight, a.anchor = Y.noteAlign, a.textMargin = Y.noteMargin, a.valign = "center";
	let o = l(a.text) ? await ae(r, a) : G(r, a), s = Math.round(o.map((e) => (e._groups || e)[0][0].getBBox().height).reduce((e, t) => e + t));
	i.attr("height", s + 2 * Y.noteMargin), t.height += s + 2 * Y.noteMargin, X.bumpVerticalPos(s + 2 * Y.noteMargin), t.stopy = t.starty + s + 2 * Y.noteMargin, t.stopx = t.startx + n.width, X.insert(t.startx, t.starty, t.stopx, t.stopy), X.models.addNote(t);
}, "drawNote"), Z = /* @__PURE__ */ t((e) => ({
	fontFamily: e.messageFontFamily,
	fontSize: e.messageFontSize,
	fontWeight: e.messageFontWeight
}), "messageFont"), Q = /* @__PURE__ */ t((e) => ({
	fontFamily: e.noteFontFamily,
	fontSize: e.noteFontSize,
	fontWeight: e.noteFontWeight
}), "noteFont"), Ne = /* @__PURE__ */ t((e) => ({
...
async function Pe(e, t) {
	...
	let { startx: n, stopx: r, message: i } = t, a = _.splitBreaks(i).length, o = l(i), s = o ? await h(i, p()) : S.calculateTextDimensions(i, Z(Y));
	if (!o) {
		let e = s.height / a;
		t.height += e, X.bumpVerticalPos(e);
	}
	let c, u = s.height - 10, d = s.width;
	if (n === r) {
		c = X.getVerticalPos() + u, Y.rightAngles || (u += Y.boxMargin, c = X.getVerticalPos() + u), u += 30;
		let e = _.getMax(d / 2, Y.width / 2);
		X.insert(n - e, X.getVerticalPos() - 10 + u, r + e, X.getVerticalPos() + 30 + u);
	} else u += Y.boxMargin, c = X.getVerticalPos() + u, X.insert(n, c - 10, r, c);
	return X.bumpVerticalPos(u), t.height += u, t.stopy = t.starty + t.height, X.insert(t.fromBounds, t.starty, t.toBounds, t.stopy), c;
}
t(Pe, "boundMessage");
var Fe = /* @__PURE__ */ t(async function(e, t, n, r) {
	let { startx: i, stopx: o, starty: s, message: c, type: u, sequenceIndex: d, sequenceVisible: f } = t, p = S.calculateTextDimensions(c, Z(Y)), m = A();
	m.x = i, m.y = s + 10, m.width = o - i, m.class = "messageText", m.dy = "1em", m.text = c, m.fontFamily = Y.messageFontFamily, m.fontSize = Y.messageFontSize, m.fontWeight = Y.messageFontWeight, m.anchor = Y.messageAlign, m.valign = "center", m.textMargin = Y.wrapPadding, m.tspan = !1, l(m.text) ? await ae(e, m, {
		startx: i,
		stopx: o,
		starty: n
	}) : G(e, m);
	let h = p.width, g;
	i === o ? g = Y.rightAngles ? e.append("path").attr("d", `M  ${i},${n} H ${i + _.getMax(Y.width / 2, h / 2)} V ${n + 25} H ${i}`) : e.append("path").attr("d", "M " + i + "," + n + " C " + (i + 60) + "," + (n - 10) + " " + (i + 60) + "," + (n + 30) + " " + i + "," + (n + 20)) : (g = e.append("line"), g.attr("x1", i), g.attr("y1", n), g.attr("x2", o), g.attr("y2", n)), u === r.db.LINETYPE.DOTTED || u === r.db.LINETYPE.DOTTED_CROSS || u === r.db.LINETYPE.DOTTED_POINT || u === r.db.LINETYPE.DOTTED_OPEN || u === r.db.LINETYPE.BIDIRECTIONAL_DOTTED ? (g.style("stroke-dasharray", "3, 3"), g.attr("class", "messageLine1")) : g.attr("class", "messageLine0");
	let v = "";
	Y.arrowMarkerAbsolute && (v = a(!0)), g.attr("stroke-width", 2), g.attr("stroke", "none"), g.style("fill", "none"), (u === r.db.LINETYPE.SOLID || u === r.db.LINETYPE.DOTTED) && g.attr("marker-end", "url(" + v + "#arrowhead)"), (u === r.db.LINETYPE.BIDIRECTIONAL_SOLID || u === r.db.LINETYPE.BIDIRECTIONAL_DOTTED) && (g.attr("marker-start", "url(" + v + "#arrowhead)"), g.attr("marker-end", "url(" + v + "#arrowhead)")), (u === r.db.LINETYPE.SOLID_POINT || u === r.db.LINETYPE.DOTTED_POINT) && g.attr("marker-end", "url(" + v + "#filled-head)"), (u === r.db.LINETYPE.SOLID_CROSS || u === r.db.LINETYPE.DOTTED_CROSS) && g.attr("marker-end", "url(" + v + "#crosshead)"), (f || Y.showSequenceNumbers) && ((u === r.db.LINETYPE.BIDIRECTIONAL_SOLID || u === r.db.LINETYPE.BIDIRECTIONAL_DOTTED) && (i < o ? g.attr("x1", i + 12) : g.attr("x1", i + 6)), e.append("line").attr("x1", i).attr("y1", n).attr("x2", i).attr("y2", n).attr("stroke-width", 0).attr("marker-start", "url(" + v + "#sequencenumber)"), e.append("text").attr("x", i).attr("y", n + 4).attr("font-family", "sans-serif").attr("font-size", "12px").attr("text-anchor", "middle").attr("class", "sequenceNumber").text(d));
}, "drawMessage"), Ie = /* @__PURE__ */ t(function(e, t, n, r, i, a, o) {
	let s = 0, c = 0, l, u = 0;
	for (let e of r) {
	...
	l && !o && X.models.addBox(l), X.bumpVerticalPos(u);
}, "addActorRenderingData"), Le = /* @__PURE__ */ t(async function(e, t, n, r) {
	if (r) {
		let r = 0;
		X.bumpVerticalPos(Y.boxMargin * 2);
		for (let i of n) {
			let n = t.get(i);
			n.stopy ||= X.getVerticalPos();
			let a = await J.drawActor(e, n, Y, !0);
			r = _.getMax(r, a);
		}
		X.bumpVerticalPos(r + Y.boxMargin);
	} else for (let r of n) {
		let n = t.get(r);
		await J.drawActor(e, n, Y, !1);
	}
}, "drawActors"), Re = /* @__PURE__ */ t(function(e, t, n, r) {
	let i = 0, a = 0;
	for (let o of n) {
		let n = t.get(o), s = Ge(n), c = J.drawPopup(e, n, s, Y, Y.forceMenus, r);
...
}, "drawActorsPopup"), ze = /* @__PURE__ */ t(function(e) {
	g(Y, e), e.fontFamily && (Y.actorFontFamily = Y.noteFontFamily = Y.messageFontFamily = e.fontFamily), e.fontSize && (Y.actorFontSize = Y.noteFontSize = Y.messageFontSize = e.fontSize), e.fontWeight && (Y.actorFontWeight = Y.noteFontWeight = Y.messageFontWeight = e.fontWeight);
}, "setConf"), Be = /* @__PURE__ */ t(function(e) {
	return X.activations.filter(function(t) {
		return t.actor === e;
	});
}, "actorActivations"), Ve = /* @__PURE__ */ t(function(e, t) {
	let n = t.get(e), r = Be(e);
	return [r.reduce(function(e, t) {
		return _.getMin(e, t.startx);
	}, n.x + n.width / 2 - 1), r.reduce(function(e, t) {
		return _.getMax(e, t.stopx);
	}, n.x + n.width / 2 + 1)];
}, "activationBounds");
function $(t, n, r, i, a) {
	X.bumpVerticalPos(r);
	...
	if (n.id && n.message && t[n.id]) {
		let r = t[n.id].width, a = Z(Y);
		n.message = S.wrapLabel(`[${n.message}]`, r - 2 * Y.wrapPadding, a), n.width = r, n.wrap = !0;
		let s = S.calculateTextDimensions(n.message, a), c = _.getMax(s.height, Y.labelBoxHeight);
		o = i + c, e.debug(`${c} - ${n.message}`);
	}
	a(n), X.bumpVerticalPos(o);
}
t($, "adjustLoopHeightForWrap");
function He(e, n, r, i, a, o, s) {
	function c(t, r) {
		t.x < a.get(e.from).x ? (X.insert(n.stopx - r, n.starty, n.startx, n.stopy + t.height / 2 + Y.noteMargin), n.stopx += r) : (X.insert(n.startx, n.starty, n.stopx + r, n.stopy + t.height / 2 + Y.noteMargin), n.stopx -= r);
	}
	t(c, "receiverAdjustment");
	function l(t, r) {
		t.x < a.get(e.to).x ? (X.insert(n.startx - r, n.starty, n.stopx, n.stopy + t.height / 2 + Y.noteMargin), n.startx += r) : (X.insert(n.stopx, n.starty, n.startx + r, n.stopy + t.height / 2 + Y.noteMargin), n.startx -= r);
	}
	...
	if (o.get(e.to) == i) {
		let t = a.get(e.to);
		c(t, u.includes(t.type) ? B / 2 + 3 : t.width / 2 + 3), t.starty = r - t.height / 2, X.bumpVerticalPos(t.height / 2);
	} else if (s.get(e.from) == i) {
		let t = a.get(e.from);
		Y.mirrorActors && l(t, u.includes(t.type) ? B / 2 : t.width / 2), t.stopy = r - t.height / 2, X.bumpVerticalPos(t.height / 2);
	} else if (s.get(e.to) == i) {
		let t = a.get(e.to);
		Y.mirrorActors && c(t, u.includes(t.type) ? B / 2 + 3 : t.width / 2 + 3), t.stopy = r - t.height / 2, X.bumpVerticalPos(t.height / 2);
	}
}
t(He, "adjustCreatedDestroyedData");
var Ue = /* @__PURE__ */ t(async function(r, i, a, o) {
	let { securityLevel: s, sequence: c } = p();
	Y = c;
	let l;
	s === "sandbox" && (l = n("#i" + i));
	let u = n(s === "sandbox" ? l.nodes()[0].contentDocument.body : "body"), d = s === "sandbox" ? l.nodes()[0].contentDocument : document;
	X.init(), e.debug(o.db);
	let f = s === "sandbox" ? u.select(`[id="${i}"]`) : n(`[id="${i}"]`), h = o.db.getActors(), g = o.db.getCreatedActors(), _ = o.db.getDestroyedActors(), v = o.db.getBoxes(), y = o.db.getActorKeys(), b = o.db.getMessages(), x = o.db.getDiagramTitle(), S = o.db.hasAtLeastOneBox(), C = o.db.hasAtLeastOneBoxWithTitle(), w = await We(h, b, o);
	if (Y.height = await Ke(h, w, v), J.insertComputerIcon(f), J.insertDatabaseIcon(f), J.insertClockIcon(f), S && (X.bumpVerticalPos(Y.boxMargin), C && X.bumpVerticalPos(v[0].textMaxHeight)), Y.hideUnusedParticipants === !0) {
	...
	Ie(f, h, g, y, 0, b, !1);
	let T = await Ye(b, h, w, o);
	J.insertArrowHead(f), J.insertArrowCrossHead(f), J.insertArrowFilledHead(f), J.insertSequenceNumber(f);
	function E(e, t) {
		let n = X.endActivation(e);
		n.starty + 18 > t && (n.starty = t - 6, t += 12), J.drawActivation(f, n, t, Y, Be(e.from).length), X.insert(n.startx, t - 10, n.stopx, t);
	}
	t(E, "activeEnd");
	let D = 1, O = 1, k = [], A = [], j = 0;
	for (let t of b) {
		...
		switch (t.type) {
			case o.db.LINETYPE.NOTE:
				X.resetVerticalPos(), r = t.noteModel, await Me(f, r);
				break;
			case o.db.LINETYPE.ACTIVE_START:
				X.newActivation(t, f, h);
				break;
			case o.db.LINETYPE.ACTIVE_END:
				E(t, X.getVerticalPos());
				break;
			case o.db.LINETYPE.LOOP_START:
				$(T, t, Y.boxMargin, Y.boxMargin + Y.boxTextMargin, (e) => X.newLoop(e));
				break;
			case o.db.LINETYPE.LOOP_END:
				n = X.endLoop(), await J.drawLoop(f, n, "loop", Y), X.bumpVerticalPos(n.stopy - X.getVerticalPos()), X.models.addLoop(n);
				break;
			case o.db.LINETYPE.RECT_START:
				$(T, t, Y.boxMargin, Y.boxMargin, (e) => X.newLoop(void 0, e.message));
				break;
			case o.db.LINETYPE.RECT_END:
				n = X.endLoop(), A.push(n), X.models.addLoop(n), X.bumpVerticalPos(n.stopy - X.getVerticalPos());
				break;
			case o.db.LINETYPE.OPT_START:
				$(T, t, Y.boxMargin, Y.boxMargin + Y.boxTextMargin, (e) => X.newLoop(e));
				break;
			case o.db.LINETYPE.OPT_END:
				n = X.endLoop(), await J.drawLoop(f, n, "opt", Y), X.bumpVerticalPos(n.stopy - X.getVerticalPos()), X.models.addLoop(n);
				break;
			case o.db.LINETYPE.ALT_START:
				$(T, t, Y.boxMargin, Y.boxMargin + Y.boxTextMargin, (e) => X.newLoop(e));
				break;
			case o.db.LINETYPE.ALT_ELSE:
				$(T, t, Y.boxMargin + Y.boxTextMargin, Y.boxMargin, (e) => X.addSectionToLoop(e));
				break;
			case o.db.LINETYPE.ALT_END:
				n = X.endLoop(), await J.drawLoop(f, n, "alt", Y), X.bumpVerticalPos(n.stopy - X.getVerticalPos()), X.models.addLoop(n);
				break;
			case o.db.LINETYPE.PAR_START:
			case o.db.LINETYPE.PAR_OVER_START:
				$(T, t, Y.boxMargin, Y.boxMargin + Y.boxTextMargin, (e) => X.newLoop(e)), X.saveVerticalPos();
				break;
			case o.db.LINETYPE.PAR_AND:
				$(T, t, Y.boxMargin + Y.boxTextMargin, Y.boxMargin, (e) => X.addSectionToLoop(e));
				break;
			case o.db.LINETYPE.PAR_END:
				n = X.endLoop(), await J.drawLoop(f, n, "par", Y), X.bumpVerticalPos(n.stopy - X.getVerticalPos()), X.models.addLoop(n);
				break;
			case o.db.LINETYPE.AUTONUMBER:
				D = t.message.start || D, O = t.message.step || O, t.message.visible ? o.db.enableSequenceNumbers() : o.db.disableSequenceNumbers();
				break;
			...
			case o.db.LINETYPE.CRITICAL_END:
				n = X.endLoop(), await J.drawLoop(f, n, "critical", Y), X.bumpVerticalPos(n.stopy - X.getVerticalPos()), X.models.addLoop(n);
				break;
			case o.db.LINETYPE.BREAK_START:
				$(T, t, Y.boxMargin, Y.boxMargin + Y.boxTextMargin, (e) => X.newLoop(e));
				break;
			case o.db.LINETYPE.BREAK_END:
				n = X.endLoop(), await J.drawLoop(f, n, "break", Y), X.bumpVerticalPos(n.stopy - X.getVerticalPos()), X.models.addLoop(n);
				break;
			default: try {
				i = t.msgModel, i.starty = X.getVerticalPos(), i.sequenceIndex = D, i.sequenceVisible = o.db.showSequenceNumbers();
				let e = await Pe(f, i);
				He(t, i, e, j, h, g, _), k.push({
					messageModel: i,
					lineStartY: e
				}), X.models.addMessage(i);
			} catch (t) {
		...
		].includes(t.type) && (D += O), j++;
	}
	e.debug("createdActors", g), e.debug("destroyedActors", _), await Le(f, h, y, !1);
	for (let e of k) await Fe(f, e.messageModel, e.lineStartY, o);
	Y.mirrorActors && await Le(f, h, y, !0), A.forEach((e) => J.drawBackgroundRect(f, e)), se(f, h, y, Y);
	for (let e of X.models.boxes) {
		e.height = X.getVerticalPos() - e.y, X.insert(e.x, e.y, e.x + e.width, e.height);
		let t = Y.boxMargin * 2;
		e.startx = e.x - t, e.starty = e.y - t * .25, e.stopx = e.startx + e.width + 2 * t, e.stopy = e.starty + e.height + t * .75, e.stroke = "rgb(0,0,0, 0.5)", J.drawBox(f, e, Y);
	}
	S && X.bumpVerticalPos(Y.boxMargin);
	let M = Re(f, h, y, d), { bounds: N } = X.getBounds();
	N.startx === void 0 && (N.startx = 0), N.starty === void 0 && (N.starty = 0), N.stopx === void 0 && (N.stopx = 0), N.stopy === void 0 && (N.stopy = 0);
	let P = N.stopy - N.starty;
	P < M.maxHeight && (P = M.maxHeight);
	let F = P + 2 * Y.diagramMarginY;
	Y.mirrorActors && (F = F - Y.boxMargin + Y.bottomMarginAdj);
	let I = N.stopx - N.startx;
	I < M.maxWidth && (I = M.maxWidth);
	let L = I + 2 * Y.diagramMarginX;
	x && f.append("text").text(x).attr("x", (N.stopx - N.startx) / 2 - 2 * Y.diagramMarginX).attr("y", -25), m(f, F, L, Y.useMaxWidth);
	let R = x ? 40 : 0;
	f.attr("viewBox", N.startx - Y.diagramMarginX + " -" + (Y.diagramMarginY + R) + " " + L + " " + (F + R)), e.debug("models:", X.models);
}, "draw");
async function We(t, n, r) {
	let i = {};
	for (let e of n) if (t.get(e.to) && t.get(e.from)) {
		let n = t.get(e.to);
		if (e.placement === r.db.PLACEMENT.LEFTOF && !n.prevActor || e.placement === r.db.PLACEMENT.RIGHTOF && !n.nextActor) continue;
		let a = e.placement !== void 0, o = !a, s = a ? Q(Y) : Z(Y), c = e.wrap ? S.wrapLabel(e.message, Y.width - 2 * Y.wrapPadding, s) : e.message, u = (l(c) ? await h(e.message, p()) : S.calculateTextDimensions(c, s)).width + 2 * Y.wrapPadding;
		o && e.from === n.nextActor ? i[e.to] = _.getMax(i[e.to] || 0, u) : o && e.from === n.prevActor ? i[e.from] = _.getMax(i[e.from] || 0, u) : o && e.from === e.to ? (i[e.from] = _.getMax(i[e.from] || 0, u / 2), i[e.to] = _.getMax(i[e.to] || 0, u / 2)) : e.placement === r.db.PLACEMENT.RIGHTOF ? i[e.from] = _.getMax(i[e.from] || 0, u) : e.placement === r.db.PLACEMENT.LEFTOF ? i[n.prevActor] = _.getMax(i[n.prevActor] || 0, u) : e.placement === r.db.PLACEMENT.OVER && (n.prevActor && (i[n.prevActor] = _.getMax(i[n.prevActor] || 0, u / 2)), n.nextActor && (i[e.from] = _.getMax(i[e.from] || 0, u / 2)));
	}
	return e.debug("maxMessageWidthPerActor:", i), i;
}
t(We, "getMaxMessageWidthPerActor");
var Ge = /* @__PURE__ */ t(function(e) {
	let t = 0, n = Ne(Y);
	for (let r in e.links) {
		let e = S.calculateTextDimensions(r, n).width + 2 * Y.wrapPadding + 2 * Y.boxMargin;
		t < e && (t = e);
	}
	return t;
...
async function Ke(e, t, n) {
	...
	for (let t of e.keys()) {
		let n = e.get(t);
		n.wrap && (n.description = S.wrapLabel(n.description, Y.width - 2 * Y.wrapPadding, Ne(Y)));
		let i = l(n.description) ? await h(n.description, p()) : S.calculateTextDimensions(n.description, Ne(Y));
		n.width = n.wrap ? Y.width : _.getMax(Y.width, i.width + 2 * Y.wrapPadding), n.height = n.wrap ? _.getMax(i.height, Y.height) : Y.height, r = _.getMax(r, n.height);
	}
	for (let n in t) {
		let r = e.get(n);
		if (!r) continue;
		...
		if (!i) {
			let e = t[n] + Y.actorMargin - r.width / 2;
			r.margin = _.getMax(e, Y.actorMargin);
			continue;
		}
		let a = t[n] + Y.actorMargin - r.width / 2 - i.width / 2;
		r.margin = _.getMax(a, Y.actorMargin);
	}
	let i = 0;
	return n.forEach((t) => {
		let n = Z(Y), r = t.actorKeys.reduce((t, n) => t += e.get(n).width + (e.get(n).margin || 0), 0), a = Y.boxMargin * 8;
		r += a, r -= 2 * Y.boxTextMargin, t.wrap && (t.name = S.wrapLabel(t.name, r - 2 * Y.wrapPadding, n));
		let o = S.calculateTextDimensions(t.name, n);
		i = _.getMax(o.height, i);
		let s = _.getMax(r, o.width + 2 * Y.wrapPadding);
		if (t.margin = Y.boxTextMargin, r < s) {
			let e = (s - r) / 2;
			t.margin += e;
		}
	}), n.forEach((e) => e.textMaxHeight = i), _.getMax(r, Y.height);
}
t(Ke, "calculateActorMargins");
var qe = /* @__PURE__ */ t(async function(t, n, r) {
	let i = n.get(t.from), a = n.get(t.to), o = i.x, s = a.x, c = t.wrap && t.message, u = l(t.message) ? await h(t.message, p()) : S.calculateTextDimensions(c ? S.wrapLabel(t.message, Y.width, Q(Y)) : t.message, Q(Y)), d = {
		width: c ? Y.width : _.getMax(Y.width, u.width + 2 * Y.noteMargin),
		height: 0,
		startx: i.x,
		stopx: 0,
		starty: 0,
	...
	let [i, a] = Ve(e.from, n), [o, s] = Ve(e.to, n), c = i <= o, l = c ? a : i, u = c ? o : s, d = Math.abs(o - s) > 2, f = /* @__PURE__ */ t((e) => c ? -e : e, "adjustValue");
	e.from === e.to ? u = l : (e.activate && !d && (u += f(Y.activationWidth / 2 - 1)), [r.db.LINETYPE.SOLID_OPEN, r.db.LINETYPE.DOTTED_OPEN].includes(e.type) || (u += f(3)), [r.db.LINETYPE.BIDIRECTIONAL_SOLID, r.db.LINETYPE.BIDIRECTIONAL_DOTTED].includes(e.type) && (l -= f(3)));
	let p = [
		i,
		a,
		o,
	...
	e.wrap && e.message && (e.message = S.wrapLabel(e.message, _.getMax(m + 2 * Y.wrapPadding, Y.width), Z(Y)));
	let h = S.calculateTextDimensions(e.message, Z(Y));
	return {
		width: _.getMax(e.wrap ? 0 : h.width + 2 * Y.wrapPadding, m + 2 * Y.wrapPadding, Y.width),
		height: 0,
		startx: l,
		stopx: u,
		starty: 0,
...
}, "buildMessageModel"), Ye = /* @__PURE__ */ t(async function(t, n, r, i) {
	let a = {}, o = [], s, c, l;
	for (let e of t) {
		switch (e.type) {
			...
			case i.db.LINETYPE.ACTIVE_START:
				{
					let t = n.get(e.from ? e.from : e.to.actor), r = Be(e.from ? e.from : e.to.actor).length, i = t.x + t.width / 2 + (r - 1) * Y.activationWidth / 2, a = {
						startx: i,
						stopx: i + Y.activationWidth,
						actor: e.from,
						enabled: !0
					};
					X.activations.push(a);
				}
				break;
			case i.db.LINETYPE.ACTIVE_END:
				{
					let t = X.activations.map((e) => e.actor).lastIndexOf(e.from);
					X.activations.splice(t, 1).splice(0, 1);
				}
				break;
		}
		e.placement === void 0 ? (l = Je(e, n, i), e.msgModel = l, l.startx && l.stopx && o.length > 0 && o.forEach((t) => {
			if (s = t, l.startx === l.stopx) {
				let t = n.get(e.from), r = n.get(e.to);
				s.from = _.getMin(t.x - l.width / 2, t.x - t.width / 2, s.from), s.to = _.getMax(r.x + l.width / 2, r.x + t.width / 2, s.to), s.width = _.getMax(s.width, Math.abs(s.to - s.from)) - Y.labelBoxWidth;
			} else s.from = _.getMin(l.startx, s.from), s.to = _.getMax(l.stopx, s.to), s.width = _.getMax(s.width, l.width) - Y.labelBoxWidth;
		})) : (c = await qe(e, n, i), e.noteModel = c, o.forEach((e) => {
			s = e, s.from = _.getMin(s.from, c.startx), s.to = _.getMax(s.to, c.startx + c.width), s.width = _.getMax(s.width, Math.abs(s.from - s.to)) - Y.labelBoxWidth;
		}));
	}
	return X.activations = [], e.debug("Loop type widths:", a), a;
}, "calculateLoopBounds"), Xe = {
	parser: F,
	get db() {
		return new ee();
	},
	...
	styles: te,
	init: /* @__PURE__ */ t((e) => {
		e.sequence ||= {}, e.wrap && (e.sequence.wrap = e.wrap, o({ sequence: { wrap: e.wrap } }));
	}, "init")
};
//#endregion
