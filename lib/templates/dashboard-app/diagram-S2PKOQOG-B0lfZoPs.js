...
import { B as n, C as r, U as i, _ as a, a as o, c as s, d as c, v as l, y as u, z as d } from "./chunk-ABZYJK2D-CVevQ3ur.js";
...
var g = c.packet, _ = class {
	constructor() {
		this.packet = [], this.setAccTitle = n, this.getAccTitle = l, this.setDiagramTitle = i, this.getDiagramTitle = r, this.getAccDescription = a, this.setAccDescription = d;
	}
	static {
		t(this, "PacketDB");
	}
	...
	for (let { start: s, end: c, bits: l, label: u } of t.blocks) {
		...
		for (c ??= s + (l ?? 1) - 1, l ??= c - s + 1, r = c, e.debug(`Packet block ${s} - ${r} with label ${u}`); i.length <= o + 1 && n.getPacket().length < v;) {
			let [e, t] = b({
				start: s,
				end: c,
				bits: l,
	...
	parse: /* @__PURE__ */ t(async (t) => {
		let n = await m("packet", t), r = x.parser?.yy;
...
}, "draw"), C = /* @__PURE__ */ t((e, t, n, { rowHeight: r, paddingX: i, paddingY: a, bitWidth: o, bitsPerRow: s, showBits: c }) => {
