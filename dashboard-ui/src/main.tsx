  ...
  return <section className="repository-runtime">
    ...
    {platform === "web" && <>
      <div className="form-grid compact">
        ...
        <Field label="Auth credential env"><input value={runtime.auth_credential_env || ""} placeholder="LUMEN_VISUAL_USERNAME" onChange={(event) => onChange({ auth_credential_env: event.target.value })} /></Field>
